...
- **Flexible service checks.** Monitor HTTP requests with ordered regex, JSONPath, header, latency, and sandboxed script assertions, plus TCP connections, DNS resolution, ICMP echo, and TLS certificates.
