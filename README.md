...
UpGrid is a self-contained service monitor. Run one binary for a capable uptime dashboard, or join several nodes into a resilient cluster without an external database, queue, or control plane.
