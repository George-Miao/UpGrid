...
- **Flexible service checks.** Monitor HTTP requests, TCP connections, DNS resolution, ICMP echo, and TLS certificates with configurable timeouts and consecutive-failure thresholds.
