...
use crate::domain::{
    ...
    PreAuthApplicationState, PreDrainApplicationState, PreviousApplicationState,
    TokenApplicationState, TransitionApplicationState,
};
use crate::raft::{Res, TC};

pub(super) const STATE_MAGIC: &[u8] = b"UPGS10";
...
pub(super) const SNAPSHOT_MAGIC: &[u8] = b"UPGA10";
