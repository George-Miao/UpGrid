(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=i(n);fetch(n.href,r)}})();const ae=globalThis,Le=ae.ShadowRoot&&(ae.ShadyCSS===void 0||ae.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ue=Symbol(),Qe=new WeakMap;let St=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==Ue)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Le&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Qe.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Qe.set(i,e))}return e}toString(){return this.cssText}};const ei=t=>new St(typeof t=="string"?t:t+"",void 0,Ue),fe=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,n,r)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+t[r+1],t[0]);return new St(i,t,Ue)},ti=(t,e)=>{if(Le)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),n=ae.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=i.cssText,t.appendChild(s)}},Ye=Le?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return ei(i)})(t):t;const{is:ii,defineProperty:si,getOwnPropertyDescriptor:ni,getOwnPropertyNames:ai,getOwnPropertySymbols:ri,getPrototypeOf:oi}=Object,be=globalThis,Ze=be.trustedTypes,li=Ze?Ze.emptyScript:"",ci=be.reactiveElementPolyfillSupport,W=(t,e)=>t,ce={toAttribute(t,e){switch(e){case Boolean:t=t?li:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},qe=(t,e)=>!ii(t,e),Xe={attribute:!0,type:String,converter:ce,reflect:!1,useDefault:!1,hasChanged:qe};Symbol.metadata??=Symbol("metadata"),be.litPropertyMetadata??=new WeakMap;let q=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Xe){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),n=this.getPropertyDescriptor(e,s,i);n!==void 0&&si(this.prototype,e,n)}}static getPropertyDescriptor(e,i,s){const{get:n,set:r}=ni(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:n,set(o){const a=n?.call(this);r?.call(this,o),this.requestUpdate(e,a,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Xe}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;const e=oi(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){const i=this.properties,s=[...ai(i),...ri(i)];for(const n of s)this.createProperty(n,i[n])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,n]of i)this.elementProperties.set(s,n)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const n=this._$Eu(i,s);n!==void 0&&this._$Eh.set(n,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)i.unshift(Ye(n))}else e!==void 0&&i.push(Ye(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ti(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){const s=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,s);if(n!==void 0&&s.reflect===!0){const r=(s.converter?.toAttribute!==void 0?s.converter:ce).toAttribute(i,s.type);this._$Em=e,r==null?this.removeAttribute(n):this.setAttribute(n,r),this._$Em=null}}_$AK(e,i){const s=this.constructor,n=s._$Eh.get(e);if(n!==void 0&&this._$Em!==n){const r=s.getPropertyOptions(n),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ce;this._$Em=n;const a=o.fromAttribute(i,r.type);this[n]=a??this._$Ej?.get(n)??a,this._$Em=null}}requestUpdate(e,i,s,n=!1,r){if(e!==void 0){const o=this.constructor;if(n===!1&&(r=this[e]),s??=o.getPropertyOptions(e),!((s.hasChanged??qe)(r,i)||s.useDefault&&s.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:n,wrapped:r},o){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??i??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,r]of this._$Ep)this[n]=r;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,r]of s){const{wrapped:o}=r,a=this[n];o!==!0||this._$AL.has(n)||a===void 0||this.C(n,void 0,r,a)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};q.elementStyles=[],q.shadowRootOptions={mode:"open"},q[W("elementProperties")]=new Map,q[W("finalized")]=new Map,ci?.({ReactiveElement:q}),(be.reactiveElementVersions??=[]).push("2.1.2");const Fe=globalThis,et=t=>t,de=Fe.trustedTypes,tt=de?de.createPolicy("lit-html",{createHTML:t=>t}):void 0,Tt="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,At="?"+I,di=`<${At}>`,M=document,Y=()=>M.createComment(""),Z=t=>t===null||typeof t!="object"&&typeof t!="function",ze=Array.isArray,ui=t=>ze(t)||typeof t?.[Symbol.iterator]=="function",_e=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,it=/-->/g,st=/>/g,N=RegExp(`>|${_e}(?:([^\\s"'>=/]+)(${_e}*=${_e}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),nt=/'/g,at=/"/g,Ct=/^(?:script|style|textarea|title)$/i,pi=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),c=pi(1),z=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),rt=new WeakMap,j=M.createTreeWalker(M,129);function Pt(t,e){if(!ze(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return tt!==void 0?tt.createHTML(e):e}const hi=(t,e)=>{const i=t.length-1,s=[];let n,r=e===2?"<svg>":e===3?"<math>":"",o=K;for(let a=0;a<i;a++){const l=t[a];let d,u,p=-1,y=0;for(;y<l.length&&(o.lastIndex=y,u=o.exec(l),u!==null);)y=o.lastIndex,o===K?u[1]==="!--"?o=it:u[1]!==void 0?o=st:u[2]!==void 0?(Ct.test(u[2])&&(n=RegExp("</"+u[2],"g")),o=N):u[3]!==void 0&&(o=N):o===N?u[0]===">"?(o=n??K,p=-1):u[1]===void 0?p=-2:(p=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?N:u[3]==='"'?at:nt):o===at||o===nt?o=N:o===it||o===st?o=K:(o=N,n=void 0);const $=o===N&&t[a+1].startsWith("/>")?" ":"";r+=o===K?l+di:p>=0?(s.push(d),l.slice(0,p)+Tt+l.slice(p)+I+$):l+I+(p===-2?a:$)}return[Pt(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class X{constructor({strings:e,_$litType$:i},s){let n;this.parts=[];let r=0,o=0;const a=e.length-1,l=this.parts,[d,u]=hi(e,i);if(this.el=X.createElement(d,s),j.currentNode=this.el.content,i===2||i===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=j.nextNode())!==null&&l.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(const p of n.getAttributeNames())if(p.endsWith(Tt)){const y=u[o++],$=n.getAttribute(p).split(I),w=/([.?@])?(.*)/.exec(y);l.push({type:1,index:r,name:w[2],strings:$,ctor:w[1]==="."?mi:w[1]==="?"?fi:w[1]==="@"?bi:ve}),n.removeAttribute(p)}else p.startsWith(I)&&(l.push({type:6,index:r}),n.removeAttribute(p));if(Ct.test(n.tagName)){const p=n.textContent.split(I),y=p.length-1;if(y>0){n.textContent=de?de.emptyScript:"";for(let $=0;$<y;$++)n.append(p[$],Y()),j.nextNode(),l.push({type:2,index:++r});n.append(p[y],Y())}}}else if(n.nodeType===8)if(n.data===At)l.push({type:2,index:r});else{let p=-1;for(;(p=n.data.indexOf(I,p+1))!==-1;)l.push({type:7,index:r}),p+=I.length-1}r++}}static createElement(e,i){const s=M.createElement("template");return s.innerHTML=e,s}}function H(t,e,i=t,s){if(e===z)return e;let n=s!==void 0?i._$Co?.[s]:i._$Cl;const r=Z(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(t),n._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=n:i._$Cl=n),n!==void 0&&(e=H(t,n._$AS(t,e.values),n,s)),e}class gi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,n=(e?.creationScope??M).importNode(i,!0);j.currentNode=n;let r=j.nextNode(),o=0,a=0,l=s[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new ie(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new vi(r,this,e)),this._$AV.push(d),l=s[++a]}o!==l?.index&&(r=j.nextNode(),o++)}return j.currentNode=M,n}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class ie{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,n){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=H(this,e,i),Z(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==z&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ui(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&Z(this._$AH)?this._$AA.nextSibling.data=e:this.T(M.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,n=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=X.createElement(Pt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(i);else{const r=new gi(n,this),o=r.u(this.options);r.p(i),this.T(o),this._$AH=r}}_$AC(e){let i=rt.get(e.strings);return i===void 0&&rt.set(e.strings,i=new X(e)),i}k(e){ze(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,n=0;for(const r of e)n===i.length?i.push(s=new ie(this.O(Y()),this.O(Y()),this,this.options)):s=i[n],s._$AI(r),n++;n<i.length&&(this._$AR(s&&s._$AB.nextSibling,n),i.length=n)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=et(e).nextSibling;et(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class ve{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,n,r){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=i,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,i=this,s,n){const r=this.strings;let o=!1;if(r===void 0)e=H(this,e,i,0),o=!Z(e)||e!==this._$AH&&e!==z,o&&(this._$AH=e);else{const a=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=H(this,a[s+l],i,l),d===z&&(d=this._$AH[l]),o||=!Z(d)||d!==this._$AH[l],d===m?e=m:e!==m&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!n&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class mi extends ve{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class fi extends ve{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class bi extends ve{constructor(e,i,s,n,r){super(e,i,s,n,r),this.type=5}_$AI(e,i=this){if((e=H(this,e,i,0)??m)===z)return;const s=this._$AH,n=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==m&&(s===m||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class vi{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){H(this,e)}}const yi=Fe.litHtmlPolyfillSupport;yi?.(X,ie),(Fe.litHtmlVersions??=[]).push("3.3.3");const xi=(t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(n===void 0){const r=i?.renderBefore??null;s._$litPart$=n=new ie(e.insertBefore(Y(),r),r,void 0,i??{})}return n._$AI(t),n};const He=globalThis;class R extends q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}R._$litElement$=!0,R.finalized=!0,He.litElementHydrateSupport?.({LitElement:R});const $i=He.litElementPolyfillSupport;$i?.({LitElement:R});(He.litElementVersions??=[]).push("4.2.2");const Je=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const wi={attribute:!0,type:String,converter:ce,reflect:!1,hasChanged:qe},_i=(t=wi,e,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(r===void 0&&globalThis.litPropertyMetadata.set(n,r=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),s==="accessor"){const{name:o}=i;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,t,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,t,a),a}}}if(s==="setter"){const{name:o}=i;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,t,!0,a)}}throw Error("Unsupported decorator location: "+s)};function ye(t){return(e,i)=>typeof i=="object"?_i(t,e,i):((s,n,r)=>{const o=n.hasOwnProperty(r);return n.constructor.createProperty(r,s),o?Object.getOwnPropertyDescriptor(n,r):void 0})(t,e,i)}function f(t){return ye({...t,state:!0,attribute:!1})}const Et={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},Dt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},ue={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},It={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'},ki={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></g>'};const Ot=Object.freeze({left:0,top:0,width:16,height:16}),pe=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),se=Object.freeze({...Ot,...pe}),Pe=Object.freeze({...se,body:"",hidden:!1}),Si=Object.freeze({width:null,height:null}),Nt=Object.freeze({...Si,...pe});function Ti(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(i===""){const n=parseInt(t);return isNaN(n)?0:s(n)}else if(i!==t){let n=0;switch(i){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return e}const Ai=/[\s,]+/;function Ci(t,e){e.split(Ai).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const jt={...Nt,preserveAspectRatio:""};function ot(t){const e={...jt},i=(s,n)=>t.getAttribute(s)||n;return e.width=i("width",null),e.height=i("height",null),e.rotate=Ti(i("rotate","")),Ci(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function Pi(t,e){for(const i in jt)if(t[i]!==e[i])return!0;return!1}const Rt=/^[a-z0-9]+(-[a-z0-9]+)*$/,ne=(t,e,i,s="")=>{const n=t.split(":");if(t.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const a=n.pop(),l=n.pop(),d={provider:n.length>0?n[0]:s,prefix:l,name:a};return e&&!re(d)?null:d}const r=n[0],o=r.split("-");if(o.length>1){const a={provider:s,prefix:o.shift(),name:o.join("-")};return e&&!re(a)?null:a}if(i&&s===""){const a={provider:s,prefix:"",name:r};return e&&!re(a,i)?null:a}return null},re=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function Ei(t,e){const i=t.icons,s=t.aliases||Object.create(null),n=Object.create(null);function r(o){if(i[o])return n[o]=[];if(!(o in n)){n[o]=null;const a=s[o]&&s[o].parent,l=a&&r(a);l&&(n[o]=[a].concat(l))}return n[o]}return Object.keys(i).concat(Object.keys(s)).forEach(r),n}function Di(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const s=((t.rotate||0)+(e.rotate||0))%4;return s&&(i.rotate=s),i}function lt(t,e){const i=Di(t,e);for(const s in Pe)s in pe?s in t&&!(s in i)&&(i[s]=pe[s]):s in e?i[s]=e[s]:s in t&&(i[s]=t[s]);return i}function Ii(t,e,i){const s=t.icons,n=t.aliases||Object.create(null);let r={};function o(a){r=lt(s[a]||n[a],r)}return o(e),i.forEach(o),lt(t,r)}function Mt(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(n=>{e(n,null),i.push(n)});const s=Ei(t);for(const n in s){const r=s[n];r&&(e(n,Ii(t,n,r)),i.push(n))}return i}const Oi={provider:"",aliases:{},not_found:{},...Ot};function ke(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function Lt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!ke(t,Oi))return null;const i=e.icons;for(const n in i){const r=i[n];if(!n||typeof r.body!="string"||!ke(r,Pe))return null}const s=e.aliases||Object.create(null);for(const n in s){const r=s[n],o=r.parent;if(!n||typeof o!="string"||!i[o]&&!s[o]||!ke(r,Pe))return null}return e}const he=Object.create(null);function Ni(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function E(t,e){const i=he[t]||(he[t]=Object.create(null));return i[e]||(i[e]=Ni(t,e))}function Ut(t,e){return Lt(e)?Mt(e,(i,s)=>{s?t.icons[i]=s:t.missing.add(i)}):[]}function ji(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function Ri(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(he)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(he[s]||{})).forEach(n=>{const r=E(s,n);i=i.concat(Object.keys(r.icons).map(o=>(s!==""?"@"+s+":":"")+n+":"+o))})}),i}let ee=!1;function qt(t){return typeof t=="boolean"&&(ee=t),ee}function te(t){const e=typeof t=="string"?ne(t,!0,ee):t;if(e){const i=E(e.provider,e.prefix),s=e.name;return i.icons[s]||(i.missing.has(s)?null:void 0)}}function Ft(t,e){const i=ne(t,!0,ee);if(!i)return!1;const s=E(i.provider,i.prefix);return e?ji(s,i.name,e):(s.missing.add(i.name),!0)}function ct(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),ee&&!e&&!t.prefix){let s=!1;return Lt(t)&&(t.prefix="",Mt(t,(n,r)=>{Ft(n,r)&&(s=!0)})),s}const i=t.prefix;return re({prefix:i,name:"a"})?!!Ut(E(e,i),t):!1}function Mi(t){return!!te(t)}function Li(t){const e=te(t);return e&&{...se,...e}}function zt(t,e){t.forEach(i=>{const s=i.loaderCallbacks;s&&(i.loaderCallbacks=s.filter(n=>n.id!==e))})}function Ui(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const s=t.provider,n=t.prefix;e.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==n)return!0;const d=l.name;if(t.icons[d])o.loaded.push({provider:s,prefix:n,name:d});else if(t.missing.has(d))o.missing.push({provider:s,prefix:n,name:d});else return i=!0,!0;return!1}),o.pending.length!==a&&(i||zt([t],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let qi=0;function Fi(t,e,i){const s=qi++,n=zt.bind(null,i,s);if(!e.pending.length)return n;const r={id:s,icons:e,callback:t,abort:n};return i.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),n}function zi(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return t.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,o=n.prefix,a=n.name,l=i[r]||(i[r]=Object.create(null)),d=l[o]||(l[o]=E(r,o));let u;a in d.icons?u=e.loaded:o===""||d.missing.has(a)?u=e.missing:u=e.pending;const p={provider:r,prefix:o,name:a};u.push(p)}),e}const Ee=Object.create(null);function dt(t,e){Ee[t]=e}function De(t){return Ee[t]||Ee[""]}function Hi(t,e=!0,i=!1){const s=[];return t.forEach(n=>{const r=typeof n=="string"?ne(n,e,i):n;r&&s.push(r)}),s}function Be(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const xe=Object.create(null),V=["https://api.simplesvg.com","https://api.unisvg.com"],oe=[];for(;V.length>0;)V.length===1||Math.random()>.5?oe.push(V.shift()):oe.push(V.pop());xe[""]=Be({resources:["https://api.iconify.design"].concat(oe)});function ut(t,e){const i=Be(e);return i===null?!1:(xe[t]=i,!0)}function $e(t){return xe[t]}function Ji(){return Object.keys(xe)}const Bi={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Ki(t,e,i,s){const n=t.resources.length,r=t.random?Math.floor(Math.random()*n):t.index;let o;if(t.random){let x=t.resources.slice(0);for(o=[];x.length>1;){const h=Math.floor(Math.random()*x.length);o.push(x[h]),x=x.slice(0,h).concat(x.slice(h+1))}o=o.concat(x)}else o=t.resources.slice(r).concat(t.resources.slice(0,r));const a=Date.now();let l="pending",d=0,u,p=null,y=[],$=[];typeof s=="function"&&$.push(s);function w(){p&&(clearTimeout(p),p=null)}function S(){l==="pending"&&(l="aborted"),w(),y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function _(x,h){h&&($=[]),typeof x=="function"&&$.push(x)}function B(){return{startTime:a,payload:e,status:l,queriesSent:d,queriesPending:y.length,subscribe:_,abort:S}}function C(){l="failed",$.forEach(x=>{x(void 0,u)})}function T(){y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function k(x,h,A){const U=h!=="success";switch(y=y.filter(P=>P!==x),l){case"pending":break;case"failed":if(U||!t.dataAfterTimeout)return;break;default:return}if(h==="abort"){u=A,C();return}if(U){u=A,y.length||(o.length?D():C());return}if(w(),T(),!t.random){const P=t.resources.indexOf(x.resource);P!==-1&&P!==t.index&&(t.index=P)}l="completed",$.forEach(P=>{P(A)})}function D(){if(l!=="pending")return;w();const x=o.shift();if(x===void 0){if(y.length){p=setTimeout(()=>{w(),l==="pending"&&(T(),C())},t.timeout);return}C();return}const h={status:"pending",resource:x,callback:(A,U)=>{k(h,A,U)}};y.push(h),d++,p=setTimeout(D,t.rotate),i(x,e,h.callback)}return setTimeout(D),B}function Ht(t){const e={...Bi,...t};let i=[];function s(){i=i.filter(o=>o().status==="pending")}function n(o,a,l){const d=Ki(e,o,a,(u,p)=>{s(),l&&l(u,p)});return i.push(d),d}function r(o){return i.find(a=>o(a))||null}return{query:n,find:r,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:s}}function pt(){}const Se=Object.create(null);function Vi(t){if(!Se[t]){const e=$e(t);if(!e)return;Se[t]={config:e,redundancy:Ht(e)}}return Se[t]}function Jt(t,e,i){let s,n;if(typeof t=="string"){const r=De(t);if(!r)return i(void 0,424),pt;n=r.send;const o=Vi(t);o&&(s=o.redundancy)}else{const r=Be(t);if(r){s=Ht(r);const o=De(t.resources?t.resources[0]:"");o&&(n=o.send)}}return!s||!n?(i(void 0,424),pt):s.query(e,n,i)().abort}function ht(){}function Gi(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Ui(t)}))}function Wi(t){const e=[],i=[];return t.forEach(s=>{(s.match(Rt)?e:i).push(s)}),{valid:e,invalid:i}}function G(t,e,i){function s(){const n=t.pendingIcons;e.forEach(r=>{n&&n.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Ut(t,i).length){s();return}}catch(n){console.error(n)}s(),Gi(t)}function gt(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Qi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:s}=t,n=t.iconsToLoad;if(delete t.iconsToLoad,!n||!n.length)return;const r=t.loadIcon;if(t.loadIcons&&(n.length>1||!r)){gt(t.loadIcons(n,s,i),d=>{G(t,n,d)});return}if(r){n.forEach(d=>{gt(r(d,s,i),u=>{G(t,[d],u?{prefix:s,icons:{[d]:u}}:null)})});return}const{valid:o,invalid:a}=Wi(n);if(a.length&&G(t,a,null),!o.length)return;const l=s.match(Rt)?De(i):null;if(!l){G(t,o,null);return}l.prepare(i,s,o).forEach(d=>{Jt(i,d,u=>{G(t,d.icons,u)})})}))}const Ke=(t,e)=>{const i=zi(Hi(t,!0,qt()));if(!i.pending.length){let a=!0;return e&&setTimeout(()=>{a&&e(i.loaded,i.missing,i.pending,ht)}),()=>{a=!1}}const s=Object.create(null),n=[];let r,o;return i.pending.forEach(a=>{const{provider:l,prefix:d}=a;if(d===o&&l===r)return;r=l,o=d,n.push(E(l,d));const u=s[l]||(s[l]=Object.create(null));u[d]||(u[d]=[])}),i.pending.forEach(a=>{const{provider:l,prefix:d,name:u}=a,p=E(l,d),y=p.pendingIcons||(p.pendingIcons=new Set);y.has(u)||(y.add(u),s[l][d].push(u))}),n.forEach(a=>{const l=s[a.provider][a.prefix];l.length&&Qi(a,l)}),e?Fi(e,i,n):ht},Yi=t=>new Promise((e,i)=>{const s=typeof t=="string"?ne(t,!0):t;if(!s){i(t);return}Ke([s||t],n=>{if(n.length&&s){const r=te(s);if(r){e({...se,...r});return}}i(t)})});function mt(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function Zi(t,e){if(typeof t=="object")return{data:mt(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=mt(t);if(r)return{data:r,value:t}}const i=ne(t,!0,!0);if(!i)return{value:t};const s=te(i);if(s!==void 0||!i.prefix)return{value:t,name:i,data:s};const n=Ke([i],()=>e(t,i,te(i)));return{value:t,name:i,loading:n}}let Bt=!1;try{Bt=navigator.vendor.indexOf("Apple")===0}catch{}function Xi(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Bt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const es=/(-?[0-9.]*[0-9]+[0-9.]*)/g,ts=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Ie(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const s=t.split(es);if(s===null||!s.length)return t;const n=[];let r=s.shift(),o=ts.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?n.push(r):n.push(Math.ceil(a*e*i)/i)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");o=!o}}function is(t,e="defs"){let i="";const s=t.indexOf("<"+e);for(;s>=0;){const n=t.indexOf(">",s),r=t.indexOf("</"+e);if(n===-1||r===-1)break;const o=t.indexOf(">",r);if(o===-1)break;i+=t.slice(n+1,r).trim(),t=t.slice(0,s).trim()+t.slice(o+1)}return{defs:i,content:t}}function ss(t,e){return t?"<defs>"+t+"</defs>"+e:e}function ns(t,e,i){const s=is(t);return ss(s.defs,e+s.content+i)}const as=t=>t==="unset"||t==="undefined"||t==="none";function Kt(t,e){const i={...se,...t},s={...Nt,...e},n={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,s].forEach(S=>{const _=[],B=S.hFlip,C=S.vFlip;let T=S.rotate;B?C?T+=2:(_.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),_.push("scale(-1 1)"),n.top=n.left=0):C&&(_.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),_.push("scale(1 -1)"),n.top=n.left=0);let k;switch(T<0&&(T-=Math.floor(T/4)*4),T=T%4,T){case 1:k=n.height/2+n.top,_.unshift("rotate(90 "+k.toString()+" "+k.toString()+")");break;case 2:_.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:k=n.width/2+n.left,_.unshift("rotate(-90 "+k.toString()+" "+k.toString()+")");break}T%2===1&&(n.left!==n.top&&(k=n.left,n.left=n.top,n.top=k),n.width!==n.height&&(k=n.width,n.width=n.height,n.height=k)),_.length&&(r=ns(r,'<g transform="'+_.join(" ")+'">',"</g>"))});const o=s.width,a=s.height,l=n.width,d=n.height;let u,p;o===null?(p=a===null?"1em":a==="auto"?d:a,u=Ie(p,l/d)):(u=o==="auto"?l:o,p=a===null?Ie(u,d/l):a==="auto"?d:a);const y={},$=(S,_)=>{as(_)||(y[S]=_.toString())};$("width",u),$("height",p);const w=[n.left,n.top,l,d];return y.viewBox=w.join(" "),{attributes:y,viewBox:w,body:r}}function Ve(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)i+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function rs(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function os(t){return"data:image/svg+xml,"+rs(t)}function Vt(t){return'url("'+os(t)+'")'}const ls=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let ge=ls();function cs(t){ge=t}function ds(){return ge}function us(t,e){const i=$e(t);if(!i)return 0;let s;if(!i.maxURL)s=0;else{let n=0;i.resources.forEach(o=>{n=Math.max(n,o.length)});const r=e+".json?icons=";s=i.maxURL-n-i.path.length-r.length}return s}function ps(t){return t===404}const hs=(t,e,i)=>{const s=[],n=us(t,e),r="icons";let o={type:r,provider:t,prefix:e,icons:[]},a=0;return i.forEach((l,d)=>{a+=l.length+1,a>=n&&d>0&&(s.push(o),o={type:r,provider:t,prefix:e,icons:[]},a=l.length),o.icons.push(l)}),s.push(o),s};function gs(t){if(typeof t=="string"){const e=$e(t);if(e)return e.path}return"/"}const ms=(t,e,i)=>{if(!ge){i("abort",424);return}let s=gs(e.provider);switch(e.type){case"icons":{const r=e.prefix,o=e.icons.join(","),a=new URLSearchParams({icons:o});s+=r+".json?"+a.toString();break}case"custom":{const r=e.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let n=503;ge(t+s).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{i(ps(o)?"abort":"next",o)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",n)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",n)})},fs={prepare:hs,send:ms};function bs(t,e,i){E(i||"",e).loadIcons=t}function vs(t,e,i){E(i||"",e).loadIcon=t}const Te="data-style";let Gt="";function ys(t){Gt=t}function ft(t,e){let i=Array.from(t.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Te));i||(i=document.createElement("style"),i.setAttribute(Te,Te),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Gt}function Wt(){dt("",fs),qt(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!ct(n))&&console.error(s)}catch{console.error(s)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const s in i){const n="IconifyProviders["+s+"] is invalid.";try{const r=i[s];if(typeof r!="object"||!r||r.resources===void 0)continue;ut(s,r)||console.error(n)}catch{console.error(n)}}}}return{iconLoaded:Mi,getIcon:Li,listIcons:Ri,addIcon:Ft,addCollection:ct,calculateSize:Ie,buildIcon:Kt,iconToHTML:Ve,svgToURL:Vt,loadIcons:Ke,loadIcon:Yi,addAPIProvider:ut,setCustomIconLoader:vs,setCustomIconsLoader:bs,appendCustomStyle:ys,_api:{getAPIConfig:$e,setAPIModule:dt,sendAPIQuery:Jt,setFetch:cs,getFetch:ds,listAPIProviders:Ji}}}const Oe={"background-color":"currentColor"},Qt={"background-color":"transparent"},bt={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},vt={"-webkit-mask":Oe,mask:Oe,background:Qt};for(const t in vt){const e=vt[t];for(const i in bt)e[t+"-"+i]=bt[i]}function yt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function xs(t,e,i){const s=document.createElement("span");let n=t.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=t.attributes,o=Ve(n,{...r,width:e.width+"",height:e.height+""}),a=Vt(o),l=s.style,d={"--svg":a,width:yt(r.width),height:yt(r.height),...i?Oe:Qt};for(const u in d)l.setProperty(u,d[u]);return s}let Q;function $s(){try{Q=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{Q=null}}function ws(t){return Q===void 0&&$s(),Q?Q.createHTML(t):t}function _s(t){const e=document.createElement("span"),i=t.attributes;let s="";i.width||(s="width: inherit;"),i.height||(s+="height: inherit;"),s&&(i.style=s);const n=Ve(t.body,i);return e.innerHTML=ws(n),e.firstChild}function Ne(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function xt(t,e){const i=e.icon.data,s=e.customisations,n=Kt(i,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=e.renderedMode;let o;r==="svg"?o=_s(n):o=xs(n,{...se,...i},r==="mask");const a=Ne(t);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,a):t.appendChild(o)}function $t(t,e,i){const s=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:s}}function ks(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const s=e.get(t);if(s)return s;const n=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const a=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");ft(a,l),this._state=$t({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const l=this.hasAttribute("inline"),d=this._state;l!==d.inline&&(d.inline=l,ft(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return this.hasAttribute("inline")}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const l=this._shadowRoot;if(a.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}xt(l,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,l=this.getAttribute("icon");if(l!==a.icon.value){this._iconChanged(l);return}if(!a.rendered||!this._visible)return;const d=this.getAttribute("mode"),u=ot(this);(a.attrMode!==d||Pi(a.customisations,u)||!Ne(this._shadowRoot))&&this._renderIcon(a.icon,u,d)}_iconChanged(a){const l=Zi(a,(d,u,p)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==d)return;const $={value:d,name:u,data:p};$.data?this._gotIconData($):y.icon=$});l.data?this._gotIconData(l):this._state=$t(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=Ne(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,ot(this),this.getAttribute("mode"))}_renderIcon(a,l,d){const u=Xi(a.data.body,d),p=this._state.inline;xt(this._shadowRoot,this._state={rendered:!0,icon:a,inline:p,customisations:l,attrMode:d,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(a=>{const l=a.some(d=>d.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=Wt();for(const a in o)r[a]=r.prototype[a]=o[a];return e.define(t,r),r}const Ss=ks()||Wt(),{iconLoaded:on,getIcon:ln,listIcons:cn,addIcon:dn,addCollection:un,calculateSize:pn,buildIcon:hn,iconToHTML:gn,svgToURL:mn,loadIcons:fn,loadIcon:bn,setCustomIconLoader:vn,setCustomIconsLoader:yn,addAPIProvider:xn,_api:$n}=Ss;class Ge extends Error{constructor(e,i){super(i),this.status=e,this.name="ApiRequestError"}}async function g(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:i.statusText}));throw new Ge(i.status,s.error||i.statusText)}return i.status===204?void 0:i.json()}function je(t,e,i=!1){if(e==="telegram"){const s=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!s?void 0:s,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const s=String(t.get("username")??""),n=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:s||void 0,password:n||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function Re(t,e=[],i=!0,s=String(t.get("kind")??"http"),n=[]){const r=String(t.get("url")),o=s==="http"?r:`${s}://${r.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:s,url:o,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),locations:Number(t.get("locations")??1),headers:{},body:null,assertions:n,skip_tls_verification:!1,tls_ca_secret_id:Ae(t,"tls_ca_secret_id"),tls_client_certificate_secret_id:Ae(t,"tls_client_certificate_secret_id"),tls_client_private_key_secret_id:Ae(t,"tls_client_private_key_secret_id"),notification_channel_ids:e,use_default_channels:i}}function Ae(t,e){return String(t.get(e)??"")||null}var Ts=Object.defineProperty,As=Object.getOwnPropertyDescriptor,J=(t,e,i,s)=>{for(var n=s>1?void 0:s?As(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(n=(s?o(e,i,n):o(n))||n);return s&&n&&Ts(e,i,n),n};let O=class extends R{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await g("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){if(t.preventDefault(),!window.confirm("Create a new single-Node Cluster?"))return;const e=new FormData(t.currentTarget),i=String(e.get("admin_username")??"").trim(),s=String(e.get("admin_password")??"");await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName(),admin_username:i,admin_password:s},{username:i,password:s})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e,i){this.saving=!0,this.error="";try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster(i)}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(t){for(let e=0;e<120;e+=1){const{promise:i,resolve:s}=Promise.withResolvers();window.setTimeout(s,250),await i;try{t&&await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify(t)});const n=await g("/api/v1/setup");if(n.cluster_ready){this.changed(n);return}}catch(n){if(!t&&n instanceof Ge&&n.status===401){window.location.assign("/");return}}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=je(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Re(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await g("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return c`<section class="flow" aria-label="UpGrid setup">
      ...
      <div class="panel"><form class="choice" @submit=${this.createChannel}>
        ...
        <label class="check"><input name="default" type="checkbox" checked /> Use as default channel</label>
      ...
      <div class="panel"><form class="choice" @submit=${this.createTarget}>
        ...
        ${this.channels.length?c`<fieldset><legend>Notification channels</legend>${this.channels.map(t=>c`<label><span><input name="channel_id" type="checkbox" value=${t.id} /> ${t.name}</span></label>`)}</fieldset>`:m}
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .check input { width: 18px; min-height: 18px; height: 18px; flex: none; }
  ...
  `;we([ye({attribute:!1})],L.prototype,"assertions",2);we([ye({attribute:"target-id"})],L.prototype,"targetId",2);we([f()],L.prototype,"draft",2);L=we([Je("http-assertion-editor")],L);function wt(t){switch(t){case"body_contains":return{kind:t,value:""};case"body_regex":return{kind:t,pattern:""};case"json_path":return{kind:t,path:"$",expected:null};case"response_header":return{kind:t,name:"",value:null};case"latency":return{kind:t,max_ms:1e3};case"script":return{kind:t,source:"status == 200"}}}const Ds={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a6 6 0 0 0 9 9a9 9 0 1 1-9-9Z"/>'},Is={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688c0-.437-.18-.835-.437-1.125c-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></g>'},Os={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></g>'};var Ns=Object.defineProperty,v=(t,e,i,s)=>{for(var n=void 0,r=t.length-1,o;r>=0;r--)(o=t[r])&&(n=o(e,i,n)||n);return n&&Ns(e,i,n),n};const le=["system","dark","bright"],_t={system:Is,dark:Ds,bright:Os},F={overview:"/",alerts:"/alerts",cluster:"/cluster",trash:"/trash",changePassword:"/admin/change-password",users:"/admin/users",apiTokens:"/admin/api-tokens"};function js(t,e){if(!e)return{tone:"pending",label:"connecting"};const i=t.filter(n=>!n.paused);if(!i.length)return{tone:"pending",label:"ready"};const s=i.filter(n=>n.availability==="down"||n.consecutive_failures>0).length;return s?s===i.length?{tone:"down",label:"down"}:{tone:"degraded",label:"partially down"}:{tone:"up",label:"up"}}function kt(){return Object.entries(F).find(([,t])=>t===window.location.pathname)?.[0]??"overview"}function Rs(){const t=localStorage.getItem("upgrid-theme");return le.includes(t)?t:"system"}class b extends R{constructor(){super(...arguments),this.targets=[],this.trashedTargets=[],this.channels=[],this.alerts=[],this.transitions=[],this.secrets=[],this.joinTokens=[],this.identities=[],this.apiTokens=[],this.authReady=!1,this.newApiToken="",this.error="",this.live=!1,this.saving=!1,this.historyLoading=!1,this.channelKind="webhook",this.channelTestMessage="",this.testingChannel=!1,this.joinCommand="",this.alertSearch="",this.alertDeliveryFilter="all",this.alertKindFilter="all",this.alertAcknowledgedFilter="all",this.search="",this.statusFilter="all",this.sort="name",this.selectedIds=new Set,this.activeSection=kt(),this.copied=!1,this.setupMode=!1,this.warningDismissed=sessionStorage.getItem("upgrid-warning-dismissed")==="1",this.unlimitedUses=!1,this.theme=Rs(),this.detailDirty=!1,this.detailInitialState="",this.systemTheme=matchMedia("(prefers-color-scheme: light)"),this.systemThemeChanged=()=>{this.theme==="system"&&this.applyTheme()},this.routeChanged=()=>{if(this.setupMode&&this.setup){window.history.replaceState(null,"",this.setup.path);return}this.activeSection=kt()}}connectedCallback(){super.connectedCallback(),this.applyTheme(),this.systemTheme.addEventListener("change",this.systemThemeChanged),window.addEventListener("popstate",this.routeChanged),this.start()}disconnectedCallback(){this.systemTheme.removeEventListener("change",this.systemThemeChanged),window.removeEventListener("popstate",this.routeChanged),this.events?.close(),super.disconnectedCallback()}async start(){try{const e=await g("/api/v1/setup");e.cluster_ready&&(this.session=await g("/api/v1/auth/session")),await this.activate(e)}catch(e){(!(e instanceof Ge)||e.status!==401)&&(this.error=e instanceof Error?e.message:String(e))}this.authReady=!0}async activate(e){if(this.setup=e,this.setupMode=e.setup,this.setupMode){window.history.replaceState(null,"",e.path),e.cluster_ready?(await this.refresh(),this.connectEvents()):this.live=!0;return}await this.refresh(),this.connectEvents()}async login(e){e.preventDefault();const i=new FormData(e.currentTarget);this.saving=!0,this.error="";try{this.session=await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify({username:String(i.get("username")??""),password:String(i.get("password")??"")})}),await this.activate(await g("/api/v1/setup"))}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async logout(){await g("/api/v1/auth/logout",{method:"POST"}),this.events?.close(),this.session=void 0,this.live=!1,this.setupMode=!1,window.history.replaceState(null,"","/")}connectEvents(){this.events?.close(),this.events=new EventSource("/api/v1/events"),this.events.addEventListener("state",()=>{this.refresh()}),this.events.onopen=()=>this.live=!0,this.events.onerror=()=>this.live=!1}applyTheme(){const e=this.theme==="system"?this.systemTheme.matches?"bright":"dark":this.theme;this.dataset.theme=e,document.querySelector('meta[name="theme-color"]')?.setAttribute("content",e==="bright"?"#f4f8f6":"#0b1110")}cycleTheme(){this.theme=le[(le.indexOf(this.theme)+1)%le.length],localStorage.setItem("upgrid-theme",this.theme),this.applyTheme()}dismissWarning(){sessionStorage.setItem("upgrid-warning-dismissed","1"),this.warningDismissed=!0}async refresh(){try{[this.targets,this.trashedTargets,this.channels,this.alerts,this.transitions,this.secrets,this.cluster,this.joinTokens,this.identities,this.apiTokens]=await Promise.all([g("/api/v1/targets"),g("/api/v1/trash/targets"),g("/api/v1/channels"),g("/api/v1/alerts"),g("/api/v1/transitions"),g("/api/v1/secrets"),g("/api/v1/cluster"),g("/api/v1/join-tokens"),g("/api/v1/identities"),g("/api/v1/api-tokens")]),this.error=""}catch(e){this.error=e instanceof Error?e.message:String(e)}}openTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.showModal()}closeTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.close()}openTarget(e){this.detailDirty=!1,this.selected=e,this.targetHistory=void 0,this.historyLoading=!0,this.loadTargetHistory(e.id),this.updateComplete.then(()=>{const i=this.renderRoot.querySelector("#detail-dialog"),s=i?.querySelector("form");s&&(this.detailInitialState=this.detailFormState(s)),i?.showModal()})}async loadTargetHistory(e){try{const i=await g(`/api/v1/targets/${e}/history?limit=720`);this.selected?.id===e&&(this.targetHistory=i)}catch(i){this.selected?.id===e&&(this.error=i instanceof Error?i.message:String(i))}finally{this.selected?.id===e&&(this.historyLoading=!1)}}closeDetailDialog(){this.renderRoot.querySelector("#detail-dialog")?.close(),this.detailDirty=!1,this.detailInitialState="",this.selected=void 0,this.targetHistory=void 0,this.historyLoading=!1}showDialog(e){this.renderRoot.querySelector(`#${e}`)?.showModal()}dismissOnBackdrop(e){const i=e.currentTarget;e.target===i&&(i.close(),i.id==="detail-dialog"&&this.closeDetailDialog())}navigate(e,i){e.preventDefault(),this.activeSection=i,window.history.pushState(null,"",F[i]),this.renderRoot.querySelector(".account-menu")?.removeAttribute("open")}closeDialog(e){this.renderRoot.querySelector(`#${e}`)?.close()}toggleMaxRedirects(e){const i=e.currentTarget,s=i.form?.elements.namedItem("max_redirects");s&&(s.disabled=!i.checked),i.form&&this.compareDetailForm(i.form)}detailFormState(e){return JSON.stringify([...new FormData(e).entries()])}compareDetailForm(e){this.detailDirty=this.detailFormState(e)!==this.detailInitialState}updateDetailDirty(e){this.compareDetailForm(e.currentTarget)}}v([f()],b.prototype,"targets");v([f()],b.prototype,"trashedTargets");v([f()],b.prototype,"channels");v([f()],b.prototype,"alerts");v([f()],b.prototype,"transitions");v([f()],b.prototype,"secrets");v([f()],b.prototype,"cluster");v([f()],b.prototype,"joinTokens");v([f()],b.prototype,"identities");v([f()],b.prototype,"apiTokens");v([f()],b.prototype,"session");v([f()],b.prototype,"authReady");v([f()],b.prototype,"newApiToken");v([f()],b.prototype,"error");v([f()],b.prototype,"live");v([f()],b.prototype,"saving");v([f()],b.prototype,"selected");v([f()],b.prototype,"targetHistory");v([f()],b.prototype,"historyLoading");v([f()],b.prototype,"channelKind");v([f()],b.prototype,"editingChannel");v([f()],b.prototype,"channelTestMessage");v([f()],b.prototype,"testingChannel");v([f()],b.prototype,"joinCommand");v([f()],b.prototype,"alertSearch");v([f()],b.prototype,"alertDeliveryFilter");v([f()],b.prototype,"alertKindFilter");v([f()],b.prototype,"alertAcknowledgedFilter");v([f()],b.prototype,"search");v([f()],b.prototype,"statusFilter");v([f()],b.prototype,"sort");v([f()],b.prototype,"selectedIds");v([f()],b.prototype,"activeSection");v([f()],b.prototype,"copied");v([f()],b.prototype,"setupMode");v([f()],b.prototype,"setup");v([f()],b.prototype,"warningDismissed");v([f()],b.prototype,"unlimitedUses");v([f()],b.prototype,"theme");v([f()],b.prototype,"detailDirty");class Ms extends b{async createTarget(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i),n=i.querySelector("http-assertion-editor")?.value??[],r=Re(s,s.getAll("channel_id").map(String),s.get("use_default_channels")==="on",void 0,n);this.saving=!0;try{await g("/api/v1/targets",{method:"POST",body:JSON.stringify(r)}),i.reset(),this.closeTargetDialog(),await this.refresh()}catch(o){this.error=o instanceof Error?o.message:String(o)}finally{this.saving=!1}}async updateTarget(e){if(e.preventDefault(),!this.selected)return;const i=new FormData(e.currentTarget),s=e.currentTarget.querySelector("http-assertion-editor")?.value??[];let n=`/api/v1/nodes/${this.selected.id}`,r={name:String(i.get("name"))};if(this.selected.kind==="http"){const o=i.get("follow_redirects")==="on";n=`/api/v1/targets/${this.selected.id}`,r={name:String(i.get("name")),kind:"http",url:String(i.get("url")),method:String(i.get("method")),accepted_statuses:String(i.get("statuses")).split(",").map(a=>{const[l,d]=a.trim().split("-").map(Number);return{start:l,end:d||l}}),follow_redirects:o,max_redirects:o?Number(i.get("max_redirects")):0,interval_seconds:Number(i.get("interval")),timeout_seconds:Number(i.get("timeout")),failure_threshold:Number(i.get("failures")),locations:Number(i.get("locations")),headers:Object.fromEntries(Object.entries(this.selected.headers).map(([a,l])=>[a,l.kind==="literal"?l.value:{secret_id:l.secret_id}])),body:this.selected.body?.kind==="literal"?this.selected.body.value:this.selected.body?{secret_id:this.selected.body.secret_id}:null,assertions:s,skip_tls_verification:i.get("skip_tls_verification")==="on",tls_ca_secret_id:String(i.get("tls_ca_secret_id")??"")||null,tls_client_certificate_secret_id:String(i.get("tls_client_certificate_secret_id")??"")||null,tls_client_private_key_secret_id:String(i.get("tls_client_private_key_secret_id")??"")||null,notification_channel_ids:i.getAll("channel_id").map(String),use_default_channels:i.get("use_default_channels")==="on"}}this.selected.kind!=="http"&&this.selected.kind!=="node"&&(n=`/api/v1/targets/${this.selected.id}`,r=Re(i,i.getAll("channel_id").map(String),i.get("use_default_channels")==="on",this.selected.kind,s)),this.saving=!0;try{await g(n,{method:"PUT",body:JSON.stringify(r)}),this.closeDetailDialog(),await this.refresh()}catch(o){this.error=o instanceof Error?o.message:String(o)}finally{this.saving=!1}}async deleteTarget(){if(!(!this.selected||!window.confirm("Move this Target and its history to Trash? You can restore it before its retention period expires."))){this.saving=!0;try{await g(`/api/v1/targets/${this.selected.id}`,{method:"DELETE"}),this.closeDetailDialog(),await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async restoreTarget(e){window.confirm(`Restore ${e.name} with its settings and history?`)&&await this.saveResource(()=>g(`/api/v1/trash/targets/${e.id}/restore`,{method:"POST"}))}async purgeTarget(e){window.confirm(`Permanently delete ${e.name} and all of its history? This cannot be undone.`)&&await this.saveResource(()=>g(`/api/v1/trash/targets/${e.id}`,{method:"DELETE"}))}async setPaused(e){if(this.selected){this.saving=!0;try{await g(`/api/v1/targets/${this.selected.id}/${e?"pause":"resume"}`,{method:"POST"}),this.closeDetailDialog(),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async createSecret(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);this.saving=!0;try{await g("/api/v1/secrets",{method:"POST",body:JSON.stringify({name:s.get("name"),value:s.get("value")})}),i.reset(),this.closeDialog("secret-dialog"),await this.refresh()}catch(n){this.error=n instanceof Error?n.message:String(n)}finally{this.saving=!1}}async createChannel(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i),n=this.editingChannel,r=je(s,this.channelKind,n!==void 0);this.saving=!0;try{await g(n?`/api/v1/channels/${n.id}`:"/api/v1/channels",{method:n?"PUT":"POST",body:JSON.stringify(r)}),await this.refresh(),i.reset(),this.editingChannel=void 0,this.channelKind="webhook",this.channelTestMessage="",this.closeDialog("channel-dialog")}catch(o){this.error=o instanceof Error?o.message:String(o)}finally{this.saving=!1}}openChannelDialog(e){this.editingChannel=e,this.channelKind=e?.kind??"webhook",this.channelTestMessage="",this.showDialog("channel-dialog")}async setChannelDefault(e,i){try{await g(`/api/v1/channels/${e.id}/default`,{method:"PUT",body:JSON.stringify({default:i})}),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}}async testChannel(e){const i=e.currentTarget.form;if(!(!i||![...i.querySelectorAll("[data-test-required]")].every(n=>n.reportValidity()))){this.testingChannel=!0,this.channelTestMessage="";try{const n=je(new FormData(i),this.channelKind);await g("/api/v1/channels/test",{method:"POST",body:JSON.stringify(n)}),this.channelTestMessage="Test sent"}catch(n){const r=n instanceof Error?n.message:String(n);this.channelTestMessage=`Test failed: ${r}`}finally{this.testingChannel=!1}}}openTokenDialog(){this.unlimitedUses=!1,this.showDialog("token-config-dialog")}async createJoinToken(e){e.preventDefault();const i=new FormData(e.currentTarget);this.saving=!0;try{const s=await g("/api/v1/join-tokens",{method:"POST",body:JSON.stringify({expires_in_seconds:Number(i.get("expiration_days"))*86400,max_uses:this.unlimitedUses?null:Number(i.get("max_uses"))})});this.joinCommand=`upgrid --join '${s.url}'`,this.copied=!1,await this.refresh(),this.closeDialog("token-config-dialog"),this.showDialog("join-dialog")}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async createIdentity(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);await this.saveResource(async()=>{await g("/api/v1/identities",{method:"POST",body:JSON.stringify({username:String(s.get("username")??""),password:String(s.get("password")??"")})}),i.reset(),this.closeDialog("add-user-dialog")})}async updateIdentity(e,i){i.preventDefault();const s=new FormData(i.currentTarget),n=String(s.get("password")??"");await this.saveResource(async()=>{await g(`/api/v1/identities/${e.id}`,{method:"PUT",body:JSON.stringify({username:String(s.get("username")??""),password:n||null})}),e.id===this.session?.identity_id&&n&&await this.logout()})}async deleteIdentity(e){window.confirm(`Delete identity ${e.username}? Its API Tokens will also be revoked.`)&&await this.saveResource(()=>g(`/api/v1/identities/${e.id}`,{method:"DELETE"}))}async createApiToken(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);await this.saveResource(async()=>{const n=Number(s.get("expires_in_days")),r=await g("/api/v1/api-tokens",{method:"POST",body:JSON.stringify({name:String(s.get("name")??""),expires_in_seconds:n?n*86400:null})});this.newApiToken=r.value,i.reset()})}async revokeApiToken(e){window.confirm(`Revoke API Token ${e.name}?`)&&await this.saveResource(()=>g(`/api/v1/api-tokens/${e.id}`,{method:"DELETE"}))}async setNodeDrain(e,i){await this.saveResource(()=>g(`/api/v1/nodes/${e.id}/drain`,{method:"PUT",body:JSON.stringify({draining:i,force:!1})}))}async removeNode(e,i){const s=i?`Replace failed Node ${e.name}? Confirm that it is permanently stopped. Its assignments will be released immediately.`:`Remove drained Node ${e.name} from the Cluster?`;window.confirm(s)&&(await this.saveResource(()=>g(`/api/v1/nodes/${e.id}?force=${i}`,{method:"DELETE"})),i&&!this.error&&this.openTokenDialog())}async acknowledgeAlert(e){await this.updateAlert("acknowledge",e)}async retryAlert(e){await this.updateAlert("retry",e)}async updateAlert(e,i){await this.saveResource(()=>g(`/api/v1/alerts/${e}`,{method:"POST",body:JSON.stringify({target_id:i.target_id,channel_id:i.channel_id,scheduled_at_ms:i.scheduled_at_ms,kind:i.kind})}))}async saveResource(e){this.saving=!0,this.error="";try{await e(),this.session&&await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async setupChanged(e){const i=e.detail;if(this.setup=i,this.setupMode=i.setup,window.history.replaceState(null,"",i.path),i.setup){i.cluster_ready&&(this.session=await g("/api/v1/auth/session"),await this.refresh(),this.connectEvents());return}this.activeSection="overview",await this.refresh(),this.connectEvents()}async revokeJoinToken(e){if(window.confirm("Revoke this Join Token? Nodes using it will no longer be admitted.")){this.saving=!0;try{await g(`/api/v1/join-tokens/${e.id}`,{method:"DELETE"}),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async copyJoinCommand(){let e=!1;try{await navigator.clipboard.writeText(this.joinCommand),e=!0}catch{const i=Object.assign(document.createElement("textarea"),{value:this.joinCommand});i.style.cssText="position: fixed; opacity: 0",document.body.append(i),i.select(),e=document.execCommand("copy"),i.remove()}if(!e){this.error="Could not copy the Join command";return}this.copied=!0,window.setTimeout(()=>this.copied=!1,2e3)}toggleSelected(e,i){const s=new Set(this.selectedIds);i?s.add(e):s.delete(e),this.selectedIds=s}async bulkPause(e){this.saving=!0;try{await Promise.all([...this.selectedIds].map(i=>g(`/api/v1/targets/${i}/${e?"pause":"resume"}`,{method:"POST"}))),this.selectedIds=new Set,await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async bulkDelete(){if(window.confirm(`Move ${this.selectedIds.size} selected Targets and their history to Trash?`)){this.saving=!0;try{await Promise.all([...this.selectedIds].map(e=>g(`/api/v1/targets/${e}`,{method:"DELETE"}))),this.selectedIds=new Set,await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async cleanupSecrets(){const e=this.secrets.filter(i=>!i.referenced);!e.length||!window.confirm(`Permanently delete ${e.length} unused ${e.length===1?"Secret":"Secrets"}? References are checked again when cleanup commits.`)||await this.saveResource(()=>g("/api/v1/secrets/unreferenced",{method:"DELETE"}))}async deleteResource(e,i,s){if(window.confirm(`Delete ${s}?`))try{await g(`/api/v1/${e}/${i}`,{method:"DELETE"}),await this.refresh()}catch(n){this.error=n instanceof Error?n.message:String(n)}}}const Ls={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5L2 22l1.5-5.5Zm-2 2l4 4"/>'};function Us(t,e){const i=e.search.trim().toLocaleLowerCase();return(!i||`${t.target_name} ${t.channel_name}`.toLocaleLowerCase().includes(i))&&(e.delivery==="all"||t.delivery===e.delivery)&&(e.kind==="all"||t.kind===e.kind)&&(e.acknowledged==="all"||(e.acknowledged==="yes"?t.acknowledged_at_ms!==null:t.acknowledged_at_ms===null))}function qs(t){return t.delivery==="pending"?t.next_attempt_at_ms===null?`${t.attempts} attempts`:`${t.attempts} attempts · next ${new Date(t.next_attempt_at_ms).toLocaleString()}`:t.delivery==="failed"?t.diagnostic??"Delivery failed":t.completed_at_ms===null?"Delivered":`Delivered ${new Date(t.completed_at_ms).toLocaleString()}`}function Fs(t,e,i,s,n,r){const o=t.filter(a=>Us(a,s));return c`
    ...
    <section class="panel alert-history" aria-label="Alert history">
      ...
      <div class="alert-filters">
        <label>Search<input type="search" .value=${s.search} placeholder="Target or channel" @input=${a=>r.setSearch(a.target.value)} /></label>
        <label>Delivery<select .value=${s.delivery} @change=${a=>r.setDelivery(a.target.value)}><option value="all">All</option><option value="pending">Pending</option><option value="delivered">Delivered</option><option value="failed">Failed</option></select></label>
        <label>Transition<select .value=${s.kind} @change=${a=>r.setKind(a.target.value)}><option value="all">All</option><option value="down">Down</option><option value="recovered">Recovered</option></select></label>
        <label>Acknowledged<select .value=${s.acknowledged} @change=${a=>r.setAcknowledged(a.target.value)}><option value="all">All</option><option value="no">No</option><option value="yes">Yes</option></select></label>
      </div>
      ${o.length?o.map(a=>c`
                <div class="resource alert-resource">
                  <div class="alert-summary">
                    <div class="channel-title">
                      ...
                      <span class=${`badge ${a.kind==="recovered"?"up":"down"}`}>${a.kind}</span>
                      <span class="badge">${a.delivery}</span>
                      ${a.acknowledged_at_ms===null?m:c`<span class="badge">acknowledged</span>`}
                    </div>
                    <code>${a.channel_name} · ${new Date(a.scheduled_at_ms).toLocaleString()}</code>
                    <span class="meta">${qs(a)}</span>
                  </div>
                  <div class="alert-actions">
                    ${a.delivery==="failed"?c`<button class="button secondary" ?disabled=${n} @click=${()=>r.retry(a)}>Retry</button>`:m}
                    ${a.acknowledged_at_ms===null?c`<button class="button secondary" ?disabled=${n} @click=${()=>r.acknowledge(a)}>Acknowledge</button>`:m}
                  </div>
                </div>
    ...
    <div class="page-columns">
      <section class="panel" aria-label="Availability history">
        ...
        ${e.length?e.map(a=>{const l=a.kind==="recovered"?"up":"down";return c`
                <div class="resource">
                  <div class="transition-main">
                    <span class=${`state ${l}`} aria-hidden="true"></span>
                    <div>
                      <strong>${a.target_name}</strong>
                      <code>${new Date(a.scheduled_at_ms).toLocaleString()}</code>
                    </div>
                  </div>
                  <span class=${`badge ${l}`}>${a.kind}</span>
                </div>
      ...
      <section class="panel" aria-label="Notification channels">
        ...
        ${i.length?i.map(a=>c`
              <div class="resource channel-resource">
                <div class="channel-summary"><div class="channel-title"><strong>${a.name}</strong><span class="badge">${a.kind}</span></div><code>${a.destination}</code></div>
                <div class="channel-actions">
                  <label class="switch"><span>Default</span><input type="checkbox" role="switch" aria-label=${`Default channel ${a.name}`} .checked=${a.default} @change=${l=>r.setDefault(a,l.target.checked)} /></label>
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${a.name}`} title=${`Edit ${a.name}`} @click=${()=>r.edit(a)}><iconify-icon .icon=${Ls} aria-hidden="true"></iconify-icon></button>
                  <button class="button danger icon-button" aria-label=${`Delete channel ${a.name}`} title=${`Delete ${a.name}`} @click=${()=>r.remove(a)}><iconify-icon .icon=${ue} aria-hidden="true"></iconify-icon></button>
                </div>
              </div>
  ...
  `}function zs(t,e,i){return c`
    ...
    </main>`}function Hs(t,e,i){return t?c`
    ...
    </div>`:c`<div class="empty">Current identity unavailable.</div>`}function Js(t,e,i,s){return c`
    <div class="admin-page">
      <div class="heading"><div><span class="eyebrow">Administration</span><h1>Users</h1></div><button class="button" type="button" @click=${s.openAddUser}>Add User</button></div>
      <section class="panel" aria-label="Operator Identities">
        ...
        ${t.map(n=>c`
            <div class="resource access-resource">
              <form class="access-form" @submit=${r=>s.updateIdentity(n,r)}>
                <label>Username<input name="username" .value=${n.username} required /></label>
                ...
                <button class="button secondary" type="submit" ?disabled=${i}>Save</button>
              </form>
              <button class="button danger" type="button" ?disabled=${n.id===e||i} @click=${()=>s.deleteIdentity(n)}>Delete</button>
            </div>`)}
      </section>
    </div>
    <dialog id="add-user-dialog" aria-labelledby="add-user-title" @click=${s.dismissDialog}>
      <div class="dialog-head"><h2 id="add-user-title">Add User</h2><p>Create a replicated Operator Identity.</p></div>
      <form @submit=${s.createIdentity}>
        <label>Username<input name="username" autocomplete="username" required autofocus /></label>
        <label>Password<input name="password" type="password" minlength="12" autocomplete="new-password" required /></label>
        <div class="dialog-actions"><button class="button secondary" type="button" @click=${s.closeAddUser}>Cancel</button><button class="button" type="submit" ?disabled=${i}>${i?"Adding…":"Add User"}</button></div>
      </form>
    </dialog>`}function Bs(t,e,i,s){return c`
    <div class="admin-page">
      ...
      <section class="panel" aria-label="API Tokens">
        ...
        <form class="choice compact-form" @submit=${s.createApiToken}>
          ...
          <button class="button" type="submit" ?disabled=${i}>Create API Token</button>
        </form>
      </section>
    </div>`}const Ks={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},Vs=fe`
...
`;function me(t,e,i){return c`
  ...
  `}function Gs(t,e){return t==="webhook"?c`<label
    ...
    /></label>`:t==="telegram"?c`
      <label
        ><span class="title-with-help"
          >Bot token
          ${me("telegram-token-help","About Telegram bot token storage",e?"Leave this blank to keep the automatically managed Secret, or enter a replacement token.":"Creating the Channel encrypts this token as an automatically managed Secret. Test sends use the entered value without storing it.")}</span
        ><input
          name="bot_token"
          type="password"
          autocomplete="off"
    ...
    <div class="form-field">
      <div class="title-with-help">
        ...
        ${me("smtp-password-help","About SMTP password storage",e?"Leave this blank to keep the automatically managed Secret. Clear the username to disable authentication.":"Enter a username and password together to enable authentication. The password is encrypted as an automatically managed Secret.")}
      </div>
      <input
        id="smtp-password"
        name="password"
    ...
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${Ws} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${Qs} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function Yt(t,e=[],i=!0){return c`
    <fieldset class="channel-fields">
      ...
      <label class="switch">
        ...
        <input
          ...
          role="switch"
          .checked=${i}
          @change=${n=>{const r=n.currentTarget;r.closest("fieldset")?.querySelectorAll('input[data-default="true"]').forEach(a=>{a.disabled=r.checked,a.checked=r.checked||a.dataset.explicit==="true"}),r.form?.dispatchEvent(new Event("input",{bubbles:!0}))}}
        />
      </label>
      <div class="channel-options">
        ${t.map(n=>{const r=e.includes(n.id),o=i&&n.default;return c`
            <label class="check">
              <input
                name="channel_id"
                type="checkbox"
    ...
    </fieldset>`}function Ys(t,e=null,i=null,s=null){const n=r=>c`
    <option value="">Not configured</option>
    ${t.map(o=>c`<option value=${o.id} ?selected=${o.id===r}>${o.name}</option>`)}
  `;return c`
  ...
  `}const Zt={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Xt(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=Zt[e],i.type=e==="http"?"url":"text");const s=t.querySelector("[data-http-options]");s&&(s.hidden=e!=="http");const n=t.elements.namedItem("method");n&&(n.disabled=e!=="http",n.disabled&&(n.value="GET"))}function Zs(t){const e=t.currentTarget;e.form&&Xt(e.form,e.value)}function Xs(t){const e=t.currentTarget;queueMicrotask(()=>Xt(e,"http"))}function en(t,e,i){return c`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${i.backdrop}>
      ...
      <form @submit=${i.create} @reset=${Xs}>
        <label>Name<input name="name" placeholder="Production API" required autofocus /></label>
        <div class="row">
          <label>Type<select name="kind" @change=${Zs}><option value="http">HTTP</option><option value="tcp">TCP connect</option><option value="dns">DNS resolution</option><option value="icmp">ICMP echo</option><option value="tls">TLS certificate</option></select></label>
    ...
    </dialog>`}function tn(t,e,i,s,n,r,o,a,l){const d=t.kind==="node",u=t.kind==="http",p=t.accepted_statuses.map(h=>h.start===h.end?h.start:`${h.start}-${h.end}`).join(","),y=t.history.slice(0,30).reverse(),$=Math.max(1,...y.map(h=>h.latency_ms)),w=e?.items??[],S=w.reduce((h,A)=>h+A.samples,0),_=w.reduce((h,A)=>h+A.successes,0),B=w.reduce((h,A)=>h+A.latency_total_ms,0),C=S?`${(_/S*100).toFixed(2)}%`:"—",T=new Map(r.map(h=>[h.id,h.name])),k=h=>new Date(h).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),D=h=>h>=1e3?`${(h/1e3).toFixed(h>=1e4?0:1)} s`:`${Math.round(h)} ms`,x=S?D(B/S):"—";return c`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${l.backdrop}>
      ...
      <form @submit=${l.update} @input=${l.changed}>
        ...
        ${d?c`<label>RPC URL<input .value=${t.url} disabled /></label>`:c`
              ...
              ${u?c`
                    ...
                    ${Ys(a,t.tls_ca_secret_id,t.tls_client_certificate_secret_id,t.tls_client_private_key_secret_id)}
                  `:m}
              ...
              ${Yt(o,t.notification_channel_ids,t.use_default_channels)}
            `}
        <div class="dialog-actions">
          ${d?m:c`<div class="danger-actions">
            <button class="button danger icon-button" type="button" aria-label="Move Target to Trash" title="Move to Trash" @click=${l.delete}><iconify-icon .icon=${ue} aria-hidden="true"></iconify-icon></button>
            <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>l.pause(!t.paused)}><iconify-icon .icon=${t.paused?Dt:Et} aria-hidden="true"></iconify-icon></button>
          </div>`}
        ...
        ${y.length?c`
          <div class="chart-plot">
            ...
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${D($)}`}>
              ${y.map(h=>{const A=h.succeeded?"Passed":"Failed",U=d||!u?h.succeeded?"reachable":"unreachable":h.status_code===null?"network error":`HTTP ${h.status_code}`,P=T.get(h.executor_node_id)??`Node ${h.executor_node_id.slice(0,8)}`,We=`${A} at ${new Date(h.recorded_at_ms).toLocaleString()}: ${h.latency_ms} ms, ${U}. Executed by ${P}`;return c`<span class="history-bar ${h.succeeded?"up":"down"}" role="listitem" aria-label=${We} title=${We} style=${`height: ${Math.max(8,h.latency_ms/$*100)}%`}></span>`})}
            </div>
          </div>
          <div class="chart-axis"><span>${k(y[0].recorded_at_ms)}</span><span>${k(y[y.length-1].recorded_at_ms)}</span></div>
    ...
    </dialog>`}var sn=Object.getOwnPropertyDescriptor,nn=(t,e,i,s)=>{for(var n=s>1?void 0:s?sn(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(n=o(n)||n);return n};let Me=class extends Ms{render(){const t=this.targets.filter(a=>a.availability==="up").length,e=this.targets.filter(a=>a.availability==="down").length,i=this.alerts.filter(a=>a.delivery==="pending").length,s=js(this.targets,this.live),n=["overview","alerts","cluster","trash"],r=this.targets.filter(a=>`${a.name} ${a.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(a=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?a.paused:a.availability===this.statusFilter).sort((a,l)=>this.sort==="status"&&a.availability.localeCompare(l.availability)||a.name.localeCompare(l.name)),o={login:a=>{this.login(a)},logout:()=>{this.logout()},createIdentity:a=>{this.createIdentity(a)},openAddUser:()=>this.showDialog("add-user-dialog"),closeAddUser:()=>this.closeDialog("add-user-dialog"),dismissDialog:a=>this.dismissOnBackdrop(a),updateIdentity:(a,l)=>{this.updateIdentity(a,l)},deleteIdentity:a=>{this.deleteIdentity(a)},createApiToken:a=>{this.createApiToken(a)},revokeApiToken:a=>{this.revokeApiToken(a)},dismissToken:()=>this.newApiToken=""};return this.authReady&&!this.setupMode&&!this.session?c`${zs(this.saving,this.error,o)}${Ce()}`:this.setupMode&&this.setup?c`
        <main class="shell setup-shell">
          <header>
            <div class="brand">
      ...
      <main class="shell">
        <header>
          ...
          <nav aria-label="Primary">
            ${n.map(a=>c`<a class=${this.activeSection===a?"active":""} href=${F[a]} @click=${l=>this.navigate(l,a)}>${a[0].toUpperCase()}${a.slice(1)}</a>`)}
          </nav>
          <div class="actions">
            ...
            <details class="account-menu">
              <summary class="button secondary icon-button" aria-label=${`Account menu for ${this.session?.username}`} title=${`Account: ${this.session?.username}`}><iconify-icon .icon=${ki} aria-hidden="true"></iconify-icon></summary>
        ...
        ${this.activeSection==="overview"?this.renderOverview(r,t,e,i):this.activeSection==="alerts"?Fs(this.alerts,this.transitions,this.channels,{search:this.alertSearch,delivery:this.alertDeliveryFilter,kind:this.alertKindFilter,acknowledged:this.alertAcknowledgedFilter},this.saving,{create:()=>this.openChannelDialog(),edit:a=>this.openChannelDialog(a),remove:a=>{this.deleteResource("channels",a.id,a.name)},setDefault:(a,l)=>{this.setChannelDefault(a,l)},acknowledge:a=>{this.acknowledgeAlert(a)},retry:a=>{this.retryAlert(a)},setSearch:a=>this.alertSearch=a,setDelivery:a=>this.alertDeliveryFilter=a,setKind:a=>this.alertKindFilter=a,setAcknowledged:a=>this.alertAcknowledgedFilter=a}):this.activeSection==="cluster"?this.renderClusterPage():this.activeSection==="trash"?this.renderTrashPage():this.activeSection==="changePassword"?Hs(this.identities.find(a=>a.id===this.session?.identity_id),this.saving,o):this.activeSection==="users"?Js(this.identities,this.session?.identity_id,this.saving,o):Bs(this.apiTokens,this.newApiToken,this.saving,o)}
      </main>${Ce()}
      ${en(this.channels,this.saving,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeTargetDialog(),create:a=>{this.createTarget(a)}})}
      ${this.selected?tn(this.selected,this.targetHistory,this.historyLoading,this.saving,this.detailDirty,this.cluster?.members??[],this.channels,this.secrets,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeDetailDialog(),update:a=>{this.updateTarget(a)},changed:a=>this.updateDetailDirty(a),redirects:a=>this.toggleMaxRedirects(a),delete:()=>{this.deleteTarget()},pause:a=>{this.setPaused(a)}}):m}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          ${Gs(this.channelKind,this.editingChannel)}
    ...
    `}renderOverview(t,e,i,s){const n=this.targets.filter(l=>this.selectedIds.has(l.id)),r=n.some(l=>!l.paused),o=n.some(l=>l.paused),a=this.secrets.filter(l=>!l.referenced);return c`
      ...
      <section class="overview-top">
        ...
        <section class="panel" aria-label="Secrets">
          <div class="panel-head"><div class="title-with-help"><h2>Secrets</h2>${me("secrets-help","About reusable Secrets","Reusable Secrets are encrypted and write-only. Reference them from Target headers or bodies and webhook headers or other Notification Channel credentials. UpGrid reports whether each Secret is referenced by an active or trashed Target or a Notification Channel.")}</div><div class="actions">${a.length?c`<button class="button danger" ?disabled=${this.saving} @click=${()=>this.cleanupSecrets()}>Delete unused (${a.length})</button>`:m}<button class="button secondary" @click=${()=>this.showDialog("secret-dialog")}>Add secret</button></div></div>
          ${this.secrets.length?this.secrets.map(l=>c`<div class="resource"><div><strong>${l.name}</strong><code>${l.id} · ${l.referenced?"In use":"Unused"}</code></div><button class="button danger icon-button" aria-label=${`Delete secret ${l.name}`} title=${`Delete ${l.name}`} @click=${()=>this.deleteResource("secrets",l.id,l.name)}><iconify-icon .icon=${ue} aria-hidden="true"></iconify-icon></button></div>`):c`<div class="empty">No reusable Secrets.</div>`}
        </section>
      </section>
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?c`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${It} aria-hidden="true"></iconify-icon></button>${r?c`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${Et} aria-hidden="true"></iconify-icon></button>`:m}${o?c`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${Dt} aria-hidden="true"></iconify-icon></button>`:m}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${ue} aria-hidden="true"></iconify-icon></button></div></div>`:m}
    ...
    `}renderClusterPage(){return c`
      ...
      <section class="panel" aria-label="Cluster topology">
        <div class="panel-head"><div class="title-with-help"><h2>Nodes</h2>${me("nodes-removal-help","About removing Nodes","Drain healthy Nodes before removal. Replace failed Nodes only after confirming the old process is permanently stopped.")}</div><span class="meta">${this.cluster?.members.length??0} members</span></div>
    ...
    `}renderTarget(t){const e=t.kind==="node",i=t.kind==="http",s=t.latest_evaluation,n=t.history.slice(0,16).reverse(),r=Math.max(1,...n.map(a=>a.latency_ms)),o=t.paused?"paused":t.availability==="down"?"down":t.consecutive_failures>0?"suspicious":t.availability;return c`
      <div class="target-wrap">
        ${e?c`<input class="select-target" type="checkbox" aria-label=${`Select ${t.name}`} disabled />`:c`<input class="select-target" type="checkbox" aria-label=${`Select ${t.name}`} .checked=${this.selectedIds.has(t.id)} @change=${a=>this.toggleSelected(t.id,a.target.checked)} />`}
        <button class=${`target ${e?"node-target":""}`} aria-label=${t.name} @click=${()=>this.openTarget(t)}>
          ...
          <div class="target-side">
            ${n.length?c`<div class="mini-chart" aria-hidden="true">${n.map(a=>c`<i class="mini-bar ${a.succeeded?"up":"down"}" style=${`height: ${Math.max(12,a.latency_ms/r*100)}%`}></i>`)}</div>`:m}
            <div class="latency">
