(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function i(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=i(s);fetch(s.href,r)}})();const ie=globalThis,Ie=ie.ShadowRoot&&(ie.ShadyCSS===void 0||ie.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,De=Symbol(),ze=new WeakMap;let bt=class{constructor(e,i,n){if(this._$cssResult$=!0,n!==De)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Ie&&e===void 0){const n=i!==void 0&&i.length===1;n&&(e=ze.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&ze.set(i,e))}return e}toString(){return this.cssText}};const Gt=t=>new bt(typeof t=="string"?t:t+"",void 0,De),Oe=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((n,s,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[r+1],t[0]);return new bt(i,t,De)},Wt=(t,e)=>{if(Ie)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const n=document.createElement("style"),s=ie.litNonce;s!==void 0&&n.setAttribute("nonce",s),n.textContent=i.cssText,t.appendChild(n)}},He=Ie?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const n of e.cssRules)i+=n.cssText;return Gt(i)})(t):t;const{is:Qt,defineProperty:Yt,getOwnPropertyDescriptor:Zt,getOwnPropertyNames:Xt,getOwnPropertySymbols:ei,getPrototypeOf:ti}=Object,pe=globalThis,Je=pe.trustedTypes,ii=Je?Je.emptyScript:"",si=pe.reactiveElementPolyfillSupport,B=(t,e)=>t,oe={toAttribute(t,e){switch(e){case Boolean:t=t?ii:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},je=(t,e)=>!Qt(t,e),Be={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:je};Symbol.metadata??=Symbol("metadata"),pe.litPropertyMetadata??=new WeakMap;let M=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Be){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const n=Symbol(),s=this.getPropertyDescriptor(e,n,i);s!==void 0&&Yt(this.prototype,e,s)}}static getPropertyDescriptor(e,i,n){const{get:s,set:r}=Zt(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:s,set(o){const a=s?.call(this);r?.call(this,o),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Be}static _$Ei(){if(this.hasOwnProperty(B("elementProperties")))return;const e=ti(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(B("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(B("properties"))){const i=this.properties,n=[...Xt(i),...ei(i)];for(const s of n)this.createProperty(s,i[s])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[n,s]of i)this.elementProperties.set(n,s)}this._$Eh=new Map;for(const[i,n]of this.elementProperties){const s=this._$Eu(i,n);s!==void 0&&this._$Eh.set(s,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const s of n)i.unshift(He(s))}else e!==void 0&&i.push(He(e));return i}static _$Eu(e,i){const n=i.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const n of i.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Wt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,n){this._$AK(e,n)}_$ET(e,i){const n=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,n);if(s!==void 0&&n.reflect===!0){const r=(n.converter?.toAttribute!==void 0?n.converter:oe).toAttribute(i,n.type);this._$Em=e,r==null?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(e,i){const n=this.constructor,s=n._$Eh.get(e);if(s!==void 0&&this._$Em!==s){const r=n.getPropertyOptions(s),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:oe;this._$Em=s;const a=o.fromAttribute(i,r.type);this[s]=a??this._$Ej?.get(s)??a,this._$Em=null}}requestUpdate(e,i,n,s=!1,r){if(e!==void 0){const o=this.constructor;if(s===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??je)(r,i)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,i,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:n,reflect:s,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??i??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(i=void 0),this._$AL.set(e,i)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}const n=this.constructor.elementProperties;if(n.size>0)for(const[s,r]of n){const{wrapped:o}=r,a=this[s];o!==!0||this._$AL.has(s)||a===void 0||this.C(s,void 0,r,a)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(i)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};M.elementStyles=[],M.shadowRootOptions={mode:"open"},M[B("elementProperties")]=new Map,M[B("finalized")]=new Map,si?.({ReactiveElement:M}),(pe.reactiveElementVersions??=[]).push("2.1.2");const Me=globalThis,Ve=t=>t,ae=Me.trustedTypes,Ke=ae?ae.createPolicy("lit-html",{createHTML:t=>t}):void 0,vt="$lit$",E=`lit$${Math.random().toFixed(9).slice(2)}$`,yt="?"+E,ni=`<${yt}>`,j=document,K=()=>j.createComment(""),G=t=>t===null||typeof t!="object"&&typeof t!="function",Ne=Array.isArray,ri=t=>Ne(t)||typeof t?.[Symbol.iterator]=="function",ve=`[ 	
\f\r]`,z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ge=/-->/g,We=/>/g,D=RegExp(`>|${ve}(?:([^\\s"'>=/]+)(${ve}*=${ve}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Qe=/'/g,Ye=/"/g,xt=/^(?:script|style|textarea|title)$/i,oi=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),u=oi(1),R=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ze=new WeakMap,O=j.createTreeWalker(j,129);function $t(t,e){if(!Ne(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ke!==void 0?Ke.createHTML(e):e}const ai=(t,e)=>{const i=t.length-1,n=[];let s,r=e===2?"<svg>":e===3?"<math>":"",o=z;for(let a=0;a<i;a++){const l=t[a];let c,d,h=-1,g=0;for(;g<l.length&&(o.lastIndex=g,d=o.exec(l),d!==null);)g=o.lastIndex,o===z?d[1]==="!--"?o=Ge:d[1]!==void 0?o=We:d[2]!==void 0?(xt.test(d[2])&&(s=RegExp("</"+d[2],"g")),o=D):d[3]!==void 0&&(o=D):o===D?d[0]===">"?(o=s??z,h=-1):d[1]===void 0?h=-2:(h=o.lastIndex-d[2].length,c=d[1],o=d[3]===void 0?D:d[3]==='"'?Ye:Qe):o===Ye||o===Qe?o=D:o===Ge||o===We?o=z:(o=D,s=void 0);const x=o===D&&t[a+1].startsWith("/>")?" ":"";r+=o===z?l+ni:h>=0?(n.push(c),l.slice(0,h)+vt+l.slice(h)+E+x):l+E+(h===-2?a:x)}return[$t(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]};class W{constructor({strings:e,_$litType$:i},n){let s;this.parts=[];let r=0,o=0;const a=e.length-1,l=this.parts,[c,d]=ai(e,i);if(this.el=W.createElement(c,n),O.currentNode=this.el.content,i===2||i===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(s=O.nextNode())!==null&&l.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(const h of s.getAttributeNames())if(h.endsWith(vt)){const g=d[o++],x=s.getAttribute(h).split(E),p=/([.?@])?(.*)/.exec(g);l.push({type:1,index:r,name:p[2],strings:x,ctor:p[1]==="."?ci:p[1]==="?"?di:p[1]==="@"?ui:fe}),s.removeAttribute(h)}else h.startsWith(E)&&(l.push({type:6,index:r}),s.removeAttribute(h));if(xt.test(s.tagName)){const h=s.textContent.split(E),g=h.length-1;if(g>0){s.textContent=ae?ae.emptyScript:"";for(let x=0;x<g;x++)s.append(h[x],K()),O.nextNode(),l.push({type:2,index:++r});s.append(h[g],K())}}}else if(s.nodeType===8)if(s.data===yt)l.push({type:2,index:r});else{let h=-1;for(;(h=s.data.indexOf(E,h+1))!==-1;)l.push({type:7,index:r}),h+=E.length-1}r++}}static createElement(e,i){const n=j.createElement("template");return n.innerHTML=e,n}}function L(t,e,i=t,n){if(e===R)return e;let s=n!==void 0?i._$Co?.[n]:i._$Cl;const r=G(e)?void 0:e._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(t),s._$AT(t,i,n)),n!==void 0?(i._$Co??=[])[n]=s:i._$Cl=s),s!==void 0&&(e=L(t,s._$AS(t,e.values),s,n)),e}class li{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:n}=this._$AD,s=(e?.creationScope??j).importNode(i,!0);O.currentNode=s;let r=O.nextNode(),o=0,a=0,l=n[0];for(;l!==void 0;){if(o===l.index){let c;l.type===2?c=new Z(r,r.nextSibling,this,e):l.type===1?c=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(c=new hi(r,this,e)),this._$AV.push(c),l=n[++a]}o!==l?.index&&(r=O.nextNode(),o++)}return O.currentNode=j,s}p(e){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,i),i+=n.strings.length-2):n._$AI(e[i])),i++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,n,s){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=L(this,e,i),G(e)?e===f||e==null||e===""?(this._$AH!==f&&this._$AR(),this._$AH=f):e!==this._$AH&&e!==R&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ri(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==f&&G(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=W.createElement($t(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(i);else{const r=new li(s,this),o=r.u(this.options);r.p(i),this.T(o),this._$AH=r}}_$AC(e){let i=Ze.get(e.strings);return i===void 0&&Ze.set(e.strings,i=new W(e)),i}k(e){Ne(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,s=0;for(const r of e)s===i.length?i.push(n=new Z(this.O(K()),this.O(K()),this,this.options)):n=i[s],n._$AI(r),s++;s<i.length&&(this._$AR(n&&n._$AB.nextSibling,s),i.length=s)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const n=Ve(e).nextSibling;Ve(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class fe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,n,s,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=e,this.name=i,this._$AM=s,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=f}_$AI(e,i=this,n,s){const r=this.strings;let o=!1;if(r===void 0)e=L(this,e,i,0),o=!G(e)||e!==this._$AH&&e!==R,o&&(this._$AH=e);else{const a=e;let l,c;for(e=r[0],l=0;l<r.length-1;l++)c=L(this,a[n+l],i,l),c===R&&(c=this._$AH[l]),o||=!G(c)||c!==this._$AH[l],c===f?e=f:e!==f&&(e+=(c??"")+r[l+1]),this._$AH[l]=c}o&&!s&&this.j(e)}j(e){e===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ci extends fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===f?void 0:e}}class di extends fe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==f)}}class ui extends fe{constructor(e,i,n,s,r){super(e,i,n,s,r),this.type=5}_$AI(e,i=this){if((e=L(this,e,i,0)??f)===R)return;const n=this._$AH,s=e===f&&n!==f||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==f&&(n===f||s);s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class hi{constructor(e,i,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}}const pi=Me.litHtmlPolyfillSupport;pi?.(W,Z),(Me.litHtmlVersions??=[]).push("3.3.3");const fi=(t,e,i)=>{const n=i?.renderBefore??e;let s=n._$litPart$;if(s===void 0){const r=i?.renderBefore??null;n._$litPart$=s=new Z(e.insertBefore(K(),r),r,void 0,i??{})}return s._$AI(t),s};const Re=globalThis;class N extends M{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=fi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return R}}N._$litElement$=!0,N.finalized=!0,Re.litElementHydrateSupport?.({LitElement:N});const gi=Re.litElementPolyfillSupport;gi?.({LitElement:N});(Re.litElementVersions??=[]).push("4.2.2");const wt=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const mi={attribute:!0,type:String,converter:oe,reflect:!1,hasChanged:je},bi=(t=mi,e,i)=>{const{kind:n,metadata:s}=i;let r=globalThis.litPropertyMetadata.get(s);if(r===void 0&&globalThis.litPropertyMetadata.set(s,r=new Map),n==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),n==="accessor"){const{name:o}=i;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,t,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,t,a),a}}}if(n==="setter"){const{name:o}=i;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,t,!0,a)}}throw Error("Unsupported decorator location: "+n)};function kt(t){return(e,i)=>typeof i=="object"?bi(t,e,i):((n,s,r)=>{const o=s.hasOwnProperty(r);return s.constructor.createProperty(r,n),o?Object.getOwnPropertyDescriptor(s,r):void 0})(t,e,i)}function m(t){return kt({...t,state:!0,attribute:!1})}const _t={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},St={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},le={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},Ct={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'};const Tt=Object.freeze({left:0,top:0,width:16,height:16}),ce=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),X=Object.freeze({...Tt,...ce}),we=Object.freeze({...X,body:"",hidden:!1}),vi=Object.freeze({width:null,height:null}),At=Object.freeze({...vi,...ce});function yi(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function n(s){for(;s<0;)s+=4;return s%4}if(i===""){const s=parseInt(t);return isNaN(s)?0:n(s)}else if(i!==t){let s=0;switch(i){case"%":s=25;break;case"deg":s=90}if(s){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/s,r%1===0?n(r):0)}}return e}const xi=/[\s,]+/;function $i(t,e){e.split(xi).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Et={...At,preserveAspectRatio:""};function Xe(t){const e={...Et},i=(n,s)=>t.getAttribute(n)||s;return e.width=i("width",null),e.height=i("height",null),e.rotate=yi(i("rotate","")),$i(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function wi(t,e){for(const i in Et)if(t[i]!==e[i])return!0;return!1}const Pt=/^[a-z0-9]+(-[a-z0-9]+)*$/,ee=(t,e,i,n="")=>{const s=t.split(":");if(t.slice(0,1)==="@"){if(s.length<2||s.length>3)return null;n=s.shift().slice(1)}if(s.length>3||!s.length)return null;if(s.length>1){const a=s.pop(),l=s.pop(),c={provider:s.length>0?s[0]:n,prefix:l,name:a};return e&&!se(c)?null:c}const r=s[0],o=r.split("-");if(o.length>1){const a={provider:n,prefix:o.shift(),name:o.join("-")};return e&&!se(a)?null:a}if(i&&n===""){const a={provider:n,prefix:"",name:r};return e&&!se(a,i)?null:a}return null},se=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function ki(t,e){const i=t.icons,n=t.aliases||Object.create(null),s=Object.create(null);function r(o){if(i[o])return s[o]=[];if(!(o in s)){s[o]=null;const a=n[o]&&n[o].parent,l=a&&r(a);l&&(s[o]=[a].concat(l))}return s[o]}return Object.keys(i).concat(Object.keys(n)).forEach(r),s}function _i(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const n=((t.rotate||0)+(e.rotate||0))%4;return n&&(i.rotate=n),i}function et(t,e){const i=_i(t,e);for(const n in we)n in ce?n in t&&!(n in i)&&(i[n]=ce[n]):n in e?i[n]=e[n]:n in t&&(i[n]=t[n]);return i}function Si(t,e,i){const n=t.icons,s=t.aliases||Object.create(null);let r={};function o(a){r=et(n[a]||s[a],r)}return o(e),i.forEach(o),et(t,r)}function It(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(s=>{e(s,null),i.push(s)});const n=ki(t);for(const s in n){const r=n[s];r&&(e(s,Si(t,s,r)),i.push(s))}return i}const Ci={provider:"",aliases:{},not_found:{},...Tt};function ye(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function Dt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!ye(t,Ci))return null;const i=e.icons;for(const s in i){const r=i[s];if(!s||typeof r.body!="string"||!ye(r,we))return null}const n=e.aliases||Object.create(null);for(const s in n){const r=n[s],o=r.parent;if(!s||typeof o!="string"||!i[o]&&!n[o]||!ye(r,we))return null}return e}const de=Object.create(null);function Ti(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function A(t,e){const i=de[t]||(de[t]=Object.create(null));return i[e]||(i[e]=Ti(t,e))}function Ot(t,e){return Dt(e)?It(e,(i,n)=>{n?t.icons[i]=n:t.missing.add(i)}):[]}function Ai(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function Ei(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(de)).forEach(n=>{(typeof n=="string"&&typeof e=="string"?[e]:Object.keys(de[n]||{})).forEach(s=>{const r=A(n,s);i=i.concat(Object.keys(r.icons).map(o=>(n!==""?"@"+n+":":"")+s+":"+o))})}),i}let Q=!1;function jt(t){return typeof t=="boolean"&&(Q=t),Q}function Y(t){const e=typeof t=="string"?ee(t,!0,Q):t;if(e){const i=A(e.provider,e.prefix),n=e.name;return i.icons[n]||(i.missing.has(n)?null:void 0)}}function Mt(t,e){const i=ee(t,!0,Q);if(!i)return!1;const n=A(i.provider,i.prefix);return e?Ai(n,i.name,e):(n.missing.add(i.name),!0)}function tt(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),Q&&!e&&!t.prefix){let n=!1;return Dt(t)&&(t.prefix="",It(t,(s,r)=>{Mt(s,r)&&(n=!0)})),n}const i=t.prefix;return se({prefix:i,name:"a"})?!!Ot(A(e,i),t):!1}function Pi(t){return!!Y(t)}function Ii(t){const e=Y(t);return e&&{...X,...e}}function Nt(t,e){t.forEach(i=>{const n=i.loaderCallbacks;n&&(i.loaderCallbacks=n.filter(s=>s.id!==e))})}function Di(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const n=t.provider,s=t.prefix;e.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==s)return!0;const c=l.name;if(t.icons[c])o.loaded.push({provider:n,prefix:s,name:c});else if(t.missing.has(c))o.missing.push({provider:n,prefix:s,name:c});else return i=!0,!0;return!1}),o.pending.length!==a&&(i||Nt([t],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let Oi=0;function ji(t,e,i){const n=Oi++,s=Nt.bind(null,i,n);if(!e.pending.length)return s;const r={id:n,icons:e,callback:t,abort:s};return i.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),s}function Mi(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((s,r)=>s.provider!==r.provider?s.provider.localeCompare(r.provider):s.prefix!==r.prefix?s.prefix.localeCompare(r.prefix):s.name.localeCompare(r.name));let n={provider:"",prefix:"",name:""};return t.forEach(s=>{if(n.name===s.name&&n.prefix===s.prefix&&n.provider===s.provider)return;n=s;const r=s.provider,o=s.prefix,a=s.name,l=i[r]||(i[r]=Object.create(null)),c=l[o]||(l[o]=A(r,o));let d;a in c.icons?d=e.loaded:o===""||c.missing.has(a)?d=e.missing:d=e.pending;const h={provider:r,prefix:o,name:a};d.push(h)}),e}const ke=Object.create(null);function it(t,e){ke[t]=e}function _e(t){return ke[t]||ke[""]}function Ni(t,e=!0,i=!1){const n=[];return t.forEach(s=>{const r=typeof s=="string"?ee(s,e,i):s;r&&n.push(r)}),n}function Le(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const ge=Object.create(null),H=["https://api.simplesvg.com","https://api.unisvg.com"],ne=[];for(;H.length>0;)H.length===1||Math.random()>.5?ne.push(H.shift()):ne.push(H.pop());ge[""]=Le({resources:["https://api.iconify.design"].concat(ne)});function st(t,e){const i=Le(e);return i===null?!1:(ge[t]=i,!0)}function me(t){return ge[t]}function Ri(){return Object.keys(ge)}const Li={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Ui(t,e,i,n){const s=t.resources.length,r=t.random?Math.floor(Math.random()*s):t.index;let o;if(t.random){let $=t.resources.slice(0);for(o=[];$.length>1;){const _=Math.floor(Math.random()*$.length);o.push($[_]),$=$.slice(0,_).concat($.slice(_+1))}o=o.concat($)}else o=t.resources.slice(r).concat(t.resources.slice(0,r));const a=Date.now();let l="pending",c=0,d,h=null,g=[],x=[];typeof n=="function"&&x.push(n);function p(){h&&(clearTimeout(h),h=null)}function T(){l==="pending"&&(l="aborted"),p(),g.forEach($=>{$.status==="pending"&&($.status="aborted")}),g=[]}function w($,_){_&&(x=[]),typeof $=="function"&&x.push($)}function q(){return{startTime:a,payload:e,status:l,queriesSent:c,queriesPending:g.length,subscribe:w,abort:T}}function C(){l="failed",x.forEach($=>{$(void 0,d)})}function S(){g.forEach($=>{$.status==="pending"&&($.status="aborted")}),g=[]}function k($,_,F){const te=_!=="success";switch(g=g.filter(I=>I!==$),l){case"pending":break;case"failed":if(te||!t.dataAfterTimeout)return;break;default:return}if(_==="abort"){d=F,C();return}if(te){d=F,g.length||(o.length?be():C());return}if(p(),S(),!t.random){const I=t.resources.indexOf($.resource);I!==-1&&I!==t.index&&(t.index=I)}l="completed",x.forEach(I=>{I(F)})}function be(){if(l!=="pending")return;p();const $=o.shift();if($===void 0){if(g.length){h=setTimeout(()=>{p(),l==="pending"&&(S(),C())},t.timeout);return}C();return}const _={status:"pending",resource:$,callback:(F,te)=>{k(_,F,te)}};g.push(_),c++,h=setTimeout(be,t.rotate),i($,e,_.callback)}return setTimeout(be),q}function Rt(t){const e={...Li,...t};let i=[];function n(){i=i.filter(o=>o().status==="pending")}function s(o,a,l){const c=Ui(e,o,a,(d,h)=>{n(),l&&l(d,h)});return i.push(c),c}function r(o){return i.find(a=>o(a))||null}return{query:s,find:r,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:n}}function nt(){}const xe=Object.create(null);function qi(t){if(!xe[t]){const e=me(t);if(!e)return;xe[t]={config:e,redundancy:Rt(e)}}return xe[t]}function Lt(t,e,i){let n,s;if(typeof t=="string"){const r=_e(t);if(!r)return i(void 0,424),nt;s=r.send;const o=qi(t);o&&(n=o.redundancy)}else{const r=Le(t);if(r){n=Rt(r);const o=_e(t.resources?t.resources[0]:"");o&&(s=o.send)}}return!n||!s?(i(void 0,424),nt):n.query(e,s,i)().abort}function rt(){}function Fi(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Di(t)}))}function zi(t){const e=[],i=[];return t.forEach(n=>{(n.match(Pt)?e:i).push(n)}),{valid:e,invalid:i}}function J(t,e,i){function n(){const s=t.pendingIcons;e.forEach(r=>{s&&s.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Ot(t,i).length){n();return}}catch(s){console.error(s)}n(),Fi(t)}function ot(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Hi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:n}=t,s=t.iconsToLoad;if(delete t.iconsToLoad,!s||!s.length)return;const r=t.loadIcon;if(t.loadIcons&&(s.length>1||!r)){ot(t.loadIcons(s,n,i),c=>{J(t,s,c)});return}if(r){s.forEach(c=>{ot(r(c,n,i),d=>{J(t,[c],d?{prefix:n,icons:{[c]:d}}:null)})});return}const{valid:o,invalid:a}=zi(s);if(a.length&&J(t,a,null),!o.length)return;const l=n.match(Pt)?_e(i):null;if(!l){J(t,o,null);return}l.prepare(i,n,o).forEach(c=>{Lt(i,c,d=>{J(t,c.icons,d)})})}))}const Ue=(t,e)=>{const i=Mi(Ni(t,!0,jt()));if(!i.pending.length){let a=!0;return e&&setTimeout(()=>{a&&e(i.loaded,i.missing,i.pending,rt)}),()=>{a=!1}}const n=Object.create(null),s=[];let r,o;return i.pending.forEach(a=>{const{provider:l,prefix:c}=a;if(c===o&&l===r)return;r=l,o=c,s.push(A(l,c));const d=n[l]||(n[l]=Object.create(null));d[c]||(d[c]=[])}),i.pending.forEach(a=>{const{provider:l,prefix:c,name:d}=a,h=A(l,c),g=h.pendingIcons||(h.pendingIcons=new Set);g.has(d)||(g.add(d),n[l][c].push(d))}),s.forEach(a=>{const l=n[a.provider][a.prefix];l.length&&Hi(a,l)}),e?ji(e,i,s):rt},Ji=t=>new Promise((e,i)=>{const n=typeof t=="string"?ee(t,!0):t;if(!n){i(t);return}Ue([n||t],s=>{if(s.length&&n){const r=Y(n);if(r){e({...X,...r});return}}i(t)})});function at(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function Bi(t,e){if(typeof t=="object")return{data:at(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=at(t);if(r)return{data:r,value:t}}const i=ee(t,!0,!0);if(!i)return{value:t};const n=Y(i);if(n!==void 0||!i.prefix)return{value:t,name:i,data:n};const s=Ue([i],()=>e(t,i,Y(i)));return{value:t,name:i,loading:s}}let Ut=!1;try{Ut=navigator.vendor.indexOf("Apple")===0}catch{}function Vi(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Ut||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const Ki=/(-?[0-9.]*[0-9]+[0-9.]*)/g,Gi=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Se(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const n=t.split(Ki);if(n===null||!n.length)return t;const s=[];let r=n.shift(),o=Gi.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?s.push(r):s.push(Math.ceil(a*e*i)/i)}else s.push(r);if(r=n.shift(),r===void 0)return s.join("");o=!o}}function Wi(t,e="defs"){let i="";const n=t.indexOf("<"+e);for(;n>=0;){const s=t.indexOf(">",n),r=t.indexOf("</"+e);if(s===-1||r===-1)break;const o=t.indexOf(">",r);if(o===-1)break;i+=t.slice(s+1,r).trim(),t=t.slice(0,n).trim()+t.slice(o+1)}return{defs:i,content:t}}function Qi(t,e){return t?"<defs>"+t+"</defs>"+e:e}function Yi(t,e,i){const n=Wi(t);return Qi(n.defs,e+n.content+i)}const Zi=t=>t==="unset"||t==="undefined"||t==="none";function qt(t,e){const i={...X,...t},n={...At,...e},s={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,n].forEach(T=>{const w=[],q=T.hFlip,C=T.vFlip;let S=T.rotate;q?C?S+=2:(w.push("translate("+(s.width+s.left).toString()+" "+(0-s.top).toString()+")"),w.push("scale(-1 1)"),s.top=s.left=0):C&&(w.push("translate("+(0-s.left).toString()+" "+(s.height+s.top).toString()+")"),w.push("scale(1 -1)"),s.top=s.left=0);let k;switch(S<0&&(S-=Math.floor(S/4)*4),S=S%4,S){case 1:k=s.height/2+s.top,w.unshift("rotate(90 "+k.toString()+" "+k.toString()+")");break;case 2:w.unshift("rotate(180 "+(s.width/2+s.left).toString()+" "+(s.height/2+s.top).toString()+")");break;case 3:k=s.width/2+s.left,w.unshift("rotate(-90 "+k.toString()+" "+k.toString()+")");break}S%2===1&&(s.left!==s.top&&(k=s.left,s.left=s.top,s.top=k),s.width!==s.height&&(k=s.width,s.width=s.height,s.height=k)),w.length&&(r=Yi(r,'<g transform="'+w.join(" ")+'">',"</g>"))});const o=n.width,a=n.height,l=s.width,c=s.height;let d,h;o===null?(h=a===null?"1em":a==="auto"?c:a,d=Se(h,l/c)):(d=o==="auto"?l:o,h=a===null?Se(d,c/l):a==="auto"?c:a);const g={},x=(T,w)=>{Zi(w)||(g[T]=w.toString())};x("width",d),x("height",h);const p=[s.left,s.top,l,c];return g.viewBox=p.join(" "),{attributes:g,viewBox:p,body:r}}function qe(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const n in e)i+=" "+n+'="'+e[n]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function Xi(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function es(t){return"data:image/svg+xml,"+Xi(t)}function Ft(t){return'url("'+es(t)+'")'}const ts=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let ue=ts();function is(t){ue=t}function ss(){return ue}function ns(t,e){const i=me(t);if(!i)return 0;let n;if(!i.maxURL)n=0;else{let s=0;i.resources.forEach(o=>{s=Math.max(s,o.length)});const r=e+".json?icons=";n=i.maxURL-s-i.path.length-r.length}return n}function rs(t){return t===404}const os=(t,e,i)=>{const n=[],s=ns(t,e),r="icons";let o={type:r,provider:t,prefix:e,icons:[]},a=0;return i.forEach((l,c)=>{a+=l.length+1,a>=s&&c>0&&(n.push(o),o={type:r,provider:t,prefix:e,icons:[]},a=l.length),o.icons.push(l)}),n.push(o),n};function as(t){if(typeof t=="string"){const e=me(t);if(e)return e.path}return"/"}const ls=(t,e,i)=>{if(!ue){i("abort",424);return}let n=as(e.provider);switch(e.type){case"icons":{const r=e.prefix,o=e.icons.join(","),a=new URLSearchParams({icons:o});n+=r+".json?"+a.toString();break}case"custom":{const r=e.uri;n+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let s=503;ue(t+n).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{i(rs(o)?"abort":"next",o)});return}return s=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",s)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",s)})},cs={prepare:os,send:ls};function ds(t,e,i){A(i||"",e).loadIcons=t}function us(t,e,i){A(i||"",e).loadIcon=t}const $e="data-style";let zt="";function hs(t){zt=t}function lt(t,e){let i=Array.from(t.childNodes).find(n=>n.hasAttribute&&n.hasAttribute($e));i||(i=document.createElement("style"),i.setAttribute($e,$e),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+zt}function Ht(){it("",cs),jt(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,n="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(s=>{try{(typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||!tt(s))&&console.error(n)}catch{console.error(n)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const n in i){const s="IconifyProviders["+n+"] is invalid.";try{const r=i[n];if(typeof r!="object"||!r||r.resources===void 0)continue;st(n,r)||console.error(s)}catch{console.error(s)}}}}return{iconLoaded:Pi,getIcon:Ii,listIcons:Ei,addIcon:Mt,addCollection:tt,calculateSize:Se,buildIcon:qt,iconToHTML:qe,svgToURL:Ft,loadIcons:Ue,loadIcon:Ji,addAPIProvider:st,setCustomIconLoader:us,setCustomIconsLoader:ds,appendCustomStyle:hs,_api:{getAPIConfig:me,setAPIModule:it,sendAPIQuery:Lt,setFetch:is,getFetch:ss,listAPIProviders:Ri}}}const Ce={"background-color":"currentColor"},Jt={"background-color":"transparent"},ct={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},dt={"-webkit-mask":Ce,mask:Ce,background:Jt};for(const t in dt){const e=dt[t];for(const i in ct)e[t+"-"+i]=ct[i]}function ut(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function ps(t,e,i){const n=document.createElement("span");let s=t.body;s.indexOf("<a")!==-1&&(s+="<!-- "+Date.now()+" -->");const r=t.attributes,o=qe(s,{...r,width:e.width+"",height:e.height+""}),a=Ft(o),l=n.style,c={"--svg":a,width:ut(r.width),height:ut(r.height),...i?Ce:Jt};for(const d in c)l.setProperty(d,c[d]);return n}let V;function fs(){try{V=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{V=null}}function gs(t){return V===void 0&&fs(),V?V.createHTML(t):t}function ms(t){const e=document.createElement("span"),i=t.attributes;let n="";i.width||(n="width: inherit;"),i.height||(n+="height: inherit;"),n&&(i.style=n);const s=qe(t.body,i);return e.innerHTML=gs(s),e.firstChild}function Te(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function ht(t,e){const i=e.icon.data,n=e.customisations,s=qt(i,n);n.preserveAspectRatio&&(s.attributes.preserveAspectRatio=n.preserveAspectRatio);const r=e.renderedMode;let o;r==="svg"?o=ms(s):o=ps(s,{...X,...i},r==="mask");const a=Te(t);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,a):t.appendChild(o)}function pt(t,e,i){const n=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:n}}function bs(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const n=e.get(t);if(n)return n;const s=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const a=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");lt(a,l),this._state=pt({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return s.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const l=this.hasAttribute("inline"),c=this._state;l!==c.inline&&(c.inline=l,lt(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return this.hasAttribute("inline")}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const l=this._shadowRoot;if(a.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}ht(l,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,l=this.getAttribute("icon");if(l!==a.icon.value){this._iconChanged(l);return}if(!a.rendered||!this._visible)return;const c=this.getAttribute("mode"),d=Xe(this);(a.attrMode!==c||wi(a.customisations,d)||!Te(this._shadowRoot))&&this._renderIcon(a.icon,d,c)}_iconChanged(a){const l=Bi(a,(c,d,h)=>{const g=this._state;if(g.rendered||this.getAttribute("icon")!==c)return;const x={value:c,name:d,data:h};x.data?this._gotIconData(x):g.icon=x});l.data?this._gotIconData(l):this._state=pt(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=Te(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,Xe(this),this.getAttribute("mode"))}_renderIcon(a,l,c){const d=Vi(a.data.body,c),h=this._state.inline;ht(this._shadowRoot,this._state={rendered:!0,icon:a,inline:h,customisations:l,attrMode:c,renderedMode:d})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(a=>{const l=a.some(c=>c.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};s.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=Ht();for(const a in o)r[a]=r.prototype[a]=o[a];return e.define(t,r),r}const vs=bs()||Ht(),{iconLoaded:Hs,getIcon:Js,listIcons:Bs,addIcon:Vs,addCollection:Ks,calculateSize:Gs,buildIcon:Ws,iconToHTML:Qs,svgToURL:Ys,loadIcons:Zs,loadIcon:Xs,setCustomIconLoader:en,setCustomIconsLoader:tn,addAPIProvider:sn,_api:nn}=vs;async function y(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const n=await i.json().catch(()=>({error:i.statusText}));throw new Error(n.error||i.statusText)}return i.status===204?void 0:i.json()}function Ae(t,e,i=!1){if(e==="telegram"){const n=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!n?void 0:n,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const n=String(t.get("username")??""),s=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:n||void 0,password:s||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function Ee(t,e=[],i=!0,n=String(t.get("kind")??"http")){const s=String(t.get("url")),r=n==="http"?s:`${n}://${s.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:n,url:r,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),headers:{},body:null,body_contains:null,skip_tls_verification:!1,notification_channel_ids:e,use_default_channels:i}}var ys=Object.defineProperty,xs=Object.getOwnPropertyDescriptor,U=(t,e,i,n)=>{for(var s=n>1?void 0:n?xs(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(s=(n?o(e,i,s):o(s))||s);return n&&s&&ys(e,i,s),s};let P=class extends N{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await y("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){t.preventDefault(),window.confirm("Create a new single-Node Cluster?")&&await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName()})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e){this.saving=!0,this.error="";try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster()}catch(i){this.fail(i),this.saving=!1}}async waitForCluster(){for(let t=0;t<120;t+=1){await new Promise(e=>window.setTimeout(e,250));try{const e=await y("/api/v1/setup");if(e.cluster_ready){this.changed(e);return}}catch{}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Ae(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Ee(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await y("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return u`<section class="flow" aria-label="UpGrid setup">
      ${this.error?u`<div class="notice" role="alert">${this.error}</div>`:f}
      ${this.setup.phase==="cluster"?this.renderCluster():this.setup.phase==="channel"?this.renderChannel():this.renderTarget()}
    </section>`}renderCluster(){return u`
      ...
      </form></div>`}renderTarget(){return u`
      ...
      <div class="panel"><form class="choice" @submit=${this.createTarget}>
        ...
        ${this.channels.length?u`<fieldset><legend>Notification channels</legend>${this.channels.map(t=>u`<label><span><input name="channel_id" type="checkbox" value=${t.id} /> ${t.name}</span></label>`)}</fieldset>`:f}
  ...
  `;U([kt({attribute:!1})],P.prototype,"setup",2);U([m()],P.prototype,"channelKind",2);U([m()],P.prototype,"channels",2);U([m()],P.prototype,"saving",2);U([m()],P.prototype,"error",2);P=U([wt("upgrid-setup")],P);const $s={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a6 6 0 0 0 9 9a9 9 0 1 1-9-9Z"/>'},ws={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688c0-.437-.18-.835-.437-1.125c-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></g>'},ks={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></g>'};var _s=Object.defineProperty,v=(t,e,i,n)=>{for(var s=void 0,r=t.length-1,o;r>=0;r--)(o=t[r])&&(s=o(e,i,s)||s);return s&&_s(e,i,s),s};const re=["system","dark","bright"],ft={system:ws,dark:$s,bright:ks},Fe={overview:"/",alerts:"/alerts",cluster:"/cluster"};function Ss(t,e){if(!e)return{tone:"pending",label:"connecting"};const i=t.filter(s=>!s.paused);if(!i.length)return{tone:"pending",label:"ready"};const n=i.filter(s=>s.availability==="down"||s.consecutive_failures>0).length;return n?n===i.length?{tone:"down",label:"down"}:{tone:"degraded",label:"partially down"}:{tone:"up",label:"up"}}function gt(){return Object.entries(Fe).find(([,t])=>t===window.location.pathname)?.[0]??"overview"}function Cs(){const t=localStorage.getItem("upgrid-theme");return re.includes(t)?t:"system"}class b extends N{constructor(){super(...arguments),this.targets=[],this.channels=[],this.alerts=[],this.transitions=[],this.secrets=[],this.joinTokens=[],this.error="",this.live=!1,this.saving=!1,this.channelKind="webhook",this.channelTestMessage="",this.testingChannel=!1,this.joinCommand="",this.search="",this.statusFilter="all",this.sort="name",this.selectedIds=new Set,this.activeSection=gt(),this.copied=!1,this.setupMode=!1,this.warningDismissed=sessionStorage.getItem("upgrid-warning-dismissed")==="1",this.unlimitedUses=!1,this.theme=Cs(),this.detailDirty=!1,this.detailInitialState="",this.systemTheme=matchMedia("(prefers-color-scheme: light)"),this.systemThemeChanged=()=>{this.theme==="system"&&this.applyTheme()},this.routeChanged=()=>{if(this.setupMode&&this.setup){window.history.replaceState(null,"",this.setup.path);return}this.activeSection=gt()}}connectedCallback(){super.connectedCallback(),this.applyTheme(),this.systemTheme.addEventListener("change",this.systemThemeChanged),window.addEventListener("popstate",this.routeChanged),this.start()}disconnectedCallback(){this.systemTheme.removeEventListener("change",this.systemThemeChanged),window.removeEventListener("popstate",this.routeChanged),this.events?.close(),super.disconnectedCallback()}async start(){try{const e=await y("/api/v1/setup");if(this.setup=e,this.setupMode=e.setup,this.setupMode){window.history.replaceState(null,"",e.path),e.cluster_ready?(await this.refresh(),this.connectEvents()):this.live=!0;return}await this.refresh(),this.connectEvents()}catch(e){this.error=e instanceof Error?e.message:String(e)}}connectEvents(){this.events?.close(),this.events=new EventSource("/api/v1/events"),this.events.addEventListener("state",()=>{this.refresh()}),this.events.onopen=()=>this.live=!0,this.events.onerror=()=>this.live=!1}applyTheme(){const e=this.theme==="system"?this.systemTheme.matches?"bright":"dark":this.theme;this.dataset.theme=e,document.querySelector('meta[name="theme-color"]')?.setAttribute("content",e==="bright"?"#f4f8f6":"#0b1110")}cycleTheme(){this.theme=re[(re.indexOf(this.theme)+1)%re.length],localStorage.setItem("upgrid-theme",this.theme),this.applyTheme()}dismissWarning(){sessionStorage.setItem("upgrid-warning-dismissed","1"),this.warningDismissed=!0}async refresh(){try{[this.targets,this.channels,this.alerts,this.transitions,this.secrets,this.cluster,this.joinTokens]=await Promise.all([y("/api/v1/targets"),y("/api/v1/channels"),y("/api/v1/alerts"),y("/api/v1/transitions"),y("/api/v1/secrets"),y("/api/v1/cluster"),y("/api/v1/join-tokens")]),this.error=""}catch(e){this.error=e instanceof Error?e.message:String(e)}}openTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.showModal()}closeTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.close()}openTarget(e){this.detailDirty=!1,this.selected=e,this.updateComplete.then(()=>{const i=this.renderRoot.querySelector("#detail-dialog"),n=i?.querySelector("form");n&&(this.detailInitialState=this.detailFormState(n)),i?.showModal()})}closeDetailDialog(){this.renderRoot.querySelector("#detail-dialog")?.close(),this.detailDirty=!1,this.detailInitialState="",this.selected=void 0}showDialog(e){this.renderRoot.querySelector(`#${e}`)?.showModal()}dismissOnBackdrop(e){const i=e.currentTarget;e.target===i&&(i.close(),i.id==="detail-dialog"&&this.closeDetailDialog())}navigate(e,i){e.preventDefault(),this.activeSection=i,window.history.pushState(null,"",Fe[i])}closeDialog(e){this.renderRoot.querySelector(`#${e}`)?.close()}toggleMaxRedirects(e){const i=e.currentTarget,n=i.form?.elements.namedItem("max_redirects");n&&(n.disabled=!i.checked),i.form&&this.compareDetailForm(i.form)}detailFormState(e){return JSON.stringify([...new FormData(e).entries()])}compareDetailForm(e){this.detailDirty=this.detailFormState(e)!==this.detailInitialState}updateDetailDirty(e){this.compareDetailForm(e.currentTarget)}}v([m()],b.prototype,"targets");v([m()],b.prototype,"channels");v([m()],b.prototype,"alerts");v([m()],b.prototype,"transitions");v([m()],b.prototype,"secrets");v([m()],b.prototype,"cluster");v([m()],b.prototype,"joinTokens");v([m()],b.prototype,"error");v([m()],b.prototype,"live");v([m()],b.prototype,"saving");v([m()],b.prototype,"selected");v([m()],b.prototype,"channelKind");v([m()],b.prototype,"editingChannel");v([m()],b.prototype,"channelTestMessage");v([m()],b.prototype,"testingChannel");v([m()],b.prototype,"joinCommand");v([m()],b.prototype,"search");v([m()],b.prototype,"statusFilter");v([m()],b.prototype,"sort");v([m()],b.prototype,"selectedIds");v([m()],b.prototype,"activeSection");v([m()],b.prototype,"copied");v([m()],b.prototype,"setupMode");v([m()],b.prototype,"setup");v([m()],b.prototype,"warningDismissed");v([m()],b.prototype,"unlimitedUses");v([m()],b.prototype,"theme");v([m()],b.prototype,"detailDirty");class Ts extends b{async createTarget(e){e.preventDefault();const i=e.currentTarget,n=new FormData(i),s=Ee(n,n.getAll("channel_id").map(String),n.get("use_default_channels")==="on");this.saving=!0;try{await y("/api/v1/targets",{method:"POST",body:JSON.stringify(s)}),i.reset(),this.closeTargetDialog(),await this.refresh()}catch(r){this.error=r instanceof Error?r.message:String(r)}finally{this.saving=!1}}async updateTarget(e){if(e.preventDefault(),!this.selected)return;const i=new FormData(e.currentTarget);let n=`/api/v1/nodes/${this.selected.id}`,s={name:String(i.get("name"))};if(this.selected.kind==="http"){const r=i.get("follow_redirects")==="on";n=`/api/v1/targets/${this.selected.id}`,s={name:String(i.get("name")),kind:"http",url:String(i.get("url")),method:String(i.get("method")),accepted_statuses:String(i.get("statuses")).split(",").map(o=>{const[a,l]=o.trim().split("-").map(Number);return{start:a,end:l||a}}),follow_redirects:r,max_redirects:r?Number(i.get("max_redirects")):0,interval_seconds:Number(i.get("interval")),timeout_seconds:Number(i.get("timeout")),failure_threshold:Number(i.get("failures")),headers:Object.fromEntries(Object.entries(this.selected.headers).map(([o,a])=>[o,a.kind==="literal"?a.value:{secret_id:a.secret_id}])),body:this.selected.body?.kind==="literal"?this.selected.body.value:this.selected.body?{secret_id:this.selected.body.secret_id}:null,body_contains:String(i.get("body_contains"))||null,skip_tls_verification:i.get("skip_tls_verification")==="on",notification_channel_ids:i.getAll("channel_id").map(String),use_default_channels:i.get("use_default_channels")==="on"}}this.selected.kind!=="http"&&this.selected.kind!=="node"&&(n=`/api/v1/targets/${this.selected.id}`,s=Ee(i,i.getAll("channel_id").map(String),i.get("use_default_channels")==="on",this.selected.kind)),this.saving=!0;try{await y(n,{method:"PUT",body:JSON.stringify(s)}),this.closeDetailDialog(),await this.refresh()}catch(r){this.error=r instanceof Error?r.message:String(r)}finally{this.saving=!1}}async deleteTarget(){if(!(!this.selected||!window.confirm("Delete this target and its history?"))){this.saving=!0;try{await y(`/api/v1/targets/${this.selected.id}`,{method:"DELETE"}),this.closeDetailDialog(),await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async setPaused(e){if(this.selected){this.saving=!0;try{await y(`/api/v1/targets/${this.selected.id}/${e?"pause":"resume"}`,{method:"POST"}),this.closeDetailDialog(),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async createSecret(e){e.preventDefault();const i=e.currentTarget,n=new FormData(i);this.saving=!0;try{await y("/api/v1/secrets",{method:"POST",body:JSON.stringify({name:n.get("name"),value:n.get("value")})}),i.reset(),this.closeDialog("secret-dialog"),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async createChannel(e){e.preventDefault();const i=e.currentTarget,n=new FormData(i),s=this.editingChannel,r=Ae(n,this.channelKind,s!==void 0);this.saving=!0;try{await y(s?`/api/v1/channels/${s.id}`:"/api/v1/channels",{method:s?"PUT":"POST",body:JSON.stringify(r)}),i.reset(),this.editingChannel=void 0,this.channelKind="webhook",this.channelTestMessage="",this.closeDialog("channel-dialog"),await this.refresh()}catch(o){this.error=o instanceof Error?o.message:String(o)}finally{this.saving=!1}}openChannelDialog(e){this.editingChannel=e,this.channelKind=e?.kind??"webhook",this.channelTestMessage="",this.showDialog("channel-dialog")}async setChannelDefault(e,i){try{await y(`/api/v1/channels/${e.id}/default`,{method:"PUT",body:JSON.stringify({default:i})}),await this.refresh()}catch(n){this.error=n instanceof Error?n.message:String(n)}}async testChannel(e){const i=e.currentTarget.form;if(!(!i||![...i.querySelectorAll("[data-test-required]")].every(s=>s.reportValidity()))){this.testingChannel=!0,this.channelTestMessage="";try{const s=Ae(new FormData(i),this.channelKind);await y("/api/v1/channels/test",{method:"POST",body:JSON.stringify(s)}),this.channelTestMessage="Test sent"}catch(s){const r=s instanceof Error?s.message:String(s);this.channelTestMessage=`Test failed: ${r}`}finally{this.testingChannel=!1}}}openTokenDialog(){this.unlimitedUses=!1,this.showDialog("token-config-dialog")}async createJoinToken(e){e.preventDefault();const i=new FormData(e.currentTarget);this.saving=!0;try{const n=await y("/api/v1/join-tokens",{method:"POST",body:JSON.stringify({expires_in_seconds:Number(i.get("expiration_days"))*86400,max_uses:this.unlimitedUses?null:Number(i.get("max_uses"))})});this.joinCommand=`upgrid --join '${n.url}'`,this.copied=!1,await this.refresh(),this.closeDialog("token-config-dialog"),this.showDialog("join-dialog")}catch(n){this.error=n instanceof Error?n.message:String(n)}finally{this.saving=!1}}async setupChanged(e){const i=e.detail;if(this.setup=i,this.setupMode=i.setup,window.history.replaceState(null,"",i.path),i.setup){i.cluster_ready&&(await this.refresh(),this.connectEvents());return}this.activeSection="overview",await this.refresh(),this.connectEvents()}async revokeJoinToken(e){if(window.confirm("Revoke this Join Token? Nodes using it will no longer be admitted.")){this.saving=!0;try{await y(`/api/v1/join-tokens/${e.id}`,{method:"DELETE"}),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async copyJoinCommand(){let e=!1;try{await navigator.clipboard.writeText(this.joinCommand),e=!0}catch{const i=Object.assign(document.createElement("textarea"),{value:this.joinCommand});i.style.cssText="position: fixed; opacity: 0",document.body.append(i),i.select(),e=document.execCommand("copy"),i.remove()}if(!e){this.error="Could not copy the Join command";return}this.copied=!0,window.setTimeout(()=>this.copied=!1,2e3)}toggleSelected(e,i){const n=new Set(this.selectedIds);i?n.add(e):n.delete(e),this.selectedIds=n}async bulkPause(e){this.saving=!0;try{await Promise.all([...this.selectedIds].map(i=>y(`/api/v1/targets/${i}/${e?"pause":"resume"}`,{method:"POST"}))),this.selectedIds=new Set,await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async bulkDelete(){if(window.confirm(`Delete ${this.selectedIds.size} selected Targets and their history?`)){this.saving=!0;try{await Promise.all([...this.selectedIds].map(e=>y(`/api/v1/targets/${e}`,{method:"DELETE"}))),this.selectedIds=new Set,await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async deleteResource(e,i,n){if(window.confirm(`Delete ${n}?`))try{await y(`/api/v1/${e}/${i}`,{method:"DELETE"}),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}}}const As={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5L2 22l1.5-5.5Zm-2 2l4 4"/>'};function Es(t,e,i){return u`
    ...
    <div class="page-columns">
      <section class="panel" aria-label="Alert history">
        ...
        ${t.length?t.map(n=>{const s=n.kind==="recovered"?"up":"down";return u`
                <div class="resource">
              ...
              `}):u`<div class="empty">No availability transitions.</div>`}
      </section>
        ...
        ${e.length?e.map(n=>u`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  ...
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${n.name}`} title=${`Edit ${n.name}`} @click=${()=>i.edit(n)}><iconify-icon .icon=${As} aria-hidden="true"></iconify-icon></button>
            ...
            `):u`<div class="empty">No notification channels.</div>`}
      </section>
    </div>
  `}const Ps={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},Is=Oe`
...
`;function he(t,e,i){return u`
  ...
  `}function Ds(t,e){return t==="webhook"?u`<label
      >Webhook URL<input
        name="url"
        type="url"
    ...
    /></label>
  `}const Os={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5c.08-1.25-.27-2.48-1-3.5c.28-1.15.28-2.35 0-3.5c0 0-1 0-3 1.5c-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5c-.39.49-.68 1.05-.85 1.65c-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></g>'},js={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M21.54 15H17a2 2 0 0 0-2 2v4.54M7 3.34V5a3 3 0 0 0 3 3v0a2 2 0 0 1 2 2v0c0 1.1.9 2 2 2v0a2 2 0 0 0 2-2v0c0-1.1.9-2 2-2h3.17M11 21.95V18a2 2 0 0 0-2-2v0a2 2 0 0 1-2-2v-1a2 2 0 0 0-2-2H2.05"/><circle cx="12" cy="12" r="10"/></g>'};function mt(){return u`
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${Os} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${js} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function Bt(t,e=[],i=!0){return u`
    <fieldset class="channel-fields">
      ...
      <div class="channel-options">
        ${t.map(s=>{const r=e.includes(s.id),o=i&&s.default;return u`
            <label class="check">
              <input
                name="channel_id"
                type="checkbox"
    ...
    </fieldset>`}const Vt={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Kt(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=Vt[e],i.type=e==="http"?"url":"text");const n=t.querySelector("[data-http-options]");n&&(n.hidden=e!=="http");const s=t.elements.namedItem("method");s&&(s.disabled=e!=="http",s.disabled&&(s.value="GET"))}function Ms(t){const e=t.currentTarget;e.form&&Kt(e.form,e.value)}function Ns(t){const e=t.currentTarget;queueMicrotask(()=>Kt(e,"http"))}function Rs(t,e,i){return u`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${i.backdrop}>
      ...
      <form @submit=${i.create} @reset=${Ns}>
        <label>Name<input name="name" placeholder="Production API" required autofocus /></label>
        <div class="row">
          <label>Type<select name="kind" @change=${Ms}><option value="http">HTTP</option><option value="tcp">TCP connect</option><option value="dns">DNS resolution</option><option value="icmp">ICMP echo</option><option value="tls">TLS certificate</option></select></label>
    ...
    </dialog>`}function Ls(t,e,i,n,s,r){const o=t.kind==="node",a=t.kind==="http",l=t.accepted_statuses.map(p=>p.start===p.end?p.start:`${p.start}-${p.end}`).join(","),c=t.history.slice(0,30).reverse(),d=Math.max(1,...c.map(p=>p.latency_ms)),h=new Map(n.map(p=>[p.id,p.name])),g=p=>new Date(p).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),x=p=>p>=1e3?`${(p/1e3).toFixed(p>=1e4?0:1)} s`:`${Math.round(p)} ms`;return u`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${r.backdrop}>
      ...
      <form @submit=${r.update} @input=${r.changed}>
        ...
        ${o?u`<label>RPC URL<input .value=${t.url} disabled /></label>`:u`
            ...
            `}
        <div class="dialog-actions">
          ${o?f:u`<div class="danger-actions">
            ...
            <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>r.pause(!t.paused)}><iconify-icon .icon=${t.paused?St:_t} aria-hidden="true"></iconify-icon></button>
          </div>`}
          <button class="button" type="submit" aria-busy=${e?"true":"false"} ?disabled=${e||!i}>Save changes</button>
        </div>
      </form>
      <section class="history">
        <div class="history-head"><h3>Evaluation history</h3>${c.length?u`<span class="meta">Latest ${c.length}</span>`:f}</div>
        ${c.length?u`
          <div class="chart-plot">
            <div class="chart-scale" aria-hidden="true"><span>${x(d)}</span><span>${x(d/2)}</span><span>0 ms</span></div>
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${x(d)}`}>
              ${c.map(p=>{const T=p.succeeded?"Passed":"Failed",w=o||!a?p.succeeded?"reachable":"unreachable":p.status_code===null?"network error":`HTTP ${p.status_code}`,q=h.get(p.executor_node_id)??`Node ${p.executor_node_id.slice(0,8)}`,C=`${T} at ${new Date(p.recorded_at_ms).toLocaleString()}: ${p.latency_ms} ms, ${w}. Executed by ${q}`;return u`<span class="history-bar ${p.succeeded?"up":"down"}" role="listitem" aria-label=${C} title=${C} style=${`height: ${Math.max(8,p.latency_ms/d*100)}%`}></span>`})}
            </div>
          </div>
          <div class="chart-axis"><span>${g(c[0].recorded_at_ms)}</span><span>${g(c[c.length-1].recorded_at_ms)}</span></div>
    ...
    </dialog>`}var Us=Object.getOwnPropertyDescriptor,qs=(t,e,i,n)=>{for(var s=n>1?void 0:n?Us(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(s=o(s)||s);return s};let Pe=class extends Ts{render(){const t=this.targets.filter(o=>o.availability==="up").length,e=this.targets.filter(o=>o.availability==="down").length,i=this.alerts.filter(o=>o.delivery==="pending").length,n=Ss(this.targets,this.live),s=["overview","alerts","cluster"],r=this.targets.filter(o=>`${o.name} ${o.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(o=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?o.paused:o.availability===this.statusFilter).sort((o,a)=>this.sort==="status"&&o.availability.localeCompare(a.availability)||o.name.localeCompare(a.name));return this.setupMode&&this.setup?u`
        <main class="shell setup-shell">
          <header>
            ...
            <div></div>
            <div class="actions"><button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${ft[this.theme]} aria-hidden="true"></iconify-icon></button></div>
          </header>
          ${this.error?u`<div class="notice" role="alert">${this.error}</div>`:f}
      ...
      <main class="shell">
        <header>
          ...
          <nav aria-label="Primary">
            ${s.map(o=>u`<a class=${this.activeSection===o?"active":""} href=${Fe[o]} @click=${a=>this.navigate(a,o)}>${o[0].toUpperCase()}${o.slice(1)}</a>`)}
          </nav>
          <div class="actions">
            <button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${ft[this.theme]} aria-hidden="true"></iconify-icon></button>
          </div>
        </header>
        ${this.error?u`<div class="notice" role="alert">${this.error}</div>`:f}
        ${this.setup?.warning&&!this.warningDismissed?u`<div class="notice" role="status">${this.setup.warning}<button class="button secondary" style="float: right; margin: -6px" @click=${this.dismissWarning}>Dismiss</button></div>`:f}
        ${this.activeSection==="overview"?this.renderOverview(r,t,e,i):this.activeSection==="alerts"?Es(this.transitions,this.channels,{create:()=>this.openChannelDialog(),edit:o=>this.openChannelDialog(o),remove:o=>{this.deleteResource("channels",o.id,o.name)},setDefault:(o,a)=>{this.setChannelDefault(o,a)}}):this.renderClusterPage()}
      </main>${mt()}
      ${Rs(this.channels,this.saving,{backdrop:o=>this.dismissOnBackdrop(o),close:()=>this.closeTargetDialog(),create:o=>{this.createTarget(o)}})}
      ${this.selected?Ls(this.selected,this.saving,this.detailDirty,this.cluster?.members??[],this.channels,{backdrop:o=>this.dismissOnBackdrop(o),close:()=>this.closeDetailDialog(),update:o=>{this.updateTarget(o)},changed:o=>this.updateDetailDirty(o),redirects:o=>this.toggleMaxRedirects(o),delete:()=>{this.deleteTarget()},pause:o=>{this.setPaused(o)}}):f}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          <label>Type<select name="type" .value=${this.channelKind} ?disabled=${this.editingChannel!==void 0} @change=${o=>{this.channelKind=o.target.value,this.channelTestMessage=""}}><option value="webhook">Webhook</option><option value="telegram">Telegram</option><option value="smtp">SMTP email</option></select></label>
          <label>Name<input name="name" placeholder="On-call" .value=${this.editingChannel?.name??""} required /></label>
          ${Ds(this.channelKind,this.editingChannel)}
    ...
    `}renderOverview(t,e,i,n){const s=this.targets.filter(a=>this.selectedIds.has(a.id)),r=s.some(a=>!a.paused),o=s.some(a=>a.paused);return u`
      ...
      <section class="overview-top">
        ...
        <section class="panel" aria-label="Secrets">
          ...
          ${this.secrets.length?this.secrets.map(a=>u`<div class="resource"><div><strong>${a.name}</strong><code>${a.id}</code></div><button class="button danger icon-button" aria-label=${`Delete secret ${a.name}`} title=${`Delete ${a.name}`} @click=${()=>this.deleteResource("secrets",a.id,a.name)}><iconify-icon .icon=${le} aria-hidden="true"></iconify-icon></button></div>`):u`<div class="empty">No reusable Secrets.</div>`}
        </section>
      </section>
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?u`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${Ct} aria-hidden="true"></iconify-icon></button>${r?u`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${_t} aria-hidden="true"></iconify-icon></button>`:f}${o?u`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${St} aria-hidden="true"></iconify-icon></button>`:f}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${le} aria-hidden="true"></iconify-icon></button></div></div>`:f}
        ${t.length?t.map(a=>this.renderTarget(a)):u`<div class="empty">${this.targets.length?"No Targets match these filters.":"No targets yet. Add the first one to begin monitoring."}</div>`}
      </section>
    `}renderClusterPage(){return u`
      ...
      <section class="panel" aria-label="Cluster topology">
        ...
        ${this.cluster?.members.map(t=>u`<div class="resource"><div><strong>${t.name}</strong><code>${t.raft_url}</code></div><div class="actions">${t.local?u`<span class="badge">This node</span>`:f}${t.leader?u`<span class="badge">Leader</span>`:f}</div></div>`)}
        ${this.cluster?.members.length?f:u`<div class="empty">Cluster topology unavailable.</div>`}
      </section>
      <section class="panel" aria-label="Join tokens">
        ...
        ${this.joinTokens.length?this.joinTokens.map(t=>u`
              <div class="resource">
    ...
    `}renderTarget(t){const e=t.kind==="node",i=t.kind==="http",n=t.latest_evaluation,s=t.history.slice(0,16).reverse(),r=Math.max(1,...s.map(a=>a.latency_ms)),o=t.paused?"paused":t.availability==="down"?"down":t.consecutive_failures>0?"suspicious":t.availability;return u`
      <div class="target-wrap">
        ${e?u`<input class="select-target" type="checkbox" aria-label=${`Select ${t.name}`} disabled />`:u`<input class="select-target" type="checkbox" aria-label=${`Select ${t.name}`} .checked=${this.selectedIds.has(t.id)} @change=${a=>this.toggleSelected(t.id,a.target.checked)} />`}
        <button class=${`target ${e?"node-target":""}`} aria-label=${t.name} @click=${()=>this.openTarget(t)}>
          <i class="state ${o}" aria-label=${o}></i>
          <div>
            <div class="target-title"><h3>${t.name}</h3><span class="badge">${t.kind.toUpperCase()}</span></div>
            <div class="meta">${t.paused?"Paused · ":""}${i?`${t.method} · `:""}${t.url} · every ${t.interval_seconds}s</div>
          </div>
          <div class="target-side">
            ${s.length?u`<div class="mini-chart" aria-hidden="true">${s.map(a=>u`<i class="mini-bar ${a.succeeded?"up":"down"}" style=${`height: ${Math.max(12,a.latency_ms/r*100)}%`}></i>`)}</div>`:f}
            <div class="latency">
