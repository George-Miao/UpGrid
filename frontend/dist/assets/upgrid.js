(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=i(n);fetch(n.href,r)}})();const se=globalThis,Me=se.ShadowRoot&&(se.ShadyCSS===void 0||se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Le=Symbol(),We=new WeakMap;let kt=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==Le)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Me&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=We.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&We.set(i,e))}return e}toString(){return this.cssText}};const ei=t=>new kt(typeof t=="string"?t:t+"",void 0,Le),ge=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,n,r)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+t[r+1],t[0]);return new kt(i,t,Le)},ti=(t,e)=>{if(Me)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),n=se.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=i.cssText,t.appendChild(s)}},Qe=Me?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return ei(i)})(t):t;const{is:ii,defineProperty:si,getOwnPropertyDescriptor:ni,getOwnPropertyNames:ai,getOwnPropertySymbols:ri,getPrototypeOf:oi}=Object,fe=globalThis,Ye=fe.trustedTypes,li=Ye?Ye.emptyScript:"",ci=fe.reactiveElementPolyfillSupport,K=(t,e)=>t,oe={toAttribute(t,e){switch(e){case Boolean:t=t?li:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Ue=(t,e)=>!ii(t,e),Ze={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:Ue};Symbol.metadata??=Symbol("metadata"),fe.litPropertyMetadata??=new WeakMap;let M=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Ze){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),n=this.getPropertyDescriptor(e,s,i);n!==void 0&&si(this.prototype,e,n)}}static getPropertyDescriptor(e,i,s){const{get:n,set:r}=ni(this.prototype,e)??{get(){return this[i]},set(a){this[i]=a}};return{get:n,set(a){const o=n?.call(this);r?.call(this,a),this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ze}static _$Ei(){if(this.hasOwnProperty(K("elementProperties")))return;const e=oi(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(K("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(K("properties"))){const i=this.properties,s=[...ai(i),...ri(i)];for(const n of s)this.createProperty(n,i[n])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,n]of i)this.elementProperties.set(s,n)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const n=this._$Eu(i,s);n!==void 0&&this._$Eh.set(n,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)i.unshift(Qe(n))}else e!==void 0&&i.push(Qe(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ti(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){const s=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,s);if(n!==void 0&&s.reflect===!0){const r=(s.converter?.toAttribute!==void 0?s.converter:oe).toAttribute(i,s.type);this._$Em=e,r==null?this.removeAttribute(n):this.setAttribute(n,r),this._$Em=null}}_$AK(e,i){const s=this.constructor,n=s._$Eh.get(e);if(n!==void 0&&this._$Em!==n){const r=s.getPropertyOptions(n),a=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:oe;this._$Em=n;const o=a.fromAttribute(i,r.type);this[n]=o??this._$Ej?.get(n)??o,this._$Em=null}}requestUpdate(e,i,s,n=!1,r){if(e!==void 0){const a=this.constructor;if(n===!1&&(r=this[e]),s??=a.getPropertyOptions(e),!((s.hasChanged??Ue)(r,i)||s.useDefault&&s.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:n,wrapped:r},a){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??i??this[e]),r!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,r]of this._$Ep)this[n]=r;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,r]of s){const{wrapped:a}=r,o=this[n];a!==!0||this._$AL.has(n)||o===void 0||this.C(n,void 0,r,o)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};M.elementStyles=[],M.shadowRootOptions={mode:"open"},M[K("elementProperties")]=new Map,M[K("finalized")]=new Map,ci?.({ReactiveElement:M}),(fe.reactiveElementVersions??=[]).push("2.1.2");const qe=globalThis,Xe=t=>t,le=qe.trustedTypes,et=le?le.createPolicy("lit-html",{createHTML:t=>t}):void 0,St="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,Tt="?"+P,di=`<${Tt}>`,j=document,G=()=>j.createComment(""),W=t=>t===null||typeof t!="object"&&typeof t!="function",Fe=Array.isArray,ui=t=>Fe(t)||typeof t?.[Symbol.iterator]=="function",we=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,tt=/-->/g,it=/>/g,I=RegExp(`>|${we}(?:([^\\s"'>=/]+)(${we}*=${we}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),st=/'/g,nt=/"/g,At=/^(?:script|style|textarea|title)$/i,pi=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),c=pi(1),L=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),at=new WeakMap,O=j.createTreeWalker(j,129);function Ct(t,e){if(!Fe(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return et!==void 0?et.createHTML(e):e}const hi=(t,e)=>{const i=t.length-1,s=[];let n,r=e===2?"<svg>":e===3?"<math>":"",a=H;for(let o=0;o<i;o++){const l=t[o];let d,u,p=-1,y=0;for(;y<l.length&&(a.lastIndex=y,u=a.exec(l),u!==null);)y=a.lastIndex,a===H?u[1]==="!--"?a=tt:u[1]!==void 0?a=it:u[2]!==void 0?(At.test(u[2])&&(n=RegExp("</"+u[2],"g")),a=I):u[3]!==void 0&&(a=I):a===I?u[0]===">"?(a=n??H,p=-1):u[1]===void 0?p=-2:(p=a.lastIndex-u[2].length,d=u[1],a=u[3]===void 0?I:u[3]==='"'?nt:st):a===nt||a===st?a=I:a===tt||a===it?a=H:(a=I,n=void 0);const $=a===I&&t[o+1].startsWith("/>")?" ":"";r+=a===H?l+di:p>=0?(s.push(d),l.slice(0,p)+St+l.slice(p)+P+$):l+P+(p===-2?o:$)}return[Ct(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class Q{constructor({strings:e,_$litType$:i},s){let n;this.parts=[];let r=0,a=0;const o=e.length-1,l=this.parts,[d,u]=hi(e,i);if(this.el=Q.createElement(d,s),O.currentNode=this.el.content,i===2||i===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=O.nextNode())!==null&&l.length<o;){if(n.nodeType===1){if(n.hasAttributes())for(const p of n.getAttributeNames())if(p.endsWith(St)){const y=u[a++],$=n.getAttribute(p).split(P),w=/([.?@])?(.*)/.exec(y);l.push({type:1,index:r,name:w[2],strings:$,ctor:w[1]==="."?fi:w[1]==="?"?mi:w[1]==="@"?bi:me}),n.removeAttribute(p)}else p.startsWith(P)&&(l.push({type:6,index:r}),n.removeAttribute(p));if(At.test(n.tagName)){const p=n.textContent.split(P),y=p.length-1;if(y>0){n.textContent=le?le.emptyScript:"";for(let $=0;$<y;$++)n.append(p[$],G()),O.nextNode(),l.push({type:2,index:++r});n.append(p[y],G())}}}else if(n.nodeType===8)if(n.data===Tt)l.push({type:2,index:r});else{let p=-1;for(;(p=n.data.indexOf(P,p+1))!==-1;)l.push({type:7,index:r}),p+=P.length-1}r++}}static createElement(e,i){const s=j.createElement("template");return s.innerHTML=e,s}}function U(t,e,i=t,s){if(e===L)return e;let n=s!==void 0?i._$Co?.[s]:i._$Cl;const r=W(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(t),n._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=n:i._$Cl=n),n!==void 0&&(e=U(t,n._$AS(t,e.values),n,s)),e}class gi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,n=(e?.creationScope??j).importNode(i,!0);O.currentNode=n;let r=O.nextNode(),a=0,o=0,l=s[0];for(;l!==void 0;){if(a===l.index){let d;l.type===2?d=new X(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new vi(r,this,e)),this._$AV.push(d),l=s[++o]}a!==l?.index&&(r=O.nextNode(),a++)}return O.currentNode=j,n}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,n){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=U(this,e,i),W(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==L&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ui(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&W(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,n=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Q.createElement(Ct(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(i);else{const r=new gi(n,this),a=r.u(this.options);r.p(i),this.T(a),this._$AH=r}}_$AC(e){let i=at.get(e.strings);return i===void 0&&at.set(e.strings,i=new Q(e)),i}k(e){Fe(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,n=0;for(const r of e)n===i.length?i.push(s=new X(this.O(G()),this.O(G()),this,this.options)):s=i[n],s._$AI(r),n++;n<i.length&&(this._$AR(s&&s._$AB.nextSibling,n),i.length=n)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=Xe(e).nextSibling;Xe(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class me{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,n,r){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=i,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=h}_$AI(e,i=this,s,n){const r=this.strings;let a=!1;if(r===void 0)e=U(this,e,i,0),a=!W(e)||e!==this._$AH&&e!==L,a&&(this._$AH=e);else{const o=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=U(this,o[s+l],i,l),d===L&&(d=this._$AH[l]),a||=!W(d)||d!==this._$AH[l],d===h?e=h:e!==h&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}a&&!n&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class fi extends me{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}}class mi extends me{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}}class bi extends me{constructor(e,i,s,n,r){super(e,i,s,n,r),this.type=5}_$AI(e,i=this){if((e=U(this,e,i,0)??h)===L)return;const s=this._$AH,n=e===h&&s!==h||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==h&&(s===h||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class vi{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}}const yi=qe.litHtmlPolyfillSupport;yi?.(Q,X),(qe.litHtmlVersions??=[]).push("3.3.3");const xi=(t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(n===void 0){const r=i?.renderBefore??null;s._$litPart$=n=new X(e.insertBefore(G(),r),r,void 0,i??{})}return n._$AI(t),n};const ze=globalThis;class N extends M{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}N._$litElement$=!0,N.finalized=!0,ze.litElementHydrateSupport?.({LitElement:N});const $i=ze.litElementPolyfillSupport;$i?.({LitElement:N});(ze.litElementVersions??=[]).push("4.2.2");const He=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const wi={attribute:!0,type:String,converter:oe,reflect:!1,hasChanged:Ue},_i=(t=wi,e,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(r===void 0&&globalThis.litPropertyMetadata.set(n,r=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),s==="accessor"){const{name:a}=i;return{set(o){const l=e.get.call(this);e.set.call(this,o),this.requestUpdate(a,l,t,!0,o)},init(o){return o!==void 0&&this.C(a,void 0,t,o),o}}}if(s==="setter"){const{name:a}=i;return function(o){const l=this[a];e.call(this,o),this.requestUpdate(a,l,t,!0,o)}}throw Error("Unsupported decorator location: "+s)};function be(t){return(e,i)=>typeof i=="object"?_i(t,e,i):((s,n,r)=>{const a=n.hasOwnProperty(r);return n.constructor.createProperty(r,s),a?Object.getOwnPropertyDescriptor(n,r):void 0})(t,e,i)}function f(t){return be({...t,state:!0,attribute:!1})}const Pt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},Et={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},ce={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},Dt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'};const It=Object.freeze({left:0,top:0,width:16,height:16}),de=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),ee=Object.freeze({...It,...de}),Ce=Object.freeze({...ee,body:"",hidden:!1}),ki=Object.freeze({width:null,height:null}),Ot=Object.freeze({...ki,...de});function Si(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(i===""){const n=parseInt(t);return isNaN(n)?0:s(n)}else if(i!==t){let n=0;switch(i){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return e}const Ti=/[\s,]+/;function Ai(t,e){e.split(Ti).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Nt={...Ot,preserveAspectRatio:""};function rt(t){const e={...Nt},i=(s,n)=>t.getAttribute(s)||n;return e.width=i("width",null),e.height=i("height",null),e.rotate=Si(i("rotate","")),Ai(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function Ci(t,e){for(const i in Nt)if(t[i]!==e[i])return!0;return!1}const jt=/^[a-z0-9]+(-[a-z0-9]+)*$/,te=(t,e,i,s="")=>{const n=t.split(":");if(t.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const o=n.pop(),l=n.pop(),d={provider:n.length>0?n[0]:s,prefix:l,name:o};return e&&!ne(d)?null:d}const r=n[0],a=r.split("-");if(a.length>1){const o={provider:s,prefix:a.shift(),name:a.join("-")};return e&&!ne(o)?null:o}if(i&&s===""){const o={provider:s,prefix:"",name:r};return e&&!ne(o,i)?null:o}return null},ne=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function Pi(t,e){const i=t.icons,s=t.aliases||Object.create(null),n=Object.create(null);function r(a){if(i[a])return n[a]=[];if(!(a in n)){n[a]=null;const o=s[a]&&s[a].parent,l=o&&r(o);l&&(n[a]=[o].concat(l))}return n[a]}return Object.keys(i).concat(Object.keys(s)).forEach(r),n}function Ei(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const s=((t.rotate||0)+(e.rotate||0))%4;return s&&(i.rotate=s),i}function ot(t,e){const i=Ei(t,e);for(const s in Ce)s in de?s in t&&!(s in i)&&(i[s]=de[s]):s in e?i[s]=e[s]:s in t&&(i[s]=t[s]);return i}function Di(t,e,i){const s=t.icons,n=t.aliases||Object.create(null);let r={};function a(o){r=ot(s[o]||n[o],r)}return a(e),i.forEach(a),ot(t,r)}function Rt(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(n=>{e(n,null),i.push(n)});const s=Pi(t);for(const n in s){const r=s[n];r&&(e(n,Di(t,n,r)),i.push(n))}return i}const Ii={provider:"",aliases:{},not_found:{},...It};function _e(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function Mt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!_e(t,Ii))return null;const i=e.icons;for(const n in i){const r=i[n];if(!n||typeof r.body!="string"||!_e(r,Ce))return null}const s=e.aliases||Object.create(null);for(const n in s){const r=s[n],a=r.parent;if(!n||typeof a!="string"||!i[a]&&!s[a]||!_e(r,Ce))return null}return e}const ue=Object.create(null);function Oi(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function C(t,e){const i=ue[t]||(ue[t]=Object.create(null));return i[e]||(i[e]=Oi(t,e))}function Lt(t,e){return Mt(e)?Rt(e,(i,s)=>{s?t.icons[i]=s:t.missing.add(i)}):[]}function Ni(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function ji(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(ue)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(ue[s]||{})).forEach(n=>{const r=C(s,n);i=i.concat(Object.keys(r.icons).map(a=>(s!==""?"@"+s+":":"")+n+":"+a))})}),i}let Y=!1;function Ut(t){return typeof t=="boolean"&&(Y=t),Y}function Z(t){const e=typeof t=="string"?te(t,!0,Y):t;if(e){const i=C(e.provider,e.prefix),s=e.name;return i.icons[s]||(i.missing.has(s)?null:void 0)}}function qt(t,e){const i=te(t,!0,Y);if(!i)return!1;const s=C(i.provider,i.prefix);return e?Ni(s,i.name,e):(s.missing.add(i.name),!0)}function lt(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),Y&&!e&&!t.prefix){let s=!1;return Mt(t)&&(t.prefix="",Rt(t,(n,r)=>{qt(n,r)&&(s=!0)})),s}const i=t.prefix;return ne({prefix:i,name:"a"})?!!Lt(C(e,i),t):!1}function Ri(t){return!!Z(t)}function Mi(t){const e=Z(t);return e&&{...ee,...e}}function Ft(t,e){t.forEach(i=>{const s=i.loaderCallbacks;s&&(i.loaderCallbacks=s.filter(n=>n.id!==e))})}function Li(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const s=t.provider,n=t.prefix;e.forEach(r=>{const a=r.icons,o=a.pending.length;a.pending=a.pending.filter(l=>{if(l.prefix!==n)return!0;const d=l.name;if(t.icons[d])a.loaded.push({provider:s,prefix:n,name:d});else if(t.missing.has(d))a.missing.push({provider:s,prefix:n,name:d});else return i=!0,!0;return!1}),a.pending.length!==o&&(i||Ft([t],r.id),r.callback(a.loaded.slice(0),a.missing.slice(0),a.pending.slice(0),r.abort))})}))}let Ui=0;function qi(t,e,i){const s=Ui++,n=Ft.bind(null,i,s);if(!e.pending.length)return n;const r={id:s,icons:e,callback:t,abort:n};return i.forEach(a=>{(a.loaderCallbacks||(a.loaderCallbacks=[])).push(r)}),n}function Fi(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return t.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,a=n.prefix,o=n.name,l=i[r]||(i[r]=Object.create(null)),d=l[a]||(l[a]=C(r,a));let u;o in d.icons?u=e.loaded:a===""||d.missing.has(o)?u=e.missing:u=e.pending;const p={provider:r,prefix:a,name:o};u.push(p)}),e}const Pe=Object.create(null);function ct(t,e){Pe[t]=e}function Ee(t){return Pe[t]||Pe[""]}function zi(t,e=!0,i=!1){const s=[];return t.forEach(n=>{const r=typeof n=="string"?te(n,e,i):n;r&&s.push(r)}),s}function Je(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const ve=Object.create(null),J=["https://api.simplesvg.com","https://api.unisvg.com"],ae=[];for(;J.length>0;)J.length===1||Math.random()>.5?ae.push(J.shift()):ae.push(J.pop());ve[""]=Je({resources:["https://api.iconify.design"].concat(ae)});function dt(t,e){const i=Je(e);return i===null?!1:(ve[t]=i,!0)}function ye(t){return ve[t]}function Hi(){return Object.keys(ve)}const Ji={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Bi(t,e,i,s){const n=t.resources.length,r=t.random?Math.floor(Math.random()*n):t.index;let a;if(t.random){let x=t.resources.slice(0);for(a=[];x.length>1;){const T=Math.floor(Math.random()*x.length);a.push(x[T]),x=x.slice(0,T).concat(x.slice(T+1))}a=a.concat(x)}else a=t.resources.slice(r).concat(t.resources.slice(0,r));const o=Date.now();let l="pending",d=0,u,p=null,y=[],$=[];typeof s=="function"&&$.push(s);function w(){p&&(clearTimeout(p),p=null)}function v(){l==="pending"&&(l="aborted"),w(),y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function _(x,T){T&&($=[]),typeof x=="function"&&$.push(x)}function F(){return{startTime:o,payload:e,status:l,queriesSent:d,queriesPending:y.length,subscribe:_,abort:v}}function A(){l="failed",$.forEach(x=>{x(void 0,u)})}function k(){y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function S(x,T,z){const ie=T!=="success";switch(y=y.filter(D=>D!==x),l){case"pending":break;case"failed":if(ie||!t.dataAfterTimeout)return;break;default:return}if(T==="abort"){u=z,A();return}if(ie){u=z,y.length||(a.length?$e():A());return}if(w(),k(),!t.random){const D=t.resources.indexOf(x.resource);D!==-1&&D!==t.index&&(t.index=D)}l="completed",$.forEach(D=>{D(z)})}function $e(){if(l!=="pending")return;w();const x=a.shift();if(x===void 0){if(y.length){p=setTimeout(()=>{w(),l==="pending"&&(k(),A())},t.timeout);return}A();return}const T={status:"pending",resource:x,callback:(z,ie)=>{S(T,z,ie)}};y.push(T),d++,p=setTimeout($e,t.rotate),i(x,e,T.callback)}return setTimeout($e),F}function zt(t){const e={...Ji,...t};let i=[];function s(){i=i.filter(a=>a().status==="pending")}function n(a,o,l){const d=Bi(e,a,o,(u,p)=>{s(),l&&l(u,p)});return i.push(d),d}function r(a){return i.find(o=>a(o))||null}return{query:n,find:r,setIndex:a=>{e.index=a},getIndex:()=>e.index,cleanup:s}}function ut(){}const ke=Object.create(null);function Ki(t){if(!ke[t]){const e=ye(t);if(!e)return;ke[t]={config:e,redundancy:zt(e)}}return ke[t]}function Ht(t,e,i){let s,n;if(typeof t=="string"){const r=Ee(t);if(!r)return i(void 0,424),ut;n=r.send;const a=Ki(t);a&&(s=a.redundancy)}else{const r=Je(t);if(r){s=zt(r);const a=Ee(t.resources?t.resources[0]:"");a&&(n=a.send)}}return!s||!n?(i(void 0,424),ut):s.query(e,n,i)().abort}function pt(){}function Vi(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Li(t)}))}function Gi(t){const e=[],i=[];return t.forEach(s=>{(s.match(jt)?e:i).push(s)}),{valid:e,invalid:i}}function B(t,e,i){function s(){const n=t.pendingIcons;e.forEach(r=>{n&&n.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Lt(t,i).length){s();return}}catch(n){console.error(n)}s(),Vi(t)}function ht(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Wi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:s}=t,n=t.iconsToLoad;if(delete t.iconsToLoad,!n||!n.length)return;const r=t.loadIcon;if(t.loadIcons&&(n.length>1||!r)){ht(t.loadIcons(n,s,i),d=>{B(t,n,d)});return}if(r){n.forEach(d=>{ht(r(d,s,i),u=>{B(t,[d],u?{prefix:s,icons:{[d]:u}}:null)})});return}const{valid:a,invalid:o}=Gi(n);if(o.length&&B(t,o,null),!a.length)return;const l=s.match(jt)?Ee(i):null;if(!l){B(t,a,null);return}l.prepare(i,s,a).forEach(d=>{Ht(i,d,u=>{B(t,d.icons,u)})})}))}const Be=(t,e)=>{const i=Fi(zi(t,!0,Ut()));if(!i.pending.length){let o=!0;return e&&setTimeout(()=>{o&&e(i.loaded,i.missing,i.pending,pt)}),()=>{o=!1}}const s=Object.create(null),n=[];let r,a;return i.pending.forEach(o=>{const{provider:l,prefix:d}=o;if(d===a&&l===r)return;r=l,a=d,n.push(C(l,d));const u=s[l]||(s[l]=Object.create(null));u[d]||(u[d]=[])}),i.pending.forEach(o=>{const{provider:l,prefix:d,name:u}=o,p=C(l,d),y=p.pendingIcons||(p.pendingIcons=new Set);y.has(u)||(y.add(u),s[l][d].push(u))}),n.forEach(o=>{const l=s[o.provider][o.prefix];l.length&&Wi(o,l)}),e?qi(e,i,n):pt},Qi=t=>new Promise((e,i)=>{const s=typeof t=="string"?te(t,!0):t;if(!s){i(t);return}Be([s||t],n=>{if(n.length&&s){const r=Z(s);if(r){e({...ee,...r});return}}i(t)})});function gt(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function Yi(t,e){if(typeof t=="object")return{data:gt(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=gt(t);if(r)return{data:r,value:t}}const i=te(t,!0,!0);if(!i)return{value:t};const s=Z(i);if(s!==void 0||!i.prefix)return{value:t,name:i,data:s};const n=Be([i],()=>e(t,i,Z(i)));return{value:t,name:i,loading:n}}let Jt=!1;try{Jt=navigator.vendor.indexOf("Apple")===0}catch{}function Zi(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Jt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const Xi=/(-?[0-9.]*[0-9]+[0-9.]*)/g,es=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function De(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const s=t.split(Xi);if(s===null||!s.length)return t;const n=[];let r=s.shift(),a=es.test(r);for(;;){if(a){const o=parseFloat(r);isNaN(o)?n.push(r):n.push(Math.ceil(o*e*i)/i)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");a=!a}}function ts(t,e="defs"){let i="";const s=t.indexOf("<"+e);for(;s>=0;){const n=t.indexOf(">",s),r=t.indexOf("</"+e);if(n===-1||r===-1)break;const a=t.indexOf(">",r);if(a===-1)break;i+=t.slice(n+1,r).trim(),t=t.slice(0,s).trim()+t.slice(a+1)}return{defs:i,content:t}}function is(t,e){return t?"<defs>"+t+"</defs>"+e:e}function ss(t,e,i){const s=ts(t);return is(s.defs,e+s.content+i)}const ns=t=>t==="unset"||t==="undefined"||t==="none";function Bt(t,e){const i={...ee,...t},s={...Ot,...e},n={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,s].forEach(v=>{const _=[],F=v.hFlip,A=v.vFlip;let k=v.rotate;F?A?k+=2:(_.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),_.push("scale(-1 1)"),n.top=n.left=0):A&&(_.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),_.push("scale(1 -1)"),n.top=n.left=0);let S;switch(k<0&&(k-=Math.floor(k/4)*4),k=k%4,k){case 1:S=n.height/2+n.top,_.unshift("rotate(90 "+S.toString()+" "+S.toString()+")");break;case 2:_.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:S=n.width/2+n.left,_.unshift("rotate(-90 "+S.toString()+" "+S.toString()+")");break}k%2===1&&(n.left!==n.top&&(S=n.left,n.left=n.top,n.top=S),n.width!==n.height&&(S=n.width,n.width=n.height,n.height=S)),_.length&&(r=ss(r,'<g transform="'+_.join(" ")+'">',"</g>"))});const a=s.width,o=s.height,l=n.width,d=n.height;let u,p;a===null?(p=o===null?"1em":o==="auto"?d:o,u=De(p,l/d)):(u=a==="auto"?l:a,p=o===null?De(u,d/l):o==="auto"?d:o);const y={},$=(v,_)=>{ns(_)||(y[v]=_.toString())};$("width",u),$("height",p);const w=[n.left,n.top,l,d];return y.viewBox=w.join(" "),{attributes:y,viewBox:w,body:r}}function Ke(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)i+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function as(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function rs(t){return"data:image/svg+xml,"+as(t)}function Kt(t){return'url("'+rs(t)+'")'}const os=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let pe=os();function ls(t){pe=t}function cs(){return pe}function ds(t,e){const i=ye(t);if(!i)return 0;let s;if(!i.maxURL)s=0;else{let n=0;i.resources.forEach(a=>{n=Math.max(n,a.length)});const r=e+".json?icons=";s=i.maxURL-n-i.path.length-r.length}return s}function us(t){return t===404}const ps=(t,e,i)=>{const s=[],n=ds(t,e),r="icons";let a={type:r,provider:t,prefix:e,icons:[]},o=0;return i.forEach((l,d)=>{o+=l.length+1,o>=n&&d>0&&(s.push(a),a={type:r,provider:t,prefix:e,icons:[]},o=l.length),a.icons.push(l)}),s.push(a),s};function hs(t){if(typeof t=="string"){const e=ye(t);if(e)return e.path}return"/"}const gs=(t,e,i)=>{if(!pe){i("abort",424);return}let s=hs(e.provider);switch(e.type){case"icons":{const r=e.prefix,a=e.icons.join(","),o=new URLSearchParams({icons:a});s+=r+".json?"+o.toString();break}case"custom":{const r=e.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let n=503;pe(t+s).then(r=>{const a=r.status;if(a!==200){setTimeout(()=>{i(us(a)?"abort":"next",a)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",n)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",n)})},fs={prepare:ps,send:gs};function ms(t,e,i){C(i||"",e).loadIcons=t}function bs(t,e,i){C(i||"",e).loadIcon=t}const Se="data-style";let Vt="";function vs(t){Vt=t}function ft(t,e){let i=Array.from(t.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Se));i||(i=document.createElement("style"),i.setAttribute(Se,Se),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Vt}function Gt(){ct("",fs),Ut(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!lt(n))&&console.error(s)}catch{console.error(s)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const s in i){const n="IconifyProviders["+s+"] is invalid.";try{const r=i[s];if(typeof r!="object"||!r||r.resources===void 0)continue;dt(s,r)||console.error(n)}catch{console.error(n)}}}}return{iconLoaded:Ri,getIcon:Mi,listIcons:ji,addIcon:qt,addCollection:lt,calculateSize:De,buildIcon:Bt,iconToHTML:Ke,svgToURL:Kt,loadIcons:Be,loadIcon:Qi,addAPIProvider:dt,setCustomIconLoader:bs,setCustomIconsLoader:ms,appendCustomStyle:vs,_api:{getAPIConfig:ye,setAPIModule:ct,sendAPIQuery:Ht,setFetch:ls,getFetch:cs,listAPIProviders:Hi}}}const Ie={"background-color":"currentColor"},Wt={"background-color":"transparent"},mt={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},bt={"-webkit-mask":Ie,mask:Ie,background:Wt};for(const t in bt){const e=bt[t];for(const i in mt)e[t+"-"+i]=mt[i]}function vt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function ys(t,e,i){const s=document.createElement("span");let n=t.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=t.attributes,a=Ke(n,{...r,width:e.width+"",height:e.height+""}),o=Kt(a),l=s.style,d={"--svg":o,width:vt(r.width),height:vt(r.height),...i?Ie:Wt};for(const u in d)l.setProperty(u,d[u]);return s}let V;function xs(){try{V=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{V=null}}function $s(t){return V===void 0&&xs(),V?V.createHTML(t):t}function ws(t){const e=document.createElement("span"),i=t.attributes;let s="";i.width||(s="width: inherit;"),i.height||(s+="height: inherit;"),s&&(i.style=s);const n=Ke(t.body,i);return e.innerHTML=$s(n),e.firstChild}function Oe(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function yt(t,e){const i=e.icon.data,s=e.customisations,n=Bt(i,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=e.renderedMode;let a;r==="svg"?a=ws(n):a=ys(n,{...ee,...i},r==="mask");const o=Oe(t);o?a.tagName==="SPAN"&&o.tagName===a.tagName?o.setAttribute("style",a.getAttribute("style")):t.replaceChild(a,o):t.appendChild(a)}function xt(t,e,i){const s=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:s}}function _s(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const s=e.get(t);if(s)return s;const n=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const o=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");ft(o,l),this._state=xt({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(o){switch(o){case"inline":{const l=this.hasAttribute("inline"),d=this._state;l!==d.inline&&(d.inline=l,ft(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const o=this.getAttribute("icon");if(o&&o.slice(0,1)==="{")try{return JSON.parse(o)}catch{}return o}set icon(o){typeof o=="object"&&(o=JSON.stringify(o)),this.setAttribute("icon",o)}get inline(){return this.hasAttribute("inline")}set inline(o){o?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(o){o?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const o=this._state;if(o.rendered){const l=this._shadowRoot;if(o.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}yt(l,o)}}get status(){const o=this._state;return o.rendered?"rendered":o.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const o=this._state,l=this.getAttribute("icon");if(l!==o.icon.value){this._iconChanged(l);return}if(!o.rendered||!this._visible)return;const d=this.getAttribute("mode"),u=rt(this);(o.attrMode!==d||Ci(o.customisations,u)||!Oe(this._shadowRoot))&&this._renderIcon(o.icon,u,d)}_iconChanged(o){const l=Yi(o,(d,u,p)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==d)return;const $={value:d,name:u,data:p};$.data?this._gotIconData($):y.icon=$});l.data?this._gotIconData(l):this._state=xt(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const o=Oe(this._shadowRoot);o&&this._shadowRoot.removeChild(o);return}this._queueCheck()}_gotIconData(o){this._checkQueued=!1,this._renderIcon(o,rt(this),this.getAttribute("mode"))}_renderIcon(o,l,d){const u=Zi(o.data.body,d),p=this._state.inline;yt(this._shadowRoot,this._state={rendered:!0,icon:o,inline:p,customisations:l,attrMode:d,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(o=>{const l=o.some(d=>d.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(o=>{o in r.prototype||Object.defineProperty(r.prototype,o,{get:function(){return this.getAttribute(o)},set:function(l){l!==null?this.setAttribute(o,l):this.removeAttribute(o)}})});const a=Gt();for(const o in a)r[o]=r.prototype[o]=a[o];return e.define(t,r),r}const ks=_s()||Gt(),{iconLoaded:sn,getIcon:nn,listIcons:an,addIcon:rn,addCollection:on,calculateSize:ln,buildIcon:cn,iconToHTML:dn,svgToURL:un,loadIcons:pn,loadIcon:hn,setCustomIconLoader:gn,setCustomIconsLoader:fn,addAPIProvider:mn,_api:bn}=ks;class Ve extends Error{constructor(e,i){super(i),this.status=e,this.name="ApiRequestError"}}async function g(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:i.statusText}));throw new Ve(i.status,s.error||i.statusText)}return i.status===204?void 0:i.json()}function Ne(t,e,i=!1){if(e==="telegram"){const s=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!s?void 0:s,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const s=String(t.get("username")??""),n=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:s||void 0,password:n||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function je(t,e=[],i=!0,s=String(t.get("kind")??"http"),n=[]){const r=String(t.get("url")),a=s==="http"?r:`${s}://${r.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:s,url:a,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),headers:{},body:null,assertions:n,skip_tls_verification:!1,tls_ca_secret_id:Te(t,"tls_ca_secret_id"),tls_client_certificate_secret_id:Te(t,"tls_client_certificate_secret_id"),tls_client_private_key_secret_id:Te(t,"tls_client_private_key_secret_id"),notification_channel_ids:e,use_default_channels:i}}function Te(t,e){return String(t.get(e)??"")||null}var Ss=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,q=(t,e,i,s)=>{for(var n=s>1?void 0:s?Ts(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=(s?a(e,i,n):a(n))||n);return s&&n&&Ss(e,i,n),n};let E=class extends N{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await g("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){if(t.preventDefault(),!window.confirm("Create a new single-Node Cluster?"))return;const e=new FormData(t.currentTarget),i=String(e.get("admin_username")??"").trim(),s=String(e.get("admin_password")??"");await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName(),admin_username:i,admin_password:s},{username:i,password:s})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e,i){this.saving=!0,this.error="";try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster(i)}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(t){for(let e=0;e<120;e+=1){const{promise:i,resolve:s}=Promise.withResolvers();window.setTimeout(s,250),await i;try{t&&await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify(t)});const n=await g("/api/v1/setup");if(n.cluster_ready){this.changed(n);return}}catch(n){if(!t&&n instanceof Ve&&n.status===401){window.location.assign("/");return}}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Ne(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=je(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await g("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return c`<section class="flow" aria-label="UpGrid setup">
      ...
      <div class="panel"><form class="choice" @submit=${this.createTarget}>
        ...
        ${this.channels.length?c`<fieldset><legend>Notification channels</legend>${this.channels.map(t=>c`<label><span><input name="channel_id" type="checkbox" value=${t.id} /> ${t.name}</span></label>`)}</fieldset>`:h}
  ...
  `;q([be({attribute:!1})],E.prototype,"setup",2);q([f()],E.prototype,"channelKind",2);q([f()],E.prototype,"channels",2);q([f()],E.prototype,"saving",2);q([f()],E.prototype,"error",2);E=q([He("upgrid-setup")],E);var As=Object.defineProperty,Cs=Object.getOwnPropertyDescriptor,xe=(t,e,i,s)=>{for(var n=s>1?void 0:s?Cs(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=(s?a(e,i,n):a(n))||n);return s&&n&&As(e,i,n),n};const Ps={body_contains:"Body contains",body_regex:"Body regex",json_path:"JSONPath",response_header:"Response header",latency:"Latency threshold",script:"Script"};let R=class extends N{constructor(){super(...arguments),this.assertions=[],this.targetId="new",this.draft=[],this.loadedTarget="",this.internals=this.attachInternals()}get value(){return structuredClone(this.draft)}willUpdate(t){t.has("targetId")&&this.loadedTarget!==this.targetId&&(this.loadedTarget=this.targetId,this.draft=structuredClone(this.assertions))}updated(){this.internals.setFormValue(JSON.stringify(this.draft))}formResetCallback(){this.draft=structuredClone(this.assertions),this.internals.setFormValue(JSON.stringify(this.draft))}add(){this.draft=[...this.draft,$t("body_contains")],this.changed()}removeAssertion(t){this.draft=this.draft.filter((e,i)=>i!==t),this.changed()}move(t,e){const i=t+e;if(i<0||i>=this.draft.length)return;const s=[...this.draft];[s[t],s[i]]=[s[i],s[t]],this.draft=s,this.changed()}setKind(t,e){const i=e.currentTarget.value;this.replace(t,$t(i))}set(t,e,i){const s=i.currentTarget,n={...this.draft[t],[e]:e==="max_ms"?Number(s.value):s.value||null};this.replace(t,n)}replace(t,e){this.draft=this.draft.map((i,s)=>s===t?e:i),this.changed()}changed(){this.internals.setFormValue(JSON.stringify(this.draft)),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}render(){return c`
      <fieldset>
      ...
      ${a.length?a.map(o=>c`
                <div class="resource alert-resource">
                  <div class="alert-summary">
                    ...
                    <span class="meta">${Us(o)}</span>
                  </div>
                  <div class="alert-actions">
                    ${o.delivery==="failed"?c`<button class="button secondary" ?disabled=${n} @click=${()=>r.retry(o)}>Retry</button>`:h}
                    ${o.acknowledged_at_ms===null?c`<button class="button secondary" ?disabled=${n} @click=${()=>r.acknowledge(o)}>Acknowledge</button>`:h}
                  </div>
                </div>
        ...
        ${i.length?i.map(o=>c`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  ...
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${o.name}`} title=${`Edit ${o.name}`} @click=${()=>r.edit(o)}><iconify-icon .icon=${Ms} aria-hidden="true"></iconify-icon></button>
  ...
  `}function Fs(t,e,i){return c`
    <main class="shell setup-shell">
      ...
      <section class="panel auth-panel" aria-labelledby="login-title">
        <form class="choice" @submit=${i.login}>
          ...
          ${e?c`<div class="notice" role="alert">${e}</div>`:h}
    ...
    </main>`}function zs(t,e,i,s,n,r){return c`
    <div class="page-columns access-panels">
      ...
      <section class="panel" aria-label="API Tokens">
        ...
        ${s?c`<div class="notice token-value" role="status"><strong>Copy this token now.</strong><code>${s}</code><button class="button secondary" @click=${r.dismissToken}>Dismiss</button></div>`:h}
    ...
    </div>`}const Hs={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},Js=ge`
...
`;function he(t,e,i){return c`
    ...
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${Ks} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${Vs} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function Qt(t,e=[],i=!0){return c`
    ...
    </fieldset>`}function Yt(t,e=null,i=null,s=null){const n=r=>c`
  ...
  `}const Zt={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Xt(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=Zt[e],i.type=e==="http"?"url":"text");const s=t.querySelector("[data-http-options]");s&&(s.hidden=e!=="http");const n=t.elements.namedItem("method");n&&(n.disabled=e!=="http",n.disabled&&(n.value="GET"))}function Gs(t){const e=t.currentTarget;e.form&&Xt(e.form,e.value)}function Ws(t){const e=t.currentTarget;queueMicrotask(()=>Xt(e,"http"))}function Qs(t,e,i,s){return c`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${s.backdrop}>
      <div class="dialog-head"><div class="title-with-help"><h2 id="add-target-title">Add target</h2>${he("target-secret-help","About Target Secrets","Advanced HTTP Targets can reference reusable Secrets for headers, request bodies, custom CA bundles, and mutual-TLS identities.")}</div><p>Start monitoring a service.</p></div>
      <form @submit=${s.create} @reset=${Ws}>
        <label>Name<input name="name" placeholder="Production API" required autofocus /></label>
        <div class="row">
          <label>Type<select name="kind" @change=${Gs}><option value="http">HTTP</option><option value="tcp">TCP connect</option><option value="dns">DNS resolution</option><option value="icmp">ICMP echo</option><option value="tls">TLS certificate</option></select></label>
          <label>URL / endpoint<input name="url" type="url" placeholder=${Zt.http} required /></label>
        </div>
        <div data-http-options><label>Method<input name="method" value="GET" required /></label><http-assertion-editor name="assertions" target-id="new"></http-assertion-editor>${Yt(e)}</div>
        <div class="row">
    ...
    </dialog>`}function Ys(t,e,i,s,n,r,a){const o=t.kind==="node",l=t.kind==="http",d=t.accepted_statuses.map(v=>v.start===v.end?v.start:`${v.start}-${v.end}`).join(","),u=t.history.slice(0,30).reverse(),p=Math.max(1,...u.map(v=>v.latency_ms)),y=new Map(s.map(v=>[v.id,v.name])),$=v=>new Date(v).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),w=v=>v>=1e3?`${(v/1e3).toFixed(v>=1e4?0:1)} s`:`${Math.round(v)} ms`;return c`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${a.backdrop}>
      <div class="dialog-head">
        ...
        <button class="button secondary icon-button dialog-close" type="button" aria-label=${`Close ${o?"Node":"Target"} details`} title="Close" @click=${a.close}><iconify-icon .icon=${Dt} aria-hidden="true"></iconify-icon></button>
      </div>
      <form @submit=${a.update} @input=${a.changed}>
        <label>Name<input name="name" .value=${t.name} required /></label>
        ${o?c`<label>RPC URL<input .value=${t.url} disabled /></label>`:c`
              ...
              ${l?c`
                    <div class="row"><label>Method<input name="method" .value=${t.method} required /></label><label>Expected statuses<input name="statuses" .value=${d} required /></label></div>
                    ...
                    ${Yt(r,t.tls_ca_secret_id,t.tls_client_certificate_secret_id,t.tls_client_private_key_secret_id)}
                  `:h}
              ...
              ${Qt(n,t.notification_channel_ids,t.use_default_channels)}
            `}
        <div class="dialog-actions">
          ${o?h:c`<div class="danger-actions">
            <button class="button danger icon-button" type="button" aria-label="Delete target" title="Delete target" @click=${a.delete}><iconify-icon .icon=${ce} aria-hidden="true"></iconify-icon></button>
            <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>a.pause(!t.paused)}><iconify-icon .icon=${t.paused?Et:Pt} aria-hidden="true"></iconify-icon></button>
          </div>`}
          <button class="button" type="submit" aria-busy=${e?"true":"false"} ?disabled=${e||!i}>Save changes</button>
        </div>
      </form>
      <section class="history">
        <div class="history-head"><h3>Evaluation history</h3>${u.length?c`<span class="meta">Latest ${u.length}</span>`:h}</div>
        ${u.length?c`
          <div class="chart-plot">
            <div class="chart-scale" aria-hidden="true"><span>${w(p)}</span><span>${w(p/2)}</span><span>0 ms</span></div>
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${w(p)}`}>
              ${u.map(v=>{const _=v.succeeded?"Passed":"Failed",F=o||!l?v.succeeded?"reachable":"unreachable":v.status_code===null?"network error":`HTTP ${v.status_code}`,A=y.get(v.executor_node_id)??`Node ${v.executor_node_id.slice(0,8)}`,k=`${_} at ${new Date(v.recorded_at_ms).toLocaleString()}: ${v.latency_ms} ms, ${F}. Executed by ${A}`;return c`<span class="history-bar ${v.succeeded?"up":"down"}" role="listitem" aria-label=${k} title=${k} style=${`height: ${Math.max(8,v.latency_ms/p*100)}%`}></span>`})}
            </div>
          </div>
          <div class="chart-axis"><span>${$(u[0].recorded_at_ms)}</span><span>${$(u[u.length-1].recorded_at_ms)}</span></div>
    ...
    </dialog>`}var Zs=Object.getOwnPropertyDescriptor,Xs=(t,e,i,s)=>{for(var n=s>1?void 0:s?Zs(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=a(n)||n);return n};let Re=class extends Rs{render(){const t=this.targets.filter(a=>a.availability==="up").length,e=this.targets.filter(a=>a.availability==="down").length,i=this.alerts.filter(a=>a.delivery==="pending").length,s=Ns(this.targets,this.live),n=["overview","alerts","cluster"],r=this.targets.filter(a=>`${a.name} ${a.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(a=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?a.paused:a.availability===this.statusFilter).sort((a,o)=>this.sort==="status"&&a.availability.localeCompare(o.availability)||a.name.localeCompare(o.name));return this.authReady&&!this.setupMode&&!this.session?c`${Fs(this.saving,this.error,{login:a=>{this.login(a)}})}${Ae()}`:this.setupMode&&this.setup?c`
        <main class="shell setup-shell">
          <header>
            <div class="brand">
            ...
            <div></div>
            <div class="actions"><button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${wt[this.theme]} aria-hidden="true"></iconify-icon></button></div>
          </header>
          ${this.error?c`<div class="notice" role="alert">${this.error}</div>`:h}
      ...
      <main class="shell">
        <header>
          ...
          <div class="actions">
            <button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${wt[this.theme]} aria-hidden="true"></iconify-icon></button>
        ...
        ${this.activeSection==="overview"?this.renderOverview(r,t,e,i):this.activeSection==="alerts"?qs(this.alerts,this.transitions,this.channels,{search:this.alertSearch,delivery:this.alertDeliveryFilter,kind:this.alertKindFilter,acknowledged:this.alertAcknowledgedFilter},this.saving,{create:()=>this.openChannelDialog(),edit:a=>this.openChannelDialog(a),remove:a=>{this.deleteResource("channels",a.id,a.name)},setDefault:(a,o)=>{this.setChannelDefault(a,o)},acknowledge:a=>{this.acknowledgeAlert(a)},retry:a=>{this.retryAlert(a)},setSearch:a=>this.alertSearch=a,setDelivery:a=>this.alertDeliveryFilter=a,setKind:a=>this.alertKindFilter=a,setAcknowledged:a=>this.alertAcknowledgedFilter=a}):this.renderClusterPage()}
      </main>${Ae()}
      ${Qs(this.channels,this.secrets,this.saving,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeTargetDialog(),create:a=>{this.createTarget(a)}})}
      ${this.selected?Ys(this.selected,this.saving,this.detailDirty,this.cluster?.members??[],this.channels,this.secrets,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeDetailDialog(),update:a=>{this.updateTarget(a)},changed:a=>this.updateDetailDirty(a),redirects:a=>this.toggleMaxRedirects(a),delete:()=>{this.deleteTarget()},pause:a=>{this.setPaused(a)}}):h}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          ${Bs(this.channelKind,this.editingChannel)}
    ...
    `}renderOverview(t,e,i,s){const n=this.targets.filter(o=>this.selectedIds.has(o.id)),r=n.some(o=>!o.paused),a=n.some(o=>o.paused);return c`
      ...
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?c`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${Dt} aria-hidden="true"></iconify-icon></button>${r?c`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${Pt} aria-hidden="true"></iconify-icon></button>`:h}${a?c`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${Et} aria-hidden="true"></iconify-icon></button>`:h}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${ce} aria-hidden="true"></iconify-icon></button></div></div>`:h}
    ...
    `}renderClusterPage(){return c`
      ...
      <section class="panel" aria-label="Cluster topology">
        ...
        ${this.cluster?.members.length?h:c`<div class="empty">Cluster topology unavailable.</div>`}
      </section>
      ...
      <div class="target-wrap">
        ...
        <button class=${`target ${e?"node-target":""}`} aria-label=${t.name} @click=${()=>this.openTarget(t)}>
          ...
          <div class="target-side">
            ${n.length?c`<div class="mini-chart" aria-hidden="true">${n.map(o=>c`<i class="mini-bar ${o.succeeded?"up":"down"}" style=${`height: ${Math.max(12,o.latency_ms/r*100)}%`}></i>`)}</div>`:h}
            <div class="latency">
