(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function i(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=i(s);fetch(s.href,r)}})();const ie=globalThis,Pe=ie.ShadowRoot&&(ie.ShadyCSS===void 0||ie.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ie=Symbol(),Fe=new WeakMap;let mt=class{constructor(e,i,n){if(this._$cssResult$=!0,n!==Ie)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Pe&&e===void 0){const n=i!==void 0&&i.length===1;n&&(e=Fe.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Fe.set(i,e))}return e}toString(){return this.cssText}};const Vt=t=>new mt(typeof t=="string"?t:t+"",void 0,Ie),De=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((n,s,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[r+1],t[0]);return new mt(i,t,Ie)},Kt=(t,e)=>{if(Pe)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const n=document.createElement("style"),s=ie.litNonce;s!==void 0&&n.setAttribute("nonce",s),n.textContent=i.cssText,t.appendChild(n)}},ze=Pe?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const n of e.cssRules)i+=n.cssText;return Vt(i)})(t):t;const{is:Wt,defineProperty:Gt,getOwnPropertyDescriptor:Qt,getOwnPropertyNames:Yt,getOwnPropertySymbols:Zt,getPrototypeOf:Xt}=Object,pe=globalThis,He=pe.trustedTypes,ei=He?He.emptyScript:"",ti=pe.reactiveElementPolyfillSupport,B=(t,e)=>t,oe={toAttribute(t,e){switch(e){case Boolean:t=t?ei:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Oe=(t,e)=>!Wt(t,e),Je={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:Oe};Symbol.metadata??=Symbol("metadata"),pe.litPropertyMetadata??=new WeakMap;let N=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Je){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const n=Symbol(),s=this.getPropertyDescriptor(e,n,i);s!==void 0&&Gt(this.prototype,e,s)}}static getPropertyDescriptor(e,i,n){const{get:s,set:r}=Qt(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:s,set(o){const a=s?.call(this);r?.call(this,o),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Je}static _$Ei(){if(this.hasOwnProperty(B("elementProperties")))return;const e=Xt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(B("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(B("properties"))){const i=this.properties,n=[...Yt(i),...Zt(i)];for(const s of n)this.createProperty(s,i[s])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[n,s]of i)this.elementProperties.set(n,s)}this._$Eh=new Map;for(const[i,n]of this.elementProperties){const s=this._$Eu(i,n);s!==void 0&&this._$Eh.set(s,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const s of n)i.unshift(ze(s))}else e!==void 0&&i.push(ze(e));return i}static _$Eu(e,i){const n=i.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const n of i.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Kt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,n){this._$AK(e,n)}_$ET(e,i){const n=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,n);if(s!==void 0&&n.reflect===!0){const r=(n.converter?.toAttribute!==void 0?n.converter:oe).toAttribute(i,n.type);this._$Em=e,r==null?this.removeAttribute(s):this.setAttribute(s,r),this._$Em=null}}_$AK(e,i){const n=this.constructor,s=n._$Eh.get(e);if(s!==void 0&&this._$Em!==s){const r=n.getPropertyOptions(s),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:oe;this._$Em=s;const a=o.fromAttribute(i,r.type);this[s]=a??this._$Ej?.get(s)??a,this._$Em=null}}requestUpdate(e,i,n,s=!1,r){if(e!==void 0){const o=this.constructor;if(s===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Oe)(r,i)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,i,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:n,reflect:s,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??i??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(i=void 0),this._$AL.set(e,i)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[s,r]of this._$Ep)this[s]=r;this._$Ep=void 0}const n=this.constructor.elementProperties;if(n.size>0)for(const[s,r]of n){const{wrapped:o}=r,a=this[s];o!==!0||this._$AL.has(s)||a===void 0||this.C(s,void 0,r,a)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(i)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};N.elementStyles=[],N.shadowRootOptions={mode:"open"},N[B("elementProperties")]=new Map,N[B("finalized")]=new Map,ti?.({ReactiveElement:N}),(pe.reactiveElementVersions??=[]).push("2.1.2");const je=globalThis,Be=t=>t,ae=je.trustedTypes,Ve=ae?ae.createPolicy("lit-html",{createHTML:t=>t}):void 0,bt="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,vt="?"+A,ii=`<${vt}>`,j=document,K=()=>j.createComment(""),W=t=>t===null||typeof t!="object"&&typeof t!="function",Me=Array.isArray,si=t=>Me(t)||typeof t?.[Symbol.iterator]=="function",ve=`[ 	
\f\r]`,z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ke=/-->/g,We=/>/g,D=RegExp(`>|${ve}(?:([^\\s"'>=/]+)(${ve}*=${ve}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ge=/'/g,Qe=/"/g,yt=/^(?:script|style|textarea|title)$/i,ni=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),d=ni(1),L=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),Ye=new WeakMap,O=j.createTreeWalker(j,129);function xt(t,e){if(!Me(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ve!==void 0?Ve.createHTML(e):e}const ri=(t,e)=>{const i=t.length-1,n=[];let s,r=e===2?"<svg>":e===3?"<math>":"",o=z;for(let a=0;a<i;a++){const l=t[a];let c,u,p=-1,g=0;for(;g<l.length&&(o.lastIndex=g,u=o.exec(l),u!==null);)g=o.lastIndex,o===z?u[1]==="!--"?o=Ke:u[1]!==void 0?o=We:u[2]!==void 0?(yt.test(u[2])&&(s=RegExp("</"+u[2],"g")),o=D):u[3]!==void 0&&(o=D):o===D?u[0]===">"?(o=s??z,p=-1):u[1]===void 0?p=-2:(p=o.lastIndex-u[2].length,c=u[1],o=u[3]===void 0?D:u[3]==='"'?Qe:Ge):o===Qe||o===Ge?o=D:o===Ke||o===We?o=z:(o=D,s=void 0);const h=o===D&&t[a+1].startsWith("/>")?" ":"";r+=o===z?l+ii:p>=0?(n.push(c),l.slice(0,p)+bt+l.slice(p)+A+h):l+A+(p===-2?a:h)}return[xt(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]};class G{constructor({strings:e,_$litType$:i},n){let s;this.parts=[];let r=0,o=0;const a=e.length-1,l=this.parts,[c,u]=ri(e,i);if(this.el=G.createElement(c,n),O.currentNode=this.el.content,i===2||i===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(s=O.nextNode())!==null&&l.length<a;){if(s.nodeType===1){if(s.hasAttributes())for(const p of s.getAttributeNames())if(p.endsWith(bt)){const g=u[o++],h=s.getAttribute(p).split(A),w=/([.?@])?(.*)/.exec(g);l.push({type:1,index:r,name:w[2],strings:h,ctor:w[1]==="."?ai:w[1]==="?"?li:w[1]==="@"?ci:fe}),s.removeAttribute(p)}else p.startsWith(A)&&(l.push({type:6,index:r}),s.removeAttribute(p));if(yt.test(s.tagName)){const p=s.textContent.split(A),g=p.length-1;if(g>0){s.textContent=ae?ae.emptyScript:"";for(let h=0;h<g;h++)s.append(p[h],K()),O.nextNode(),l.push({type:2,index:++r});s.append(p[g],K())}}}else if(s.nodeType===8)if(s.data===vt)l.push({type:2,index:r});else{let p=-1;for(;(p=s.data.indexOf(A,p+1))!==-1;)l.push({type:7,index:r}),p+=A.length-1}r++}}static createElement(e,i){const n=j.createElement("template");return n.innerHTML=e,n}}function U(t,e,i=t,n){if(e===L)return e;let s=n!==void 0?i._$Co?.[n]:i._$Cl;const r=W(e)?void 0:e._$litDirective$;return s?.constructor!==r&&(s?._$AO?.(!1),r===void 0?s=void 0:(s=new r(t),s._$AT(t,i,n)),n!==void 0?(i._$Co??=[])[n]=s:i._$Cl=s),s!==void 0&&(e=U(t,s._$AS(t,e.values),s,n)),e}class oi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:n}=this._$AD,s=(e?.creationScope??j).importNode(i,!0);O.currentNode=s;let r=O.nextNode(),o=0,a=0,l=n[0];for(;l!==void 0;){if(o===l.index){let c;l.type===2?c=new Z(r,r.nextSibling,this,e):l.type===1?c=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(c=new di(r,this,e)),this._$AV.push(c),l=n[++a]}o!==l?.index&&(r=O.nextNode(),o++)}return O.currentNode=j,s}p(e){let i=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,i),i+=n.strings.length-2):n._$AI(e[i])),i++}}class Z{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,n,s){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=U(this,e,i),W(e)?e===f||e==null||e===""?(this._$AH!==f&&this._$AR(),this._$AH=f):e!==this._$AH&&e!==L&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):si(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==f&&W(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=G.createElement(xt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(i);else{const r=new oi(s,this),o=r.u(this.options);r.p(i),this.T(o),this._$AH=r}}_$AC(e){let i=Ye.get(e.strings);return i===void 0&&Ye.set(e.strings,i=new G(e)),i}k(e){Me(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let n,s=0;for(const r of e)s===i.length?i.push(n=new Z(this.O(K()),this.O(K()),this,this.options)):n=i[s],n._$AI(r),s++;s<i.length&&(this._$AR(n&&n._$AB.nextSibling,s),i.length=s)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const n=Be(e).nextSibling;Be(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class fe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,n,s,r){this.type=1,this._$AH=f,this._$AN=void 0,this.element=e,this.name=i,this._$AM=s,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=f}_$AI(e,i=this,n,s){const r=this.strings;let o=!1;if(r===void 0)e=U(this,e,i,0),o=!W(e)||e!==this._$AH&&e!==L,o&&(this._$AH=e);else{const a=e;let l,c;for(e=r[0],l=0;l<r.length-1;l++)c=U(this,a[n+l],i,l),c===L&&(c=this._$AH[l]),o||=!W(c)||c!==this._$AH[l],c===f?e=f:e!==f&&(e+=(c??"")+r[l+1]),this._$AH[l]=c}o&&!s&&this.j(e)}j(e){e===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ai extends fe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===f?void 0:e}}class li extends fe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==f)}}class ci extends fe{constructor(e,i,n,s,r){super(e,i,n,s,r),this.type=5}_$AI(e,i=this){if((e=U(this,e,i,0)??f)===L)return;const n=this._$AH,s=e===f&&n!==f||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==f&&(n===f||s);s&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class di{constructor(e,i,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}}const ui=je.litHtmlPolyfillSupport;ui?.(G,Z),(je.litHtmlVersions??=[]).push("3.3.3");const hi=(t,e,i)=>{const n=i?.renderBefore??e;let s=n._$litPart$;if(s===void 0){const r=i?.renderBefore??null;n._$litPart$=s=new Z(e.insertBefore(K(),r),r,void 0,i??{})}return s._$AI(t),s};const Ne=globalThis;class R extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=hi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}R._$litElement$=!0,R.finalized=!0,Ne.litElementHydrateSupport?.({LitElement:R});const pi=Ne.litElementPolyfillSupport;pi?.({LitElement:R});(Ne.litElementVersions??=[]).push("4.2.2");const $t=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const fi={attribute:!0,type:String,converter:oe,reflect:!1,hasChanged:Oe},gi=(t=fi,e,i)=>{const{kind:n,metadata:s}=i;let r=globalThis.litPropertyMetadata.get(s);if(r===void 0&&globalThis.litPropertyMetadata.set(s,r=new Map),n==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),n==="accessor"){const{name:o}=i;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,t,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,t,a),a}}}if(n==="setter"){const{name:o}=i;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,t,!0,a)}}throw Error("Unsupported decorator location: "+n)};function wt(t){return(e,i)=>typeof i=="object"?gi(t,e,i):((n,s,r)=>{const o=s.hasOwnProperty(r);return s.constructor.createProperty(r,n),o?Object.getOwnPropertyDescriptor(s,r):void 0})(t,e,i)}function m(t){return wt({...t,state:!0,attribute:!1})}const kt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},_t={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},le={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},St={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'};const Ct=Object.freeze({left:0,top:0,width:16,height:16}),ce=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),X=Object.freeze({...Ct,...ce}),we=Object.freeze({...X,body:"",hidden:!1}),mi=Object.freeze({width:null,height:null}),Tt=Object.freeze({...mi,...ce});function bi(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function n(s){for(;s<0;)s+=4;return s%4}if(i===""){const s=parseInt(t);return isNaN(s)?0:n(s)}else if(i!==t){let s=0;switch(i){case"%":s=25;break;case"deg":s=90}if(s){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/s,r%1===0?n(r):0)}}return e}const vi=/[\s,]+/;function yi(t,e){e.split(vi).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const At={...Tt,preserveAspectRatio:""};function Ze(t){const e={...At},i=(n,s)=>t.getAttribute(n)||s;return e.width=i("width",null),e.height=i("height",null),e.rotate=bi(i("rotate","")),yi(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function xi(t,e){for(const i in At)if(t[i]!==e[i])return!0;return!1}const Et=/^[a-z0-9]+(-[a-z0-9]+)*$/,ee=(t,e,i,n="")=>{const s=t.split(":");if(t.slice(0,1)==="@"){if(s.length<2||s.length>3)return null;n=s.shift().slice(1)}if(s.length>3||!s.length)return null;if(s.length>1){const a=s.pop(),l=s.pop(),c={provider:s.length>0?s[0]:n,prefix:l,name:a};return e&&!se(c)?null:c}const r=s[0],o=r.split("-");if(o.length>1){const a={provider:n,prefix:o.shift(),name:o.join("-")};return e&&!se(a)?null:a}if(i&&n===""){const a={provider:n,prefix:"",name:r};return e&&!se(a,i)?null:a}return null},se=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function $i(t,e){const i=t.icons,n=t.aliases||Object.create(null),s=Object.create(null);function r(o){if(i[o])return s[o]=[];if(!(o in s)){s[o]=null;const a=n[o]&&n[o].parent,l=a&&r(a);l&&(s[o]=[a].concat(l))}return s[o]}return Object.keys(i).concat(Object.keys(n)).forEach(r),s}function wi(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const n=((t.rotate||0)+(e.rotate||0))%4;return n&&(i.rotate=n),i}function Xe(t,e){const i=wi(t,e);for(const n in we)n in ce?n in t&&!(n in i)&&(i[n]=ce[n]):n in e?i[n]=e[n]:n in t&&(i[n]=t[n]);return i}function ki(t,e,i){const n=t.icons,s=t.aliases||Object.create(null);let r={};function o(a){r=Xe(n[a]||s[a],r)}return o(e),i.forEach(o),Xe(t,r)}function Pt(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(s=>{e(s,null),i.push(s)});const n=$i(t);for(const s in n){const r=n[s];r&&(e(s,ki(t,s,r)),i.push(s))}return i}const _i={provider:"",aliases:{},not_found:{},...Ct};function ye(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function It(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!ye(t,_i))return null;const i=e.icons;for(const s in i){const r=i[s];if(!s||typeof r.body!="string"||!ye(r,we))return null}const n=e.aliases||Object.create(null);for(const s in n){const r=n[s],o=r.parent;if(!s||typeof o!="string"||!i[o]&&!n[o]||!ye(r,we))return null}return e}const de=Object.create(null);function Si(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function T(t,e){const i=de[t]||(de[t]=Object.create(null));return i[e]||(i[e]=Si(t,e))}function Dt(t,e){return It(e)?Pt(e,(i,n)=>{n?t.icons[i]=n:t.missing.add(i)}):[]}function Ci(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function Ti(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(de)).forEach(n=>{(typeof n=="string"&&typeof e=="string"?[e]:Object.keys(de[n]||{})).forEach(s=>{const r=T(n,s);i=i.concat(Object.keys(r.icons).map(o=>(n!==""?"@"+n+":":"")+s+":"+o))})}),i}let Q=!1;function Ot(t){return typeof t=="boolean"&&(Q=t),Q}function Y(t){const e=typeof t=="string"?ee(t,!0,Q):t;if(e){const i=T(e.provider,e.prefix),n=e.name;return i.icons[n]||(i.missing.has(n)?null:void 0)}}function jt(t,e){const i=ee(t,!0,Q);if(!i)return!1;const n=T(i.provider,i.prefix);return e?Ci(n,i.name,e):(n.missing.add(i.name),!0)}function et(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),Q&&!e&&!t.prefix){let n=!1;return It(t)&&(t.prefix="",Pt(t,(s,r)=>{jt(s,r)&&(n=!0)})),n}const i=t.prefix;return se({prefix:i,name:"a"})?!!Dt(T(e,i),t):!1}function Ai(t){return!!Y(t)}function Ei(t){const e=Y(t);return e&&{...X,...e}}function Mt(t,e){t.forEach(i=>{const n=i.loaderCallbacks;n&&(i.loaderCallbacks=n.filter(s=>s.id!==e))})}function Pi(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const n=t.provider,s=t.prefix;e.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==s)return!0;const c=l.name;if(t.icons[c])o.loaded.push({provider:n,prefix:s,name:c});else if(t.missing.has(c))o.missing.push({provider:n,prefix:s,name:c});else return i=!0,!0;return!1}),o.pending.length!==a&&(i||Mt([t],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let Ii=0;function Di(t,e,i){const n=Ii++,s=Mt.bind(null,i,n);if(!e.pending.length)return s;const r={id:n,icons:e,callback:t,abort:s};return i.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),s}function Oi(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((s,r)=>s.provider!==r.provider?s.provider.localeCompare(r.provider):s.prefix!==r.prefix?s.prefix.localeCompare(r.prefix):s.name.localeCompare(r.name));let n={provider:"",prefix:"",name:""};return t.forEach(s=>{if(n.name===s.name&&n.prefix===s.prefix&&n.provider===s.provider)return;n=s;const r=s.provider,o=s.prefix,a=s.name,l=i[r]||(i[r]=Object.create(null)),c=l[o]||(l[o]=T(r,o));let u;a in c.icons?u=e.loaded:o===""||c.missing.has(a)?u=e.missing:u=e.pending;const p={provider:r,prefix:o,name:a};u.push(p)}),e}const ke=Object.create(null);function tt(t,e){ke[t]=e}function _e(t){return ke[t]||ke[""]}function ji(t,e=!0,i=!1){const n=[];return t.forEach(s=>{const r=typeof s=="string"?ee(s,e,i):s;r&&n.push(r)}),n}function Re(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const ge=Object.create(null),H=["https://api.simplesvg.com","https://api.unisvg.com"],ne=[];for(;H.length>0;)H.length===1||Math.random()>.5?ne.push(H.shift()):ne.push(H.pop());ge[""]=Re({resources:["https://api.iconify.design"].concat(ne)});function it(t,e){const i=Re(e);return i===null?!1:(ge[t]=i,!0)}function me(t){return ge[t]}function Mi(){return Object.keys(ge)}const Ni={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Ri(t,e,i,n){const s=t.resources.length,r=t.random?Math.floor(Math.random()*s):t.index;let o;if(t.random){let x=t.resources.slice(0);for(o=[];x.length>1;){const _=Math.floor(Math.random()*x.length);o.push(x[_]),x=x.slice(0,_).concat(x.slice(_+1))}o=o.concat(x)}else o=t.resources.slice(r).concat(t.resources.slice(0,r));const a=Date.now();let l="pending",c=0,u,p=null,g=[],h=[];typeof n=="function"&&h.push(n);function w(){p&&(clearTimeout(p),p=null)}function C(){l==="pending"&&(l="aborted"),w(),g.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),g=[]}function $(x,_){_&&(h=[]),typeof x=="function"&&h.push(x)}function M(){return{startTime:a,payload:e,status:l,queriesSent:c,queriesPending:g.length,subscribe:$,abort:C}}function P(){l="failed",h.forEach(x=>{x(void 0,u)})}function S(){g.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),g=[]}function k(x,_,F){const te=_!=="success";switch(g=g.filter(I=>I!==x),l){case"pending":break;case"failed":if(te||!t.dataAfterTimeout)return;break;default:return}if(_==="abort"){u=F,P();return}if(te){u=F,g.length||(o.length?be():P());return}if(w(),S(),!t.random){const I=t.resources.indexOf(x.resource);I!==-1&&I!==t.index&&(t.index=I)}l="completed",h.forEach(I=>{I(F)})}function be(){if(l!=="pending")return;w();const x=o.shift();if(x===void 0){if(g.length){p=setTimeout(()=>{w(),l==="pending"&&(S(),P())},t.timeout);return}P();return}const _={status:"pending",resource:x,callback:(F,te)=>{k(_,F,te)}};g.push(_),c++,p=setTimeout(be,t.rotate),i(x,e,_.callback)}return setTimeout(be),M}function Nt(t){const e={...Ni,...t};let i=[];function n(){i=i.filter(o=>o().status==="pending")}function s(o,a,l){const c=Ri(e,o,a,(u,p)=>{n(),l&&l(u,p)});return i.push(c),c}function r(o){return i.find(a=>o(a))||null}return{query:s,find:r,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:n}}function st(){}const xe=Object.create(null);function Li(t){if(!xe[t]){const e=me(t);if(!e)return;xe[t]={config:e,redundancy:Nt(e)}}return xe[t]}function Rt(t,e,i){let n,s;if(typeof t=="string"){const r=_e(t);if(!r)return i(void 0,424),st;s=r.send;const o=Li(t);o&&(n=o.redundancy)}else{const r=Re(t);if(r){n=Nt(r);const o=_e(t.resources?t.resources[0]:"");o&&(s=o.send)}}return!n||!s?(i(void 0,424),st):n.query(e,s,i)().abort}function nt(){}function Ui(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Pi(t)}))}function qi(t){const e=[],i=[];return t.forEach(n=>{(n.match(Et)?e:i).push(n)}),{valid:e,invalid:i}}function J(t,e,i){function n(){const s=t.pendingIcons;e.forEach(r=>{s&&s.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Dt(t,i).length){n();return}}catch(s){console.error(s)}n(),Ui(t)}function rt(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Fi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:n}=t,s=t.iconsToLoad;if(delete t.iconsToLoad,!s||!s.length)return;const r=t.loadIcon;if(t.loadIcons&&(s.length>1||!r)){rt(t.loadIcons(s,n,i),c=>{J(t,s,c)});return}if(r){s.forEach(c=>{rt(r(c,n,i),u=>{J(t,[c],u?{prefix:n,icons:{[c]:u}}:null)})});return}const{valid:o,invalid:a}=qi(s);if(a.length&&J(t,a,null),!o.length)return;const l=n.match(Et)?_e(i):null;if(!l){J(t,o,null);return}l.prepare(i,n,o).forEach(c=>{Rt(i,c,u=>{J(t,c.icons,u)})})}))}const Le=(t,e)=>{const i=Oi(ji(t,!0,Ot()));if(!i.pending.length){let a=!0;return e&&setTimeout(()=>{a&&e(i.loaded,i.missing,i.pending,nt)}),()=>{a=!1}}const n=Object.create(null),s=[];let r,o;return i.pending.forEach(a=>{const{provider:l,prefix:c}=a;if(c===o&&l===r)return;r=l,o=c,s.push(T(l,c));const u=n[l]||(n[l]=Object.create(null));u[c]||(u[c]=[])}),i.pending.forEach(a=>{const{provider:l,prefix:c,name:u}=a,p=T(l,c),g=p.pendingIcons||(p.pendingIcons=new Set);g.has(u)||(g.add(u),n[l][c].push(u))}),s.forEach(a=>{const l=n[a.provider][a.prefix];l.length&&Fi(a,l)}),e?Di(e,i,s):nt},zi=t=>new Promise((e,i)=>{const n=typeof t=="string"?ee(t,!0):t;if(!n){i(t);return}Le([n||t],s=>{if(s.length&&n){const r=Y(n);if(r){e({...X,...r});return}}i(t)})});function ot(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function Hi(t,e){if(typeof t=="object")return{data:ot(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=ot(t);if(r)return{data:r,value:t}}const i=ee(t,!0,!0);if(!i)return{value:t};const n=Y(i);if(n!==void 0||!i.prefix)return{value:t,name:i,data:n};const s=Le([i],()=>e(t,i,Y(i)));return{value:t,name:i,loading:s}}let Lt=!1;try{Lt=navigator.vendor.indexOf("Apple")===0}catch{}function Ji(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Lt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const Bi=/(-?[0-9.]*[0-9]+[0-9.]*)/g,Vi=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Se(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const n=t.split(Bi);if(n===null||!n.length)return t;const s=[];let r=n.shift(),o=Vi.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?s.push(r):s.push(Math.ceil(a*e*i)/i)}else s.push(r);if(r=n.shift(),r===void 0)return s.join("");o=!o}}function Ki(t,e="defs"){let i="";const n=t.indexOf("<"+e);for(;n>=0;){const s=t.indexOf(">",n),r=t.indexOf("</"+e);if(s===-1||r===-1)break;const o=t.indexOf(">",r);if(o===-1)break;i+=t.slice(s+1,r).trim(),t=t.slice(0,n).trim()+t.slice(o+1)}return{defs:i,content:t}}function Wi(t,e){return t?"<defs>"+t+"</defs>"+e:e}function Gi(t,e,i){const n=Ki(t);return Wi(n.defs,e+n.content+i)}const Qi=t=>t==="unset"||t==="undefined"||t==="none";function Ut(t,e){const i={...X,...t},n={...Tt,...e},s={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,n].forEach(C=>{const $=[],M=C.hFlip,P=C.vFlip;let S=C.rotate;M?P?S+=2:($.push("translate("+(s.width+s.left).toString()+" "+(0-s.top).toString()+")"),$.push("scale(-1 1)"),s.top=s.left=0):P&&($.push("translate("+(0-s.left).toString()+" "+(s.height+s.top).toString()+")"),$.push("scale(1 -1)"),s.top=s.left=0);let k;switch(S<0&&(S-=Math.floor(S/4)*4),S=S%4,S){case 1:k=s.height/2+s.top,$.unshift("rotate(90 "+k.toString()+" "+k.toString()+")");break;case 2:$.unshift("rotate(180 "+(s.width/2+s.left).toString()+" "+(s.height/2+s.top).toString()+")");break;case 3:k=s.width/2+s.left,$.unshift("rotate(-90 "+k.toString()+" "+k.toString()+")");break}S%2===1&&(s.left!==s.top&&(k=s.left,s.left=s.top,s.top=k),s.width!==s.height&&(k=s.width,s.width=s.height,s.height=k)),$.length&&(r=Gi(r,'<g transform="'+$.join(" ")+'">',"</g>"))});const o=n.width,a=n.height,l=s.width,c=s.height;let u,p;o===null?(p=a===null?"1em":a==="auto"?c:a,u=Se(p,l/c)):(u=o==="auto"?l:o,p=a===null?Se(u,c/l):a==="auto"?c:a);const g={},h=(C,$)=>{Qi($)||(g[C]=$.toString())};h("width",u),h("height",p);const w=[s.left,s.top,l,c];return g.viewBox=w.join(" "),{attributes:g,viewBox:w,body:r}}function Ue(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const n in e)i+=" "+n+'="'+e[n]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function Yi(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function Zi(t){return"data:image/svg+xml,"+Yi(t)}function qt(t){return'url("'+Zi(t)+'")'}const Xi=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let ue=Xi();function es(t){ue=t}function ts(){return ue}function is(t,e){const i=me(t);if(!i)return 0;let n;if(!i.maxURL)n=0;else{let s=0;i.resources.forEach(o=>{s=Math.max(s,o.length)});const r=e+".json?icons=";n=i.maxURL-s-i.path.length-r.length}return n}function ss(t){return t===404}const ns=(t,e,i)=>{const n=[],s=is(t,e),r="icons";let o={type:r,provider:t,prefix:e,icons:[]},a=0;return i.forEach((l,c)=>{a+=l.length+1,a>=s&&c>0&&(n.push(o),o={type:r,provider:t,prefix:e,icons:[]},a=l.length),o.icons.push(l)}),n.push(o),n};function rs(t){if(typeof t=="string"){const e=me(t);if(e)return e.path}return"/"}const os=(t,e,i)=>{if(!ue){i("abort",424);return}let n=rs(e.provider);switch(e.type){case"icons":{const r=e.prefix,o=e.icons.join(","),a=new URLSearchParams({icons:o});n+=r+".json?"+a.toString();break}case"custom":{const r=e.uri;n+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let s=503;ue(t+n).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{i(ss(o)?"abort":"next",o)});return}return s=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",s)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",s)})},as={prepare:ns,send:os};function ls(t,e,i){T(i||"",e).loadIcons=t}function cs(t,e,i){T(i||"",e).loadIcon=t}const $e="data-style";let Ft="";function ds(t){Ft=t}function at(t,e){let i=Array.from(t.childNodes).find(n=>n.hasAttribute&&n.hasAttribute($e));i||(i=document.createElement("style"),i.setAttribute($e,$e),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Ft}function zt(){tt("",as),Ot(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,n="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(s=>{try{(typeof s!="object"||s===null||s instanceof Array||typeof s.icons!="object"||typeof s.prefix!="string"||!et(s))&&console.error(n)}catch{console.error(n)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const n in i){const s="IconifyProviders["+n+"] is invalid.";try{const r=i[n];if(typeof r!="object"||!r||r.resources===void 0)continue;it(n,r)||console.error(s)}catch{console.error(s)}}}}return{iconLoaded:Ai,getIcon:Ei,listIcons:Ti,addIcon:jt,addCollection:et,calculateSize:Se,buildIcon:Ut,iconToHTML:Ue,svgToURL:qt,loadIcons:Le,loadIcon:zi,addAPIProvider:it,setCustomIconLoader:cs,setCustomIconsLoader:ls,appendCustomStyle:ds,_api:{getAPIConfig:me,setAPIModule:tt,sendAPIQuery:Rt,setFetch:es,getFetch:ts,listAPIProviders:Mi}}}const Ce={"background-color":"currentColor"},Ht={"background-color":"transparent"},lt={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},ct={"-webkit-mask":Ce,mask:Ce,background:Ht};for(const t in ct){const e=ct[t];for(const i in lt)e[t+"-"+i]=lt[i]}function dt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function us(t,e,i){const n=document.createElement("span");let s=t.body;s.indexOf("<a")!==-1&&(s+="<!-- "+Date.now()+" -->");const r=t.attributes,o=Ue(s,{...r,width:e.width+"",height:e.height+""}),a=qt(o),l=n.style,c={"--svg":a,width:dt(r.width),height:dt(r.height),...i?Ce:Ht};for(const u in c)l.setProperty(u,c[u]);return n}let V;function hs(){try{V=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{V=null}}function ps(t){return V===void 0&&hs(),V?V.createHTML(t):t}function fs(t){const e=document.createElement("span"),i=t.attributes;let n="";i.width||(n="width: inherit;"),i.height||(n+="height: inherit;"),n&&(i.style=n);const s=Ue(t.body,i);return e.innerHTML=ps(s),e.firstChild}function Te(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function ut(t,e){const i=e.icon.data,n=e.customisations,s=Ut(i,n);n.preserveAspectRatio&&(s.attributes.preserveAspectRatio=n.preserveAspectRatio);const r=e.renderedMode;let o;r==="svg"?o=fs(s):o=us(s,{...X,...i},r==="mask");const a=Te(t);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,a):t.appendChild(o)}function ht(t,e,i){const n=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:n}}function gs(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const n=e.get(t);if(n)return n;const s=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const a=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");at(a,l),this._state=ht({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return s.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const l=this.hasAttribute("inline"),c=this._state;l!==c.inline&&(c.inline=l,at(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return this.hasAttribute("inline")}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const l=this._shadowRoot;if(a.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}ut(l,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,l=this.getAttribute("icon");if(l!==a.icon.value){this._iconChanged(l);return}if(!a.rendered||!this._visible)return;const c=this.getAttribute("mode"),u=Ze(this);(a.attrMode!==c||xi(a.customisations,u)||!Te(this._shadowRoot))&&this._renderIcon(a.icon,u,c)}_iconChanged(a){const l=Hi(a,(c,u,p)=>{const g=this._state;if(g.rendered||this.getAttribute("icon")!==c)return;const h={value:c,name:u,data:p};h.data?this._gotIconData(h):g.icon=h});l.data?this._gotIconData(l):this._state=ht(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=Te(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,Ze(this),this.getAttribute("mode"))}_renderIcon(a,l,c){const u=Ji(a.data.body,c),p=this._state.inline;ut(this._shadowRoot,this._state={rendered:!0,icon:a,inline:p,customisations:l,attrMode:c,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(a=>{const l=a.some(c=>c.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};s.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=zt();for(const a in o)r[a]=r.prototype[a]=o[a];return e.define(t,r),r}const ms=gs()||zt(),{iconLoaded:Us,getIcon:qs,listIcons:Fs,addIcon:zs,addCollection:Hs,calculateSize:Js,buildIcon:Bs,iconToHTML:Vs,svgToURL:Ks,loadIcons:Ws,loadIcon:Gs,setCustomIconLoader:Qs,setCustomIconsLoader:Ys,addAPIProvider:Zs,_api:Xs}=ms;async function y(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const n=await i.json().catch(()=>({error:i.statusText}));throw new Error(n.error||i.statusText)}return i.status===204?void 0:i.json()}function Ae(t,e,i=!1){if(e==="telegram"){const n=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!n?void 0:n,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const n=String(t.get("username")??""),s=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:n||void 0,password:s||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function Jt(t,e=[],i=!0){return{name:String(t.get("name")),url:String(t.get("url")),method:String(t.get("method")),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),headers:{},body:null,body_contains:null,skip_tls_verification:!1,notification_channel_ids:e,use_default_channels:i}}var bs=Object.defineProperty,vs=Object.getOwnPropertyDescriptor,q=(t,e,i,n)=>{for(var s=n>1?void 0:n?vs(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(s=(n?o(e,i,s):o(s))||s);return n&&s&&bs(e,i,s),s};let E=class extends R{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await y("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){t.preventDefault(),window.confirm("Create a new single-Node Cluster?")&&await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName()})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e){this.saving=!0,this.error="";try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster()}catch(i){this.fail(i),this.saving=!1}}async waitForCluster(){for(let t=0;t<120;t+=1){await new Promise(e=>window.setTimeout(e,250));try{const e=await y("/api/v1/setup");if(e.cluster_ready){this.changed(e);return}}catch{}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Ae(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Jt(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await y("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return d`<section class="flow" aria-label="UpGrid setup">
        ...
        ${e.length?e.map(n=>d`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  ...
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${n.name}`} title=${`Edit ${n.name}`} @click=${()=>i.edit(n)}><iconify-icon .icon=${Cs} aria-hidden="true"></iconify-icon></button>
  ...
  `}const As={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},Es=De`
...
`;function he(t,e,i){return d`
    <span class="help-tooltip-wrap">
      <button class="help-tooltip-trigger" type="button" aria-label=${e} aria-describedby=${t}>
        <iconify-icon .icon=${As} aria-hidden="true"></iconify-icon>
      </button>
      <span class="help-tooltip" id=${t} role="tooltip">${i}</span>
    </span>
  `}function Ps(t,e){return t==="webhook"?d`<label
      >Webhook URL<input
        name="url"
        type="url"
    ...
    /></label>
  `}const Is={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5c.08-1.25-.27-2.48-1-3.5c.28-1.15.28-2.35 0-3.5c0 0-1 0-3 1.5c-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5c-.39.49-.68 1.05-.85 1.65c-.17.6-.22 1.23-.15 1.85v4"/><path d="M9 18c-4.51 2-5-2-7-2"/></g>'},Ds={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M21.54 15H17a2 2 0 0 0-2 2v4.54M7 3.34V5a3 3 0 0 0 3 3v0a2 2 0 0 1 2 2v0c0 1.1.9 2 2 2v0a2 2 0 0 0 2-2v0c0-1.1.9-2 2-2h3.17M11 21.95V18a2 2 0 0 0-2-2v0a2 2 0 0 1-2-2v-1a2 2 0 0 0-2-2H2.05"/><circle cx="12" cy="12" r="10"/></g>'};function gt(){return d`
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${Is} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${Ds} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function Bt(t,e=[],i=!0){return d`
    ...
    </fieldset>`}function Os(t,e,i){return d`
    ...
    </dialog>`}function js(t,e,i,n,s,r){const o=t.kind==="node",a=t.accepted_statuses.map(h=>h.start===h.end?h.start:`${h.start}-${h.end}`).join(","),l=t.history.slice(0,30).reverse(),c=Math.max(1,...l.map(h=>h.latency_ms)),u=new Map(n.map(h=>[h.id,h.name])),p=h=>new Date(h).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),g=h=>h>=1e3?`${(h/1e3).toFixed(h>=1e4?0:1)} s`:`${Math.round(h)} ms`;return d`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${r.backdrop}>
      <div class="dialog-head">
        ...
        <button class="button secondary icon-button dialog-close" type="button" aria-label=${`Close ${o?"Node":"Target"} details`} title="Close" @click=${r.close}><iconify-icon .icon=${St} aria-hidden="true"></iconify-icon></button>
      </div>
      ...
      <section class="history">
        ...
        ${l.length?d`
          <div class="chart-plot">
            ...
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${g(c)}`}>
              ${l.map(h=>{const w=h.succeeded?"Passed":"Failed",C=o?h.succeeded?"reachable":"unreachable":h.status_code===null?"network error":`HTTP ${h.status_code}`,$=u.get(h.executor_node_id)??`Node ${h.executor_node_id.slice(0,8)}`,M=`${w} at ${new Date(h.recorded_at_ms).toLocaleString()}: ${h.latency_ms} ms, ${C}. Executed by ${$}`;return d`<span class="history-bar ${h.succeeded?"up":"down"}" role="listitem" aria-label=${M} title=${M} style=${`height: ${Math.max(8,h.latency_ms/c*100)}%`}></span>`})}
            </div>
          </div>
    ...
    </dialog>`}var Ms=Object.getOwnPropertyDescriptor,Ns=(t,e,i,n)=>{for(var s=n>1?void 0:n?Ms(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(s=o(s)||s);return s};let Ee=class extends Ss{render(){const t=this.targets.filter(o=>o.availability==="up").length,e=this.targets.filter(o=>o.availability==="down").length,i=this.alerts.filter(o=>o.delivery==="pending").length,n=ks(this.targets,this.live),s=["overview","alerts","cluster"],r=this.targets.filter(o=>`${o.name} ${o.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(o=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?o.paused:o.availability===this.statusFilter).sort((o,a)=>this.sort==="status"&&o.availability.localeCompare(a.availability)||o.name.localeCompare(a.name));return this.setupMode&&this.setup?d`
        <main class="shell setup-shell">
          <header>
            ...
            <div></div>
            <div class="actions"><button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${pt[this.theme]} aria-hidden="true"></iconify-icon></button></div>
          </header>
          ${this.error?d`<div class="notice" role="alert">${this.error}</div>`:f}
      ...
      <main class="shell">
        <header>
          ...
          <nav aria-label="Primary">
            ${s.map(o=>d`<a class=${this.activeSection===o?"active":""} href=${qe[o]} @click=${a=>this.navigate(a,o)}>${o[0].toUpperCase()}${o.slice(1)}</a>`)}
          </nav>
          <div class="actions">
            <button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${pt[this.theme]} aria-hidden="true"></iconify-icon></button>
          </div>
        </header>
        ${this.error?d`<div class="notice" role="alert">${this.error}</div>`:f}
      ...
      ${Os(this.channels,this.saving,{backdrop:o=>this.dismissOnBackdrop(o),close:()=>this.closeTargetDialog(),create:o=>{this.createTarget(o)}})}
      ${this.selected?js(this.selected,this.saving,this.detailDirty,this.cluster?.members??[],this.channels,{backdrop:o=>this.dismissOnBackdrop(o),close:()=>this.closeDetailDialog(),update:o=>{this.updateTarget(o)},changed:o=>this.updateDetailDirty(o),redirects:o=>this.toggleMaxRedirects(o),delete:()=>{this.deleteTarget()},pause:o=>{this.setPaused(o)}}):f}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          ${Ps(this.channelKind,this.editingChannel)}
