(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function s(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=s(i);fetch(i.href,r)}})();const te=globalThis,Ee=te.ShadowRoot&&(te.ShadyCSS===void 0||te.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Pe=Symbol(),Ue=new WeakMap;let pt=class{constructor(e,s,n){if(this._$cssResult$=!0,n!==Pe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=s}get styleSheet(){let e=this.o;const s=this.t;if(Ee&&e===void 0){const n=s!==void 0&&s.length===1;n&&(e=Ue.get(s)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Ue.set(s,e))}return e}toString(){return this.cssText}};const Ht=t=>new pt(typeof t=="string"?t:t+"",void 0,Pe),ft=(t,...e)=>{const s=t.length===1?t[0]:e.reduce((n,i,r)=>n+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[r+1],t[0]);return new pt(s,t,Pe)},Jt=(t,e)=>{if(Ee)t.adoptedStyleSheets=e.map(s=>s instanceof CSSStyleSheet?s:s.styleSheet);else for(const s of e){const n=document.createElement("style"),i=te.litNonce;i!==void 0&&n.setAttribute("nonce",i),n.textContent=s.cssText,t.appendChild(n)}},qe=Ee?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let s="";for(const n of e.cssRules)s+=n.cssText;return Ht(s)})(t):t;const{is:Bt,defineProperty:Vt,getOwnPropertyDescriptor:Wt,getOwnPropertyNames:Kt,getOwnPropertySymbols:Qt,getPrototypeOf:Gt}=Object,ue=globalThis,Fe=ue.trustedTypes,Yt=Fe?Fe.emptyScript:"",Zt=ue.reactiveElementPolyfillSupport,J=(t,e)=>t,oe={toAttribute(t,e){switch(e){case Boolean:t=t?Yt:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=t!==null;break;case Number:s=t===null?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch{s=null}}return s}},Ie=(t,e)=>!Bt(t,e),ze={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:Ie};Symbol.metadata??=Symbol("metadata"),ue.litPropertyMetadata??=new WeakMap;let N=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,s=ze){if(s.state&&(s.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((s=Object.create(s)).wrapped=!0),this.elementProperties.set(e,s),!s.noAccessor){const n=Symbol(),i=this.getPropertyDescriptor(e,n,s);i!==void 0&&Vt(this.prototype,e,i)}}static getPropertyDescriptor(e,s,n){const{get:i,set:r}=Wt(this.prototype,e)??{get(){return this[s]},set(o){this[s]=o}};return{get:i,set(o){const a=i?.call(this);r?.call(this,o),this.requestUpdate(e,a,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ze}static _$Ei(){if(this.hasOwnProperty(J("elementProperties")))return;const e=Gt(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(J("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(J("properties"))){const s=this.properties,n=[...Kt(s),...Qt(s)];for(const i of n)this.createProperty(i,s[i])}const e=this[Symbol.metadata];if(e!==null){const s=litPropertyMetadata.get(e);if(s!==void 0)for(const[n,i]of s)this.elementProperties.set(n,i)}this._$Eh=new Map;for(const[s,n]of this.elementProperties){const i=this._$Eu(s,n);i!==void 0&&this._$Eh.set(i,s)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const s=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const i of n)s.unshift(qe(i))}else e!==void 0&&s.push(qe(e));return s}static _$Eu(e,s){const n=s.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,s=this.constructor.elementProperties;for(const n of s.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Jt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,s,n){this._$AK(e,n)}_$ET(e,s){const n=this.constructor.elementProperties.get(e),i=this.constructor._$Eu(e,n);if(i!==void 0&&n.reflect===!0){const r=(n.converter?.toAttribute!==void 0?n.converter:oe).toAttribute(s,n.type);this._$Em=e,r==null?this.removeAttribute(i):this.setAttribute(i,r),this._$Em=null}}_$AK(e,s){const n=this.constructor,i=n._$Eh.get(e);if(i!==void 0&&this._$Em!==i){const r=n.getPropertyOptions(i),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:oe;this._$Em=i;const a=o.fromAttribute(s,r.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(e,s,n,i=!1,r){if(e!==void 0){const o=this.constructor;if(i===!1&&(r=this[e]),n??=o.getPropertyOptions(e),!((n.hasChanged??Ie)(r,s)||n.useDefault&&n.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,n))))return;this.C(e,s,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,s,{useDefault:n,reflect:i,wrapped:r},o){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??s??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(s=void 0),this._$AL.set(e,s)),i===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(s){Promise.reject(s)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[i,r]of this._$Ep)this[i]=r;this._$Ep=void 0}const n=this.constructor.elementProperties;if(n.size>0)for(const[i,r]of n){const{wrapped:o}=r,a=this[i];o!==!0||this._$AL.has(i)||a===void 0||this.C(i,void 0,r,a)}}let e=!1;const s=this._$AL;try{e=this.shouldUpdate(s),e?(this.willUpdate(s),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(s)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(s)}willUpdate(e){}_$AE(e){this._$EO?.forEach(s=>s.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(s=>this._$ET(s,this[s])),this._$EM()}updated(e){}firstUpdated(e){}};N.elementStyles=[],N.shadowRootOptions={mode:"open"},N[J("elementProperties")]=new Map,N[J("finalized")]=new Map,Zt?.({ReactiveElement:N}),(ue.reactiveElementVersions??=[]).push("2.1.2");const Oe=globalThis,He=t=>t,ae=Oe.trustedTypes,Je=ae?ae.createPolicy("lit-html",{createHTML:t=>t}):void 0,gt="$lit$",T=`lit$${Math.random().toFixed(9).slice(2)}$`,mt="?"+T,Xt=`<${mt}>`,j=document,V=()=>j.createComment(""),W=t=>t===null||typeof t!="object"&&typeof t!="function",De=Array.isArray,es=t=>De(t)||typeof t?.[Symbol.iterator]=="function",be=`[ 	
\f\r]`,F=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Be=/-->/g,Ve=/>/g,O=RegExp(`>|${be}(?:([^\\s"'>=/]+)(${be}*=${be}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),We=/'/g,Ke=/"/g,bt=/^(?:script|style|textarea|title)$/i,ts=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),h=ts(1),R=Symbol.for("lit-noChange"),p=Symbol.for("lit-nothing"),Qe=new WeakMap,D=j.createTreeWalker(j,129);function vt(t,e){if(!De(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Je!==void 0?Je.createHTML(e):e}const ss=(t,e)=>{const s=t.length-1,n=[];let i,r=e===2?"<svg>":e===3?"<math>":"",o=F;for(let a=0;a<s;a++){const l=t[a];let c,u,d=-1,f=0;for(;f<l.length&&(o.lastIndex=f,u=o.exec(l),u!==null);)f=o.lastIndex,o===F?u[1]==="!--"?o=Be:u[1]!==void 0?o=Ve:u[2]!==void 0?(bt.test(u[2])&&(i=RegExp("</"+u[2],"g")),o=O):u[3]!==void 0&&(o=O):o===O?u[0]===">"?(o=i??F,d=-1):u[1]===void 0?d=-2:(d=o.lastIndex-u[2].length,c=u[1],o=u[3]===void 0?O:u[3]==='"'?Ke:We):o===Ke||o===We?o=O:o===Be||o===Ve?o=F:(o=O,i=void 0);const x=o===O&&t[a+1].startsWith("/>")?" ":"";r+=o===F?l+Xt:d>=0?(n.push(c),l.slice(0,d)+gt+l.slice(d)+T+x):l+T+(d===-2?a:x)}return[vt(t,r+(t[s]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]};class K{constructor({strings:e,_$litType$:s},n){let i;this.parts=[];let r=0,o=0;const a=e.length-1,l=this.parts,[c,u]=ss(e,s);if(this.el=K.createElement(c,n),D.currentNode=this.el.content,s===2||s===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(i=D.nextNode())!==null&&l.length<a;){if(i.nodeType===1){if(i.hasAttributes())for(const d of i.getAttributeNames())if(d.endsWith(gt)){const f=u[o++],x=i.getAttribute(d).split(T),$=/([.?@])?(.*)/.exec(f);l.push({type:1,index:r,name:$[2],strings:x,ctor:$[1]==="."?ns:$[1]==="?"?rs:$[1]==="@"?os:he}),i.removeAttribute(d)}else d.startsWith(T)&&(l.push({type:6,index:r}),i.removeAttribute(d));if(bt.test(i.tagName)){const d=i.textContent.split(T),f=d.length-1;if(f>0){i.textContent=ae?ae.emptyScript:"";for(let x=0;x<f;x++)i.append(d[x],V()),D.nextNode(),l.push({type:2,index:++r});i.append(d[f],V())}}}else if(i.nodeType===8)if(i.data===mt)l.push({type:2,index:r});else{let d=-1;for(;(d=i.data.indexOf(T,d+1))!==-1;)l.push({type:7,index:r}),d+=T.length-1}r++}}static createElement(e,s){const n=j.createElement("template");return n.innerHTML=e,n}}function L(t,e,s=t,n){if(e===R)return e;let i=n!==void 0?s._$Co?.[n]:s._$Cl;const r=W(e)?void 0:e._$litDirective$;return i?.constructor!==r&&(i?._$AO?.(!1),r===void 0?i=void 0:(i=new r(t),i._$AT(t,s,n)),n!==void 0?(s._$Co??=[])[n]=i:s._$Cl=i),i!==void 0&&(e=L(t,i._$AS(t,e.values),i,n)),e}class is{constructor(e,s){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=s}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:s},parts:n}=this._$AD,i=(e?.creationScope??j).importNode(s,!0);D.currentNode=i;let r=D.nextNode(),o=0,a=0,l=n[0];for(;l!==void 0;){if(o===l.index){let c;l.type===2?c=new Y(r,r.nextSibling,this,e):l.type===1?c=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(c=new as(r,this,e)),this._$AV.push(c),l=n[++a]}o!==l?.index&&(r=D.nextNode(),o++)}return D.currentNode=j,i}p(e){let s=0;for(const n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,s),s+=n.strings.length-2):n._$AI(e[s])),s++}}class Y{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,s,n,i){this.type=2,this._$AH=p,this._$AN=void 0,this._$AA=e,this._$AB=s,this._$AM=n,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const s=this._$AM;return s!==void 0&&e?.nodeType===11&&(e=s.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,s=this){e=L(this,e,s),W(e)?e===p||e==null||e===""?(this._$AH!==p&&this._$AR(),this._$AH=p):e!==this._$AH&&e!==R&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):es(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==p&&W(this._$AH)?this._$AA.nextSibling.data=e:this.T(j.createTextNode(e)),this._$AH=e}$(e){const{values:s,_$litType$:n}=e,i=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=K.createElement(vt(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===i)this._$AH.p(s);else{const r=new is(i,this),o=r.u(this.options);r.p(s),this.T(o),this._$AH=r}}_$AC(e){let s=Qe.get(e.strings);return s===void 0&&Qe.set(e.strings,s=new K(e)),s}k(e){De(this._$AH)||(this._$AH=[],this._$AR());const s=this._$AH;let n,i=0;for(const r of e)i===s.length?s.push(n=new Y(this.O(V()),this.O(V()),this,this.options)):n=s[i],n._$AI(r),i++;i<s.length&&(this._$AR(n&&n._$AB.nextSibling,i),s.length=i)}_$AR(e=this._$AA.nextSibling,s){for(this._$AP?.(!1,!0,s);e!==this._$AB;){const n=He(e).nextSibling;He(e).remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class he{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,s,n,i,r){this.type=1,this._$AH=p,this._$AN=void 0,this.element=e,this.name=s,this._$AM=i,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=p}_$AI(e,s=this,n,i){const r=this.strings;let o=!1;if(r===void 0)e=L(this,e,s,0),o=!W(e)||e!==this._$AH&&e!==R,o&&(this._$AH=e);else{const a=e;let l,c;for(e=r[0],l=0;l<r.length-1;l++)c=L(this,a[n+l],s,l),c===R&&(c=this._$AH[l]),o||=!W(c)||c!==this._$AH[l],c===p?e=p:e!==p&&(e+=(c??"")+r[l+1]),this._$AH[l]=c}o&&!i&&this.j(e)}j(e){e===p?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ns extends he{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===p?void 0:e}}class rs extends he{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==p)}}class os extends he{constructor(e,s,n,i,r){super(e,s,n,i,r),this.type=5}_$AI(e,s=this){if((e=L(this,e,s,0)??p)===R)return;const n=this._$AH,i=e===p&&n!==p||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,r=e!==p&&(n===p||i);i&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class as{constructor(e,s,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=s,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}}const ls=Oe.litHtmlPolyfillSupport;ls?.(K,Y),(Oe.litHtmlVersions??=[]).push("3.3.3");const cs=(t,e,s)=>{const n=s?.renderBefore??e;let i=n._$litPart$;if(i===void 0){const r=s?.renderBefore??null;n._$litPart$=i=new Y(e.insertBefore(V(),r),r,void 0,s??{})}return i._$AI(t),i};const je=globalThis;class M extends N{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const s=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=cs(s,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return R}}M._$litElement$=!0,M.finalized=!0,je.litElementHydrateSupport?.({LitElement:M});const ds=je.litElementPolyfillSupport;ds?.({LitElement:M});(je.litElementVersions??=[]).push("4.2.2");const yt=t=>(e,s)=>{s!==void 0?s.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const us={attribute:!0,type:String,converter:oe,reflect:!1,hasChanged:Ie},hs=(t=us,e,s)=>{const{kind:n,metadata:i}=s;let r=globalThis.litPropertyMetadata.get(i);if(r===void 0&&globalThis.litPropertyMetadata.set(i,r=new Map),n==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(s.name,t),n==="accessor"){const{name:o}=s;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,t,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,t,a),a}}}if(n==="setter"){const{name:o}=s;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,t,!0,a)}}throw Error("Unsupported decorator location: "+n)};function xt(t){return(e,s)=>typeof s=="object"?hs(t,e,s):((n,i,r)=>{const o=i.hasOwnProperty(r);return i.constructor.createProperty(r,n),o?Object.getOwnPropertyDescriptor(i,r):void 0})(t,e,s)}function g(t){return xt({...t,state:!0,attribute:!1})}const $t={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},wt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},se={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},_t={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'};const kt=Object.freeze({left:0,top:0,width:16,height:16}),le=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),Z=Object.freeze({...kt,...le}),$e=Object.freeze({...Z,body:"",hidden:!1}),ps=Object.freeze({width:null,height:null}),St=Object.freeze({...ps,...le});function fs(t,e=0){const s=t.replace(/^-?[0-9.]*/,"");function n(i){for(;i<0;)i+=4;return i%4}if(s===""){const i=parseInt(t);return isNaN(i)?0:n(i)}else if(s!==t){let i=0;switch(s){case"%":i=25;break;case"deg":i=90}if(i){let r=parseFloat(t.slice(0,t.length-s.length));return isNaN(r)?0:(r=r/i,r%1===0?n(r):0)}}return e}const gs=/[\s,]+/;function ms(t,e){e.split(gs).forEach(s=>{switch(s.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Ct={...St,preserveAspectRatio:""};function Ge(t){const e={...Ct},s=(n,i)=>t.getAttribute(n)||i;return e.width=s("width",null),e.height=s("height",null),e.rotate=fs(s("rotate","")),ms(e,s("flip","")),e.preserveAspectRatio=s("preserveAspectRatio",s("preserveaspectratio","")),e}function bs(t,e){for(const s in Ct)if(t[s]!==e[s])return!0;return!1}const At=/^[a-z0-9]+(-[a-z0-9]+)*$/,X=(t,e,s,n="")=>{const i=t.split(":");if(t.slice(0,1)==="@"){if(i.length<2||i.length>3)return null;n=i.shift().slice(1)}if(i.length>3||!i.length)return null;if(i.length>1){const a=i.pop(),l=i.pop(),c={provider:i.length>0?i[0]:n,prefix:l,name:a};return e&&!ie(c)?null:c}const r=i[0],o=r.split("-");if(o.length>1){const a={provider:n,prefix:o.shift(),name:o.join("-")};return e&&!ie(a)?null:a}if(s&&n===""){const a={provider:n,prefix:"",name:r};return e&&!ie(a,s)?null:a}return null},ie=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function vs(t,e){const s=t.icons,n=t.aliases||Object.create(null),i=Object.create(null);function r(o){if(s[o])return i[o]=[];if(!(o in i)){i[o]=null;const a=n[o]&&n[o].parent,l=a&&r(a);l&&(i[o]=[a].concat(l))}return i[o]}return Object.keys(s).concat(Object.keys(n)).forEach(r),i}function ys(t,e){const s={};!t.hFlip!=!e.hFlip&&(s.hFlip=!0),!t.vFlip!=!e.vFlip&&(s.vFlip=!0);const n=((t.rotate||0)+(e.rotate||0))%4;return n&&(s.rotate=n),s}function Ye(t,e){const s=ys(t,e);for(const n in $e)n in le?n in t&&!(n in s)&&(s[n]=le[n]):n in e?s[n]=e[n]:n in t&&(s[n]=t[n]);return s}function xs(t,e,s){const n=t.icons,i=t.aliases||Object.create(null);let r={};function o(a){r=Ye(n[a]||i[a],r)}return o(e),s.forEach(o),Ye(t,r)}function Tt(t,e){const s=[];if(typeof t!="object"||typeof t.icons!="object")return s;t.not_found instanceof Array&&t.not_found.forEach(i=>{e(i,null),s.push(i)});const n=vs(t);for(const i in n){const r=n[i];r&&(e(i,xs(t,i,r)),s.push(i))}return s}const $s={provider:"",aliases:{},not_found:{},...kt};function ve(t,e){for(const s in e)if(s in t&&typeof t[s]!=typeof e[s])return!1;return!0}function Et(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!ve(t,$s))return null;const s=e.icons;for(const i in s){const r=s[i];if(!i||typeof r.body!="string"||!ve(r,$e))return null}const n=e.aliases||Object.create(null);for(const i in n){const r=n[i],o=r.parent;if(!i||typeof o!="string"||!s[o]&&!n[o]||!ve(r,$e))return null}return e}const ce=Object.create(null);function ws(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function A(t,e){const s=ce[t]||(ce[t]=Object.create(null));return s[e]||(s[e]=ws(t,e))}function Pt(t,e){return Et(e)?Tt(e,(s,n)=>{n?t.icons[s]=n:t.missing.add(s)}):[]}function _s(t,e,s){try{if(typeof s.body=="string")return t.icons[e]={...s},!0}catch{}return!1}function ks(t,e){let s=[];return(typeof t=="string"?[t]:Object.keys(ce)).forEach(n=>{(typeof n=="string"&&typeof e=="string"?[e]:Object.keys(ce[n]||{})).forEach(i=>{const r=A(n,i);s=s.concat(Object.keys(r.icons).map(o=>(n!==""?"@"+n+":":"")+i+":"+o))})}),s}let Q=!1;function It(t){return typeof t=="boolean"&&(Q=t),Q}function G(t){const e=typeof t=="string"?X(t,!0,Q):t;if(e){const s=A(e.provider,e.prefix),n=e.name;return s.icons[n]||(s.missing.has(n)?null:void 0)}}function Ot(t,e){const s=X(t,!0,Q);if(!s)return!1;const n=A(s.provider,s.prefix);return e?_s(n,s.name,e):(n.missing.add(s.name),!0)}function Ze(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),Q&&!e&&!t.prefix){let n=!1;return Et(t)&&(t.prefix="",Tt(t,(i,r)=>{Ot(i,r)&&(n=!0)})),n}const s=t.prefix;return ie({prefix:s,name:"a"})?!!Pt(A(e,s),t):!1}function Ss(t){return!!G(t)}function Cs(t){const e=G(t);return e&&{...Z,...e}}function Dt(t,e){t.forEach(s=>{const n=s.loaderCallbacks;n&&(s.loaderCallbacks=n.filter(i=>i.id!==e))})}function As(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let s=!1;const n=t.provider,i=t.prefix;e.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==i)return!0;const c=l.name;if(t.icons[c])o.loaded.push({provider:n,prefix:i,name:c});else if(t.missing.has(c))o.missing.push({provider:n,prefix:i,name:c});else return s=!0,!0;return!1}),o.pending.length!==a&&(s||Dt([t],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let Ts=0;function Es(t,e,s){const n=Ts++,i=Dt.bind(null,s,n);if(!e.pending.length)return i;const r={id:n,icons:e,callback:t,abort:i};return s.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),i}function Ps(t){const e={loaded:[],missing:[],pending:[]},s=Object.create(null);t.sort((i,r)=>i.provider!==r.provider?i.provider.localeCompare(r.provider):i.prefix!==r.prefix?i.prefix.localeCompare(r.prefix):i.name.localeCompare(r.name));let n={provider:"",prefix:"",name:""};return t.forEach(i=>{if(n.name===i.name&&n.prefix===i.prefix&&n.provider===i.provider)return;n=i;const r=i.provider,o=i.prefix,a=i.name,l=s[r]||(s[r]=Object.create(null)),c=l[o]||(l[o]=A(r,o));let u;a in c.icons?u=e.loaded:o===""||c.missing.has(a)?u=e.missing:u=e.pending;const d={provider:r,prefix:o,name:a};u.push(d)}),e}const we=Object.create(null);function Xe(t,e){we[t]=e}function _e(t){return we[t]||we[""]}function Is(t,e=!0,s=!1){const n=[];return t.forEach(i=>{const r=typeof i=="string"?X(i,e,s):i;r&&n.push(r)}),n}function Ne(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const pe=Object.create(null),z=["https://api.simplesvg.com","https://api.unisvg.com"],ne=[];for(;z.length>0;)z.length===1||Math.random()>.5?ne.push(z.shift()):ne.push(z.pop());pe[""]=Ne({resources:["https://api.iconify.design"].concat(ne)});function et(t,e){const s=Ne(e);return s===null?!1:(pe[t]=s,!0)}function fe(t){return pe[t]}function Os(){return Object.keys(pe)}const Ds={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function js(t,e,s,n){const i=t.resources.length,r=t.random?Math.floor(Math.random()*i):t.index;let o;if(t.random){let v=t.resources.slice(0);for(o=[];v.length>1;){const k=Math.floor(Math.random()*v.length);o.push(v[k]),v=v.slice(0,k).concat(v.slice(k+1))}o=o.concat(v)}else o=t.resources.slice(r).concat(t.resources.slice(0,r));const a=Date.now();let l="pending",c=0,u,d=null,f=[],x=[];typeof n=="function"&&x.push(n);function $(){d&&(clearTimeout(d),d=null)}function C(){l==="pending"&&(l="aborted"),$(),f.forEach(v=>{v.status==="pending"&&(v.status="aborted")}),f=[]}function w(v,k){k&&(x=[]),typeof v=="function"&&x.push(v)}function ge(){return{startTime:a,payload:e,status:l,queriesSent:c,queriesPending:f.length,subscribe:w,abort:C}}function P(){l="failed",x.forEach(v=>{v(void 0,u)})}function S(){f.forEach(v=>{v.status==="pending"&&(v.status="aborted")}),f=[]}function _(v,k,q){const ee=k!=="success";switch(f=f.filter(I=>I!==v),l){case"pending":break;case"failed":if(ee||!t.dataAfterTimeout)return;break;default:return}if(k==="abort"){u=q,P();return}if(ee){u=q,f.length||(o.length?me():P());return}if($(),S(),!t.random){const I=t.resources.indexOf(v.resource);I!==-1&&I!==t.index&&(t.index=I)}l="completed",x.forEach(I=>{I(q)})}function me(){if(l!=="pending")return;$();const v=o.shift();if(v===void 0){if(f.length){d=setTimeout(()=>{$(),l==="pending"&&(S(),P())},t.timeout);return}P();return}const k={status:"pending",resource:v,callback:(q,ee)=>{_(k,q,ee)}};f.push(k),c++,d=setTimeout(me,t.rotate),s(v,e,k.callback)}return setTimeout(me),ge}function jt(t){const e={...Ds,...t};let s=[];function n(){s=s.filter(o=>o().status==="pending")}function i(o,a,l){const c=js(e,o,a,(u,d)=>{n(),l&&l(u,d)});return s.push(c),c}function r(o){return s.find(a=>o(a))||null}return{query:i,find:r,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:n}}function tt(){}const ye=Object.create(null);function Ns(t){if(!ye[t]){const e=fe(t);if(!e)return;ye[t]={config:e,redundancy:jt(e)}}return ye[t]}function Nt(t,e,s){let n,i;if(typeof t=="string"){const r=_e(t);if(!r)return s(void 0,424),tt;i=r.send;const o=Ns(t);o&&(n=o.redundancy)}else{const r=Ne(t);if(r){n=jt(r);const o=_e(t.resources?t.resources[0]:"");o&&(i=o.send)}}return!n||!i?(s(void 0,424),tt):n.query(e,i,s)().abort}function st(){}function Ms(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,As(t)}))}function Rs(t){const e=[],s=[];return t.forEach(n=>{(n.match(At)?e:s).push(n)}),{valid:e,invalid:s}}function H(t,e,s){function n(){const i=t.pendingIcons;e.forEach(r=>{i&&i.delete(r),t.icons[r]||t.missing.add(r)})}if(s&&typeof s=="object")try{if(!Pt(t,s).length){n();return}}catch(i){console.error(i)}n(),Ms(t)}function it(t,e){t instanceof Promise?t.then(s=>{e(s)}).catch(()=>{e(null)}):e(t)}function Ls(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:s,prefix:n}=t,i=t.iconsToLoad;if(delete t.iconsToLoad,!i||!i.length)return;const r=t.loadIcon;if(t.loadIcons&&(i.length>1||!r)){it(t.loadIcons(i,n,s),c=>{H(t,i,c)});return}if(r){i.forEach(c=>{it(r(c,n,s),u=>{H(t,[c],u?{prefix:n,icons:{[c]:u}}:null)})});return}const{valid:o,invalid:a}=Rs(i);if(a.length&&H(t,a,null),!o.length)return;const l=n.match(At)?_e(s):null;if(!l){H(t,o,null);return}l.prepare(s,n,o).forEach(c=>{Nt(s,c,u=>{H(t,c.icons,u)})})}))}const Me=(t,e)=>{const s=Ps(Is(t,!0,It()));if(!s.pending.length){let a=!0;return e&&setTimeout(()=>{a&&e(s.loaded,s.missing,s.pending,st)}),()=>{a=!1}}const n=Object.create(null),i=[];let r,o;return s.pending.forEach(a=>{const{provider:l,prefix:c}=a;if(c===o&&l===r)return;r=l,o=c,i.push(A(l,c));const u=n[l]||(n[l]=Object.create(null));u[c]||(u[c]=[])}),s.pending.forEach(a=>{const{provider:l,prefix:c,name:u}=a,d=A(l,c),f=d.pendingIcons||(d.pendingIcons=new Set);f.has(u)||(f.add(u),n[l][c].push(u))}),i.forEach(a=>{const l=n[a.provider][a.prefix];l.length&&Ls(a,l)}),e?Es(e,s,i):st},Us=t=>new Promise((e,s)=>{const n=typeof t=="string"?X(t,!0):t;if(!n){s(t);return}Me([n||t],i=>{if(i.length&&n){const r=G(n);if(r){e({...Z,...r});return}}s(t)})});function nt(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function qs(t,e){if(typeof t=="object")return{data:nt(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=nt(t);if(r)return{data:r,value:t}}const s=X(t,!0,!0);if(!s)return{value:t};const n=G(s);if(n!==void 0||!s.prefix)return{value:t,name:s,data:n};const i=Me([s],()=>e(t,s,G(s)));return{value:t,name:s,loading:i}}let Mt=!1;try{Mt=navigator.vendor.indexOf("Apple")===0}catch{}function Fs(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Mt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const zs=/(-?[0-9.]*[0-9]+[0-9.]*)/g,Hs=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function ke(t,e,s){if(e===1)return t;if(s=s||100,typeof t=="number")return Math.ceil(t*e*s)/s;if(typeof t!="string")return t;const n=t.split(zs);if(n===null||!n.length)return t;const i=[];let r=n.shift(),o=Hs.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?i.push(r):i.push(Math.ceil(a*e*s)/s)}else i.push(r);if(r=n.shift(),r===void 0)return i.join("");o=!o}}function Js(t,e="defs"){let s="";const n=t.indexOf("<"+e);for(;n>=0;){const i=t.indexOf(">",n),r=t.indexOf("</"+e);if(i===-1||r===-1)break;const o=t.indexOf(">",r);if(o===-1)break;s+=t.slice(i+1,r).trim(),t=t.slice(0,n).trim()+t.slice(o+1)}return{defs:s,content:t}}function Bs(t,e){return t?"<defs>"+t+"</defs>"+e:e}function Vs(t,e,s){const n=Js(t);return Bs(n.defs,e+n.content+s)}const Ws=t=>t==="unset"||t==="undefined"||t==="none";function Rt(t,e){const s={...Z,...t},n={...St,...e},i={left:s.left,top:s.top,width:s.width,height:s.height};let r=s.body;[s,n].forEach(C=>{const w=[],ge=C.hFlip,P=C.vFlip;let S=C.rotate;ge?P?S+=2:(w.push("translate("+(i.width+i.left).toString()+" "+(0-i.top).toString()+")"),w.push("scale(-1 1)"),i.top=i.left=0):P&&(w.push("translate("+(0-i.left).toString()+" "+(i.height+i.top).toString()+")"),w.push("scale(1 -1)"),i.top=i.left=0);let _;switch(S<0&&(S-=Math.floor(S/4)*4),S=S%4,S){case 1:_=i.height/2+i.top,w.unshift("rotate(90 "+_.toString()+" "+_.toString()+")");break;case 2:w.unshift("rotate(180 "+(i.width/2+i.left).toString()+" "+(i.height/2+i.top).toString()+")");break;case 3:_=i.width/2+i.left,w.unshift("rotate(-90 "+_.toString()+" "+_.toString()+")");break}S%2===1&&(i.left!==i.top&&(_=i.left,i.left=i.top,i.top=_),i.width!==i.height&&(_=i.width,i.width=i.height,i.height=_)),w.length&&(r=Vs(r,'<g transform="'+w.join(" ")+'">',"</g>"))});const o=n.width,a=n.height,l=i.width,c=i.height;let u,d;o===null?(d=a===null?"1em":a==="auto"?c:a,u=ke(d,l/c)):(u=o==="auto"?l:o,d=a===null?ke(u,c/l):a==="auto"?c:a);const f={},x=(C,w)=>{Ws(w)||(f[C]=w.toString())};x("width",u),x("height",d);const $=[i.left,i.top,l,c];return f.viewBox=$.join(" "),{attributes:f,viewBox:$,body:r}}function Re(t,e){let s=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const n in e)s+=" "+n+'="'+e[n]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+s+">"+t+"</svg>"}function Ks(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function Qs(t){return"data:image/svg+xml,"+Ks(t)}function Lt(t){return'url("'+Qs(t)+'")'}const Gs=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let de=Gs();function Ys(t){de=t}function Zs(){return de}function Xs(t,e){const s=fe(t);if(!s)return 0;let n;if(!s.maxURL)n=0;else{let i=0;s.resources.forEach(o=>{i=Math.max(i,o.length)});const r=e+".json?icons=";n=s.maxURL-i-s.path.length-r.length}return n}function ei(t){return t===404}const ti=(t,e,s)=>{const n=[],i=Xs(t,e),r="icons";let o={type:r,provider:t,prefix:e,icons:[]},a=0;return s.forEach((l,c)=>{a+=l.length+1,a>=i&&c>0&&(n.push(o),o={type:r,provider:t,prefix:e,icons:[]},a=l.length),o.icons.push(l)}),n.push(o),n};function si(t){if(typeof t=="string"){const e=fe(t);if(e)return e.path}return"/"}const ii=(t,e,s)=>{if(!de){s("abort",424);return}let n=si(e.provider);switch(e.type){case"icons":{const r=e.prefix,o=e.icons.join(","),a=new URLSearchParams({icons:o});n+=r+".json?"+a.toString();break}case"custom":{const r=e.uri;n+=r.slice(0,1)==="/"?r.slice(1):r;break}default:s("abort",400);return}let i=503;de(t+n).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{s(ei(o)?"abort":"next",o)});return}return i=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?s("abort",r):s("next",i)});return}setTimeout(()=>{s("success",r)})}).catch(()=>{s("next",i)})},ni={prepare:ti,send:ii};function ri(t,e,s){A(s||"",e).loadIcons=t}function oi(t,e,s){A(s||"",e).loadIcon=t}const xe="data-style";let Ut="";function ai(t){Ut=t}function rt(t,e){let s=Array.from(t.childNodes).find(n=>n.hasAttribute&&n.hasAttribute(xe));s||(s=document.createElement("style"),s.setAttribute(xe,xe),t.appendChild(s)),s.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Ut}function qt(){Xe("",ni),It(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const s=t.IconifyPreload,n="Invalid IconifyPreload syntax.";typeof s=="object"&&s!==null&&(s instanceof Array?s:[s]).forEach(i=>{try{(typeof i!="object"||i===null||i instanceof Array||typeof i.icons!="object"||typeof i.prefix!="string"||!Ze(i))&&console.error(n)}catch{console.error(n)}})}if(t.IconifyProviders!==void 0){const s=t.IconifyProviders;if(typeof s=="object"&&s!==null)for(const n in s){const i="IconifyProviders["+n+"] is invalid.";try{const r=s[n];if(typeof r!="object"||!r||r.resources===void 0)continue;et(n,r)||console.error(i)}catch{console.error(i)}}}}return{iconLoaded:Ss,getIcon:Cs,listIcons:ks,addIcon:Ot,addCollection:Ze,calculateSize:ke,buildIcon:Rt,iconToHTML:Re,svgToURL:Lt,loadIcons:Me,loadIcon:Us,addAPIProvider:et,setCustomIconLoader:oi,setCustomIconsLoader:ri,appendCustomStyle:ai,_api:{getAPIConfig:fe,setAPIModule:Xe,sendAPIQuery:Nt,setFetch:Ys,getFetch:Zs,listAPIProviders:Os}}}const Se={"background-color":"currentColor"},Ft={"background-color":"transparent"},ot={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},at={"-webkit-mask":Se,mask:Se,background:Ft};for(const t in at){const e=at[t];for(const s in ot)e[t+"-"+s]=ot[s]}function lt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function li(t,e,s){const n=document.createElement("span");let i=t.body;i.indexOf("<a")!==-1&&(i+="<!-- "+Date.now()+" -->");const r=t.attributes,o=Re(i,{...r,width:e.width+"",height:e.height+""}),a=Lt(o),l=n.style,c={"--svg":a,width:lt(r.width),height:lt(r.height),...s?Se:Ft};for(const u in c)l.setProperty(u,c[u]);return n}let B;function ci(){try{B=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{B=null}}function di(t){return B===void 0&&ci(),B?B.createHTML(t):t}function ui(t){const e=document.createElement("span"),s=t.attributes;let n="";s.width||(n="width: inherit;"),s.height||(n+="height: inherit;"),n&&(s.style=n);const i=Re(t.body,s);return e.innerHTML=di(i),e.firstChild}function Ce(t){return Array.from(t.childNodes).find(e=>{const s=e.tagName&&e.tagName.toUpperCase();return s==="SPAN"||s==="SVG"})}function ct(t,e){const s=e.icon.data,n=e.customisations,i=Rt(s,n);n.preserveAspectRatio&&(i.attributes.preserveAspectRatio=n.preserveAspectRatio);const r=e.renderedMode;let o;r==="svg"?o=ui(i):o=li(i,{...Z,...s},r==="mask");const a=Ce(t);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,a):t.appendChild(o)}function dt(t,e,s){const n=s&&(s.rendered?s:s.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:n}}function hi(t="iconify-icon"){let e,s;try{e=window.customElements,s=window.HTMLElement}catch{return}if(!e||!s)return;const n=e.get(t);if(n)return n;const i=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends s{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const a=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");rt(a,l),this._state=dt({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return i.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const l=this.hasAttribute("inline"),c=this._state;l!==c.inline&&(c.inline=l,rt(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return this.hasAttribute("inline")}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const l=this._shadowRoot;if(a.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}ct(l,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,l=this.getAttribute("icon");if(l!==a.icon.value){this._iconChanged(l);return}if(!a.rendered||!this._visible)return;const c=this.getAttribute("mode"),u=Ge(this);(a.attrMode!==c||bs(a.customisations,u)||!Ce(this._shadowRoot))&&this._renderIcon(a.icon,u,c)}_iconChanged(a){const l=qs(a,(c,u,d)=>{const f=this._state;if(f.rendered||this.getAttribute("icon")!==c)return;const x={value:c,name:u,data:d};x.data?this._gotIconData(x):f.icon=x});l.data?this._gotIconData(l):this._state=dt(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=Ce(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,Ge(this),this.getAttribute("mode"))}_renderIcon(a,l,c){const u=Fs(a.data.body,c),d=this._state.inline;ct(this._shadowRoot,this._state={rendered:!0,icon:a,inline:d,customisations:l,attrMode:c,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(a=>{const l=a.some(c=>c.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};i.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=qt();for(const a in o)r[a]=r.prototype[a]=o[a];return e.define(t,r),r}const pi=hi()||qt(),{iconLoaded:Ai,getIcon:Ti,listIcons:Ei,addIcon:Pi,addCollection:Ii,calculateSize:Oi,buildIcon:Di,iconToHTML:ji,svgToURL:Ni,loadIcons:Mi,loadIcon:Ri,setCustomIconLoader:Li,setCustomIconsLoader:Ui,addAPIProvider:qi,_api:Fi}=pi;async function y(t,e){const s=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!s.ok){const n=await s.json().catch(()=>({error:s.statusText}));throw new Error(n.error||s.statusText)}return s.status===204?void 0:s.json()}function Ae(t,e){return e==="telegram"?{type:"telegram",name:t.get("name"),bot_token:t.get("bot_token"),chat_id:t.get("chat_id")}:{type:"webhook",name:t.get("name"),url:t.get("url"),headers:{}}}function zt(t,e=[]){return{name:String(t.get("name")),url:String(t.get("url")),method:String(t.get("method")),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),headers:{},body:null,body_contains:null,skip_tls_verification:!1,notification_channel_ids:e}}var fi=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,U=(t,e,s,n)=>{for(var i=n>1?void 0:n?gi(e,s):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(i=(n?o(e,s,i):o(i))||i);return n&&i&&fi(e,s,i),i};let E=class extends M{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await y("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){t.preventDefault(),window.confirm("Create a new single-Node Cluster?")&&await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName()})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,s=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(s.get("join_link")??"").trim()})}async choose(t,e){this.saving=!0,this.error="";try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster()}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(){for(let t=0;t<120;t+=1){await new Promise(e=>window.setTimeout(e,250));try{const e=await y("/api/v1/setup");if(e.cluster_ready){this.changed(e);return}}catch{}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),s=Ae(e,this.channelKind);await this.createResource("/api/v1/channels",s)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),s=zt(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",s)}async createResource(t,e){this.saving=!0;try{await y(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(s){this.fail(s),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await y("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return h`<section class="flow" aria-label="UpGrid setup">
      ${this.error?h`<div class="notice" role="alert">${this.error}</div>`:p}
      ...
      <div class="panel"><form class="choice" @submit=${this.createTarget}>
        ...
        ${this.channels.length?h`<fieldset><legend>Notification channels</legend>${this.channels.map(t=>h`<label><span><input name="channel_id" type="checkbox" value=${t.id} /> ${t.name}</span></label>`)}</fieldset>`:p}
  ...
  `;U([xt({attribute:!1})],E.prototype,"setup",2);U([g()],E.prototype,"channelKind",2);U([g()],E.prototype,"channels",2);U([g()],E.prototype,"saving",2);U([g()],E.prototype,"error",2);E=U([yt("upgrid-setup")],E);const mi={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a6 6 0 0 0 9 9a9 9 0 1 1-9-9Z"/>'},bi={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688c0-.437-.18-.835-.437-1.125c-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></g>'},vi={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></g>'};var yi=Object.defineProperty,b=(t,e,s,n)=>{for(var i=void 0,r=t.length-1,o;r>=0;r--)(o=t[r])&&(i=o(e,s,i)||i);return i&&yi(e,s,i),i};const re=["system","dark","bright"],ut={system:bi,dark:mi,bright:vi},Le={overview:"/",alerts:"/alerts",cluster:"/cluster"};function ht(){return Object.entries(Le).find(([,t])=>t===window.location.pathname)?.[0]??"overview"}function xi(){const t=localStorage.getItem("upgrid-theme");return re.includes(t)?t:"system"}class m extends M{constructor(){super(...arguments),this.targets=[],this.channels=[],this.alerts=[],this.secrets=[],this.joinTokens=[],this.error="",this.live=!1,this.saving=!1,this.channelKind="webhook",this.channelTestMessage="",this.testingChannel=!1,this.joinCommand="",this.search="",this.statusFilter="all",this.sort="name",this.selectedIds=new Set,this.activeSection=ht(),this.copied=!1,this.setupMode=!1,this.warningDismissed=sessionStorage.getItem("upgrid-warning-dismissed")==="1",this.unlimitedUses=!1,this.theme=xi(),this.detailDirty=!1,this.detailInitialState="",this.systemTheme=matchMedia("(prefers-color-scheme: light)"),this.systemThemeChanged=()=>{this.theme==="system"&&this.applyTheme()},this.routeChanged=()=>{if(this.setupMode&&this.setup){window.history.replaceState(null,"",this.setup.path);return}this.activeSection=ht()}}connectedCallback(){super.connectedCallback(),this.applyTheme(),this.systemTheme.addEventListener("change",this.systemThemeChanged),window.addEventListener("popstate",this.routeChanged),this.start()}disconnectedCallback(){this.systemTheme.removeEventListener("change",this.systemThemeChanged),window.removeEventListener("popstate",this.routeChanged),this.events?.close(),super.disconnectedCallback()}async start(){try{const e=await y("/api/v1/setup");if(this.setup=e,this.setupMode=e.setup,this.setupMode){window.history.replaceState(null,"",e.path),e.cluster_ready?(await this.refresh(),this.connectEvents()):this.live=!0;return}await this.refresh(),this.connectEvents()}catch(e){this.error=e instanceof Error?e.message:String(e)}}connectEvents(){this.events?.close(),this.events=new EventSource("/api/v1/events"),this.events.addEventListener("state",()=>{this.refresh()}),this.events.onopen=()=>this.live=!0,this.events.onerror=()=>this.live=!1}applyTheme(){const e=this.theme==="system"?this.systemTheme.matches?"bright":"dark":this.theme;this.dataset.theme=e,document.querySelector('meta[name="theme-color"]')?.setAttribute("content",e==="bright"?"#f4f8f6":"#0b1110")}cycleTheme(){this.theme=re[(re.indexOf(this.theme)+1)%re.length],localStorage.setItem("upgrid-theme",this.theme),this.applyTheme()}dismissWarning(){sessionStorage.setItem("upgrid-warning-dismissed","1"),this.warningDismissed=!0}async refresh(){try{[this.targets,this.channels,this.alerts,this.secrets,this.cluster,this.joinTokens]=await Promise.all([y("/api/v1/targets"),y("/api/v1/channels"),y("/api/v1/alerts"),y("/api/v1/secrets"),y("/api/v1/cluster"),y("/api/v1/join-tokens")]),this.error=""}catch(e){this.error=e instanceof Error?e.message:String(e)}}openTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.showModal()}closeTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.close()}openTarget(e){this.detailDirty=!1,this.selected=e,this.updateComplete.then(()=>{const s=this.renderRoot.querySelector("#detail-dialog"),n=s?.querySelector("form");n&&(this.detailInitialState=this.detailFormState(n)),s?.showModal()})}closeDetailDialog(){this.renderRoot.querySelector("#detail-dialog")?.close(),this.detailDirty=!1,this.detailInitialState="",this.selected=void 0}showDialog(e){this.renderRoot.querySelector(`#${e}`)?.showModal()}dismissOnBackdrop(e){const s=e.currentTarget;e.target===s&&(s.close(),s.id==="detail-dialog"&&this.closeDetailDialog())}navigate(e,s){e.preventDefault(),this.activeSection=s,window.history.pushState(null,"",Le[s]),this.updateComplete.then(()=>this.renderRoot.querySelector(`#${s}`)?.scrollIntoView({behavior:"smooth",block:"start"}))}closeDialog(e){this.renderRoot.querySelector(`#${e}`)?.close()}toggleMaxRedirects(e){const s=e.currentTarget,n=s.form?.elements.namedItem("max_redirects");n&&(n.disabled=!s.checked),s.form&&this.compareDetailForm(s.form)}detailFormState(e){return JSON.stringify([...new FormData(e).entries()])}compareDetailForm(e){this.detailDirty=this.detailFormState(e)!==this.detailInitialState}updateDetailDirty(e){this.compareDetailForm(e.currentTarget)}}b([g()],m.prototype,"targets");b([g()],m.prototype,"channels");b([g()],m.prototype,"alerts");b([g()],m.prototype,"secrets");b([g()],m.prototype,"cluster");b([g()],m.prototype,"joinTokens");b([g()],m.prototype,"error");b([g()],m.prototype,"live");b([g()],m.prototype,"saving");b([g()],m.prototype,"selected");b([g()],m.prototype,"channelKind");b([g()],m.prototype,"channelTestMessage");b([g()],m.prototype,"testingChannel");b([g()],m.prototype,"joinCommand");b([g()],m.prototype,"search");b([g()],m.prototype,"statusFilter");b([g()],m.prototype,"sort");b([g()],m.prototype,"selectedIds");b([g()],m.prototype,"activeSection");b([g()],m.prototype,"copied");b([g()],m.prototype,"setupMode");b([g()],m.prototype,"setup");b([g()],m.prototype,"warningDismissed");b([g()],m.prototype,"unlimitedUses");b([g()],m.prototype,"theme");b([g()],m.prototype,"detailDirty");class $i extends m{async createTarget(e){e.preventDefault();const s=e.currentTarget,n=new FormData(s),i=zt(n);this.saving=!0;try{await y("/api/v1/targets",{method:"POST",body:JSON.stringify(i)}),s.reset(),this.closeTargetDialog(),await this.refresh()}catch(r){this.error=r instanceof Error?r.message:String(r)}finally{this.saving=!1}}async updateTarget(e){if(e.preventDefault(),!this.selected)return;const s=new FormData(e.currentTarget),n=s.get("follow_redirects")==="on",i={name:String(s.get("name")),url:String(s.get("url")),method:String(s.get("method")),accepted_statuses:String(s.get("statuses")).split(",").map(r=>{const[o,a]=r.trim().split("-").map(Number);return{start:o,end:a||o}}),follow_redirects:n,max_redirects:n?Number(s.get("max_redirects")):0,interval_seconds:Number(s.get("interval")),timeout_seconds:Number(s.get("timeout")),failure_threshold:Number(s.get("failures")),headers:Object.fromEntries(Object.entries(this.selected.headers).map(([r,o])=>[r,o.kind==="literal"?o.value:{secret_id:o.secret_id}])),body:this.selected.body?.kind==="literal"?this.selected.body.value:this.selected.body?{secret_id:this.selected.body.secret_id}:null,body_contains:String(s.get("body_contains"))||null,skip_tls_verification:s.get("skip_tls_verification")==="on",notification_channel_ids:this.selected.notification_channel_ids};this.saving=!0;try{await y(`/api/v1/targets/${this.selected.id}`,{method:"PUT",body:JSON.stringify(i)}),this.closeDetailDialog(),await this.refresh()}catch(r){this.error=r instanceof Error?r.message:String(r)}finally{this.saving=!1}}async deleteTarget(){if(!(!this.selected||!window.confirm("Delete this target and its history?"))){this.saving=!0;try{await y(`/api/v1/targets/${this.selected.id}`,{method:"DELETE"}),this.closeDetailDialog(),await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async setPaused(e){if(this.selected){this.saving=!0;try{await y(`/api/v1/targets/${this.selected.id}/${e?"pause":"resume"}`,{method:"POST"}),this.closeDetailDialog(),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}}async createSecret(e){e.preventDefault();const s=e.currentTarget,n=new FormData(s);this.saving=!0;try{await y("/api/v1/secrets",{method:"POST",body:JSON.stringify({name:n.get("name"),value:n.get("value")})}),s.reset(),this.closeDialog("secret-dialog"),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async createChannel(e){e.preventDefault();const s=e.currentTarget,n=new FormData(s),i=Ae(n,this.channelKind);this.saving=!0;try{await y("/api/v1/channels",{method:"POST",body:JSON.stringify(i)}),s.reset(),this.channelKind="webhook",this.channelTestMessage="",this.closeDialog("channel-dialog"),await this.refresh()}catch(r){this.error=r instanceof Error?r.message:String(r)}finally{this.saving=!1}}openChannelDialog(){this.channelTestMessage="",this.showDialog("channel-dialog")}async testChannel(e){const s=e.currentTarget.form;if(!(!s||![...s.querySelectorAll("[data-test-required]")].every(i=>i.reportValidity()))){this.testingChannel=!0,this.channelTestMessage="";try{const i=Ae(new FormData(s),this.channelKind);await y("/api/v1/channels/test",{method:"POST",body:JSON.stringify(i)}),this.channelTestMessage="Test sent"}catch(i){const r=i instanceof Error?i.message:String(i);this.channelTestMessage=`Test failed: ${r}`}finally{this.testingChannel=!1}}}openTokenDialog(){this.unlimitedUses=!1,this.showDialog("token-config-dialog")}async createJoinToken(e){e.preventDefault();const s=new FormData(e.currentTarget);this.saving=!0;try{const n=await y("/api/v1/join-tokens",{method:"POST",body:JSON.stringify({expires_in_seconds:Number(s.get("expiration_days"))*86400,max_uses:this.unlimitedUses?null:Number(s.get("max_uses"))})});this.joinCommand=`upgrid --join '${n.url}'`,this.copied=!1,await this.refresh(),this.closeDialog("token-config-dialog"),this.showDialog("join-dialog")}catch(n){this.error=n instanceof Error?n.message:String(n)}finally{this.saving=!1}}async setupChanged(e){const s=e.detail;if(this.setup=s,this.setupMode=s.setup,window.history.replaceState(null,"",s.path),s.setup){s.cluster_ready&&(await this.refresh(),this.connectEvents());return}this.activeSection="overview",await this.refresh(),this.connectEvents()}async revokeJoinToken(e){if(window.confirm("Revoke this Join Token? Nodes using it will no longer be admitted.")){this.saving=!0;try{await y(`/api/v1/join-tokens/${e.id}`,{method:"DELETE"}),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}}async copyJoinCommand(){let e=!1;try{await navigator.clipboard.writeText(this.joinCommand),e=!0}catch{const s=Object.assign(document.createElement("textarea"),{value:this.joinCommand});s.style.cssText="position: fixed; opacity: 0",document.body.append(s),s.select(),e=document.execCommand("copy"),s.remove()}if(!e){this.error="Could not copy the Join command";return}this.copied=!0,window.setTimeout(()=>this.copied=!1,2e3)}toggleSelected(e,s){const n=new Set(this.selectedIds);s?n.add(e):n.delete(e),this.selectedIds=n}async bulkPause(e){this.saving=!0;try{await Promise.all([...this.selectedIds].map(s=>y(`/api/v1/targets/${s}/${e?"pause":"resume"}`,{method:"POST"}))),this.selectedIds=new Set,await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async bulkDelete(){if(window.confirm(`Delete ${this.selectedIds.size} selected Targets and their history?`)){this.saving=!0;try{await Promise.all([...this.selectedIds].map(e=>y(`/api/v1/targets/${e}`,{method:"DELETE"}))),this.selectedIds=new Set,await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async deleteResource(e,s,n){if(window.confirm(`Delete ${n}?`))try{await y(`/api/v1/${e}/${s}`,{method:"DELETE"}),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}}}function wi(t,e,s,n,i){const r=t.accepted_statuses.map(d=>d.start===d.end?d.start:`${d.start}-${d.end}`).join(","),o=t.history.slice(0,30).reverse(),a=Math.max(1,...o.map(d=>d.latency_ms)),l=new Map(n.map(d=>[d.id,d.name])),c=d=>new Date(d).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),u=d=>d>=1e3?`${(d/1e3).toFixed(d>=1e4?0:1)} s`:`${Math.round(d)} ms`;return h`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${i.backdrop}>
      <div class="dialog-head">
        ...
        <button class="button secondary icon-button dialog-close" type="button" aria-label="Close target details" title="Close" @click=${i.close}><iconify-icon .icon=${_t} aria-hidden="true"></iconify-icon></button>
      </div>
      <form @submit=${i.update} @input=${i.changed}>
        ...
        <div class="dialog-actions">
          <div class="danger-actions">
            <button class="button danger icon-button" type="button" aria-label="Delete target" title="Delete target" @click=${i.delete}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button>
            <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>i.pause(!t.paused)}><iconify-icon .icon=${t.paused?wt:$t} aria-hidden="true"></iconify-icon></button>
          </div>
          <button class="button" type="submit" aria-busy=${e?"true":"false"} ?disabled=${e||!s}>Save changes</button>
        </div>
      </form>
      <section class="history">
        <div class="history-head"><h3>Evaluation history</h3>${o.length?h`<span class="meta">Latest ${o.length}</span>`:p}</div>
        ${o.length?h`
          <div class="chart-plot">
            ...
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${u(a)}`}>
              ${o.map(d=>{const f=d.succeeded?"Passed":"Failed",x=d.status_code===null?"network error":`HTTP ${d.status_code}`,$=l.get(d.executor_node_id)??`Node ${d.executor_node_id.slice(0,8)}`,C=`${f} at ${new Date(d.recorded_at_ms).toLocaleString()}: ${d.latency_ms} ms, ${x}. Executed by ${$}`;return h`<span class="history-bar ${d.succeeded?"up":"down"}" role="listitem" aria-label=${C} title=${C} style=${`height: ${Math.max(8,d.latency_ms/a*100)}%`}></span>`})}
            </div>
          </div>
    ...
    </dialog>`}var _i=Object.getOwnPropertyDescriptor,ki=(t,e,s,n)=>{for(var i=n>1?void 0:n?_i(e,s):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(i=o(i)||i);return i};let Te=class extends $i{render(){const t=this.targets.filter(r=>r.availability==="up").length,e=this.targets.filter(r=>r.availability==="down").length,s=this.alerts.filter(r=>r.delivery==="pending").length,n=["overview","alerts","cluster"],i=this.targets.filter(r=>`${r.name} ${r.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(r=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?r.paused:r.availability===this.statusFilter).sort((r,o)=>this.sort==="status"&&r.availability.localeCompare(o.availability)||r.name.localeCompare(o.name));return this.setupMode&&this.setup?h`
      ...
      <main class="shell">
        <header>
          ...
          <nav aria-label="Primary">
            ${n.map(r=>h`<a class=${this.activeSection===r?"active":""} href=${Le[r]} @click=${o=>this.navigate(o,r)}>${r[0].toUpperCase()}${r.slice(1)}</a>`)}
          </nav>
          <div class="actions">
        ...
        ${this.error?h`<div class="notice" role="alert">${this.error}</div>`:p}
        ${this.setup?.warning&&!this.warningDismissed?h`<div class="notice" role="status">${this.setup.warning}<button class="button secondary" style="float: right; margin: -6px" @click=${this.dismissWarning}>Dismiss</button></div>`:p}
      ...
      ${this.selected?wi(this.selected,this.saving,this.detailDirty,this.cluster?.members??[],{backdrop:r=>this.dismissOnBackdrop(r),close:()=>this.closeDetailDialog(),update:r=>{this.updateTarget(r)},changed:r=>this.updateDetailDirty(r),redirects:r=>this.toggleMaxRedirects(r),delete:()=>{this.deleteTarget()},pause:r=>{this.setPaused(r)}}):p}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          <label>Name<input name="name" placeholder="On-call" required /></label>
          ${this.channelKind==="webhook"?h`<label>Webhook URL<input name="url" type="url" placeholder="https://hooks.example.com/upgrid" data-test-required required /></label>`:h`<label>Bot token<input name="bot_token" type="password" autocomplete="off" data-test-required required /></label><label>Chat ID<input name="chat_id" data-test-required required /></label>`}
          <div class="dialog-actions">${this.channelTestMessage?h`<span class="meta" role="status" style="margin-right:auto">${this.channelTestMessage}</span>`:p}<button class="button secondary" type="button" @click=${()=>this.closeDialog("channel-dialog")}>Cancel</button><button class="button secondary" type="button" aria-busy=${this.testingChannel} ?disabled=${this.testingChannel||this.saving} @click=${this.testChannel}>${this.testingChannel?"Sending…":"Send test"}</button><button class="button" type="submit" ?disabled=${this.saving||this.testingChannel}>Create channel</button></div>
        </form>
      </dialog>
    ...
    `}renderOverview(t,e,s,n){const i=this.targets.filter(a=>this.selectedIds.has(a.id)),r=i.some(a=>!a.paused),o=i.some(a=>a.paused);return h`
      ...
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?h`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${_t} aria-hidden="true"></iconify-icon></button>${r?h`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${$t} aria-hidden="true"></iconify-icon></button>`:p}${o?h`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${wt} aria-hidden="true"></iconify-icon></button>`:p}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button></div></div>`:p}
    ...
    `}renderAlertsPage(){return h`
      ...
      <section class="panel" aria-label="Notification channels">
        ...
        ${this.channels.length?this.channels.map(t=>h`<div class="resource"><div><div class="actions"><strong>${t.name}</strong><span class="badge">${t.kind}</span></div><code>${t.destination}</code></div><button class="button danger icon-button" aria-label=${`Delete channel ${t.name}`} title=${`Delete ${t.name}`} @click=${()=>this.deleteResource("channels",t.id,t.name)}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button></div>`):h`<div class="empty">No notification channels.</div>`}
      </section>
      </div>
    `}renderClusterPage(){return h`
      ...
      <section class="panel" aria-label="Cluster topology">
        ...
        ${this.cluster?.members.map(t=>h`<div class="resource"><div><strong>${t.name}</strong><code>${t.raft_url}</code></div><div class="actions">${t.local?h`<span class="badge">This node</span>`:p}${t.leader?h`<span class="badge">Leader</span>`:p}</div></div>`)}
        ${this.cluster?.members.length?p:h`<div class="empty">Cluster topology unavailable.</div>`}
      </section>
      ...
      <div class="target-wrap">
        ...
        <button class="target" aria-label=${t.name} @click=${()=>this.openTarget(t)}>
          ...
          <div class="target-side">
            ${s.length?h`<div class="mini-chart" aria-hidden="true">${s.map(r=>h`<i class="mini-bar ${r.succeeded?"up":"down"}" style=${`height: ${Math.max(12,r.latency_ms/n*100)}%`}></i>`)}</div>`:p}
            <div class="latency">
