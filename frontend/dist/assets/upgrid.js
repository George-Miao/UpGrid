(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))s(a);new MutationObserver(a=>{for(const n of a)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(a){const n={};return a.integrity&&(n.integrity=a.integrity),a.referrerPolicy&&(n.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?n.credentials="include":a.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(a){if(a.ep)return;a.ep=!0;const n=i(a);fetch(a.href,n)}})();const ue=globalThis,ze=ue.ShadowRoot&&(ue.ShadyCSS===void 0||ue.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,He=Symbol(),et=new WeakMap;let Pt=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==He)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(ze&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=et.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&et.set(i,e))}return e}toString(){return this.cssText}};const ri=t=>new Pt(typeof t=="string"?t:t+"",void 0,He),xe=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,a,n)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+t[n+1],t[0]);return new Pt(i,t,He)},oi=(t,e)=>{if(ze)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),a=ue.litNonce;a!==void 0&&s.setAttribute("nonce",a),s.textContent=i.cssText,t.appendChild(s)}},tt=ze?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return ri(i)})(t):t;const{is:li,defineProperty:ci,getOwnPropertyDescriptor:di,getOwnPropertyNames:ui,getOwnPropertySymbols:pi,getPrototypeOf:hi}=Object,$e=globalThis,it=$e.trustedTypes,gi=it?it.emptyScript:"",mi=$e.reactiveElementPolyfillSupport,Z=(t,e)=>t,me={toAttribute(t,e){switch(e){case Boolean:t=t?gi:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Je=(t,e)=>!li(t,e),st={attribute:!0,type:String,converter:me,reflect:!1,useDefault:!1,hasChanged:Je};Symbol.metadata??=Symbol("metadata"),$e.litPropertyMetadata??=new WeakMap;let z=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=st){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),a=this.getPropertyDescriptor(e,s,i);a!==void 0&&ci(this.prototype,e,a)}}static getPropertyDescriptor(e,i,s){const{get:a,set:n}=di(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:a,set(o){const r=a?.call(this);n?.call(this,o),this.requestUpdate(e,r,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??st}static _$Ei(){if(this.hasOwnProperty(Z("elementProperties")))return;const e=hi(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Z("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Z("properties"))){const i=this.properties,s=[...ui(i),...pi(i)];for(const a of s)this.createProperty(a,i[a])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,a]of i)this.elementProperties.set(s,a)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const a=this._$Eu(i,s);a!==void 0&&this._$Eh.set(a,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const a of s)i.unshift(tt(a))}else e!==void 0&&i.push(tt(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return oi(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){const s=this.constructor.elementProperties.get(e),a=this.constructor._$Eu(e,s);if(a!==void 0&&s.reflect===!0){const n=(s.converter?.toAttribute!==void 0?s.converter:me).toAttribute(i,s.type);this._$Em=e,n==null?this.removeAttribute(a):this.setAttribute(a,n),this._$Em=null}}_$AK(e,i){const s=this.constructor,a=s._$Eh.get(e);if(a!==void 0&&this._$Em!==a){const n=s.getPropertyOptions(a),o=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:me;this._$Em=a;const r=o.fromAttribute(i,n.type);this[a]=r??this._$Ej?.get(a)??r,this._$Em=null}}requestUpdate(e,i,s,a=!1,n){if(e!==void 0){const o=this.constructor;if(a===!1&&(n=this[e]),s??=o.getPropertyOptions(e),!((s.hasChanged??Je)(n,i)||s.useDefault&&s.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:a,wrapped:n},o){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??i??this[e]),n!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),a===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[a,n]of this._$Ep)this[a]=n;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[a,n]of s){const{wrapped:o}=n,r=this[a];o!==!0||this._$AL.has(a)||r===void 0||this.C(a,void 0,n,r)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};z.elementStyles=[],z.shadowRootOptions={mode:"open"},z[Z("elementProperties")]=new Map,z[Z("finalized")]=new Map,mi?.({ReactiveElement:z}),($e.reactiveElementVersions??=[]).push("2.1.2");const Be=globalThis,at=t=>t,fe=Be.trustedTypes,nt=fe?fe.createPolicy("lit-html",{createHTML:t=>t}):void 0,Et="$lit$",O=`lit$${Math.random().toFixed(9).slice(2)}$`,Dt="?"+O,fi=`<${Dt}>`,U=document,ee=()=>U.createComment(""),te=t=>t===null||typeof t!="object"&&typeof t!="function",Ge=Array.isArray,bi=t=>Ge(t)||typeof t?.[Symbol.iterator]=="function",Ae=`[ 	
\f\r]`,W=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,rt=/-->/g,ot=/>/g,j=RegExp(`>|${Ae}(?:([^\\s"'>=/]+)(${Ae}*=${Ae}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),lt=/'/g,ct=/"/g,It=/^(?:script|style|textarea|title)$/i,vi=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),c=vi(1),B=Symbol.for("lit-noChange"),f=Symbol.for("lit-nothing"),dt=new WeakMap,M=U.createTreeWalker(U,129);function Ot(t,e){if(!Ge(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return nt!==void 0?nt.createHTML(e):e}const yi=(t,e)=>{const i=t.length-1,s=[];let a,n=e===2?"<svg>":e===3?"<math>":"",o=W;for(let r=0;r<i;r++){const l=t[r];let d,u,p=-1,y=0;for(;y<l.length&&(o.lastIndex=y,u=o.exec(l),u!==null);)y=o.lastIndex,o===W?u[1]==="!--"?o=rt:u[1]!==void 0?o=ot:u[2]!==void 0?(It.test(u[2])&&(a=RegExp("</"+u[2],"g")),o=j):u[3]!==void 0&&(o=j):o===j?u[0]===">"?(o=a??W,p=-1):u[1]===void 0?p=-2:(p=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?j:u[3]==='"'?ct:lt):o===ct||o===lt?o=j:o===rt||o===ot?o=W:(o=j,a=void 0);const x=o===j&&t[r+1].startsWith("/>")?" ":"";n+=o===W?l+fi:p>=0?(s.push(d),l.slice(0,p)+Et+l.slice(p)+O+x):l+O+(p===-2?r:x)}return[Ot(t,n+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class ie{constructor({strings:e,_$litType$:i},s){let a;this.parts=[];let n=0,o=0;const r=e.length-1,l=this.parts,[d,u]=yi(e,i);if(this.el=ie.createElement(d,s),M.currentNode=this.el.content,i===2||i===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=M.nextNode())!==null&&l.length<r;){if(a.nodeType===1){if(a.hasAttributes())for(const p of a.getAttributeNames())if(p.endsWith(Et)){const y=u[o++],x=a.getAttribute(p).split(O),k=/([.?@])?(.*)/.exec(y);l.push({type:1,index:n,name:k[2],strings:x,ctor:k[1]==="."?$i:k[1]==="?"?wi:k[1]==="@"?ki:we}),a.removeAttribute(p)}else p.startsWith(O)&&(l.push({type:6,index:n}),a.removeAttribute(p));if(It.test(a.tagName)){const p=a.textContent.split(O),y=p.length-1;if(y>0){a.textContent=fe?fe.emptyScript:"";for(let x=0;x<y;x++)a.append(p[x],ee()),M.nextNode(),l.push({type:2,index:++n});a.append(p[y],ee())}}}else if(a.nodeType===8)if(a.data===Dt)l.push({type:2,index:n});else{let p=-1;for(;(p=a.data.indexOf(O,p+1))!==-1;)l.push({type:7,index:n}),p+=O.length-1}n++}}static createElement(e,i){const s=U.createElement("template");return s.innerHTML=e,s}}function G(t,e,i=t,s){if(e===B)return e;let a=s!==void 0?i._$Co?.[s]:i._$Cl;const n=te(e)?void 0:e._$litDirective$;return a?.constructor!==n&&(a?._$AO?.(!1),n===void 0?a=void 0:(a=new n(t),a._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=a:i._$Cl=a),a!==void 0&&(e=G(t,a._$AS(t,e.values),a,s)),e}class xi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,a=(e?.creationScope??U).importNode(i,!0);M.currentNode=a;let n=M.nextNode(),o=0,r=0,l=s[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new re(n,n.nextSibling,this,e):l.type===1?d=new l.ctor(n,l.name,l.strings,this,e):l.type===6&&(d=new _i(n,this,e)),this._$AV.push(d),l=s[++r]}o!==l?.index&&(n=M.nextNode(),o++)}return M.currentNode=U,a}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class re{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,a){this.type=2,this._$AH=f,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=G(this,e,i),te(e)?e===f||e==null||e===""?(this._$AH!==f&&this._$AR(),this._$AH=f):e!==this._$AH&&e!==B&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):bi(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==f&&te(this._$AH)?this._$AA.nextSibling.data=e:this.T(U.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,a=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=ie.createElement(Ot(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===a)this._$AH.p(i);else{const n=new xi(a,this),o=n.u(this.options);n.p(i),this.T(o),this._$AH=n}}_$AC(e){let i=dt.get(e.strings);return i===void 0&&dt.set(e.strings,i=new ie(e)),i}k(e){Ge(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,a=0;for(const n of e)a===i.length?i.push(s=new re(this.O(ee()),this.O(ee()),this,this.options)):s=i[a],s._$AI(n),a++;a<i.length&&(this._$AR(s&&s._$AB.nextSibling,a),i.length=a)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=at(e).nextSibling;at(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class we{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,a,n){this.type=1,this._$AH=f,this._$AN=void 0,this.element=e,this.name=i,this._$AM=a,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=f}_$AI(e,i=this,s,a){const n=this.strings;let o=!1;if(n===void 0)e=G(this,e,i,0),o=!te(e)||e!==this._$AH&&e!==B,o&&(this._$AH=e);else{const r=e;let l,d;for(e=n[0],l=0;l<n.length-1;l++)d=G(this,r[s+l],i,l),d===B&&(d=this._$AH[l]),o||=!te(d)||d!==this._$AH[l],d===f?e=f:e!==f&&(e+=(d??"")+n[l+1]),this._$AH[l]=d}o&&!a&&this.j(e)}j(e){e===f?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class $i extends we{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===f?void 0:e}}class wi extends we{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==f)}}class ki extends we{constructor(e,i,s,a,n){super(e,i,s,a,n),this.type=5}_$AI(e,i=this){if((e=G(this,e,i,0)??f)===B)return;const s=this._$AH,a=e===f&&s!==f||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,n=e!==f&&(s===f||a);a&&this.element.removeEventListener(this.name,this,s),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class _i{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){G(this,e)}}const Si=Be.litHtmlPolyfillSupport;Si?.(ie,re),(Be.litHtmlVersions??=[]).push("3.3.3");const Ti=(t,e,i)=>{const s=i?.renderBefore??e;let a=s._$litPart$;if(a===void 0){const n=i?.renderBefore??null;s._$litPart$=a=new re(e.insertBefore(ee(),n),n,void 0,i??{})}return a._$AI(t),a};const Ve=globalThis;class L extends z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ti(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return B}}L._$litElement$=!0,L.finalized=!0,Ve.litElementHydrateSupport?.({LitElement:L});const Ai=Ve.litElementPolyfillSupport;Ai?.({LitElement:L});(Ve.litElementVersions??=[]).push("4.2.2");const Ke=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const Ci={attribute:!0,type:String,converter:me,reflect:!1,hasChanged:Je},Pi=(t=Ci,e,i)=>{const{kind:s,metadata:a}=i;let n=globalThis.litPropertyMetadata.get(a);if(n===void 0&&globalThis.litPropertyMetadata.set(a,n=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),n.set(i.name,t),s==="accessor"){const{name:o}=i;return{set(r){const l=e.get.call(this);e.set.call(this,r),this.requestUpdate(o,l,t,!0,r)},init(r){return r!==void 0&&this.C(o,void 0,t,r),r}}}if(s==="setter"){const{name:o}=i;return function(r){const l=this[o];e.call(this,r),this.requestUpdate(o,l,t,!0,r)}}throw Error("Unsupported decorator location: "+s)};function ke(t){return(e,i)=>typeof i=="object"?Pi(t,e,i):((s,a,n)=>{const o=a.hasOwnProperty(n);return a.constructor.createProperty(n,s),o?Object.getOwnPropertyDescriptor(a,n):void 0})(t,e,i)}function m(t){return ke({...t,state:!0,attribute:!1})}const Nt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},jt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},se={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},Rt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'},Ei={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></g>'};const Mt=Object.freeze({left:0,top:0,width:16,height:16}),be=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),oe=Object.freeze({...Mt,...be}),Oe=Object.freeze({...oe,body:"",hidden:!1}),Di=Object.freeze({width:null,height:null}),Lt=Object.freeze({...Di,...be});function Ii(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function s(a){for(;a<0;)a+=4;return a%4}if(i===""){const a=parseInt(t);return isNaN(a)?0:s(a)}else if(i!==t){let a=0;switch(i){case"%":a=25;break;case"deg":a=90}if(a){let n=parseFloat(t.slice(0,t.length-i.length));return isNaN(n)?0:(n=n/a,n%1===0?s(n):0)}}return e}const Oi=/[\s,]+/;function Ni(t,e){e.split(Oi).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Ut={...Lt,preserveAspectRatio:""};function ut(t){const e={...Ut},i=(s,a)=>t.getAttribute(s)||a;return e.width=i("width",null),e.height=i("height",null),e.rotate=Ii(i("rotate","")),Ni(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function ji(t,e){for(const i in Ut)if(t[i]!==e[i])return!0;return!1}const qt=/^[a-z0-9]+(-[a-z0-9]+)*$/,le=(t,e,i,s="")=>{const a=t.split(":");if(t.slice(0,1)==="@"){if(a.length<2||a.length>3)return null;s=a.shift().slice(1)}if(a.length>3||!a.length)return null;if(a.length>1){const r=a.pop(),l=a.pop(),d={provider:a.length>0?a[0]:s,prefix:l,name:r};return e&&!pe(d)?null:d}const n=a[0],o=n.split("-");if(o.length>1){const r={provider:s,prefix:o.shift(),name:o.join("-")};return e&&!pe(r)?null:r}if(i&&s===""){const r={provider:s,prefix:"",name:n};return e&&!pe(r,i)?null:r}return null},pe=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function Ri(t,e){const i=t.icons,s=t.aliases||Object.create(null),a=Object.create(null);function n(o){if(i[o])return a[o]=[];if(!(o in a)){a[o]=null;const r=s[o]&&s[o].parent,l=r&&n(r);l&&(a[o]=[r].concat(l))}return a[o]}return Object.keys(i).concat(Object.keys(s)).forEach(n),a}function Mi(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const s=((t.rotate||0)+(e.rotate||0))%4;return s&&(i.rotate=s),i}function pt(t,e){const i=Mi(t,e);for(const s in Oe)s in be?s in t&&!(s in i)&&(i[s]=be[s]):s in e?i[s]=e[s]:s in t&&(i[s]=t[s]);return i}function Li(t,e,i){const s=t.icons,a=t.aliases||Object.create(null);let n={};function o(r){n=pt(s[r]||a[r],n)}return o(e),i.forEach(o),pt(t,n)}function Ft(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(a=>{e(a,null),i.push(a)});const s=Ri(t);for(const a in s){const n=s[a];n&&(e(a,Li(t,a,n)),i.push(a))}return i}const Ui={provider:"",aliases:{},not_found:{},...Mt};function Ce(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function zt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!Ce(t,Ui))return null;const i=e.icons;for(const a in i){const n=i[a];if(!a||typeof n.body!="string"||!Ce(n,Oe))return null}const s=e.aliases||Object.create(null);for(const a in s){const n=s[a],o=n.parent;if(!a||typeof o!="string"||!i[o]&&!s[o]||!Ce(n,Oe))return null}return e}const ve=Object.create(null);function qi(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function D(t,e){const i=ve[t]||(ve[t]=Object.create(null));return i[e]||(i[e]=qi(t,e))}function Ht(t,e){return zt(e)?Ft(e,(i,s)=>{s?t.icons[i]=s:t.missing.add(i)}):[]}function Fi(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function zi(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(ve)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(ve[s]||{})).forEach(a=>{const n=D(s,a);i=i.concat(Object.keys(n.icons).map(o=>(s!==""?"@"+s+":":"")+a+":"+o))})}),i}let ae=!1;function Jt(t){return typeof t=="boolean"&&(ae=t),ae}function ne(t){const e=typeof t=="string"?le(t,!0,ae):t;if(e){const i=D(e.provider,e.prefix),s=e.name;return i.icons[s]||(i.missing.has(s)?null:void 0)}}function Bt(t,e){const i=le(t,!0,ae);if(!i)return!1;const s=D(i.provider,i.prefix);return e?Fi(s,i.name,e):(s.missing.add(i.name),!0)}function ht(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),ae&&!e&&!t.prefix){let s=!1;return zt(t)&&(t.prefix="",Ft(t,(a,n)=>{Bt(a,n)&&(s=!0)})),s}const i=t.prefix;return pe({prefix:i,name:"a"})?!!Ht(D(e,i),t):!1}function Hi(t){return!!ne(t)}function Ji(t){const e=ne(t);return e&&{...oe,...e}}function Gt(t,e){t.forEach(i=>{const s=i.loaderCallbacks;s&&(i.loaderCallbacks=s.filter(a=>a.id!==e))})}function Bi(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const s=t.provider,a=t.prefix;e.forEach(n=>{const o=n.icons,r=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==a)return!0;const d=l.name;if(t.icons[d])o.loaded.push({provider:s,prefix:a,name:d});else if(t.missing.has(d))o.missing.push({provider:s,prefix:a,name:d});else return i=!0,!0;return!1}),o.pending.length!==r&&(i||Gt([t],n.id),n.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),n.abort))})}))}let Gi=0;function Vi(t,e,i){const s=Gi++,a=Gt.bind(null,i,s);if(!e.pending.length)return a;const n={id:s,icons:e,callback:t,abort:a};return i.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(n)}),a}function Ki(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((a,n)=>a.provider!==n.provider?a.provider.localeCompare(n.provider):a.prefix!==n.prefix?a.prefix.localeCompare(n.prefix):a.name.localeCompare(n.name));let s={provider:"",prefix:"",name:""};return t.forEach(a=>{if(s.name===a.name&&s.prefix===a.prefix&&s.provider===a.provider)return;s=a;const n=a.provider,o=a.prefix,r=a.name,l=i[n]||(i[n]=Object.create(null)),d=l[o]||(l[o]=D(n,o));let u;r in d.icons?u=e.loaded:o===""||d.missing.has(r)?u=e.missing:u=e.pending;const p={provider:n,prefix:o,name:r};u.push(p)}),e}const Ne=Object.create(null);function gt(t,e){Ne[t]=e}function je(t){return Ne[t]||Ne[""]}function Wi(t,e=!0,i=!1){const s=[];return t.forEach(a=>{const n=typeof a=="string"?le(a,e,i):a;n&&s.push(n)}),s}function We(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const _e=Object.create(null),Q=["https://api.simplesvg.com","https://api.unisvg.com"],he=[];for(;Q.length>0;)Q.length===1||Math.random()>.5?he.push(Q.shift()):he.push(Q.pop());_e[""]=We({resources:["https://api.iconify.design"].concat(he)});function mt(t,e){const i=We(e);return i===null?!1:(_e[t]=i,!0)}function Se(t){return _e[t]}function Qi(){return Object.keys(_e)}const Yi={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Zi(t,e,i,s){const a=t.resources.length,n=t.random?Math.floor(Math.random()*a):t.index;let o;if(t.random){let $=t.resources.slice(0);for(o=[];$.length>1;){const S=Math.floor(Math.random()*$.length);o.push($[S]),$=$.slice(0,S).concat($.slice(S+1))}o=o.concat($)}else o=t.resources.slice(n).concat(t.resources.slice(0,n));const r=Date.now();let l="pending",d=0,u,p=null,y=[],x=[];typeof s=="function"&&x.push(s);function k(){p&&(clearTimeout(p),p=null)}function C(){l==="pending"&&(l="aborted"),k(),y.forEach($=>{$.status==="pending"&&($.status="aborted")}),y=[]}function w($,S){S&&(x=[]),typeof $=="function"&&x.push($)}function K(){return{startTime:r,payload:e,status:l,queriesSent:d,queriesPending:y.length,subscribe:w,abort:C}}function P(){l="failed",x.forEach($=>{$(void 0,u)})}function T(){y.forEach($=>{$.status==="pending"&&($.status="aborted")}),y=[]}function _($,S,I){const A=S!=="success";switch(y=y.filter(g=>g!==$),l){case"pending":break;case"failed":if(A||!t.dataAfterTimeout)return;break;default:return}if(S==="abort"){u=I,P();return}if(A){u=I,y.length||(o.length?F():P());return}if(k(),T(),!t.random){const g=t.resources.indexOf($.resource);g!==-1&&g!==t.index&&(t.index=g)}l="completed",x.forEach(g=>{g(I)})}function F(){if(l!=="pending")return;k();const $=o.shift();if($===void 0){if(y.length){p=setTimeout(()=>{k(),l==="pending"&&(T(),P())},t.timeout);return}P();return}const S={status:"pending",resource:$,callback:(I,A)=>{_(S,I,A)}};y.push(S),d++,p=setTimeout(F,t.rotate),i($,e,S.callback)}return setTimeout(F),K}function Vt(t){const e={...Yi,...t};let i=[];function s(){i=i.filter(o=>o().status==="pending")}function a(o,r,l){const d=Zi(e,o,r,(u,p)=>{s(),l&&l(u,p)});return i.push(d),d}function n(o){return i.find(r=>o(r))||null}return{query:a,find:n,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:s}}function ft(){}const Pe=Object.create(null);function Xi(t){if(!Pe[t]){const e=Se(t);if(!e)return;Pe[t]={config:e,redundancy:Vt(e)}}return Pe[t]}function Kt(t,e,i){let s,a;if(typeof t=="string"){const n=je(t);if(!n)return i(void 0,424),ft;a=n.send;const o=Xi(t);o&&(s=o.redundancy)}else{const n=We(t);if(n){s=Vt(n);const o=je(t.resources?t.resources[0]:"");o&&(a=o.send)}}return!s||!a?(i(void 0,424),ft):s.query(e,a,i)().abort}function bt(){}function es(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Bi(t)}))}function ts(t){const e=[],i=[];return t.forEach(s=>{(s.match(qt)?e:i).push(s)}),{valid:e,invalid:i}}function Y(t,e,i){function s(){const a=t.pendingIcons;e.forEach(n=>{a&&a.delete(n),t.icons[n]||t.missing.add(n)})}if(i&&typeof i=="object")try{if(!Ht(t,i).length){s();return}}catch(a){console.error(a)}s(),es(t)}function vt(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function is(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:s}=t,a=t.iconsToLoad;if(delete t.iconsToLoad,!a||!a.length)return;const n=t.loadIcon;if(t.loadIcons&&(a.length>1||!n)){vt(t.loadIcons(a,s,i),d=>{Y(t,a,d)});return}if(n){a.forEach(d=>{vt(n(d,s,i),u=>{Y(t,[d],u?{prefix:s,icons:{[d]:u}}:null)})});return}const{valid:o,invalid:r}=ts(a);if(r.length&&Y(t,r,null),!o.length)return;const l=s.match(qt)?je(i):null;if(!l){Y(t,o,null);return}l.prepare(i,s,o).forEach(d=>{Kt(i,d,u=>{Y(t,d.icons,u)})})}))}const Qe=(t,e)=>{const i=Ki(Wi(t,!0,Jt()));if(!i.pending.length){let r=!0;return e&&setTimeout(()=>{r&&e(i.loaded,i.missing,i.pending,bt)}),()=>{r=!1}}const s=Object.create(null),a=[];let n,o;return i.pending.forEach(r=>{const{provider:l,prefix:d}=r;if(d===o&&l===n)return;n=l,o=d,a.push(D(l,d));const u=s[l]||(s[l]=Object.create(null));u[d]||(u[d]=[])}),i.pending.forEach(r=>{const{provider:l,prefix:d,name:u}=r,p=D(l,d),y=p.pendingIcons||(p.pendingIcons=new Set);y.has(u)||(y.add(u),s[l][d].push(u))}),a.forEach(r=>{const l=s[r.provider][r.prefix];l.length&&is(r,l)}),e?Vi(e,i,a):bt},ss=t=>new Promise((e,i)=>{const s=typeof t=="string"?le(t,!0):t;if(!s){i(t);return}Qe([s||t],a=>{if(a.length&&s){const n=ne(s);if(n){e({...oe,...n});return}}i(t)})});function yt(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function as(t,e){if(typeof t=="object")return{data:yt(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const n=yt(t);if(n)return{data:n,value:t}}const i=le(t,!0,!0);if(!i)return{value:t};const s=ne(i);if(s!==void 0||!i.prefix)return{value:t,name:i,data:s};const a=Qe([i],()=>e(t,i,ne(i)));return{value:t,name:i,loading:a}}let Wt=!1;try{Wt=navigator.vendor.indexOf("Apple")===0}catch{}function ns(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Wt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const rs=/(-?[0-9.]*[0-9]+[0-9.]*)/g,os=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Re(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const s=t.split(rs);if(s===null||!s.length)return t;const a=[];let n=s.shift(),o=os.test(n);for(;;){if(o){const r=parseFloat(n);isNaN(r)?a.push(n):a.push(Math.ceil(r*e*i)/i)}else a.push(n);if(n=s.shift(),n===void 0)return a.join("");o=!o}}function ls(t,e="defs"){let i="";const s=t.indexOf("<"+e);for(;s>=0;){const a=t.indexOf(">",s),n=t.indexOf("</"+e);if(a===-1||n===-1)break;const o=t.indexOf(">",n);if(o===-1)break;i+=t.slice(a+1,n).trim(),t=t.slice(0,s).trim()+t.slice(o+1)}return{defs:i,content:t}}function cs(t,e){return t?"<defs>"+t+"</defs>"+e:e}function ds(t,e,i){const s=ls(t);return cs(s.defs,e+s.content+i)}const us=t=>t==="unset"||t==="undefined"||t==="none";function Qt(t,e){const i={...oe,...t},s={...Lt,...e},a={left:i.left,top:i.top,width:i.width,height:i.height};let n=i.body;[i,s].forEach(C=>{const w=[],K=C.hFlip,P=C.vFlip;let T=C.rotate;K?P?T+=2:(w.push("translate("+(a.width+a.left).toString()+" "+(0-a.top).toString()+")"),w.push("scale(-1 1)"),a.top=a.left=0):P&&(w.push("translate("+(0-a.left).toString()+" "+(a.height+a.top).toString()+")"),w.push("scale(1 -1)"),a.top=a.left=0);let _;switch(T<0&&(T-=Math.floor(T/4)*4),T=T%4,T){case 1:_=a.height/2+a.top,w.unshift("rotate(90 "+_.toString()+" "+_.toString()+")");break;case 2:w.unshift("rotate(180 "+(a.width/2+a.left).toString()+" "+(a.height/2+a.top).toString()+")");break;case 3:_=a.width/2+a.left,w.unshift("rotate(-90 "+_.toString()+" "+_.toString()+")");break}T%2===1&&(a.left!==a.top&&(_=a.left,a.left=a.top,a.top=_),a.width!==a.height&&(_=a.width,a.width=a.height,a.height=_)),w.length&&(n=ds(n,'<g transform="'+w.join(" ")+'">',"</g>"))});const o=s.width,r=s.height,l=a.width,d=a.height;let u,p;o===null?(p=r===null?"1em":r==="auto"?d:r,u=Re(p,l/d)):(u=o==="auto"?l:o,p=r===null?Re(u,d/l):r==="auto"?d:r);const y={},x=(C,w)=>{us(w)||(y[C]=w.toString())};x("width",u),x("height",p);const k=[a.left,a.top,l,d];return y.viewBox=k.join(" "),{attributes:y,viewBox:k,body:n}}function Ye(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)i+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function ps(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function hs(t){return"data:image/svg+xml,"+ps(t)}function Yt(t){return'url("'+hs(t)+'")'}const gs=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let ye=gs();function ms(t){ye=t}function fs(){return ye}function bs(t,e){const i=Se(t);if(!i)return 0;let s;if(!i.maxURL)s=0;else{let a=0;i.resources.forEach(o=>{a=Math.max(a,o.length)});const n=e+".json?icons=";s=i.maxURL-a-i.path.length-n.length}return s}function vs(t){return t===404}const ys=(t,e,i)=>{const s=[],a=bs(t,e),n="icons";let o={type:n,provider:t,prefix:e,icons:[]},r=0;return i.forEach((l,d)=>{r+=l.length+1,r>=a&&d>0&&(s.push(o),o={type:n,provider:t,prefix:e,icons:[]},r=l.length),o.icons.push(l)}),s.push(o),s};function xs(t){if(typeof t=="string"){const e=Se(t);if(e)return e.path}return"/"}const $s=(t,e,i)=>{if(!ye){i("abort",424);return}let s=xs(e.provider);switch(e.type){case"icons":{const n=e.prefix,o=e.icons.join(","),r=new URLSearchParams({icons:o});s+=n+".json?"+r.toString();break}case"custom":{const n=e.uri;s+=n.slice(0,1)==="/"?n.slice(1):n;break}default:i("abort",400);return}let a=503;ye(t+s).then(n=>{const o=n.status;if(o!==200){setTimeout(()=>{i(vs(o)?"abort":"next",o)});return}return a=501,n.json()}).then(n=>{if(typeof n!="object"||n===null){setTimeout(()=>{n===404?i("abort",n):i("next",a)});return}setTimeout(()=>{i("success",n)})}).catch(()=>{i("next",a)})},ws={prepare:ys,send:$s};function ks(t,e,i){D(i||"",e).loadIcons=t}function _s(t,e,i){D(i||"",e).loadIcon=t}const Ee="data-style";let Zt="";function Ss(t){Zt=t}function xt(t,e){let i=Array.from(t.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Ee));i||(i=document.createElement("style"),i.setAttribute(Ee,Ee),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Zt}function Xt(){gt("",ws),Jt(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(a=>{try{(typeof a!="object"||a===null||a instanceof Array||typeof a.icons!="object"||typeof a.prefix!="string"||!ht(a))&&console.error(s)}catch{console.error(s)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const s in i){const a="IconifyProviders["+s+"] is invalid.";try{const n=i[s];if(typeof n!="object"||!n||n.resources===void 0)continue;mt(s,n)||console.error(a)}catch{console.error(a)}}}}return{iconLoaded:Hi,getIcon:Ji,listIcons:zi,addIcon:Bt,addCollection:ht,calculateSize:Re,buildIcon:Qt,iconToHTML:Ye,svgToURL:Yt,loadIcons:Qe,loadIcon:ss,addAPIProvider:mt,setCustomIconLoader:_s,setCustomIconsLoader:ks,appendCustomStyle:Ss,_api:{getAPIConfig:Se,setAPIModule:gt,sendAPIQuery:Kt,setFetch:ms,getFetch:fs,listAPIProviders:Qi}}}const Me={"background-color":"currentColor"},ei={"background-color":"transparent"},$t={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},wt={"-webkit-mask":Me,mask:Me,background:ei};for(const t in wt){const e=wt[t];for(const i in $t)e[t+"-"+i]=$t[i]}function kt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function Ts(t,e,i){const s=document.createElement("span");let a=t.body;a.indexOf("<a")!==-1&&(a+="<!-- "+Date.now()+" -->");const n=t.attributes,o=Ye(a,{...n,width:e.width+"",height:e.height+""}),r=Yt(o),l=s.style,d={"--svg":r,width:kt(n.width),height:kt(n.height),...i?Me:ei};for(const u in d)l.setProperty(u,d[u]);return s}let X;function As(){try{X=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{X=null}}function Cs(t){return X===void 0&&As(),X?X.createHTML(t):t}function Ps(t){const e=document.createElement("span"),i=t.attributes;let s="";i.width||(s="width: inherit;"),i.height||(s+="height: inherit;"),s&&(i.style=s);const a=Ye(t.body,i);return e.innerHTML=Cs(a),e.firstChild}function Le(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function _t(t,e){const i=e.icon.data,s=e.customisations,a=Qt(i,s);s.preserveAspectRatio&&(a.attributes.preserveAspectRatio=s.preserveAspectRatio);const n=e.renderedMode;let o;n==="svg"?o=Ps(a):o=Ts(a,{...oe,...i},n==="mask");const r=Le(t);r?o.tagName==="SPAN"&&r.tagName===o.tagName?r.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,r):t.appendChild(o)}function St(t,e,i){const s=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:s}}function Es(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const s=e.get(t);if(s)return s;const a=["icon","mode","inline","noobserver","width","height","rotate","flip"],n=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const r=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");xt(r,l),this._state=St({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return a.slice(0)}attributeChangedCallback(r){switch(r){case"inline":{const l=this.hasAttribute("inline"),d=this._state;l!==d.inline&&(d.inline=l,xt(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const r=this.getAttribute("icon");if(r&&r.slice(0,1)==="{")try{return JSON.parse(r)}catch{}return r}set icon(r){typeof r=="object"&&(r=JSON.stringify(r)),this.setAttribute("icon",r)}get inline(){return this.hasAttribute("inline")}set inline(r){r?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(r){r?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const r=this._state;if(r.rendered){const l=this._shadowRoot;if(r.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}_t(l,r)}}get status(){const r=this._state;return r.rendered?"rendered":r.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const r=this._state,l=this.getAttribute("icon");if(l!==r.icon.value){this._iconChanged(l);return}if(!r.rendered||!this._visible)return;const d=this.getAttribute("mode"),u=ut(this);(r.attrMode!==d||ji(r.customisations,u)||!Le(this._shadowRoot))&&this._renderIcon(r.icon,u,d)}_iconChanged(r){const l=as(r,(d,u,p)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==d)return;const x={value:d,name:u,data:p};x.data?this._gotIconData(x):y.icon=x});l.data?this._gotIconData(l):this._state=St(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const r=Le(this._shadowRoot);r&&this._shadowRoot.removeChild(r);return}this._queueCheck()}_gotIconData(r){this._checkQueued=!1,this._renderIcon(r,ut(this),this.getAttribute("mode"))}_renderIcon(r,l,d){const u=ns(r.data.body,d),p=this._state.inline;_t(this._shadowRoot,this._state={rendered:!0,icon:r,inline:p,customisations:l,attrMode:d,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(r=>{const l=r.some(d=>d.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};a.forEach(r=>{r in n.prototype||Object.defineProperty(n.prototype,r,{get:function(){return this.getAttribute(r)},set:function(l){l!==null?this.setAttribute(r,l):this.removeAttribute(r)}})});const o=Xt();for(const r in o)n[r]=n.prototype[r]=o[r];return e.define(t,n),n}const Ds=Es()||Xt(),{iconLoaded:pa,getIcon:ha,listIcons:ga,addIcon:ma,addCollection:fa,calculateSize:ba,buildIcon:va,iconToHTML:ya,svgToURL:xa,loadIcons:$a,loadIcon:wa,setCustomIconLoader:ka,setCustomIconsLoader:_a,addAPIProvider:Sa,_api:Ta}=Ds;class H extends Error{constructor(e,i){super(i),this.status=e,this.name="ApiRequestError"}}async function h(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:i.statusText}));throw new H(i.status,s.error||i.statusText)}return i.status===204?void 0:i.json()}function Ue(t,e,i=!1){if(e==="telegram"){const s=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!s?void 0:s,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const s=String(t.get("username")??""),a=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:s||void 0,password:a||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function qe(t,e=[],i=!0,s=String(t.get("kind")??"http"),a=[]){const n=String(t.get("url")),o=s==="http"?n:`${s}://${n.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:s,url:o,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),locations:Number(t.get("locations")??1),headers:{},body:null,assertions:a,skip_tls_verification:!1,tls_ca_secret_id:De(t,"tls_ca_secret_id"),tls_client_certificate_secret_id:De(t,"tls_client_certificate_secret_id"),tls_client_private_key_secret_id:De(t,"tls_client_private_key_secret_id"),notification_channel_ids:e,use_default_channels:i}}function De(t,e){return String(t.get(e)??"")||null}var Is=Object.defineProperty,Os=Object.getOwnPropertyDescriptor,V=(t,e,i,s)=>{for(var a=s>1?void 0:s?Os(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Is(e,i,a),a};let N=class extends L{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await h("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){if(t.preventDefault(),!window.confirm("Create a new single-Node Cluster?"))return;const e=new FormData(t.currentTarget),i=String(e.get("admin_username")??"").trim(),s=String(e.get("admin_password")??"");await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName(),admin_username:i,admin_password:s},{username:i,password:s})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e,i){this.saving=!0,this.error="";try{await h(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster(i)}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(t){for(let e=0;e<120;e+=1){const{promise:i,resolve:s}=Promise.withResolvers();window.setTimeout(s,250),await i;try{t&&await h("/api/v1/auth/login",{method:"POST",body:JSON.stringify(t)});const a=await h("/api/v1/setup");if(a.cluster_ready){this.changed(a);return}}catch(a){if(!t&&a instanceof H&&a.status===401){window.location.assign("/");return}}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Ue(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=qe(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await h(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await h("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return c`<section class="flow" aria-label="UpGrid setup">
  ...
  `;V([ke({attribute:!1})],N.prototype,"setup",2);V([m()],N.prototype,"channelKind",2);V([m()],N.prototype,"channels",2);V([m()],N.prototype,"saving",2);V([m()],N.prototype,"error",2);N=V([Ke("upgrid-setup")],N);var Ns=Object.defineProperty,js=Object.getOwnPropertyDescriptor,Te=(t,e,i,s)=>{for(var a=s>1?void 0:s?js(e,i):e,n=t.length-1,o;n>=0;n--)(o=t[n])&&(a=(s?o(e,i,a):o(a))||a);return s&&a&&Ns(e,i,a),a};const Rs={body_contains:"Body contains",body_regex:"Body regex",json_path:"JSONPath",response_header:"Response header",latency:"Latency threshold",script:"Script"};let q=class extends L{constructor(){super(...arguments),this.assertions=[],this.targetId="new",this.draft=[],this.loadedTarget="",this.internals=this.attachInternals()}get value(){return structuredClone(this.draft)}willUpdate(t){t.has("targetId")&&this.loadedTarget!==this.targetId&&(this.loadedTarget=this.targetId,this.draft=structuredClone(this.assertions))}updated(){this.internals.setFormValue(JSON.stringify(this.draft))}formResetCallback(){this.draft=structuredClone(this.assertions),this.internals.setFormValue(JSON.stringify(this.draft))}add(){this.draft=[...this.draft,Tt("body_contains")],this.changed()}removeAssertion(t){this.draft=this.draft.filter((e,i)=>i!==t),this.changed()}move(t,e){const i=t+e;if(i<0||i>=this.draft.length)return;const s=[...this.draft];[s[t],s[i]]=[s[i],s[t]],this.draft=s,this.changed()}setKind(t,e){const i=e.currentTarget.value;this.replace(t,Tt(i))}set(t,e,i){const s=i.currentTarget,a={...this.draft[t],[e]:e==="max_ms"?Number(s.value):s.value||null};this.replace(t,a)}replace(t,e){this.draft=this.draft.map((i,s)=>s===t?e:i),this.changed()}changed(){this.internals.setFormValue(JSON.stringify(this.draft)),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}render(){return c`
    ...
    `}renderAssertion(t,e){return c`
      <div class="assertion">
        <label>Type<select aria-label=${`Assertion ${e+1} type`} .value=${t.kind} @change=${i=>this.setKind(e,i)}>${Object.entries(Rs).map(([i,s])=>c`<option value=${i}>${s}</option>`)}</select></label>
        ...
        ${i.length?i.map(r=>c`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  ...
                  <button class="button danger icon-button" aria-label=${`Delete channel ${r.name}`} title=${`Delete ${r.name}`} @click=${()=>n.remove(r)}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button>
                </div>
              </div>
            `):c`<div class="empty">No notification channels.</div>`}
      </section>
    </div>
  `}function Vs(t,e,i){return c`
    ...
    </main>`}function Ks(t,e,i){return t?c`
      ...
      <section class="panel" aria-label="Operator Identities">
        ...
        ${t.map(n=>c`
            <div class="resource user-resource">
              ...
              <button class="button danger icon-button" type="button" aria-label=${`Delete user ${n.username}`} title=${`Delete ${n.username}`} ?disabled=${n.id===e||s} @click=${()=>a.deleteIdentity(n)}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button>
            </div>`)}
      </section>
    </div>
    ...
    ${i?c`
          ...
          </dialog>`:f}`}function Qs(t,e,i,s){return c`
    <div class="admin-page">
    ...
    </dialog>`}function Ys(t,e,i){return c`
    <div class="admin-page">
    ...
    </div>`}const Zs={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},Xs=xe`
...
`;function J(t,e,i){return c`
  ...
  `}function ea(t,e){return t==="webhook"?c`<label
    ...
    /></label>`:t==="telegram"?c`
      <label
        ><span class="title-with-help"
          >Bot token
          ${J("telegram-token-help","About Telegram bot token storage",e?"Get a replacement token from Telegram's @BotFather. Leave this blank to keep the automatically managed Secret, or enter the replacement token.":"Get a bot token from Telegram's @BotFather. Creating the Channel encrypts it as an automatically managed Secret. Test sends use the entered value without storing it.")}</span
        ><input
          name="bot_token"
          type="password"
          autocomplete="off"
    ...
    <div class="form-field">
      <div class="title-with-help">
        ...
        ${J("smtp-password-help","About SMTP password storage",e?"Leave this blank to keep the automatically managed Secret. Clear the username to disable authentication.":"Enter a username and password together to enable authentication. The password is encrypted as an automatically managed Secret.")}
      </div>
      <input
        id="smtp-password"
        name="password"
    ...
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${ta} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${ia} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function ti(t,e=[],i=!0){return c`
    ...
    </div>`}function sa(t,e=null,i=null,s=null){const a=n=>c`
  ...
  `}const ii={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Ze(t,e){t.querySelectorAll("[role='tab']").forEach(i=>{const s=i.dataset.tab===e;i.setAttribute("aria-selected",String(s)),i.tabIndex=s?0:-1}),t.querySelectorAll("[role='tabpanel']").forEach(i=>{i.hidden=i.dataset.panel!==e})}function si(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=ii[e],i.type=e==="http"?"url":"text"),t.querySelectorAll("[data-http-only]").forEach(o=>{o.hidden=e!=="http"});const s=t.querySelector("[role='tab'][aria-selected='true']")?.dataset.tab??"general",a=t.querySelector("[data-tab='assertions']");a&&(a.disabled=e!=="http"),Ze(t,e!=="http"&&s==="assertions"?"general":s);const n=t.elements.namedItem("method");n&&(n.disabled=e!=="http",n.disabled&&(n.value="GET"))}function aa(t){const e=t.currentTarget;e.form&&si(e.form,e.value)}function de(t){const e=t.currentTarget;e.form&&e.dataset.tab&&Ze(e.form,e.dataset.tab)}function na(t){const e=t.currentTarget;queueMicrotask(()=>{si(e,"http"),Ze(e,"general")})}function ra(t,e,i){return c`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${i.backdrop}>
      ...
      <form id="target-form" @submit=${i.create} @reset=${na}>
        <section id="target-general-panel" class="target-tab-panel" role="tabpanel" data-panel="general" aria-labelledby="target-general-tab">
          ...
          <div class="row">
            <label>Type<select name="kind" @change=${aa}><option value="http">HTTP</option><option value="tcp">TCP connect</option><option value="dns">DNS resolution</option><option value="icmp">ICMP echo</option><option value="tls">TLS certificate</option></select></label>
            <label>URL / endpoint<input name="url" type="url" placeholder=${ii.http} required /></label>
          </div>
    ...
    </dialog>`}function oa(t,e,i,s,a,n,o,r,l,d){const u=t.kind==="node",p=t.kind==="http",y=t.accepted_statuses.map(g=>g.start===g.end?g.start:`${g.start}-${g.end}`).join(","),x=t.history.slice(0,30).reverse(),k=Math.max(1,...x.map(g=>g.latency_ms)),C=e?.items??[],w=C.reduce((g,E)=>g+E.samples,0),K=C.reduce((g,E)=>g+E.successes,0),P=C.reduce((g,E)=>g+E.latency_total_ms,0),T=w?`${(K/w*100).toFixed(2)}%`:"—",_=new Map(o.map(g=>[g.id,g.name])),F=g=>new Date(g).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),$=g=>g>=1e3?`${(g/1e3).toFixed(g>=1e4?0:1)} s`:`${Math.round(g)} ms`,S=w?$(P/w):"—",I=[{id:"details",label:"Details"},{id:"general",label:"General"},...p?[{id:"assertions",label:"Assertions"}]:[],...u?[]:[{id:"evaluation",label:"Evaluation"},{id:"notifications",label:"Notifications"}]],A=I.some(({id:g})=>g===n)?n:"details";return c`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${d.backdrop}>
      ...
      <form id="detail-form" class="detail-form" @submit=${d.update} @input=${d.changed}>
        <section id="target-details-panel" class="target-tab-panel details-panel" role="tabpanel" aria-label="Details" ?hidden=${A!=="details"}>
          <section class="history">
            ...
            ${i?c`<p class="meta">Loading long-term history…</p>`:w?c`
                    <div class="history-summary" aria-label="Long-term evaluation summary">
                      ...
                      <div><span>Evaluations</span><strong>${w.toLocaleString()}</strong></div>
                    </div>
            ...
            ${x.length?c`
              <div class="chart-plot">
                ...
                <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${$(k)}`}>
                  ${x.map(g=>{const E=g.succeeded?"Passed":"Failed",ai=u||!p?g.succeeded?"reachable":"unreachable":g.status_code===null?"network error":`HTTP ${g.status_code}`,ni=_.get(g.executor_node_id)??`Node ${g.executor_node_id.slice(0,8)}`,Xe=`${E} at ${new Date(g.recorded_at_ms).toLocaleString()}: ${g.latency_ms} ms, ${ai}. Executed by ${ni}`;return c`<span class="history-bar ${g.succeeded?"up":"down"}" role="listitem" aria-label=${Xe} title=${Xe} style=${`height: ${Math.max(8,g.latency_ms/k*100)}%`}></span>`})}
                </div>
              </div>
              <div class="chart-axis"><span>${F(x[0].recorded_at_ms)}</span><span>${F(x[x.length-1].recorded_at_ms)}</span></div>
        ...
        <section id="target-general-panel" class="target-tab-panel" role="tabpanel" aria-label="General" ?hidden=${A!=="general"}>
          ...
          ${u?c`<label>RPC URL<input .value=${t.url} disabled /></label>`:c`
                ...
                ${p?c`
                      ...
                      ${sa(l,t.tls_ca_secret_id,t.tls_client_certificate_secret_id,t.tls_client_private_key_secret_id)}
                    `:f}
              `}
        </section>
        ...
        ${u?f:c`
              ...
              <section id="target-notifications-panel" class="target-tab-panel" role="tabpanel" aria-label="Notifications" ?hidden=${A!=="notifications"}>
                ${ti(r,t.notification_channel_ids,t.use_default_channels)}
              </section>
            `}
        ${A==="details"?u?f:c`<div class="dialog-actions"><div class="danger-actions">
                  <button class="button danger icon-button" type="button" aria-label="Move Target to Trash" title="Move to Trash" @click=${d.delete}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button>
                  <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>d.pause(!t.paused)}><iconify-icon .icon=${t.paused?jt:Nt} aria-hidden="true"></iconify-icon></button>
        ...
        <main class="shell setup-shell">
          <header>
            ...
            <div></div>
            <div class="actions"><button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${Ie[this.theme]} aria-hidden="true"></iconify-icon></button></div>
          </header>
          ${this.error?c`<div class="notice" role="alert">${this.error}</div>`:f}
      ...
      <main class="shell">
        <header>
          ...
          <div class="actions">
            <button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${Ie[this.theme]} aria-hidden="true"></iconify-icon></button>
        ...
        ${this.activeSection==="overview"?this.renderOverview(n,t,e,i):this.activeSection==="alerts"?Gs(this.alerts,this.transitions,this.channels,{search:this.alertSearch,delivery:this.alertDeliveryFilter,kind:this.alertKindFilter,acknowledged:this.alertAcknowledgedFilter},this.saving,{create:()=>this.openChannelDialog(),edit:r=>this.openChannelDialog(r),remove:r=>{this.deleteResource("channels",r.id,r.name)},setDefault:(r,l)=>{this.setChannelDefault(r,l)},acknowledge:r=>{this.acknowledgeAlert(r)},retry:r=>{this.retryAlert(r)},setSearch:r=>this.alertSearch=r,setDelivery:r=>this.alertDeliveryFilter=r,setKind:r=>this.alertKindFilter=r,setAcknowledged:r=>this.alertAcknowledgedFilter=r}):this.activeSection==="cluster"?this.renderClusterPage():this.activeSection==="trash"?this.renderTrashPage():this.activeSection==="manage"?Ys(this.settings,this.saving,r=>{this.updateSettings(r)}):this.activeSection==="changePassword"?Ks(this.identities.find(r=>r.id===this.session?.identity_id),this.saving,o):this.activeSection==="users"?Ws(this.identities,this.session?.identity_id,this.editingIdentity,this.saving,o):Qs(this.apiTokens,this.newApiToken,this.saving,o)}
      </main>${ce()}
      ${ra(this.channels,this.saving,{backdrop:r=>this.dismissOnBackdrop(r),close:()=>this.closeTargetDialog(),create:r=>{this.createTarget(r)}})}
      ${this.selected?oa(this.selected,this.targetHistory,this.historyLoading,this.saving,this.detailDirty,this.detailTab,this.cluster?.members??[],this.channels,this.secrets,{backdrop:r=>this.dismissOnBackdrop(r),close:()=>this.closeDetailDialog(),update:r=>{this.updateTarget(r)},changed:r=>this.updateDetailDirty(r),redirects:r=>this.toggleMaxRedirects(r),delete:()=>{this.deleteTarget()},selectTab:r=>this.selectDetailTab(r),pause:r=>{this.setPaused(r)}}):f}
      <dialog id="secret-dialog" aria-labelledby="secret-title" @click=${this.dismissOnBackdrop}>
        <div class="dialog-head"><div class="title-with-help"><h2 id="secret-title">Add secret</h2>${J("add-secret-help","About adding a Secret","Create an encrypted, write-only value to reference from Target requests or webhook headers through the HTTP API.")}</div></div>
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          ${ea(this.channelKind,this.editingChannel)}
    ...
    `}renderPublicStatusPage(t){const e=t.filter(n=>n.availability==="up"&&!n.paused).length,i=t.filter(n=>n.availability==="down"&&!n.paused).length,s=t.filter(n=>n.paused).length,a=At(t,this.live);return c`
      ...
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?c`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${Rt} aria-hidden="true"></iconify-icon></button>${n?c`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${Nt} aria-hidden="true"></iconify-icon></button>`:f}${o?c`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${jt} aria-hidden="true"></iconify-icon></button>`:f}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${se} aria-hidden="true"></iconify-icon></button></div></div>`:f}
    ...
    `}renderTrashPage(){return c`
      ...
      <section class="panel" aria-label="Trashed Targets">
        <div class="panel-head"><div class="title-with-help"><h2>Deleted Targets</h2>${J("trash-retention-help","About deleted Target retention","Settings and history remain recoverable until the retention deadline.")}</div><span class="meta">${this.trashedTargets.length} stored</span></div>
    ...
    `}renderClusterPage(){return c`
      ...
      <section class="panel" aria-label="Cluster topology">
        <div class="panel-head"><div class="title-with-help"><h2>Nodes</h2>${J("nodes-removal-help","About removing Nodes","Drain healthy Nodes before removal. Replace failed Nodes only after confirming the old process is permanently stopped.")}</div><span class="meta">${this.cluster?.members.length??0} members</span></div>
