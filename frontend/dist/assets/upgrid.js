(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function i(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=i(n);fetch(n.href,r)}})();const se=globalThis,Re=se.ShadowRoot&&(se.ShadyCSS===void 0||se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Me=Symbol(),Ge=new WeakMap;let kt=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==Me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Re&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Ge.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Ge.set(i,e))}return e}toString(){return this.cssText}};const Zt=t=>new kt(typeof t=="string"?t:t+"",void 0,Me),ge=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,n,r)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+t[r+1],t[0]);return new kt(i,t,Me)},Xt=(t,e)=>{if(Re)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),n=se.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=i.cssText,t.appendChild(s)}},We=Re?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return Zt(i)})(t):t;const{is:ei,defineProperty:ti,getOwnPropertyDescriptor:ii,getOwnPropertyNames:si,getOwnPropertySymbols:ni,getPrototypeOf:ai}=Object,fe=globalThis,Qe=fe.trustedTypes,ri=Qe?Qe.emptyScript:"",oi=fe.reactiveElementPolyfillSupport,K=(t,e)=>t,oe={toAttribute(t,e){switch(e){case Boolean:t=t?ri:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Le=(t,e)=>!ei(t,e),Ye={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:Le};Symbol.metadata??=Symbol("metadata"),fe.litPropertyMetadata??=new WeakMap;let M=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Ye){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),n=this.getPropertyDescriptor(e,s,i);n!==void 0&&ti(this.prototype,e,n)}}static getPropertyDescriptor(e,i,s){const{get:n,set:r}=ii(this.prototype,e)??{get(){return this[i]},set(a){this[i]=a}};return{get:n,set(a){const o=n?.call(this);r?.call(this,a),this.requestUpdate(e,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Ye}static _$Ei(){if(this.hasOwnProperty(K("elementProperties")))return;const e=ai(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(K("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(K("properties"))){const i=this.properties,s=[...si(i),...ni(i)];for(const n of s)this.createProperty(n,i[n])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,n]of i)this.elementProperties.set(s,n)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const n=this._$Eu(i,s);n!==void 0&&this._$Eh.set(n,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)i.unshift(We(n))}else e!==void 0&&i.push(We(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Xt(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){const s=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,s);if(n!==void 0&&s.reflect===!0){const r=(s.converter?.toAttribute!==void 0?s.converter:oe).toAttribute(i,s.type);this._$Em=e,r==null?this.removeAttribute(n):this.setAttribute(n,r),this._$Em=null}}_$AK(e,i){const s=this.constructor,n=s._$Eh.get(e);if(n!==void 0&&this._$Em!==n){const r=s.getPropertyOptions(n),a=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:oe;this._$Em=n;const o=a.fromAttribute(i,r.type);this[n]=o??this._$Ej?.get(n)??o,this._$Em=null}}requestUpdate(e,i,s,n=!1,r){if(e!==void 0){const a=this.constructor;if(n===!1&&(r=this[e]),s??=a.getPropertyOptions(e),!((s.hasChanged??Le)(r,i)||s.useDefault&&s.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:n,wrapped:r},a){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??i??this[e]),r!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,r]of this._$Ep)this[n]=r;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,r]of s){const{wrapped:a}=r,o=this[n];a!==!0||this._$AL.has(n)||o===void 0||this.C(n,void 0,r,o)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};M.elementStyles=[],M.shadowRootOptions={mode:"open"},M[K("elementProperties")]=new Map,M[K("finalized")]=new Map,oi?.({ReactiveElement:M}),(fe.reactiveElementVersions??=[]).push("2.1.2");const Ue=globalThis,Ze=t=>t,le=Ue.trustedTypes,Xe=le?le.createPolicy("lit-html",{createHTML:t=>t}):void 0,_t="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,St="?"+P,li=`<${St}>`,N=document,G=()=>N.createComment(""),W=t=>t===null||typeof t!="object"&&typeof t!="function",qe=Array.isArray,ci=t=>qe(t)||typeof t?.[Symbol.iterator]=="function",we=`[ 	
\f\r]`,H=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,et=/-->/g,tt=/>/g,I=RegExp(`>|${we}(?:([^\\s"'>=/]+)(${we}*=${we}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),it=/'/g,st=/"/g,Tt=/^(?:script|style|textarea|title)$/i,di=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),d=di(1),L=Symbol.for("lit-noChange"),h=Symbol.for("lit-nothing"),nt=new WeakMap,O=N.createTreeWalker(N,129);function At(t,e){if(!qe(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return Xe!==void 0?Xe.createHTML(e):e}const pi=(t,e)=>{const i=t.length-1,s=[];let n,r=e===2?"<svg>":e===3?"<math>":"",a=H;for(let o=0;o<i;o++){const l=t[o];let c,p,u=-1,y=0;for(;y<l.length&&(a.lastIndex=y,p=a.exec(l),p!==null);)y=a.lastIndex,a===H?p[1]==="!--"?a=et:p[1]!==void 0?a=tt:p[2]!==void 0?(Tt.test(p[2])&&(n=RegExp("</"+p[2],"g")),a=I):p[3]!==void 0&&(a=I):a===I?p[0]===">"?(a=n??H,u=-1):p[1]===void 0?u=-2:(u=a.lastIndex-p[2].length,c=p[1],a=p[3]===void 0?I:p[3]==='"'?st:it):a===st||a===it?a=I:a===et||a===tt?a=H:(a=I,n=void 0);const x=a===I&&t[o+1].startsWith("/>")?" ":"";r+=a===H?l+li:u>=0?(s.push(c),l.slice(0,u)+_t+l.slice(u)+P+x):l+P+(u===-2?o:x)}return[At(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class Q{constructor({strings:e,_$litType$:i},s){let n;this.parts=[];let r=0,a=0;const o=e.length-1,l=this.parts,[c,p]=pi(e,i);if(this.el=Q.createElement(c,s),O.currentNode=this.el.content,i===2||i===3){const u=this.el.content.firstChild;u.replaceWith(...u.childNodes)}for(;(n=O.nextNode())!==null&&l.length<o;){if(n.nodeType===1){if(n.hasAttributes())for(const u of n.getAttributeNames())if(u.endsWith(_t)){const y=p[a++],x=n.getAttribute(u).split(P),m=/([.?@])?(.*)/.exec(y);l.push({type:1,index:r,name:m[2],strings:x,ctor:m[1]==="."?hi:m[1]==="?"?gi:m[1]==="@"?fi:me}),n.removeAttribute(u)}else u.startsWith(P)&&(l.push({type:6,index:r}),n.removeAttribute(u));if(Tt.test(n.tagName)){const u=n.textContent.split(P),y=u.length-1;if(y>0){n.textContent=le?le.emptyScript:"";for(let x=0;x<y;x++)n.append(u[x],G()),O.nextNode(),l.push({type:2,index:++r});n.append(u[y],G())}}}else if(n.nodeType===8)if(n.data===St)l.push({type:2,index:r});else{let u=-1;for(;(u=n.data.indexOf(P,u+1))!==-1;)l.push({type:7,index:r}),u+=P.length-1}r++}}static createElement(e,i){const s=N.createElement("template");return s.innerHTML=e,s}}function U(t,e,i=t,s){if(e===L)return e;let n=s!==void 0?i._$Co?.[s]:i._$Cl;const r=W(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(t),n._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=n:i._$Cl=n),n!==void 0&&(e=U(t,n._$AS(t,e.values),n,s)),e}class ui{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,n=(e?.creationScope??N).importNode(i,!0);O.currentNode=n;let r=O.nextNode(),a=0,o=0,l=s[0];for(;l!==void 0;){if(a===l.index){let c;l.type===2?c=new X(r,r.nextSibling,this,e):l.type===1?c=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(c=new mi(r,this,e)),this._$AV.push(c),l=s[++o]}a!==l?.index&&(r=O.nextNode(),a++)}return O.currentNode=N,n}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class X{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,n){this.type=2,this._$AH=h,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=U(this,e,i),W(e)?e===h||e==null||e===""?(this._$AH!==h&&this._$AR(),this._$AH=h):e!==this._$AH&&e!==L&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ci(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==h&&W(this._$AH)?this._$AA.nextSibling.data=e:this.T(N.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,n=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=Q.createElement(At(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(i);else{const r=new ui(n,this),a=r.u(this.options);r.p(i),this.T(a),this._$AH=r}}_$AC(e){let i=nt.get(e.strings);return i===void 0&&nt.set(e.strings,i=new Q(e)),i}k(e){qe(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,n=0;for(const r of e)n===i.length?i.push(s=new X(this.O(G()),this.O(G()),this,this.options)):s=i[n],s._$AI(r),n++;n<i.length&&(this._$AR(s&&s._$AB.nextSibling,n),i.length=n)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=Ze(e).nextSibling;Ze(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class me{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,n,r){this.type=1,this._$AH=h,this._$AN=void 0,this.element=e,this.name=i,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=h}_$AI(e,i=this,s,n){const r=this.strings;let a=!1;if(r===void 0)e=U(this,e,i,0),a=!W(e)||e!==this._$AH&&e!==L,a&&(this._$AH=e);else{const o=e;let l,c;for(e=r[0],l=0;l<r.length-1;l++)c=U(this,o[s+l],i,l),c===L&&(c=this._$AH[l]),a||=!W(c)||c!==this._$AH[l],c===h?e=h:e!==h&&(e+=(c??"")+r[l+1]),this._$AH[l]=c}a&&!n&&this.j(e)}j(e){e===h?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class hi extends me{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===h?void 0:e}}class gi extends me{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==h)}}class fi extends me{constructor(e,i,s,n,r){super(e,i,s,n,r),this.type=5}_$AI(e,i=this){if((e=U(this,e,i,0)??h)===L)return;const s=this._$AH,n=e===h&&s!==h||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==h&&(s===h||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class mi{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}}const bi=Ue.litHtmlPolyfillSupport;bi?.(Q,X),(Ue.litHtmlVersions??=[]).push("3.3.3");const vi=(t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(n===void 0){const r=i?.renderBefore??null;s._$litPart$=n=new X(e.insertBefore(G(),r),r,void 0,i??{})}return n._$AI(t),n};const Fe=globalThis;class j extends M{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=vi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return L}}j._$litElement$=!0,j.finalized=!0,Fe.litElementHydrateSupport?.({LitElement:j});const yi=Fe.litElementPolyfillSupport;yi?.({LitElement:j});(Fe.litElementVersions??=[]).push("4.2.2");const ze=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const xi={attribute:!0,type:String,converter:oe,reflect:!1,hasChanged:Le},$i=(t=xi,e,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(r===void 0&&globalThis.litPropertyMetadata.set(n,r=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),s==="accessor"){const{name:a}=i;return{set(o){const l=e.get.call(this);e.set.call(this,o),this.requestUpdate(a,l,t,!0,o)},init(o){return o!==void 0&&this.C(a,void 0,t,o),o}}}if(s==="setter"){const{name:a}=i;return function(o){const l=this[a];e.call(this,o),this.requestUpdate(a,l,t,!0,o)}}throw Error("Unsupported decorator location: "+s)};function be(t){return(e,i)=>typeof i=="object"?$i(t,e,i):((s,n,r)=>{const a=n.hasOwnProperty(r);return n.constructor.createProperty(r,s),a?Object.getOwnPropertyDescriptor(n,r):void 0})(t,e,i)}function f(t){return be({...t,state:!0,attribute:!1})}const Ct={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},Pt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},ce={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},Et={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'};const Dt=Object.freeze({left:0,top:0,width:16,height:16}),de=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),ee=Object.freeze({...Dt,...de}),Ae=Object.freeze({...ee,body:"",hidden:!1}),wi=Object.freeze({width:null,height:null}),It=Object.freeze({...wi,...de});function ki(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(i===""){const n=parseInt(t);return isNaN(n)?0:s(n)}else if(i!==t){let n=0;switch(i){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return e}const _i=/[\s,]+/;function Si(t,e){e.split(_i).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Ot={...It,preserveAspectRatio:""};function at(t){const e={...Ot},i=(s,n)=>t.getAttribute(s)||n;return e.width=i("width",null),e.height=i("height",null),e.rotate=ki(i("rotate","")),Si(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function Ti(t,e){for(const i in Ot)if(t[i]!==e[i])return!0;return!1}const jt=/^[a-z0-9]+(-[a-z0-9]+)*$/,te=(t,e,i,s="")=>{const n=t.split(":");if(t.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const o=n.pop(),l=n.pop(),c={provider:n.length>0?n[0]:s,prefix:l,name:o};return e&&!ne(c)?null:c}const r=n[0],a=r.split("-");if(a.length>1){const o={provider:s,prefix:a.shift(),name:a.join("-")};return e&&!ne(o)?null:o}if(i&&s===""){const o={provider:s,prefix:"",name:r};return e&&!ne(o,i)?null:o}return null},ne=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function Ai(t,e){const i=t.icons,s=t.aliases||Object.create(null),n=Object.create(null);function r(a){if(i[a])return n[a]=[];if(!(a in n)){n[a]=null;const o=s[a]&&s[a].parent,l=o&&r(o);l&&(n[a]=[o].concat(l))}return n[a]}return Object.keys(i).concat(Object.keys(s)).forEach(r),n}function Ci(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const s=((t.rotate||0)+(e.rotate||0))%4;return s&&(i.rotate=s),i}function rt(t,e){const i=Ci(t,e);for(const s in Ae)s in de?s in t&&!(s in i)&&(i[s]=de[s]):s in e?i[s]=e[s]:s in t&&(i[s]=t[s]);return i}function Pi(t,e,i){const s=t.icons,n=t.aliases||Object.create(null);let r={};function a(o){r=rt(s[o]||n[o],r)}return a(e),i.forEach(a),rt(t,r)}function Nt(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(n=>{e(n,null),i.push(n)});const s=Ai(t);for(const n in s){const r=s[n];r&&(e(n,Pi(t,n,r)),i.push(n))}return i}const Ei={provider:"",aliases:{},not_found:{},...Dt};function ke(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function Rt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!ke(t,Ei))return null;const i=e.icons;for(const n in i){const r=i[n];if(!n||typeof r.body!="string"||!ke(r,Ae))return null}const s=e.aliases||Object.create(null);for(const n in s){const r=s[n],a=r.parent;if(!n||typeof a!="string"||!i[a]&&!s[a]||!ke(r,Ae))return null}return e}const pe=Object.create(null);function Di(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function C(t,e){const i=pe[t]||(pe[t]=Object.create(null));return i[e]||(i[e]=Di(t,e))}function Mt(t,e){return Rt(e)?Nt(e,(i,s)=>{s?t.icons[i]=s:t.missing.add(i)}):[]}function Ii(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function Oi(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(pe)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(pe[s]||{})).forEach(n=>{const r=C(s,n);i=i.concat(Object.keys(r.icons).map(a=>(s!==""?"@"+s+":":"")+n+":"+a))})}),i}let Y=!1;function Lt(t){return typeof t=="boolean"&&(Y=t),Y}function Z(t){const e=typeof t=="string"?te(t,!0,Y):t;if(e){const i=C(e.provider,e.prefix),s=e.name;return i.icons[s]||(i.missing.has(s)?null:void 0)}}function Ut(t,e){const i=te(t,!0,Y);if(!i)return!1;const s=C(i.provider,i.prefix);return e?Ii(s,i.name,e):(s.missing.add(i.name),!0)}function ot(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),Y&&!e&&!t.prefix){let s=!1;return Rt(t)&&(t.prefix="",Nt(t,(n,r)=>{Ut(n,r)&&(s=!0)})),s}const i=t.prefix;return ne({prefix:i,name:"a"})?!!Mt(C(e,i),t):!1}function ji(t){return!!Z(t)}function Ni(t){const e=Z(t);return e&&{...ee,...e}}function qt(t,e){t.forEach(i=>{const s=i.loaderCallbacks;s&&(i.loaderCallbacks=s.filter(n=>n.id!==e))})}function Ri(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const s=t.provider,n=t.prefix;e.forEach(r=>{const a=r.icons,o=a.pending.length;a.pending=a.pending.filter(l=>{if(l.prefix!==n)return!0;const c=l.name;if(t.icons[c])a.loaded.push({provider:s,prefix:n,name:c});else if(t.missing.has(c))a.missing.push({provider:s,prefix:n,name:c});else return i=!0,!0;return!1}),a.pending.length!==o&&(i||qt([t],r.id),r.callback(a.loaded.slice(0),a.missing.slice(0),a.pending.slice(0),r.abort))})}))}let Mi=0;function Li(t,e,i){const s=Mi++,n=qt.bind(null,i,s);if(!e.pending.length)return n;const r={id:s,icons:e,callback:t,abort:n};return i.forEach(a=>{(a.loaderCallbacks||(a.loaderCallbacks=[])).push(r)}),n}function Ui(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return t.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,a=n.prefix,o=n.name,l=i[r]||(i[r]=Object.create(null)),c=l[a]||(l[a]=C(r,a));let p;o in c.icons?p=e.loaded:a===""||c.missing.has(o)?p=e.missing:p=e.pending;const u={provider:r,prefix:a,name:o};p.push(u)}),e}const Ce=Object.create(null);function lt(t,e){Ce[t]=e}function Pe(t){return Ce[t]||Ce[""]}function qi(t,e=!0,i=!1){const s=[];return t.forEach(n=>{const r=typeof n=="string"?te(n,e,i):n;r&&s.push(r)}),s}function He(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const ve=Object.create(null),J=["https://api.simplesvg.com","https://api.unisvg.com"],ae=[];for(;J.length>0;)J.length===1||Math.random()>.5?ae.push(J.shift()):ae.push(J.pop());ve[""]=He({resources:["https://api.iconify.design"].concat(ae)});function ct(t,e){const i=He(e);return i===null?!1:(ve[t]=i,!0)}function ye(t){return ve[t]}function Fi(){return Object.keys(ve)}const zi={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Hi(t,e,i,s){const n=t.resources.length,r=t.random?Math.floor(Math.random()*n):t.index;let a;if(t.random){let $=t.resources.slice(0);for(a=[];$.length>1;){const _=Math.floor(Math.random()*$.length);a.push($[_]),$=$.slice(0,_).concat($.slice(_+1))}a=a.concat($)}else a=t.resources.slice(r).concat(t.resources.slice(0,r));const o=Date.now();let l="pending",c=0,p,u=null,y=[],x=[];typeof s=="function"&&x.push(s);function m(){u&&(clearTimeout(u),u=null)}function A(){l==="pending"&&(l="aborted"),m(),y.forEach($=>{$.status==="pending"&&($.status="aborted")}),y=[]}function w($,_){_&&(x=[]),typeof $=="function"&&x.push($)}function F(){return{startTime:o,payload:e,status:l,queriesSent:c,queriesPending:y.length,subscribe:w,abort:A}}function T(){l="failed",x.forEach($=>{$(void 0,p)})}function S(){y.forEach($=>{$.status==="pending"&&($.status="aborted")}),y=[]}function k($,_,z){const ie=_!=="success";switch(y=y.filter(D=>D!==$),l){case"pending":break;case"failed":if(ie||!t.dataAfterTimeout)return;break;default:return}if(_==="abort"){p=z,T();return}if(ie){p=z,y.length||(a.length?$e():T());return}if(m(),S(),!t.random){const D=t.resources.indexOf($.resource);D!==-1&&D!==t.index&&(t.index=D)}l="completed",x.forEach(D=>{D(z)})}function $e(){if(l!=="pending")return;m();const $=a.shift();if($===void 0){if(y.length){u=setTimeout(()=>{m(),l==="pending"&&(S(),T())},t.timeout);return}T();return}const _={status:"pending",resource:$,callback:(z,ie)=>{k(_,z,ie)}};y.push(_),c++,u=setTimeout($e,t.rotate),i($,e,_.callback)}return setTimeout($e),F}function Ft(t){const e={...zi,...t};let i=[];function s(){i=i.filter(a=>a().status==="pending")}function n(a,o,l){const c=Hi(e,a,o,(p,u)=>{s(),l&&l(p,u)});return i.push(c),c}function r(a){return i.find(o=>a(o))||null}return{query:n,find:r,setIndex:a=>{e.index=a},getIndex:()=>e.index,cleanup:s}}function dt(){}const _e=Object.create(null);function Ji(t){if(!_e[t]){const e=ye(t);if(!e)return;_e[t]={config:e,redundancy:Ft(e)}}return _e[t]}function zt(t,e,i){let s,n;if(typeof t=="string"){const r=Pe(t);if(!r)return i(void 0,424),dt;n=r.send;const a=Ji(t);a&&(s=a.redundancy)}else{const r=He(t);if(r){s=Ft(r);const a=Pe(t.resources?t.resources[0]:"");a&&(n=a.send)}}return!s||!n?(i(void 0,424),dt):s.query(e,n,i)().abort}function pt(){}function Bi(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Ri(t)}))}function Ki(t){const e=[],i=[];return t.forEach(s=>{(s.match(jt)?e:i).push(s)}),{valid:e,invalid:i}}function B(t,e,i){function s(){const n=t.pendingIcons;e.forEach(r=>{n&&n.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Mt(t,i).length){s();return}}catch(n){console.error(n)}s(),Bi(t)}function ut(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Vi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:s}=t,n=t.iconsToLoad;if(delete t.iconsToLoad,!n||!n.length)return;const r=t.loadIcon;if(t.loadIcons&&(n.length>1||!r)){ut(t.loadIcons(n,s,i),c=>{B(t,n,c)});return}if(r){n.forEach(c=>{ut(r(c,s,i),p=>{B(t,[c],p?{prefix:s,icons:{[c]:p}}:null)})});return}const{valid:a,invalid:o}=Ki(n);if(o.length&&B(t,o,null),!a.length)return;const l=s.match(jt)?Pe(i):null;if(!l){B(t,a,null);return}l.prepare(i,s,a).forEach(c=>{zt(i,c,p=>{B(t,c.icons,p)})})}))}const Je=(t,e)=>{const i=Ui(qi(t,!0,Lt()));if(!i.pending.length){let o=!0;return e&&setTimeout(()=>{o&&e(i.loaded,i.missing,i.pending,pt)}),()=>{o=!1}}const s=Object.create(null),n=[];let r,a;return i.pending.forEach(o=>{const{provider:l,prefix:c}=o;if(c===a&&l===r)return;r=l,a=c,n.push(C(l,c));const p=s[l]||(s[l]=Object.create(null));p[c]||(p[c]=[])}),i.pending.forEach(o=>{const{provider:l,prefix:c,name:p}=o,u=C(l,c),y=u.pendingIcons||(u.pendingIcons=new Set);y.has(p)||(y.add(p),s[l][c].push(p))}),n.forEach(o=>{const l=s[o.provider][o.prefix];l.length&&Vi(o,l)}),e?Li(e,i,n):pt},Gi=t=>new Promise((e,i)=>{const s=typeof t=="string"?te(t,!0):t;if(!s){i(t);return}Je([s||t],n=>{if(n.length&&s){const r=Z(s);if(r){e({...ee,...r});return}}i(t)})});function ht(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function Wi(t,e){if(typeof t=="object")return{data:ht(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=ht(t);if(r)return{data:r,value:t}}const i=te(t,!0,!0);if(!i)return{value:t};const s=Z(i);if(s!==void 0||!i.prefix)return{value:t,name:i,data:s};const n=Je([i],()=>e(t,i,Z(i)));return{value:t,name:i,loading:n}}let Ht=!1;try{Ht=navigator.vendor.indexOf("Apple")===0}catch{}function Qi(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Ht||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const Yi=/(-?[0-9.]*[0-9]+[0-9.]*)/g,Zi=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Ee(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const s=t.split(Yi);if(s===null||!s.length)return t;const n=[];let r=s.shift(),a=Zi.test(r);for(;;){if(a){const o=parseFloat(r);isNaN(o)?n.push(r):n.push(Math.ceil(o*e*i)/i)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");a=!a}}function Xi(t,e="defs"){let i="";const s=t.indexOf("<"+e);for(;s>=0;){const n=t.indexOf(">",s),r=t.indexOf("</"+e);if(n===-1||r===-1)break;const a=t.indexOf(">",r);if(a===-1)break;i+=t.slice(n+1,r).trim(),t=t.slice(0,s).trim()+t.slice(a+1)}return{defs:i,content:t}}function es(t,e){return t?"<defs>"+t+"</defs>"+e:e}function ts(t,e,i){const s=Xi(t);return es(s.defs,e+s.content+i)}const is=t=>t==="unset"||t==="undefined"||t==="none";function Jt(t,e){const i={...ee,...t},s={...It,...e},n={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,s].forEach(A=>{const w=[],F=A.hFlip,T=A.vFlip;let S=A.rotate;F?T?S+=2:(w.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),w.push("scale(-1 1)"),n.top=n.left=0):T&&(w.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),w.push("scale(1 -1)"),n.top=n.left=0);let k;switch(S<0&&(S-=Math.floor(S/4)*4),S=S%4,S){case 1:k=n.height/2+n.top,w.unshift("rotate(90 "+k.toString()+" "+k.toString()+")");break;case 2:w.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:k=n.width/2+n.left,w.unshift("rotate(-90 "+k.toString()+" "+k.toString()+")");break}S%2===1&&(n.left!==n.top&&(k=n.left,n.left=n.top,n.top=k),n.width!==n.height&&(k=n.width,n.width=n.height,n.height=k)),w.length&&(r=ts(r,'<g transform="'+w.join(" ")+'">',"</g>"))});const a=s.width,o=s.height,l=n.width,c=n.height;let p,u;a===null?(u=o===null?"1em":o==="auto"?c:o,p=Ee(u,l/c)):(p=a==="auto"?l:a,u=o===null?Ee(p,c/l):o==="auto"?c:o);const y={},x=(A,w)=>{is(w)||(y[A]=w.toString())};x("width",p),x("height",u);const m=[n.left,n.top,l,c];return y.viewBox=m.join(" "),{attributes:y,viewBox:m,body:r}}function Be(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)i+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function ss(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function ns(t){return"data:image/svg+xml,"+ss(t)}function Bt(t){return'url("'+ns(t)+'")'}const as=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let ue=as();function rs(t){ue=t}function os(){return ue}function ls(t,e){const i=ye(t);if(!i)return 0;let s;if(!i.maxURL)s=0;else{let n=0;i.resources.forEach(a=>{n=Math.max(n,a.length)});const r=e+".json?icons=";s=i.maxURL-n-i.path.length-r.length}return s}function cs(t){return t===404}const ds=(t,e,i)=>{const s=[],n=ls(t,e),r="icons";let a={type:r,provider:t,prefix:e,icons:[]},o=0;return i.forEach((l,c)=>{o+=l.length+1,o>=n&&c>0&&(s.push(a),a={type:r,provider:t,prefix:e,icons:[]},o=l.length),a.icons.push(l)}),s.push(a),s};function ps(t){if(typeof t=="string"){const e=ye(t);if(e)return e.path}return"/"}const us=(t,e,i)=>{if(!ue){i("abort",424);return}let s=ps(e.provider);switch(e.type){case"icons":{const r=e.prefix,a=e.icons.join(","),o=new URLSearchParams({icons:a});s+=r+".json?"+o.toString();break}case"custom":{const r=e.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let n=503;ue(t+s).then(r=>{const a=r.status;if(a!==200){setTimeout(()=>{i(cs(a)?"abort":"next",a)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",n)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",n)})},hs={prepare:ds,send:us};function gs(t,e,i){C(i||"",e).loadIcons=t}function fs(t,e,i){C(i||"",e).loadIcon=t}const Se="data-style";let Kt="";function ms(t){Kt=t}function gt(t,e){let i=Array.from(t.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Se));i||(i=document.createElement("style"),i.setAttribute(Se,Se),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Kt}function Vt(){lt("",hs),Lt(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!ot(n))&&console.error(s)}catch{console.error(s)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const s in i){const n="IconifyProviders["+s+"] is invalid.";try{const r=i[s];if(typeof r!="object"||!r||r.resources===void 0)continue;ct(s,r)||console.error(n)}catch{console.error(n)}}}}return{iconLoaded:ji,getIcon:Ni,listIcons:Oi,addIcon:Ut,addCollection:ot,calculateSize:Ee,buildIcon:Jt,iconToHTML:Be,svgToURL:Bt,loadIcons:Je,loadIcon:Gi,addAPIProvider:ct,setCustomIconLoader:fs,setCustomIconsLoader:gs,appendCustomStyle:ms,_api:{getAPIConfig:ye,setAPIModule:lt,sendAPIQuery:zt,setFetch:rs,getFetch:os,listAPIProviders:Fi}}}const De={"background-color":"currentColor"},Gt={"background-color":"transparent"},ft={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},mt={"-webkit-mask":De,mask:De,background:Gt};for(const t in mt){const e=mt[t];for(const i in ft)e[t+"-"+i]=ft[i]}function bt(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function bs(t,e,i){const s=document.createElement("span");let n=t.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=t.attributes,a=Be(n,{...r,width:e.width+"",height:e.height+""}),o=Bt(a),l=s.style,c={"--svg":o,width:bt(r.width),height:bt(r.height),...i?De:Gt};for(const p in c)l.setProperty(p,c[p]);return s}let V;function vs(){try{V=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{V=null}}function ys(t){return V===void 0&&vs(),V?V.createHTML(t):t}function xs(t){const e=document.createElement("span"),i=t.attributes;let s="";i.width||(s="width: inherit;"),i.height||(s+="height: inherit;"),s&&(i.style=s);const n=Be(t.body,i);return e.innerHTML=ys(n),e.firstChild}function Ie(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function vt(t,e){const i=e.icon.data,s=e.customisations,n=Jt(i,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=e.renderedMode;let a;r==="svg"?a=xs(n):a=bs(n,{...ee,...i},r==="mask");const o=Ie(t);o?a.tagName==="SPAN"&&o.tagName===a.tagName?o.setAttribute("style",a.getAttribute("style")):t.replaceChild(a,o):t.appendChild(a)}function yt(t,e,i){const s=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:s}}function $s(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const s=e.get(t);if(s)return s;const n=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const o=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");gt(o,l),this._state=yt({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(o){switch(o){case"inline":{const l=this.hasAttribute("inline"),c=this._state;l!==c.inline&&(c.inline=l,gt(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const o=this.getAttribute("icon");if(o&&o.slice(0,1)==="{")try{return JSON.parse(o)}catch{}return o}set icon(o){typeof o=="object"&&(o=JSON.stringify(o)),this.setAttribute("icon",o)}get inline(){return this.hasAttribute("inline")}set inline(o){o?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(o){o?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const o=this._state;if(o.rendered){const l=this._shadowRoot;if(o.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}vt(l,o)}}get status(){const o=this._state;return o.rendered?"rendered":o.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const o=this._state,l=this.getAttribute("icon");if(l!==o.icon.value){this._iconChanged(l);return}if(!o.rendered||!this._visible)return;const c=this.getAttribute("mode"),p=at(this);(o.attrMode!==c||Ti(o.customisations,p)||!Ie(this._shadowRoot))&&this._renderIcon(o.icon,p,c)}_iconChanged(o){const l=Wi(o,(c,p,u)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==c)return;const x={value:c,name:p,data:u};x.data?this._gotIconData(x):y.icon=x});l.data?this._gotIconData(l):this._state=yt(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const o=Ie(this._shadowRoot);o&&this._shadowRoot.removeChild(o);return}this._queueCheck()}_gotIconData(o){this._checkQueued=!1,this._renderIcon(o,at(this),this.getAttribute("mode"))}_renderIcon(o,l,c){const p=Qi(o.data.body,c),u=this._state.inline;vt(this._shadowRoot,this._state={rendered:!0,icon:o,inline:u,customisations:l,attrMode:c,renderedMode:p})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(o=>{const l=o.some(c=>c.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(o=>{o in r.prototype||Object.defineProperty(r.prototype,o,{get:function(){return this.getAttribute(o)},set:function(l){l!==null?this.setAttribute(o,l):this.removeAttribute(o)}})});const a=Vt();for(const o in a)r[o]=r.prototype[o]=a[o];return e.define(t,r),r}const ws=$s()||Vt(),{iconLoaded:en,getIcon:tn,listIcons:sn,addIcon:nn,addCollection:an,calculateSize:rn,buildIcon:on,iconToHTML:ln,svgToURL:cn,loadIcons:dn,loadIcon:pn,setCustomIconLoader:un,setCustomIconsLoader:hn,addAPIProvider:gn,_api:fn}=ws;class Ke extends Error{constructor(e,i){super(i),this.status=e,this.name="ApiRequestError"}}async function g(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:i.statusText}));throw new Ke(i.status,s.error||i.statusText)}return i.status===204?void 0:i.json()}function Oe(t,e,i=!1){if(e==="telegram"){const s=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!s?void 0:s,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const s=String(t.get("username")??""),n=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:s||void 0,password:n||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function je(t,e=[],i=!0,s=String(t.get("kind")??"http"),n=[]){const r=String(t.get("url")),a=s==="http"?r:`${s}://${r.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:s,url:a,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),headers:{},body:null,assertions:n,skip_tls_verification:!1,notification_channel_ids:e,use_default_channels:i}}var ks=Object.defineProperty,_s=Object.getOwnPropertyDescriptor,q=(t,e,i,s)=>{for(var n=s>1?void 0:s?_s(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=(s?a(e,i,n):a(n))||n);return s&&n&&ks(e,i,n),n};let E=class extends j{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await g("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){if(t.preventDefault(),!window.confirm("Create a new single-Node Cluster?"))return;const e=new FormData(t.currentTarget),i=String(e.get("admin_username")??"").trim(),s=String(e.get("admin_password")??"");await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName(),admin_username:i,admin_password:s},{username:i,password:s})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e,i){this.saving=!0,this.error="";try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster(i)}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(t){for(let e=0;e<120;e+=1){const{promise:i,resolve:s}=Promise.withResolvers();window.setTimeout(s,250),await i;try{t&&await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify(t)});const n=await g("/api/v1/setup");if(n.cluster_ready){this.changed(n);return}}catch(n){if(!t&&n instanceof Ke&&n.status===401){window.location.assign("/");return}}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Oe(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=je(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await g("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return d`<section class="flow" aria-label="UpGrid setup">
  ...
  `;q([be({attribute:!1})],E.prototype,"setup",2);q([f()],E.prototype,"channelKind",2);q([f()],E.prototype,"channels",2);q([f()],E.prototype,"saving",2);q([f()],E.prototype,"error",2);E=q([ze("upgrid-setup")],E);var Ss=Object.defineProperty,Ts=Object.getOwnPropertyDescriptor,xe=(t,e,i,s)=>{for(var n=s>1?void 0:s?Ts(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=(s?a(e,i,n):a(n))||n);return s&&n&&Ss(e,i,n),n};const As={body_contains:"Body contains",body_regex:"Body regex",json_path:"JSONPath",response_header:"Response header",latency:"Latency threshold",script:"Script"};let R=class extends j{constructor(){super(...arguments),this.assertions=[],this.targetId="new",this.draft=[],this.loadedTarget="",this.internals=this.attachInternals()}get value(){return structuredClone(this.draft)}willUpdate(t){t.has("targetId")&&this.loadedTarget!==this.targetId&&(this.loadedTarget=this.targetId,this.draft=structuredClone(this.assertions))}updated(){this.internals.setFormValue(JSON.stringify(this.draft))}formResetCallback(){this.draft=structuredClone(this.assertions),this.internals.setFormValue(JSON.stringify(this.draft))}add(){this.draft=[...this.draft,xt("body_contains")],this.changed()}removeAssertion(t){this.draft=this.draft.filter((e,i)=>i!==t),this.changed()}move(t,e){const i=t+e;if(i<0||i>=this.draft.length)return;const s=[...this.draft];[s[t],s[i]]=[s[i],s[t]],this.draft=s,this.changed()}setKind(t,e){const i=e.currentTarget.value;this.replace(t,xt(i))}set(t,e,i){const s=i.currentTarget,n={...this.draft[t],[e]:e==="max_ms"?Number(s.value):s.value||null};this.replace(t,n)}replace(t,e){this.draft=this.draft.map((i,s)=>s===t?e:i),this.changed()}changed(){this.internals.setFormValue(JSON.stringify(this.draft)),this.dispatchEvent(new Event("input",{bubbles:!0,composed:!0}))}render(){return d`
      <fieldset>
        <legend>Ordered response assertions</legend>
        ${this.draft.length?this.draft.map((t,e)=>this.renderAssertion(t,e)):d`<p class="empty">No response assertions. HTTP status ranges still apply.</p>`}
        <button class="add" type="button" @click=${this.add}>Add assertion</button>
      </fieldset>
    `}renderAssertion(t,e){return d`
      <div class="assertion">
        <label>Type<select aria-label=${`Assertion ${e+1} type`} .value=${t.kind} @change=${i=>this.setKind(e,i)}>${Object.entries(As).map(([i,s])=>d`<option value=${i}>${s}</option>`)}</select></label>
  ...
  `;xe([be({attribute:!1})],R.prototype,"assertions",2);xe([be({attribute:"target-id"})],R.prototype,"targetId",2);xe([f()],R.prototype,"draft",2);R=xe([ze("http-assertion-editor")],R);function xt(t){switch(t){case"body_contains":return{kind:t,value:""};case"body_regex":return{kind:t,pattern:""};case"json_path":return{kind:t,path:"$",expected:null};case"response_header":return{kind:t,name:"",value:null};case"latency":return{kind:t,max_ms:1e3};case"script":return{kind:t,source:"status == 200"}}}const Cs={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3a6 6 0 0 0 9 9a9 9 0 1 1-9-9Z"/>'},Ps={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="13.5" cy="6.5" r=".5"/><circle cx="17.5" cy="10.5" r=".5"/><circle cx="8.5" cy="7.5" r=".5"/><circle cx="6.5" cy="12.5" r=".5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688c0-.437-.18-.835-.437-1.125c-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/></g>'},Es={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="4"/><path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></g>'};var Ds=Object.defineProperty,v=(t,e,i,s)=>{for(var n=void 0,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=a(e,i,n)||n);return n&&Ds(e,i,n),n};const re=["system","dark","bright"],$t={system:Ps,dark:Cs,bright:Es},Ve={overview:"/",alerts:"/alerts",cluster:"/cluster"};function Is(t,e){if(!e)return{tone:"pending",label:"connecting"};const i=t.filter(n=>!n.paused);if(!i.length)return{tone:"pending",label:"ready"};const s=i.filter(n=>n.availability==="down"||n.consecutive_failures>0).length;return s?s===i.length?{tone:"down",label:"down"}:{tone:"degraded",label:"partially down"}:{tone:"up",label:"up"}}function wt(){return Object.entries(Ve).find(([,t])=>t===window.location.pathname)?.[0]??"overview"}function Os(){const t=localStorage.getItem("upgrid-theme");return re.includes(t)?t:"system"}class b extends j{constructor(){super(...arguments),this.targets=[],this.channels=[],this.alerts=[],this.transitions=[],this.secrets=[],this.joinTokens=[],this.identities=[],this.apiTokens=[],this.authReady=!1,this.newApiToken="",this.error="",this.live=!1,this.saving=!1,this.channelKind="webhook",this.channelTestMessage="",this.testingChannel=!1,this.joinCommand="",this.alertSearch="",this.alertDeliveryFilter="all",this.alertKindFilter="all",this.alertAcknowledgedFilter="all",this.search="",this.statusFilter="all",this.sort="name",this.selectedIds=new Set,this.activeSection=wt(),this.copied=!1,this.setupMode=!1,this.warningDismissed=sessionStorage.getItem("upgrid-warning-dismissed")==="1",this.unlimitedUses=!1,this.theme=Os(),this.detailDirty=!1,this.detailInitialState="",this.systemTheme=matchMedia("(prefers-color-scheme: light)"),this.systemThemeChanged=()=>{this.theme==="system"&&this.applyTheme()},this.routeChanged=()=>{if(this.setupMode&&this.setup){window.history.replaceState(null,"",this.setup.path);return}this.activeSection=wt()}}connectedCallback(){super.connectedCallback(),this.applyTheme(),this.systemTheme.addEventListener("change",this.systemThemeChanged),window.addEventListener("popstate",this.routeChanged),this.start()}disconnectedCallback(){this.systemTheme.removeEventListener("change",this.systemThemeChanged),window.removeEventListener("popstate",this.routeChanged),this.events?.close(),super.disconnectedCallback()}async start(){try{const e=await g("/api/v1/setup");e.cluster_ready&&(this.session=await g("/api/v1/auth/session")),await this.activate(e)}catch(e){(!(e instanceof Ke)||e.status!==401)&&(this.error=e instanceof Error?e.message:String(e))}this.authReady=!0}async activate(e){if(this.setup=e,this.setupMode=e.setup,this.setupMode){window.history.replaceState(null,"",e.path),e.cluster_ready?(await this.refresh(),this.connectEvents()):this.live=!0;return}await this.refresh(),this.connectEvents()}async login(e){e.preventDefault();const i=new FormData(e.currentTarget);this.saving=!0,this.error="";try{this.session=await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify({username:String(i.get("username")??""),password:String(i.get("password")??"")})}),await this.activate(await g("/api/v1/setup"))}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async logout(){await g("/api/v1/auth/logout",{method:"POST"}),this.events?.close(),this.session=void 0,this.live=!1,this.setupMode=!1,window.history.replaceState(null,"","/")}connectEvents(){this.events?.close(),this.events=new EventSource("/api/v1/events"),this.events.addEventListener("state",()=>{this.refresh()}),this.events.onopen=()=>this.live=!0,this.events.onerror=()=>this.live=!1}applyTheme(){const e=this.theme==="system"?this.systemTheme.matches?"bright":"dark":this.theme;this.dataset.theme=e,document.querySelector('meta[name="theme-color"]')?.setAttribute("content",e==="bright"?"#f4f8f6":"#0b1110")}cycleTheme(){this.theme=re[(re.indexOf(this.theme)+1)%re.length],localStorage.setItem("upgrid-theme",this.theme),this.applyTheme()}dismissWarning(){sessionStorage.setItem("upgrid-warning-dismissed","1"),this.warningDismissed=!0}async refresh(){try{[this.targets,this.channels,this.alerts,this.transitions,this.secrets,this.cluster,this.joinTokens,this.identities,this.apiTokens]=await Promise.all([g("/api/v1/targets"),g("/api/v1/channels"),g("/api/v1/alerts"),g("/api/v1/transitions"),g("/api/v1/secrets"),g("/api/v1/cluster"),g("/api/v1/join-tokens"),g("/api/v1/identities"),g("/api/v1/api-tokens")]),this.error=""}catch(e){this.error=e instanceof Error?e.message:String(e)}}openTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.showModal()}closeTargetDialog(){this.renderRoot.querySelector("#target-dialog")?.close()}openTarget(e){this.detailDirty=!1,this.selected=e,this.updateComplete.then(()=>{const i=this.renderRoot.querySelector("#detail-dialog"),s=i?.querySelector("form");s&&(this.detailInitialState=this.detailFormState(s)),i?.showModal()})}closeDetailDialog(){this.renderRoot.querySelector("#detail-dialog")?.close(),this.detailDirty=!1,this.detailInitialState="",this.selected=void 0}showDialog(e){this.renderRoot.querySelector(`#${e}`)?.showModal()}dismissOnBackdrop(e){const i=e.currentTarget;e.target===i&&(i.close(),i.id==="detail-dialog"&&this.closeDetailDialog())}navigate(e,i){e.preventDefault(),this.activeSection=i,window.history.pushState(null,"",Ve[i])}closeDialog(e){this.renderRoot.querySelector(`#${e}`)?.close()}toggleMaxRedirects(e){const i=e.currentTarget,s=i.form?.elements.namedItem("max_redirects");s&&(s.disabled=!i.checked),i.form&&this.compareDetailForm(i.form)}detailFormState(e){return JSON.stringify([...new FormData(e).entries()])}compareDetailForm(e){this.detailDirty=this.detailFormState(e)!==this.detailInitialState}updateDetailDirty(e){this.compareDetailForm(e.currentTarget)}}v([f()],b.prototype,"targets");v([f()],b.prototype,"channels");v([f()],b.prototype,"alerts");v([f()],b.prototype,"transitions");v([f()],b.prototype,"secrets");v([f()],b.prototype,"cluster");v([f()],b.prototype,"joinTokens");v([f()],b.prototype,"identities");v([f()],b.prototype,"apiTokens");v([f()],b.prototype,"session");v([f()],b.prototype,"authReady");v([f()],b.prototype,"newApiToken");v([f()],b.prototype,"error");v([f()],b.prototype,"live");v([f()],b.prototype,"saving");v([f()],b.prototype,"selected");v([f()],b.prototype,"channelKind");v([f()],b.prototype,"editingChannel");v([f()],b.prototype,"channelTestMessage");v([f()],b.prototype,"testingChannel");v([f()],b.prototype,"joinCommand");v([f()],b.prototype,"alertSearch");v([f()],b.prototype,"alertDeliveryFilter");v([f()],b.prototype,"alertKindFilter");v([f()],b.prototype,"alertAcknowledgedFilter");v([f()],b.prototype,"search");v([f()],b.prototype,"statusFilter");v([f()],b.prototype,"sort");v([f()],b.prototype,"selectedIds");v([f()],b.prototype,"activeSection");v([f()],b.prototype,"copied");v([f()],b.prototype,"setupMode");v([f()],b.prototype,"setup");v([f()],b.prototype,"warningDismissed");v([f()],b.prototype,"unlimitedUses");v([f()],b.prototype,"theme");v([f()],b.prototype,"detailDirty");class js extends b{async createTarget(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i),n=i.querySelector("http-assertion-editor")?.value??[],r=je(s,s.getAll("channel_id").map(String),s.get("use_default_channels")==="on",void 0,n);this.saving=!0;try{await g("/api/v1/targets",{method:"POST",body:JSON.stringify(r)}),i.reset(),this.closeTargetDialog(),await this.refresh()}catch(a){this.error=a instanceof Error?a.message:String(a)}finally{this.saving=!1}}async updateTarget(e){if(e.preventDefault(),!this.selected)return;const i=new FormData(e.currentTarget),s=e.currentTarget.querySelector("http-assertion-editor")?.value??[];let n=`/api/v1/nodes/${this.selected.id}`,r={name:String(i.get("name"))};if(this.selected.kind==="http"){const a=i.get("follow_redirects")==="on";n=`/api/v1/targets/${this.selected.id}`,r={name:String(i.get("name")),kind:"http",url:String(i.get("url")),method:String(i.get("method")),accepted_statuses:String(i.get("statuses")).split(",").map(o=>{const[l,c]=o.trim().split("-").map(Number);return{start:l,end:c||l}}),follow_redirects:a,max_redirects:a?Number(i.get("max_redirects")):0,interval_seconds:Number(i.get("interval")),timeout_seconds:Number(i.get("timeout")),failure_threshold:Number(i.get("failures")),headers:Object.fromEntries(Object.entries(this.selected.headers).map(([o,l])=>[o,l.kind==="literal"?l.value:{secret_id:l.secret_id}])),body:this.selected.body?.kind==="literal"?this.selected.body.value:this.selected.body?{secret_id:this.selected.body.secret_id}:null,assertions:s,skip_tls_verification:i.get("skip_tls_verification")==="on",notification_channel_ids:i.getAll("channel_id").map(String),use_default_channels:i.get("use_default_channels")==="on"}}this.selected.kind!=="http"&&this.selected.kind!=="node"&&(n=`/api/v1/targets/${this.selected.id}`,r=je(i,i.getAll("channel_id").map(String),i.get("use_default_channels")==="on",this.selected.kind,s)),this.saving=!0;try{await g(n,{method:"PUT",body:JSON.stringify(r)}),this.closeDetailDialog(),await this.refresh()}catch(a){this.error=a instanceof Error?a.message:String(a)}finally{this.saving=!1}}async deleteTarget(){if(!(!this.selected||!window.confirm("Delete this target and its history?"))){this.saving=!0;try{await g(`/api/v1/targets/${this.selected.id}`,{method:"DELETE"}),this.closeDetailDialog(),await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async setPaused(e){if(this.selected){this.saving=!0;try{await g(`/api/v1/targets/${this.selected.id}/${e?"pause":"resume"}`,{method:"POST"}),this.closeDetailDialog(),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async createSecret(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);this.saving=!0;try{await g("/api/v1/secrets",{method:"POST",body:JSON.stringify({name:s.get("name"),value:s.get("value")})}),i.reset(),this.closeDialog("secret-dialog"),await this.refresh()}catch(n){this.error=n instanceof Error?n.message:String(n)}finally{this.saving=!1}}async createChannel(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i),n=this.editingChannel,r=Oe(s,this.channelKind,n!==void 0);this.saving=!0;try{await g(n?`/api/v1/channels/${n.id}`:"/api/v1/channels",{method:n?"PUT":"POST",body:JSON.stringify(r)}),await this.refresh(),i.reset(),this.editingChannel=void 0,this.channelKind="webhook",this.channelTestMessage="",this.closeDialog("channel-dialog")}catch(a){this.error=a instanceof Error?a.message:String(a)}finally{this.saving=!1}}openChannelDialog(e){this.editingChannel=e,this.channelKind=e?.kind??"webhook",this.channelTestMessage="",this.showDialog("channel-dialog")}async setChannelDefault(e,i){try{await g(`/api/v1/channels/${e.id}/default`,{method:"PUT",body:JSON.stringify({default:i})}),await this.refresh()}catch(s){this.error=s instanceof Error?s.message:String(s)}}async testChannel(e){const i=e.currentTarget.form;if(!(!i||![...i.querySelectorAll("[data-test-required]")].every(n=>n.reportValidity()))){this.testingChannel=!0,this.channelTestMessage="";try{const n=Oe(new FormData(i),this.channelKind);await g("/api/v1/channels/test",{method:"POST",body:JSON.stringify(n)}),this.channelTestMessage="Test sent"}catch(n){const r=n instanceof Error?n.message:String(n);this.channelTestMessage=`Test failed: ${r}`}finally{this.testingChannel=!1}}}openTokenDialog(){this.unlimitedUses=!1,this.showDialog("token-config-dialog")}async createJoinToken(e){e.preventDefault();const i=new FormData(e.currentTarget);this.saving=!0;try{const s=await g("/api/v1/join-tokens",{method:"POST",body:JSON.stringify({expires_in_seconds:Number(i.get("expiration_days"))*86400,max_uses:this.unlimitedUses?null:Number(i.get("max_uses"))})});this.joinCommand=`upgrid --join '${s.url}'`,this.copied=!1,await this.refresh(),this.closeDialog("token-config-dialog"),this.showDialog("join-dialog")}catch(s){this.error=s instanceof Error?s.message:String(s)}finally{this.saving=!1}}async createIdentity(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);await this.saveResource(async()=>{await g("/api/v1/identities",{method:"POST",body:JSON.stringify({username:String(s.get("username")??""),password:String(s.get("password")??"")})}),i.reset()})}async updateIdentity(e,i){i.preventDefault();const s=new FormData(i.currentTarget),n=String(s.get("password")??"");await this.saveResource(async()=>{await g(`/api/v1/identities/${e.id}`,{method:"PUT",body:JSON.stringify({username:String(s.get("username")??""),password:n||null})}),e.id===this.session?.identity_id&&n&&await this.logout()})}async deleteIdentity(e){window.confirm(`Delete identity ${e.username}? Its API Tokens will also be revoked.`)&&await this.saveResource(()=>g(`/api/v1/identities/${e.id}`,{method:"DELETE"}))}async createApiToken(e){e.preventDefault();const i=e.currentTarget,s=new FormData(i);await this.saveResource(async()=>{const n=Number(s.get("expires_in_days")),r=await g("/api/v1/api-tokens",{method:"POST",body:JSON.stringify({name:String(s.get("name")??""),expires_in_seconds:n?n*86400:null})});this.newApiToken=r.value,i.reset()})}async revokeApiToken(e){window.confirm(`Revoke API Token ${e.name}?`)&&await this.saveResource(()=>g(`/api/v1/api-tokens/${e.id}`,{method:"DELETE"}))}async setNodeDrain(e,i){await this.saveResource(()=>g(`/api/v1/nodes/${e.id}/drain`,{method:"PUT",body:JSON.stringify({draining:i,force:!1})}))}async removeNode(e,i){const s=i?`Replace failed Node ${e.name}? Confirm that it is permanently stopped. Its assignments will be released immediately.`:`Remove drained Node ${e.name} from the Cluster?`;window.confirm(s)&&(await this.saveResource(()=>g(`/api/v1/nodes/${e.id}?force=${i}`,{method:"DELETE"})),i&&!this.error&&this.openTokenDialog())}async acknowledgeAlert(e){await this.updateAlert("acknowledge",e)}async retryAlert(e){await this.updateAlert("retry",e)}async updateAlert(e,i){await this.saveResource(()=>g(`/api/v1/alerts/${e}`,{method:"POST",body:JSON.stringify({target_id:i.target_id,channel_id:i.channel_id,scheduled_at_ms:i.scheduled_at_ms,kind:i.kind})}))}async saveResource(e){this.saving=!0,this.error="";try{await e(),this.session&&await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async setupChanged(e){const i=e.detail;if(this.setup=i,this.setupMode=i.setup,window.history.replaceState(null,"",i.path),i.setup){i.cluster_ready&&(this.session=await g("/api/v1/auth/session"),await this.refresh(),this.connectEvents());return}this.activeSection="overview",await this.refresh(),this.connectEvents()}async revokeJoinToken(e){if(window.confirm("Revoke this Join Token? Nodes using it will no longer be admitted.")){this.saving=!0;try{await g(`/api/v1/join-tokens/${e.id}`,{method:"DELETE"}),await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}}async copyJoinCommand(){let e=!1;try{await navigator.clipboard.writeText(this.joinCommand),e=!0}catch{const i=Object.assign(document.createElement("textarea"),{value:this.joinCommand});i.style.cssText="position: fixed; opacity: 0",document.body.append(i),i.select(),e=document.execCommand("copy"),i.remove()}if(!e){this.error="Could not copy the Join command";return}this.copied=!0,window.setTimeout(()=>this.copied=!1,2e3)}toggleSelected(e,i){const s=new Set(this.selectedIds);i?s.add(e):s.delete(e),this.selectedIds=s}async bulkPause(e){this.saving=!0;try{await Promise.all([...this.selectedIds].map(i=>g(`/api/v1/targets/${i}/${e?"pause":"resume"}`,{method:"POST"}))),this.selectedIds=new Set,await this.refresh()}catch(i){this.error=i instanceof Error?i.message:String(i)}finally{this.saving=!1}}async bulkDelete(){if(window.confirm(`Delete ${this.selectedIds.size} selected Targets and their history?`)){this.saving=!0;try{await Promise.all([...this.selectedIds].map(e=>g(`/api/v1/targets/${e}`,{method:"DELETE"}))),this.selectedIds=new Set,await this.refresh()}catch(e){this.error=e instanceof Error?e.message:String(e)}finally{this.saving=!1}}}async deleteResource(e,i,s){if(window.confirm(`Delete ${s}?`))try{await g(`/api/v1/${e}/${i}`,{method:"DELETE"}),await this.refresh()}catch(n){this.error=n instanceof Error?n.message:String(n)}}}const Ns={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5L2 22l1.5-5.5Zm-2 2l4 4"/>'};function Rs(t,e){const i=e.search.trim().toLocaleLowerCase();return(!i||`${t.target_name} ${t.channel_name}`.toLocaleLowerCase().includes(i))&&(e.delivery==="all"||t.delivery===e.delivery)&&(e.kind==="all"||t.kind===e.kind)&&(e.acknowledged==="all"||(e.acknowledged==="yes"?t.acknowledged_at_ms!==null:t.acknowledged_at_ms===null))}function Ms(t){return t.delivery==="pending"?t.next_attempt_at_ms===null?`${t.attempts} attempts`:`${t.attempts} attempts · next ${new Date(t.next_attempt_at_ms).toLocaleString()}`:t.delivery==="failed"?t.diagnostic??"Delivery failed":t.completed_at_ms===null?"Delivered":`Delivered ${new Date(t.completed_at_ms).toLocaleString()}`}function Ls(t,e,i,s,n,r){const a=t.filter(o=>Rs(o,s));return d`
      ...
      ${a.length?a.map(o=>d`
                <div class="resource alert-resource">
                  <div class="alert-summary">
                    ...
                    <span class="meta">${Ms(o)}</span>
                  </div>
                  <div class="alert-actions">
                    ${o.delivery==="failed"?d`<button class="button secondary" ?disabled=${n} @click=${()=>r.retry(o)}>Retry</button>`:h}
                    ${o.acknowledged_at_ms===null?d`<button class="button secondary" ?disabled=${n} @click=${()=>r.acknowledge(o)}>Acknowledge</button>`:h}
                  </div>
                </div>
        ...
        ${i.length?i.map(o=>d`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  ...
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${o.name}`} title=${`Edit ${o.name}`} @click=${()=>r.edit(o)}><iconify-icon .icon=${Ns} aria-hidden="true"></iconify-icon></button>
                  <button class="button danger icon-button" aria-label=${`Delete channel ${o.name}`} title=${`Delete ${o.name}`} @click=${()=>r.remove(o)}><iconify-icon .icon=${ce} aria-hidden="true"></iconify-icon></button>
                </div>
              </div>
            `):d`<div class="empty">No notification channels.</div>`}
      </section>
    </div>
  `}function Us(t,e,i){return d`
    ...
    </main>`}function qs(t,e,i,s,n,r){return d`
    <div class="page-columns access-panels">
      ...
      <section class="panel" aria-label="API Tokens">
        ...
        ${s?d`<div class="notice token-value" role="status"><strong>Copy this token now.</strong><code>${s}</code><button class="button secondary" @click=${r.dismissToken}>Dismiss</button></div>`:h}
    ...
    </div>`}const Fs={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4m0-4h.01"/></g>'},zs=ge`
...
`;function he(t,e,i){return d`
  ...
  `}function Hs(t,e){return t==="webhook"?d`<label
    ...
    /></label>`:t==="telegram"?d`
      <label
        ><span class="title-with-help"
          >Bot token
          ${he("telegram-token-help","About Telegram bot token storage",e?"Leave this blank to keep the automatically managed Secret, or enter a replacement token.":"Creating the Channel encrypts this token as an automatically managed Secret. Test sends use the entered value without storing it.")}</span
        ><input
          name="bot_token"
          type="password"
          autocomplete="off"
    ...
    <div class="form-field">
      <div class="title-with-help">
        ...
        ${he("smtp-password-help","About SMTP password storage",e?"Leave this blank to keep the automatically managed Secret. Clear the username to disable authentication.":"Enter a username and password together to enable authentication. The password is encrypted as an automatically managed Secret.")}
      </div>
      <input
        id="smtp-password"
        name="password"
    ...
    <footer aria-label="Project information">
      <div class="footer-links">
        ...
        <a href="https://github.com/George-Miao/UpGrid">
          <iconify-icon .icon=${Js} aria-hidden="true"></iconify-icon>GitHub
        </a>
        <span aria-hidden="true">|</span>
        <a href="https://upgrid.rs">
          <iconify-icon .icon=${Bs} aria-hidden="true"></iconify-icon>upgrid.rs
        </a>
      </div>
  ...
  `}function Wt(t,e=[],i=!0){return d`
    ...
    </fieldset>`}const Qt={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Yt(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=Qt[e],i.type=e==="http"?"url":"text");const s=t.querySelector("[data-http-options]");s&&(s.hidden=e!=="http");const n=t.elements.namedItem("method");n&&(n.disabled=e!=="http",n.disabled&&(n.value="GET"))}function Ks(t){const e=t.currentTarget;e.form&&Yt(e.form,e.value)}function Vs(t){const e=t.currentTarget;queueMicrotask(()=>Yt(e,"http"))}function Gs(t,e,i){return d`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${i.backdrop}>
      <div class="dialog-head"><div class="title-with-help"><h2 id="add-target-title">Add target</h2>${he("target-secret-help","About Target Secrets","Advanced Target headers and request bodies can reference reusable Secrets through the HTTP API.")}</div><p>Start monitoring a service.</p></div>
      <form @submit=${i.create} @reset=${Vs}>
        <label>Name<input name="name" placeholder="Production API" required autofocus /></label>
        <div class="row">
          <label>Type<select name="kind" @change=${Ks}><option value="http">HTTP</option><option value="tcp">TCP connect</option><option value="dns">DNS resolution</option><option value="icmp">ICMP echo</option><option value="tls">TLS certificate</option></select></label>
          <label>URL / endpoint<input name="url" type="url" placeholder=${Qt.http} required /></label>
        </div>
    ...
    </dialog>`}function Ws(t,e,i,s,n,r){const a=t.kind==="node",o=t.kind==="http",l=t.accepted_statuses.map(m=>m.start===m.end?m.start:`${m.start}-${m.end}`).join(","),c=t.history.slice(0,30).reverse(),p=Math.max(1,...c.map(m=>m.latency_ms)),u=new Map(s.map(m=>[m.id,m.name])),y=m=>new Date(m).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),x=m=>m>=1e3?`${(m/1e3).toFixed(m>=1e4?0:1)} s`:`${Math.round(m)} ms`;return d`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${r.backdrop}>
      <div class="dialog-head">
        ...
        <button class="button secondary icon-button dialog-close" type="button" aria-label=${`Close ${a?"Node":"Target"} details`} title="Close" @click=${r.close}><iconify-icon .icon=${Et} aria-hidden="true"></iconify-icon></button>
      </div>
      <form @submit=${r.update} @input=${r.changed}>
        ...
        ${a?d`<label>RPC URL<input .value=${t.url} disabled /></label>`:d`
              ...
              ${Wt(n,t.notification_channel_ids,t.use_default_channels)}
            `}
        <div class="dialog-actions">
          ${a?h:d`<div class="danger-actions">
            <button class="button danger icon-button" type="button" aria-label="Delete target" title="Delete target" @click=${r.delete}><iconify-icon .icon=${ce} aria-hidden="true"></iconify-icon></button>
            <button class=${`button ${t.paused?"success":"warning"} icon-button`} type="button" aria-label=${t.paused?"Resume evaluations":"Pause evaluations"} title=${t.paused?"Resume evaluations":"Pause evaluations"} @click=${()=>r.pause(!t.paused)}><iconify-icon .icon=${t.paused?Pt:Ct} aria-hidden="true"></iconify-icon></button>
          </div>`}
      ...
      <section class="history">
        ...
        ${c.length?d`
          <div class="chart-plot">
            <div class="chart-scale" aria-hidden="true"><span>${x(p)}</span><span>${x(p/2)}</span><span>0 ms</span></div>
            <div class="history-chart" role="list" aria-label=${`Recent evaluation latency, 0 to ${x(p)}`}>
              ${c.map(m=>{const A=m.succeeded?"Passed":"Failed",w=a||!o?m.succeeded?"reachable":"unreachable":m.status_code===null?"network error":`HTTP ${m.status_code}`,F=u.get(m.executor_node_id)??`Node ${m.executor_node_id.slice(0,8)}`,T=`${A} at ${new Date(m.recorded_at_ms).toLocaleString()}: ${m.latency_ms} ms, ${w}. Executed by ${F}`;return d`<span class="history-bar ${m.succeeded?"up":"down"}" role="listitem" aria-label=${T} title=${T} style=${`height: ${Math.max(8,m.latency_ms/p*100)}%`}></span>`})}
            </div>
          </div>
    ...
    </dialog>`}var Qs=Object.getOwnPropertyDescriptor,Ys=(t,e,i,s)=>{for(var n=s>1?void 0:s?Qs(e,i):e,r=t.length-1,a;r>=0;r--)(a=t[r])&&(n=a(n)||n);return n};let Ne=class extends js{render(){const t=this.targets.filter(a=>a.availability==="up").length,e=this.targets.filter(a=>a.availability==="down").length,i=this.alerts.filter(a=>a.delivery==="pending").length,s=Is(this.targets,this.live),n=["overview","alerts","cluster"],r=this.targets.filter(a=>`${a.name} ${a.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(a=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?a.paused:a.availability===this.statusFilter).sort((a,o)=>this.sort==="status"&&a.availability.localeCompare(o.availability)||a.name.localeCompare(o.name));return this.authReady&&!this.setupMode&&!this.session?d`${Us(this.saving,this.error,{login:a=>{this.login(a)}})}${Te()}`:this.setupMode&&this.setup?d`
        <main class="shell setup-shell">
          <header>
            <div class="brand">
            ...
            <div></div>
            <div class="actions"><button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${$t[this.theme]} aria-hidden="true"></iconify-icon></button></div>
          </header>
          ${this.error?d`<div class="notice" role="alert">${this.error}</div>`:h}
      ...
      <main class="shell">
        <header>
          ...
          <nav aria-label="Primary">
            ${n.map(a=>d`<a class=${this.activeSection===a?"active":""} href=${Ve[a]} @click=${o=>this.navigate(o,a)}>${a[0].toUpperCase()}${a.slice(1)}</a>`)}
          </nav>
          <div class="actions">
            <button class="button secondary icon-button" aria-label=${`Theme: ${this.theme[0].toUpperCase()}${this.theme.slice(1)}`} title=${`Theme: ${this.theme}. Click to switch.`} @click=${this.cycleTheme}><iconify-icon .icon=${$t[this.theme]} aria-hidden="true"></iconify-icon></button>
        ...
        ${this.activeSection==="overview"?this.renderOverview(r,t,e,i):this.activeSection==="alerts"?Ls(this.alerts,this.transitions,this.channels,{search:this.alertSearch,delivery:this.alertDeliveryFilter,kind:this.alertKindFilter,acknowledged:this.alertAcknowledgedFilter},this.saving,{create:()=>this.openChannelDialog(),edit:a=>this.openChannelDialog(a),remove:a=>{this.deleteResource("channels",a.id,a.name)},setDefault:(a,o)=>{this.setChannelDefault(a,o)},acknowledge:a=>{this.acknowledgeAlert(a)},retry:a=>{this.retryAlert(a)},setSearch:a=>this.alertSearch=a,setDelivery:a=>this.alertDeliveryFilter=a,setKind:a=>this.alertKindFilter=a,setAcknowledged:a=>this.alertAcknowledgedFilter=a}):this.renderClusterPage()}
      </main>${Te()}
      ${Gs(this.channels,this.saving,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeTargetDialog(),create:a=>{this.createTarget(a)}})}
      ${this.selected?Ws(this.selected,this.saving,this.detailDirty,this.cluster?.members??[],this.channels,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeDetailDialog(),update:a=>{this.updateTarget(a)},changed:a=>this.updateDetailDirty(a),redirects:a=>this.toggleMaxRedirects(a),delete:()=>{this.deleteTarget()},pause:a=>{this.setPaused(a)}}):h}
      ...
      <dialog id="channel-dialog" aria-labelledby="channel-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createChannel}>
          ...
          ${Hs(this.channelKind,this.editingChannel)}
    ...
    `}renderOverview(t,e,i,s){const n=this.targets.filter(o=>this.selectedIds.has(o.id)),r=n.some(o=>!o.paused),a=n.some(o=>o.paused);return d`
      ...
      <section class="panel" aria-label="Targets">
        ...
        ${this.selectedIds.size?d`<div class="bulk"><span class="meta">${this.selectedIds.size} selected</span><div class="bulk-actions"><button class="button secondary icon-button" aria-label="Unselect all" title="Unselect all" @click=${()=>this.selectedIds=new Set}><iconify-icon .icon=${Et} aria-hidden="true"></iconify-icon></button>${r?d`<button class="button warning icon-button" aria-label="Pause selected" title="Pause selected" @click=${()=>this.bulkPause(!0)}><iconify-icon .icon=${Ct} aria-hidden="true"></iconify-icon></button>`:h}${a?d`<button class="button success icon-button" aria-label="Resume selected" title="Resume selected" @click=${()=>this.bulkPause(!1)}><iconify-icon .icon=${Pt} aria-hidden="true"></iconify-icon></button>`:h}<button class="button danger icon-button" aria-label="Delete selected" title="Delete selected" @click=${this.bulkDelete}><iconify-icon .icon=${ce} aria-hidden="true"></iconify-icon></button></div></div>`:h}
      ...
      <div class="target-wrap">
        ...
        <button class=${`target ${e?"node-target":""}`} aria-label=${t.name} @click=${()=>this.openTarget(t)}>
          ...
          <div class="target-side">
            ${n.length?d`<div class="mini-chart" aria-hidden="true">${n.map(o=>d`<i class="mini-bar ${o.succeeded?"up":"down"}" style=${`height: ${Math.max(12,o.latency_ms/r*100)}%`}></i>`)}</div>`:h}
            <div class="latency">
