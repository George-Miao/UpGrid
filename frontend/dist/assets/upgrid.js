(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function i(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=i(n);fetch(n.href,r)}})();const oe=globalThis,Ue=oe.ShadowRoot&&(oe.ShadyCSS===void 0||oe.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,qe=Symbol(),Ze=new WeakMap;let At=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==qe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(Ue&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Ze.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Ze.set(i,e))}return e}toString(){return this.cssText}};const ii=t=>new At(typeof t=="string"?t:t+"",void 0,qe),be=(t,...e)=>{const i=t.length===1?t[0]:e.reduce((s,n,r)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+t[r+1],t[0]);return new At(i,t,qe)},si=(t,e)=>{if(Ue)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),n=oe.litNonce;n!==void 0&&s.setAttribute("nonce",n),s.textContent=i.cssText,t.appendChild(s)}},Xe=Ue?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return ii(i)})(t):t;const{is:ni,defineProperty:ai,getOwnPropertyDescriptor:ri,getOwnPropertyNames:oi,getOwnPropertySymbols:li,getPrototypeOf:ci}=Object,ve=globalThis,et=ve.trustedTypes,di=et?et.emptyScript:"",ui=ve.reactiveElementPolyfillSupport,W=(t,e)=>t,ue={toAttribute(t,e){switch(e){case Boolean:t=t?di:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},Fe=(t,e)=>!ni(t,e),tt={attribute:!0,type:String,converter:ue,reflect:!1,useDefault:!1,hasChanged:Fe};Symbol.metadata??=Symbol("metadata"),ve.litPropertyMetadata??=new WeakMap;let q=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=tt){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),n=this.getPropertyDescriptor(e,s,i);n!==void 0&&ai(this.prototype,e,n)}}static getPropertyDescriptor(e,i,s){const{get:n,set:r}=ri(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:n,set(o){const a=n?.call(this);r?.call(this,o),this.requestUpdate(e,a,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??tt}static _$Ei(){if(this.hasOwnProperty(W("elementProperties")))return;const e=ci(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(W("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(W("properties"))){const i=this.properties,s=[...oi(i),...li(i)];for(const n of s)this.createProperty(n,i[n])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,n]of i)this.elementProperties.set(s,n)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const n=this._$Eu(i,s);n!==void 0&&this._$Eh.set(n,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const n of s)i.unshift(Xe(n))}else e!==void 0&&i.push(Xe(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return si(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){const s=this.constructor.elementProperties.get(e),n=this.constructor._$Eu(e,s);if(n!==void 0&&s.reflect===!0){const r=(s.converter?.toAttribute!==void 0?s.converter:ue).toAttribute(i,s.type);this._$Em=e,r==null?this.removeAttribute(n):this.setAttribute(n,r),this._$Em=null}}_$AK(e,i){const s=this.constructor,n=s._$Eh.get(e);if(n!==void 0&&this._$Em!==n){const r=s.getPropertyOptions(n),o=typeof r.converter=="function"?{fromAttribute:r.converter}:r.converter?.fromAttribute!==void 0?r.converter:ue;this._$Em=n;const a=o.fromAttribute(i,r.type);this[n]=a??this._$Ej?.get(n)??a,this._$Em=null}}requestUpdate(e,i,s,n=!1,r){if(e!==void 0){const o=this.constructor;if(n===!1&&(r=this[e]),s??=o.getPropertyOptions(e),!((s.hasChanged??Fe)(r,i)||s.useDefault&&s.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(o._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:n,wrapped:r},o){s&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,o??i??this[e]),r!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),n===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[n,r]of this._$Ep)this[n]=r;this._$Ep=void 0}const s=this.constructor.elementProperties;if(s.size>0)for(const[n,r]of s){const{wrapped:o}=r,a=this[n];o!==!0||this._$AL.has(n)||a===void 0||this.C(n,void 0,r,a)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(s=>s.hostUpdate?.()),this.update(i)):this._$EM()}catch(s){throw e=!1,this._$EM(),s}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};q.elementStyles=[],q.shadowRootOptions={mode:"open"},q[W("elementProperties")]=new Map,q[W("finalized")]=new Map,ui?.({ReactiveElement:q}),(ve.reactiveElementVersions??=[]).push("2.1.2");const ze=globalThis,it=t=>t,pe=ze.trustedTypes,st=pe?pe.createPolicy("lit-html",{createHTML:t=>t}):void 0,Ct="$lit$",I=`lit$${Math.random().toFixed(9).slice(2)}$`,Et="?"+I,pi=`<${Et}>`,M=document,Z=()=>M.createComment(""),X=t=>t===null||typeof t!="object"&&typeof t!="function",He=Array.isArray,hi=t=>He(t)||typeof t?.[Symbol.iterator]=="function",_e=`[ 	
\f\r]`,K=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,nt=/-->/g,at=/>/g,N=RegExp(`>|${_e}(?:([^\\s"'>=/]+)(${_e}*=${_e}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),rt=/'/g,ot=/"/g,Pt=/^(?:script|style|textarea|title)$/i,gi=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),c=gi(1),z=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),lt=new WeakMap,j=M.createTreeWalker(M,129);function Dt(t,e){if(!He(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return st!==void 0?st.createHTML(e):e}const mi=(t,e)=>{const i=t.length-1,s=[];let n,r=e===2?"<svg>":e===3?"<math>":"",o=K;for(let a=0;a<i;a++){const l=t[a];let d,u,p=-1,y=0;for(;y<l.length&&(o.lastIndex=y,u=o.exec(l),u!==null);)y=o.lastIndex,o===K?u[1]==="!--"?o=nt:u[1]!==void 0?o=at:u[2]!==void 0?(Pt.test(u[2])&&(n=RegExp("</"+u[2],"g")),o=N):u[3]!==void 0&&(o=N):o===N?u[0]===">"?(o=n??K,p=-1):u[1]===void 0?p=-2:(p=o.lastIndex-u[2].length,d=u[1],o=u[3]===void 0?N:u[3]==='"'?ot:rt):o===ot||o===rt?o=N:o===nt||o===at?o=K:(o=N,n=void 0);const $=o===N&&t[a+1].startsWith("/>")?" ":"";r+=o===K?l+pi:p>=0?(s.push(d),l.slice(0,p)+Ct+l.slice(p)+I+$):l+I+(p===-2?a:$)}return[Dt(t,r+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class ee{constructor({strings:e,_$litType$:i},s){let n;this.parts=[];let r=0,o=0;const a=e.length-1,l=this.parts,[d,u]=mi(e,i);if(this.el=ee.createElement(d,s),j.currentNode=this.el.content,i===2||i===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=j.nextNode())!==null&&l.length<a;){if(n.nodeType===1){if(n.hasAttributes())for(const p of n.getAttributeNames())if(p.endsWith(Ct)){const y=u[o++],$=n.getAttribute(p).split(I),w=/([.?@])?(.*)/.exec(y);l.push({type:1,index:r,name:w[2],strings:$,ctor:w[1]==="."?bi:w[1]==="?"?vi:w[1]==="@"?yi:ye}),n.removeAttribute(p)}else p.startsWith(I)&&(l.push({type:6,index:r}),n.removeAttribute(p));if(Pt.test(n.tagName)){const p=n.textContent.split(I),y=p.length-1;if(y>0){n.textContent=pe?pe.emptyScript:"";for(let $=0;$<y;$++)n.append(p[$],Z()),j.nextNode(),l.push({type:2,index:++r});n.append(p[y],Z())}}}else if(n.nodeType===8)if(n.data===Et)l.push({type:2,index:r});else{let p=-1;for(;(p=n.data.indexOf(I,p+1))!==-1;)l.push({type:7,index:r}),p+=I.length-1}r++}}static createElement(e,i){const s=M.createElement("template");return s.innerHTML=e,s}}function H(t,e,i=t,s){if(e===z)return e;let n=s!==void 0?i._$Co?.[s]:i._$Cl;const r=X(e)?void 0:e._$litDirective$;return n?.constructor!==r&&(n?._$AO?.(!1),r===void 0?n=void 0:(n=new r(t),n._$AT(t,i,s)),s!==void 0?(i._$Co??=[])[s]=n:i._$Cl=n),n!==void 0&&(e=H(t,n._$AS(t,e.values),n,s)),e}class fi{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,n=(e?.creationScope??M).importNode(i,!0);j.currentNode=n;let r=j.nextNode(),o=0,a=0,l=s[0];for(;l!==void 0;){if(o===l.index){let d;l.type===2?d=new se(r,r.nextSibling,this,e):l.type===1?d=new l.ctor(r,l.name,l.strings,this,e):l.type===6&&(d=new xi(r,this,e)),this._$AV.push(d),l=s[++a]}o!==l?.index&&(r=j.nextNode(),o++)}return j.currentNode=M,n}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class se{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,s,n){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=H(this,e,i),X(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==z&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):hi(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&X(this._$AH)?this._$AA.nextSibling.data=e:this.T(M.createTextNode(e)),this._$AH=e}$(e){const{values:i,_$litType$:s}=e,n=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=ee.createElement(Dt(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===n)this._$AH.p(i);else{const r=new fi(n,this),o=r.u(this.options);r.p(i),this.T(o),this._$AH=r}}_$AC(e){let i=lt.get(e.strings);return i===void 0&&lt.set(e.strings,i=new ee(e)),i}k(e){He(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,n=0;for(const r of e)n===i.length?i.push(s=new se(this.O(Z()),this.O(Z()),this,this.options)):s=i[n],s._$AI(r),n++;n<i.length&&(this._$AR(s&&s._$AB.nextSibling,n),i.length=n)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){const s=it(e).nextSibling;it(e).remove(),e=s}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class ye{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,n,r){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=i,this._$AM=n,this.options=r,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,i=this,s,n){const r=this.strings;let o=!1;if(r===void 0)e=H(this,e,i,0),o=!X(e)||e!==this._$AH&&e!==z,o&&(this._$AH=e);else{const a=e;let l,d;for(e=r[0],l=0;l<r.length-1;l++)d=H(this,a[s+l],i,l),d===z&&(d=this._$AH[l]),o||=!X(d)||d!==this._$AH[l],d===m?e=m:e!==m&&(e+=(d??"")+r[l+1]),this._$AH[l]=d}o&&!n&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class bi extends ye{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class vi extends ye{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class yi extends ye{constructor(e,i,s,n,r){super(e,i,s,n,r),this.type=5}_$AI(e,i=this){if((e=H(this,e,i,0)??m)===z)return;const s=this._$AH,n=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,r=e!==m&&(s===m||n);n&&this.element.removeEventListener(this.name,this,s),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class xi{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){H(this,e)}}const $i=ze.litHtmlPolyfillSupport;$i?.(ee,se),(ze.litHtmlVersions??=[]).push("3.3.3");const wi=(t,e,i)=>{const s=i?.renderBefore??e;let n=s._$litPart$;if(n===void 0){const r=i?.renderBefore??null;s._$litPart$=n=new se(e.insertBefore(Z(),r),r,void 0,i??{})}return n._$AI(t),n};const Je=globalThis;class R extends q{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=wi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return z}}R._$litElement$=!0,R.finalized=!0,Je.litElementHydrateSupport?.({LitElement:R});const ki=Je.litElementPolyfillSupport;ki?.({LitElement:R});(Je.litElementVersions??=[]).push("4.2.2");const Be=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};const _i={attribute:!0,type:String,converter:ue,reflect:!1,hasChanged:Fe},Si=(t=_i,e,i)=>{const{kind:s,metadata:n}=i;let r=globalThis.litPropertyMetadata.get(n);if(r===void 0&&globalThis.litPropertyMetadata.set(n,r=new Map),s==="setter"&&((t=Object.create(t)).wrapped=!0),r.set(i.name,t),s==="accessor"){const{name:o}=i;return{set(a){const l=e.get.call(this);e.set.call(this,a),this.requestUpdate(o,l,t,!0,a)},init(a){return a!==void 0&&this.C(o,void 0,t,a),a}}}if(s==="setter"){const{name:o}=i;return function(a){const l=this[o];e.call(this,a),this.requestUpdate(o,l,t,!0,a)}}throw Error("Unsupported decorator location: "+s)};function xe(t){return(e,i)=>typeof i=="object"?Si(t,e,i):((s,n,r)=>{const o=n.hasOwnProperty(r);return n.constructor.createProperty(r,s),o?Object.getOwnPropertyDescriptor(n,r):void 0})(t,e,i)}function f(t){return xe({...t,state:!0,attribute:!1})}const It={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 4h4v16H6zm8 0h4v16h-4z"/>'},Ot={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m5 3l14 9l-14 9V3z"/>'},he={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6h18m-2 0v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6m3 0V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2m-6 5v6m4-6v6"/>'},Nt={width:24,height:24,body:'<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 6L6 18M6 6l12 12"/>'},Ti={width:24,height:24,body:'<g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></g>'};const jt=Object.freeze({left:0,top:0,width:16,height:16}),ge=Object.freeze({rotate:0,vFlip:!1,hFlip:!1}),ne=Object.freeze({...jt,...ge}),Pe=Object.freeze({...ne,body:"",hidden:!1}),Ai=Object.freeze({width:null,height:null}),Rt=Object.freeze({...Ai,...ge});function Ci(t,e=0){const i=t.replace(/^-?[0-9.]*/,"");function s(n){for(;n<0;)n+=4;return n%4}if(i===""){const n=parseInt(t);return isNaN(n)?0:s(n)}else if(i!==t){let n=0;switch(i){case"%":n=25;break;case"deg":n=90}if(n){let r=parseFloat(t.slice(0,t.length-i.length));return isNaN(r)?0:(r=r/n,r%1===0?s(r):0)}}return e}const Ei=/[\s,]+/;function Pi(t,e){e.split(Ei).forEach(i=>{switch(i.trim()){case"horizontal":t.hFlip=!0;break;case"vertical":t.vFlip=!0;break}})}const Mt={...Rt,preserveAspectRatio:""};function ct(t){const e={...Mt},i=(s,n)=>t.getAttribute(s)||n;return e.width=i("width",null),e.height=i("height",null),e.rotate=Ci(i("rotate","")),Pi(e,i("flip","")),e.preserveAspectRatio=i("preserveAspectRatio",i("preserveaspectratio","")),e}function Di(t,e){for(const i in Mt)if(t[i]!==e[i])return!0;return!1}const Lt=/^[a-z0-9]+(-[a-z0-9]+)*$/,ae=(t,e,i,s="")=>{const n=t.split(":");if(t.slice(0,1)==="@"){if(n.length<2||n.length>3)return null;s=n.shift().slice(1)}if(n.length>3||!n.length)return null;if(n.length>1){const a=n.pop(),l=n.pop(),d={provider:n.length>0?n[0]:s,prefix:l,name:a};return e&&!le(d)?null:d}const r=n[0],o=r.split("-");if(o.length>1){const a={provider:s,prefix:o.shift(),name:o.join("-")};return e&&!le(a)?null:a}if(i&&s===""){const a={provider:s,prefix:"",name:r};return e&&!le(a,i)?null:a}return null},le=(t,e)=>t?!!((e&&t.prefix===""||t.prefix)&&t.name):!1;function Ii(t,e){const i=t.icons,s=t.aliases||Object.create(null),n=Object.create(null);function r(o){if(i[o])return n[o]=[];if(!(o in n)){n[o]=null;const a=s[o]&&s[o].parent,l=a&&r(a);l&&(n[o]=[a].concat(l))}return n[o]}return Object.keys(i).concat(Object.keys(s)).forEach(r),n}function Oi(t,e){const i={};!t.hFlip!=!e.hFlip&&(i.hFlip=!0),!t.vFlip!=!e.vFlip&&(i.vFlip=!0);const s=((t.rotate||0)+(e.rotate||0))%4;return s&&(i.rotate=s),i}function dt(t,e){const i=Oi(t,e);for(const s in Pe)s in ge?s in t&&!(s in i)&&(i[s]=ge[s]):s in e?i[s]=e[s]:s in t&&(i[s]=t[s]);return i}function Ni(t,e,i){const s=t.icons,n=t.aliases||Object.create(null);let r={};function o(a){r=dt(s[a]||n[a],r)}return o(e),i.forEach(o),dt(t,r)}function Ut(t,e){const i=[];if(typeof t!="object"||typeof t.icons!="object")return i;t.not_found instanceof Array&&t.not_found.forEach(n=>{e(n,null),i.push(n)});const s=Ii(t);for(const n in s){const r=s[n];r&&(e(n,Ni(t,n,r)),i.push(n))}return i}const ji={provider:"",aliases:{},not_found:{},...jt};function Se(t,e){for(const i in e)if(i in t&&typeof t[i]!=typeof e[i])return!1;return!0}function qt(t){if(typeof t!="object"||t===null)return null;const e=t;if(typeof e.prefix!="string"||!t.icons||typeof t.icons!="object"||!Se(t,ji))return null;const i=e.icons;for(const n in i){const r=i[n];if(!n||typeof r.body!="string"||!Se(r,Pe))return null}const s=e.aliases||Object.create(null);for(const n in s){const r=s[n],o=r.parent;if(!n||typeof o!="string"||!i[o]&&!s[o]||!Se(r,Pe))return null}return e}const me=Object.create(null);function Ri(t,e){return{provider:t,prefix:e,icons:Object.create(null),missing:new Set}}function P(t,e){const i=me[t]||(me[t]=Object.create(null));return i[e]||(i[e]=Ri(t,e))}function Ft(t,e){return qt(e)?Ut(e,(i,s)=>{s?t.icons[i]=s:t.missing.add(i)}):[]}function Mi(t,e,i){try{if(typeof i.body=="string")return t.icons[e]={...i},!0}catch{}return!1}function Li(t,e){let i=[];return(typeof t=="string"?[t]:Object.keys(me)).forEach(s=>{(typeof s=="string"&&typeof e=="string"?[e]:Object.keys(me[s]||{})).forEach(n=>{const r=P(s,n);i=i.concat(Object.keys(r.icons).map(o=>(s!==""?"@"+s+":":"")+n+":"+o))})}),i}let te=!1;function zt(t){return typeof t=="boolean"&&(te=t),te}function ie(t){const e=typeof t=="string"?ae(t,!0,te):t;if(e){const i=P(e.provider,e.prefix),s=e.name;return i.icons[s]||(i.missing.has(s)?null:void 0)}}function Ht(t,e){const i=ae(t,!0,te);if(!i)return!1;const s=P(i.provider,i.prefix);return e?Mi(s,i.name,e):(s.missing.add(i.name),!0)}function ut(t,e){if(typeof t!="object")return!1;if(typeof e!="string"&&(e=t.provider||""),te&&!e&&!t.prefix){let s=!1;return qt(t)&&(t.prefix="",Ut(t,(n,r)=>{Ht(n,r)&&(s=!0)})),s}const i=t.prefix;return le({prefix:i,name:"a"})?!!Ft(P(e,i),t):!1}function Ui(t){return!!ie(t)}function qi(t){const e=ie(t);return e&&{...ne,...e}}function Jt(t,e){t.forEach(i=>{const s=i.loaderCallbacks;s&&(i.loaderCallbacks=s.filter(n=>n.id!==e))})}function Fi(t){t.pendingCallbacksFlag||(t.pendingCallbacksFlag=!0,setTimeout(()=>{t.pendingCallbacksFlag=!1;const e=t.loaderCallbacks?t.loaderCallbacks.slice(0):[];if(!e.length)return;let i=!1;const s=t.provider,n=t.prefix;e.forEach(r=>{const o=r.icons,a=o.pending.length;o.pending=o.pending.filter(l=>{if(l.prefix!==n)return!0;const d=l.name;if(t.icons[d])o.loaded.push({provider:s,prefix:n,name:d});else if(t.missing.has(d))o.missing.push({provider:s,prefix:n,name:d});else return i=!0,!0;return!1}),o.pending.length!==a&&(i||Jt([t],r.id),r.callback(o.loaded.slice(0),o.missing.slice(0),o.pending.slice(0),r.abort))})}))}let zi=0;function Hi(t,e,i){const s=zi++,n=Jt.bind(null,i,s);if(!e.pending.length)return n;const r={id:s,icons:e,callback:t,abort:n};return i.forEach(o=>{(o.loaderCallbacks||(o.loaderCallbacks=[])).push(r)}),n}function Ji(t){const e={loaded:[],missing:[],pending:[]},i=Object.create(null);t.sort((n,r)=>n.provider!==r.provider?n.provider.localeCompare(r.provider):n.prefix!==r.prefix?n.prefix.localeCompare(r.prefix):n.name.localeCompare(r.name));let s={provider:"",prefix:"",name:""};return t.forEach(n=>{if(s.name===n.name&&s.prefix===n.prefix&&s.provider===n.provider)return;s=n;const r=n.provider,o=n.prefix,a=n.name,l=i[r]||(i[r]=Object.create(null)),d=l[o]||(l[o]=P(r,o));let u;a in d.icons?u=e.loaded:o===""||d.missing.has(a)?u=e.missing:u=e.pending;const p={provider:r,prefix:o,name:a};u.push(p)}),e}const De=Object.create(null);function pt(t,e){De[t]=e}function Ie(t){return De[t]||De[""]}function Bi(t,e=!0,i=!1){const s=[];return t.forEach(n=>{const r=typeof n=="string"?ae(n,e,i):n;r&&s.push(r)}),s}function Ke(t){let e;if(typeof t.resources=="string")e=[t.resources];else if(e=t.resources,!(e instanceof Array)||!e.length)return null;return{resources:e,path:t.path||"/",maxURL:t.maxURL||500,rotate:t.rotate||750,timeout:t.timeout||5e3,random:t.random===!0,index:t.index||0,dataAfterTimeout:t.dataAfterTimeout!==!1}}const $e=Object.create(null),V=["https://api.simplesvg.com","https://api.unisvg.com"],ce=[];for(;V.length>0;)V.length===1||Math.random()>.5?ce.push(V.shift()):ce.push(V.pop());$e[""]=Ke({resources:["https://api.iconify.design"].concat(ce)});function ht(t,e){const i=Ke(e);return i===null?!1:($e[t]=i,!0)}function we(t){return $e[t]}function Ki(){return Object.keys($e)}const Vi={resources:[],index:0,timeout:2e3,rotate:750,random:!1,dataAfterTimeout:!1};function Gi(t,e,i,s){const n=t.resources.length,r=t.random?Math.floor(Math.random()*n):t.index;let o;if(t.random){let x=t.resources.slice(0);for(o=[];x.length>1;){const h=Math.floor(Math.random()*x.length);o.push(x[h]),x=x.slice(0,h).concat(x.slice(h+1))}o=o.concat(x)}else o=t.resources.slice(r).concat(t.resources.slice(0,r));const a=Date.now();let l="pending",d=0,u,p=null,y=[],$=[];typeof s=="function"&&$.push(s);function w(){p&&(clearTimeout(p),p=null)}function S(){l==="pending"&&(l="aborted"),w(),y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function k(x,h){h&&($=[]),typeof x=="function"&&$.push(x)}function B(){return{startTime:a,payload:e,status:l,queriesSent:d,queriesPending:y.length,subscribe:k,abort:S}}function C(){l="failed",$.forEach(x=>{x(void 0,u)})}function T(){y.forEach(x=>{x.status==="pending"&&(x.status="aborted")}),y=[]}function _(x,h,A){const U=h!=="success";switch(y=y.filter(E=>E!==x),l){case"pending":break;case"failed":if(U||!t.dataAfterTimeout)return;break;default:return}if(h==="abort"){u=A,C();return}if(U){u=A,y.length||(o.length?D():C());return}if(w(),T(),!t.random){const E=t.resources.indexOf(x.resource);E!==-1&&E!==t.index&&(t.index=E)}l="completed",$.forEach(E=>{E(A)})}function D(){if(l!=="pending")return;w();const x=o.shift();if(x===void 0){if(y.length){p=setTimeout(()=>{w(),l==="pending"&&(T(),C())},t.timeout);return}C();return}const h={status:"pending",resource:x,callback:(A,U)=>{_(h,A,U)}};y.push(h),d++,p=setTimeout(D,t.rotate),i(x,e,h.callback)}return setTimeout(D),B}function Bt(t){const e={...Vi,...t};let i=[];function s(){i=i.filter(o=>o().status==="pending")}function n(o,a,l){const d=Gi(e,o,a,(u,p)=>{s(),l&&l(u,p)});return i.push(d),d}function r(o){return i.find(a=>o(a))||null}return{query:n,find:r,setIndex:o=>{e.index=o},getIndex:()=>e.index,cleanup:s}}function gt(){}const Te=Object.create(null);function Wi(t){if(!Te[t]){const e=we(t);if(!e)return;Te[t]={config:e,redundancy:Bt(e)}}return Te[t]}function Kt(t,e,i){let s,n;if(typeof t=="string"){const r=Ie(t);if(!r)return i(void 0,424),gt;n=r.send;const o=Wi(t);o&&(s=o.redundancy)}else{const r=Ke(t);if(r){s=Bt(r);const o=Ie(t.resources?t.resources[0]:"");o&&(n=o.send)}}return!s||!n?(i(void 0,424),gt):s.query(e,n,i)().abort}function mt(){}function Qi(t){t.iconsLoaderFlag||(t.iconsLoaderFlag=!0,setTimeout(()=>{t.iconsLoaderFlag=!1,Fi(t)}))}function Yi(t){const e=[],i=[];return t.forEach(s=>{(s.match(Lt)?e:i).push(s)}),{valid:e,invalid:i}}function G(t,e,i){function s(){const n=t.pendingIcons;e.forEach(r=>{n&&n.delete(r),t.icons[r]||t.missing.add(r)})}if(i&&typeof i=="object")try{if(!Ft(t,i).length){s();return}}catch(n){console.error(n)}s(),Qi(t)}function ft(t,e){t instanceof Promise?t.then(i=>{e(i)}).catch(()=>{e(null)}):e(t)}function Zi(t,e){t.iconsToLoad?t.iconsToLoad=t.iconsToLoad.concat(e).sort():t.iconsToLoad=e,t.iconsQueueFlag||(t.iconsQueueFlag=!0,setTimeout(()=>{t.iconsQueueFlag=!1;const{provider:i,prefix:s}=t,n=t.iconsToLoad;if(delete t.iconsToLoad,!n||!n.length)return;const r=t.loadIcon;if(t.loadIcons&&(n.length>1||!r)){ft(t.loadIcons(n,s,i),d=>{G(t,n,d)});return}if(r){n.forEach(d=>{ft(r(d,s,i),u=>{G(t,[d],u?{prefix:s,icons:{[d]:u}}:null)})});return}const{valid:o,invalid:a}=Yi(n);if(a.length&&G(t,a,null),!o.length)return;const l=s.match(Lt)?Ie(i):null;if(!l){G(t,o,null);return}l.prepare(i,s,o).forEach(d=>{Kt(i,d,u=>{G(t,d.icons,u)})})}))}const Ve=(t,e)=>{const i=Ji(Bi(t,!0,zt()));if(!i.pending.length){let a=!0;return e&&setTimeout(()=>{a&&e(i.loaded,i.missing,i.pending,mt)}),()=>{a=!1}}const s=Object.create(null),n=[];let r,o;return i.pending.forEach(a=>{const{provider:l,prefix:d}=a;if(d===o&&l===r)return;r=l,o=d,n.push(P(l,d));const u=s[l]||(s[l]=Object.create(null));u[d]||(u[d]=[])}),i.pending.forEach(a=>{const{provider:l,prefix:d,name:u}=a,p=P(l,d),y=p.pendingIcons||(p.pendingIcons=new Set);y.has(u)||(y.add(u),s[l][d].push(u))}),n.forEach(a=>{const l=s[a.provider][a.prefix];l.length&&Zi(a,l)}),e?Hi(e,i,n):mt},Xi=t=>new Promise((e,i)=>{const s=typeof t=="string"?ae(t,!0):t;if(!s){i(t);return}Ve([s||t],n=>{if(n.length&&s){const r=ie(s);if(r){e({...ne,...r});return}}i(t)})});function bt(t){try{const e=typeof t=="string"?JSON.parse(t):t;if(typeof e.body=="string")return{...e}}catch{}}function es(t,e){if(typeof t=="object")return{data:bt(t),value:t};if(typeof t!="string")return{value:t};if(t.includes("{")){const r=bt(t);if(r)return{data:r,value:t}}const i=ae(t,!0,!0);if(!i)return{value:t};const s=ie(i);if(s!==void 0||!i.prefix)return{value:t,name:i,data:s};const n=Ve([i],()=>e(t,i,ie(i)));return{value:t,name:i,loading:n}}let Vt=!1;try{Vt=navigator.vendor.indexOf("Apple")===0}catch{}function ts(t,e){switch(e){case"svg":case"bg":case"mask":return e}return e!=="style"&&(Vt||t.indexOf("<a")===-1)?"svg":t.indexOf("currentColor")===-1?"bg":"mask"}const is=/(-?[0-9.]*[0-9]+[0-9.]*)/g,ss=/^-?[0-9.]*[0-9]+[0-9.]*$/g;function Oe(t,e,i){if(e===1)return t;if(i=i||100,typeof t=="number")return Math.ceil(t*e*i)/i;if(typeof t!="string")return t;const s=t.split(is);if(s===null||!s.length)return t;const n=[];let r=s.shift(),o=ss.test(r);for(;;){if(o){const a=parseFloat(r);isNaN(a)?n.push(r):n.push(Math.ceil(a*e*i)/i)}else n.push(r);if(r=s.shift(),r===void 0)return n.join("");o=!o}}function ns(t,e="defs"){let i="";const s=t.indexOf("<"+e);for(;s>=0;){const n=t.indexOf(">",s),r=t.indexOf("</"+e);if(n===-1||r===-1)break;const o=t.indexOf(">",r);if(o===-1)break;i+=t.slice(n+1,r).trim(),t=t.slice(0,s).trim()+t.slice(o+1)}return{defs:i,content:t}}function as(t,e){return t?"<defs>"+t+"</defs>"+e:e}function rs(t,e,i){const s=ns(t);return as(s.defs,e+s.content+i)}const os=t=>t==="unset"||t==="undefined"||t==="none";function Gt(t,e){const i={...ne,...t},s={...Rt,...e},n={left:i.left,top:i.top,width:i.width,height:i.height};let r=i.body;[i,s].forEach(S=>{const k=[],B=S.hFlip,C=S.vFlip;let T=S.rotate;B?C?T+=2:(k.push("translate("+(n.width+n.left).toString()+" "+(0-n.top).toString()+")"),k.push("scale(-1 1)"),n.top=n.left=0):C&&(k.push("translate("+(0-n.left).toString()+" "+(n.height+n.top).toString()+")"),k.push("scale(1 -1)"),n.top=n.left=0);let _;switch(T<0&&(T-=Math.floor(T/4)*4),T=T%4,T){case 1:_=n.height/2+n.top,k.unshift("rotate(90 "+_.toString()+" "+_.toString()+")");break;case 2:k.unshift("rotate(180 "+(n.width/2+n.left).toString()+" "+(n.height/2+n.top).toString()+")");break;case 3:_=n.width/2+n.left,k.unshift("rotate(-90 "+_.toString()+" "+_.toString()+")");break}T%2===1&&(n.left!==n.top&&(_=n.left,n.left=n.top,n.top=_),n.width!==n.height&&(_=n.width,n.width=n.height,n.height=_)),k.length&&(r=rs(r,'<g transform="'+k.join(" ")+'">',"</g>"))});const o=s.width,a=s.height,l=n.width,d=n.height;let u,p;o===null?(p=a===null?"1em":a==="auto"?d:a,u=Oe(p,l/d)):(u=o==="auto"?l:o,p=a===null?Oe(u,d/l):a==="auto"?d:a);const y={},$=(S,k)=>{os(k)||(y[S]=k.toString())};$("width",u),$("height",p);const w=[n.left,n.top,l,d];return y.viewBox=w.join(" "),{attributes:y,viewBox:w,body:r}}function Ge(t,e){let i=t.indexOf("xlink:")===-1?"":' xmlns:xlink="http://www.w3.org/1999/xlink"';for(const s in e)i+=" "+s+'="'+e[s]+'"';return'<svg xmlns="http://www.w3.org/2000/svg"'+i+">"+t+"</svg>"}function ls(t){return t.replace(/"/g,"'").replace(/%/g,"%25").replace(/#/g,"%23").replace(/</g,"%3C").replace(/>/g,"%3E").replace(/\s+/g," ")}function cs(t){return"data:image/svg+xml,"+ls(t)}function Wt(t){return'url("'+cs(t)+'")'}const ds=()=>{let t;try{if(t=fetch,typeof t=="function")return t}catch{}};let fe=ds();function us(t){fe=t}function ps(){return fe}function hs(t,e){const i=we(t);if(!i)return 0;let s;if(!i.maxURL)s=0;else{let n=0;i.resources.forEach(o=>{n=Math.max(n,o.length)});const r=e+".json?icons=";s=i.maxURL-n-i.path.length-r.length}return s}function gs(t){return t===404}const ms=(t,e,i)=>{const s=[],n=hs(t,e),r="icons";let o={type:r,provider:t,prefix:e,icons:[]},a=0;return i.forEach((l,d)=>{a+=l.length+1,a>=n&&d>0&&(s.push(o),o={type:r,provider:t,prefix:e,icons:[]},a=l.length),o.icons.push(l)}),s.push(o),s};function fs(t){if(typeof t=="string"){const e=we(t);if(e)return e.path}return"/"}const bs=(t,e,i)=>{if(!fe){i("abort",424);return}let s=fs(e.provider);switch(e.type){case"icons":{const r=e.prefix,o=e.icons.join(","),a=new URLSearchParams({icons:o});s+=r+".json?"+a.toString();break}case"custom":{const r=e.uri;s+=r.slice(0,1)==="/"?r.slice(1):r;break}default:i("abort",400);return}let n=503;fe(t+s).then(r=>{const o=r.status;if(o!==200){setTimeout(()=>{i(gs(o)?"abort":"next",o)});return}return n=501,r.json()}).then(r=>{if(typeof r!="object"||r===null){setTimeout(()=>{r===404?i("abort",r):i("next",n)});return}setTimeout(()=>{i("success",r)})}).catch(()=>{i("next",n)})},vs={prepare:ms,send:bs};function ys(t,e,i){P(i||"",e).loadIcons=t}function xs(t,e,i){P(i||"",e).loadIcon=t}const Ae="data-style";let Qt="";function $s(t){Qt=t}function vt(t,e){let i=Array.from(t.childNodes).find(s=>s.hasAttribute&&s.hasAttribute(Ae));i||(i=document.createElement("style"),i.setAttribute(Ae,Ae),t.appendChild(i)),i.textContent=":host{display:inline-block;vertical-align:"+(e?"-0.125em":"0")+"}span,svg{display:block;margin:auto}"+Qt}function Yt(){pt("",vs),zt(!0);let t;try{t=window}catch{}if(t){if(t.IconifyPreload!==void 0){const i=t.IconifyPreload,s="Invalid IconifyPreload syntax.";typeof i=="object"&&i!==null&&(i instanceof Array?i:[i]).forEach(n=>{try{(typeof n!="object"||n===null||n instanceof Array||typeof n.icons!="object"||typeof n.prefix!="string"||!ut(n))&&console.error(s)}catch{console.error(s)}})}if(t.IconifyProviders!==void 0){const i=t.IconifyProviders;if(typeof i=="object"&&i!==null)for(const s in i){const n="IconifyProviders["+s+"] is invalid.";try{const r=i[s];if(typeof r!="object"||!r||r.resources===void 0)continue;ht(s,r)||console.error(n)}catch{console.error(n)}}}}return{iconLoaded:Ui,getIcon:qi,listIcons:Li,addIcon:Ht,addCollection:ut,calculateSize:Oe,buildIcon:Gt,iconToHTML:Ge,svgToURL:Wt,loadIcons:Ve,loadIcon:Xi,addAPIProvider:ht,setCustomIconLoader:xs,setCustomIconsLoader:ys,appendCustomStyle:$s,_api:{getAPIConfig:we,setAPIModule:pt,sendAPIQuery:Kt,setFetch:us,getFetch:ps,listAPIProviders:Ki}}}const Ne={"background-color":"currentColor"},Zt={"background-color":"transparent"},yt={image:"var(--svg)",repeat:"no-repeat",size:"100% 100%"},xt={"-webkit-mask":Ne,mask:Ne,background:Zt};for(const t in xt){const e=xt[t];for(const i in yt)e[t+"-"+i]=yt[i]}function $t(t){return t?t+(t.match(/^[-0-9.]+$/)?"px":""):"inherit"}function ws(t,e,i){const s=document.createElement("span");let n=t.body;n.indexOf("<a")!==-1&&(n+="<!-- "+Date.now()+" -->");const r=t.attributes,o=Ge(n,{...r,width:e.width+"",height:e.height+""}),a=Wt(o),l=s.style,d={"--svg":a,width:$t(r.width),height:$t(r.height),...i?Ne:Zt};for(const u in d)l.setProperty(u,d[u]);return s}let Q;function ks(){try{Q=window.trustedTypes.createPolicy("iconify",{createHTML:t=>t})}catch{Q=null}}function _s(t){return Q===void 0&&ks(),Q?Q.createHTML(t):t}function Ss(t){const e=document.createElement("span"),i=t.attributes;let s="";i.width||(s="width: inherit;"),i.height||(s+="height: inherit;"),s&&(i.style=s);const n=Ge(t.body,i);return e.innerHTML=_s(n),e.firstChild}function je(t){return Array.from(t.childNodes).find(e=>{const i=e.tagName&&e.tagName.toUpperCase();return i==="SPAN"||i==="SVG"})}function wt(t,e){const i=e.icon.data,s=e.customisations,n=Gt(i,s);s.preserveAspectRatio&&(n.attributes.preserveAspectRatio=s.preserveAspectRatio);const r=e.renderedMode;let o;r==="svg"?o=Ss(n):o=ws(n,{...ne,...i},r==="mask");const a=je(t);a?o.tagName==="SPAN"&&a.tagName===o.tagName?a.setAttribute("style",o.getAttribute("style")):t.replaceChild(o,a):t.appendChild(o)}function kt(t,e,i){const s=i&&(i.rendered?i:i.lastRender);return{rendered:!1,inline:e,icon:t,lastRender:s}}function Ts(t="iconify-icon"){let e,i;try{e=window.customElements,i=window.HTMLElement}catch{return}if(!e||!i)return;const s=e.get(t);if(s)return s;const n=["icon","mode","inline","noobserver","width","height","rotate","flip"],r=class extends i{_shadowRoot;_initialised=!1;_state;_checkQueued=!1;_connected=!1;_observer=null;_visible=!0;constructor(){super();const a=this._shadowRoot=this.attachShadow({mode:"open"}),l=this.hasAttribute("inline");vt(a,l),this._state=kt({value:""},l),this._queueCheck()}connectedCallback(){this._connected=!0,this.startObserver()}disconnectedCallback(){this._connected=!1,this.stopObserver()}static get observedAttributes(){return n.slice(0)}attributeChangedCallback(a){switch(a){case"inline":{const l=this.hasAttribute("inline"),d=this._state;l!==d.inline&&(d.inline=l,vt(this._shadowRoot,l));break}case"noobserver":{this.hasAttribute("noobserver")?this.startObserver():this.stopObserver();break}default:this._queueCheck()}}get icon(){const a=this.getAttribute("icon");if(a&&a.slice(0,1)==="{")try{return JSON.parse(a)}catch{}return a}set icon(a){typeof a=="object"&&(a=JSON.stringify(a)),this.setAttribute("icon",a)}get inline(){return this.hasAttribute("inline")}set inline(a){a?this.setAttribute("inline","true"):this.removeAttribute("inline")}get observer(){return this.hasAttribute("observer")}set observer(a){a?this.setAttribute("observer","true"):this.removeAttribute("observer")}restartAnimation(){const a=this._state;if(a.rendered){const l=this._shadowRoot;if(a.renderedMode==="svg")try{l.lastChild.setCurrentTime(0);return}catch{}wt(l,a)}}get status(){const a=this._state;return a.rendered?"rendered":a.icon.data===null?"failed":"loading"}_queueCheck(){this._checkQueued||(this._checkQueued=!0,setTimeout(()=>{this._check()}))}_check(){if(!this._checkQueued)return;this._checkQueued=!1;const a=this._state,l=this.getAttribute("icon");if(l!==a.icon.value){this._iconChanged(l);return}if(!a.rendered||!this._visible)return;const d=this.getAttribute("mode"),u=ct(this);(a.attrMode!==d||Di(a.customisations,u)||!je(this._shadowRoot))&&this._renderIcon(a.icon,u,d)}_iconChanged(a){const l=es(a,(d,u,p)=>{const y=this._state;if(y.rendered||this.getAttribute("icon")!==d)return;const $={value:d,name:u,data:p};$.data?this._gotIconData($):y.icon=$});l.data?this._gotIconData(l):this._state=kt(l,this._state.inline,this._state)}_forceRender(){if(!this._visible){const a=je(this._shadowRoot);a&&this._shadowRoot.removeChild(a);return}this._queueCheck()}_gotIconData(a){this._checkQueued=!1,this._renderIcon(a,ct(this),this.getAttribute("mode"))}_renderIcon(a,l,d){const u=ts(a.data.body,d),p=this._state.inline;wt(this._shadowRoot,this._state={rendered:!0,icon:a,inline:p,customisations:l,attrMode:d,renderedMode:u})}startObserver(){if(!this._observer&&!this.hasAttribute("noobserver"))try{this._observer=new IntersectionObserver(a=>{const l=a.some(d=>d.isIntersecting);l!==this._visible&&(this._visible=l,this._forceRender())}),this._observer.observe(this)}catch{if(this._observer){try{this._observer.disconnect()}catch{}this._observer=null}}}stopObserver(){this._observer&&(this._observer.disconnect(),this._observer=null,this._visible=!0,this._connected&&this._forceRender())}};n.forEach(a=>{a in r.prototype||Object.defineProperty(r.prototype,a,{get:function(){return this.getAttribute(a)},set:function(l){l!==null?this.setAttribute(a,l):this.removeAttribute(a)}})});const o=Yt();for(const a in o)r[a]=r.prototype[a]=o[a];return e.define(t,r),r}const As=Ts()||Yt(),{iconLoaded:cn,getIcon:dn,listIcons:un,addIcon:pn,addCollection:hn,calculateSize:gn,buildIcon:mn,iconToHTML:fn,svgToURL:bn,loadIcons:vn,loadIcon:yn,setCustomIconLoader:xn,setCustomIconsLoader:$n,addAPIProvider:wn,_api:kn}=As;class We extends Error{constructor(e,i){super(i),this.status=e,this.name="ApiRequestError"}}async function g(t,e){const i=await fetch(t,{...e,headers:{...e?.body?{"content-type":"application/json"}:{},...e?.headers}});if(!i.ok){const s=await i.json().catch(()=>({error:i.statusText}));throw new We(i.status,s.error||i.statusText)}return i.status===204?void 0:i.json()}function Re(t,e,i=!1){if(e==="telegram"){const s=String(t.get("bot_token")??"");return{type:"telegram",name:t.get("name"),bot_token:i&&!s?void 0:s,chat_id:t.get("chat_id"),default:t.get("default")==="on"}}if(e==="smtp"){const s=String(t.get("username")??""),n=String(t.get("password")??"");return{type:"smtp",name:t.get("name"),host:t.get("host"),port:Number(t.get("port")),security:t.get("security"),username:s||void 0,password:n||void 0,from:t.get("from"),to:t.get("to"),default:t.get("default")==="on"}}return{type:"webhook",name:t.get("name"),url:t.get("url"),headers:i?void 0:{},default:t.get("default")==="on"}}function Me(t,e=[],i=!0,s=String(t.get("kind")??"http"),n=[]){const r=String(t.get("url")),o=s==="http"?r:`${s}://${r.replace(/^[a-z][a-z0-9+.-]*:\/\//i,"")}`;return{name:String(t.get("name")),kind:s,url:o,method:String(t.get("method")??"GET"),accepted_statuses:[{start:200,end:299}],follow_redirects:!0,max_redirects:5,interval_seconds:Number(t.get("interval")),timeout_seconds:Number(t.get("timeout")),failure_threshold:Number(t.get("failures")),locations:Number(t.get("locations")??1),headers:{},body:null,assertions:n,skip_tls_verification:!1,tls_ca_secret_id:Ce(t,"tls_ca_secret_id"),tls_client_certificate_secret_id:Ce(t,"tls_client_certificate_secret_id"),tls_client_private_key_secret_id:Ce(t,"tls_client_private_key_secret_id"),notification_channel_ids:e,use_default_channels:i}}function Ce(t,e){return String(t.get(e)??"")||null}var Cs=Object.defineProperty,Es=Object.getOwnPropertyDescriptor,J=(t,e,i,s)=>{for(var n=s>1?void 0:s?Es(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(n=(s?o(e,i,n):o(n))||n);return s&&n&&Cs(e,i,n),n};let O=class extends R{constructor(){super(...arguments),this.channelKind="webhook",this.channels=[],this.saving=!1,this.error=""}connectedCallback(){super.connectedCallback(),this.loadChannels()}updated(t){t.has("setup")&&this.loadChannels()}async loadChannels(){if(!(!this.setup?.cluster_ready||this.setup.phase!=="target"))try{this.channels=await g("/api/v1/channels")}catch(t){this.fail(t)}}submittedNodeName(){return this.shadowRoot?.querySelector("#setup-node-name")?.value.trim()??""}async createCluster(t){if(t.preventDefault(),!window.confirm("Create a new single-Node Cluster?"))return;const e=new FormData(t.currentTarget),i=String(e.get("admin_username")??"").trim(),s=String(e.get("admin_password")??"");await this.choose("/api/v1/setup/new-cluster",{node_name:this.submittedNodeName(),admin_username:i,admin_password:s},{username:i,password:s})}async joinCluster(t){t.preventDefault();const e=t.currentTarget,i=new FormData(e);await this.choose("/api/v1/cluster/join",{node_name:this.submittedNodeName(),join_link:String(i.get("join_link")??"").trim()})}async choose(t,e,i){this.saving=!0,this.error="";try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.waitForCluster(i)}catch(s){this.fail(s),this.saving=!1}}async waitForCluster(t){for(let e=0;e<120;e+=1){const{promise:i,resolve:s}=Promise.withResolvers();window.setTimeout(s,250),await i;try{t&&await g("/api/v1/auth/login",{method:"POST",body:JSON.stringify(t)});const n=await g("/api/v1/setup");if(n.cluster_ready){this.changed(n);return}}catch(n){if(!t&&n instanceof We&&n.status===401){window.location.assign("/");return}}}throw new Error("Cluster setup did not finish within 30 seconds")}async createChannel(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Re(e,this.channelKind);await this.createResource("/api/v1/channels",i)}async createTarget(t){t.preventDefault();const e=new FormData(t.currentTarget),i=Me(e,e.getAll("channel_id").map(String));await this.createResource("/api/v1/targets",i)}async createResource(t,e){this.saving=!0;try{await g(t,{method:"POST",body:JSON.stringify(e)}),await this.next()}catch(i){this.fail(i),this.saving=!1}}async next(){this.saving=!0;try{this.changed(await g("/api/v1/setup/next",{method:"POST"}))}catch(t){this.fail(t),this.saving=!1}}changed(t){this.saving=!1,this.dispatchEvent(new CustomEvent("setup-changed",{detail:t,bubbles:!0,composed:!0}))}fail(t){this.error=t instanceof Error?t.message:String(t)}render(){return c`<section class="flow" aria-label="UpGrid setup">
        ...
        ${i.length?i.map(a=>c`
              <div class="resource channel-resource">
                ...
                <div class="channel-actions">
                  <label class="switch"><span>Default</span><input class="switch-control" type="checkbox" role="switch" aria-label=${`Default channel ${a.name}`} .checked=${a.default} @change=${l=>r.setDefault(a,l.target.checked)} /></label>
                  <button class="button secondary icon-button" aria-label=${`Edit channel ${a.name}`} title=${`Edit ${a.name}`} @click=${()=>r.edit(a)}><iconify-icon .icon=${qs} aria-hidden="true"></iconify-icon></button>
                  <button class="button danger icon-button" aria-label=${`Delete channel ${a.name}`} title=${`Delete ${a.name}`} @click=${()=>r.remove(a)}><iconify-icon .icon=${he} aria-hidden="true"></iconify-icon></button>
                </div>
              </div>
  ...
  `}function Js(t,e,i){return c`
    ...
    </main>`}function Bs(t,e,i){return t?c`
    ...
    </div>`:c`<div class="empty">Current identity unavailable.</div>`}function Ks(t,e,i,s,n){return c`
    <div class="admin-page">
      ...
      <section class="panel" aria-label="Operator Identities">
        ...
        ${t.map(r=>c`
            <div class="resource">
              ...
              <div class="actions">
                <button class="button secondary" type="button" ?disabled=${s} @click=${()=>n.openEditUser(r)}>Edit</button>
                <button class="button danger" type="button" ?disabled=${r.id===e||s} @click=${()=>n.deleteIdentity(r)}>Delete</button>
              </div>
            </div>`)}
      </section>
    </div>
    ...
    ${i?c`
          <dialog id="edit-user-dialog" aria-labelledby="edit-user-title" @click=${n.dismissDialog}>
            ...
            <form @submit=${r=>n.updateIdentity(i,r)}>
          ...
          </dialog>`:m}`}function Vs(t,e,i,s){return c`
    <div class="admin-page">
...
`;function Y(t,e,i){return c`
  ...
  `}function Xt(t,e=[],i=!0){return c`
    <fieldset class="channel-fields">
      ...
      <div class="channel-options">
        ${t.length?t.map(n=>{const r=e.includes(n.id),o=i&&n.default;return c`
    ...
    </fieldset>`}function Xs(t,e=null,i=null,s=null){const n=r=>c`
  ...
  `}const ei={http:"https://example.com/health",tcp:"database.internal:5432",dns:"service.internal",icmp:"192.0.2.10",tls:"example.com:443"};function Qe(t,e){t.querySelectorAll("[role='tab']").forEach(i=>{const s=i.dataset.tab===e;i.setAttribute("aria-selected",String(s)),i.tabIndex=s?0:-1}),t.querySelectorAll("[role='tabpanel']").forEach(i=>{i.hidden=i.dataset.panel!==e})}function ti(t,e){const i=t.elements.namedItem("url");i&&(i.placeholder=ei[e],i.type=e==="http"?"url":"text"),t.querySelectorAll("[data-http-only]").forEach(o=>{o.hidden=e!=="http"});const s=t.querySelector("[role='tab'][aria-selected='true']")?.dataset.tab??"general",n=t.querySelector("[data-tab='assertions']");n&&(n.disabled=e!=="http"),Qe(t,e!=="http"&&s==="assertions"?"general":s);const r=t.elements.namedItem("method");r&&(r.disabled=e!=="http",r.disabled&&(r.value="GET"))}function en(t){const e=t.currentTarget;e.form&&ti(e.form,e.value)}function re(t){const e=t.currentTarget;e.form&&e.dataset.tab&&Qe(e.form,e.dataset.tab)}function tn(t){const e=t.currentTarget;queueMicrotask(()=>{ti(e,"http"),Qe(e,"general")})}function sn(t,e,i){return c`
    <dialog id="target-dialog" aria-labelledby="add-target-title" @click=${i.backdrop}>
      ...
      <form @submit=${i.create} @reset=${tn}>
        <div class="form-tabs" role="tablist" aria-label="Target settings">
          <button id="target-general-tab" type="button" role="tab" data-tab="general" aria-controls="target-general-panel" aria-selected="true" @click=${re}>General</button>
          <button id="target-assertions-tab" type="button" role="tab" data-tab="assertions" aria-controls="target-assertions-panel" aria-selected="false" tabindex="-1" @click=${re}>Assertions</button>
          <button id="target-evaluation-tab" type="button" role="tab" data-tab="evaluation" aria-controls="target-evaluation-panel" aria-selected="false" tabindex="-1" @click=${re}>Evaluation</button>
          <button id="target-notifications-tab" type="button" role="tab" data-tab="notifications" aria-controls="target-notifications-panel" aria-selected="false" tabindex="-1" @click=${re}>Notifications</button>
        </div>
    ...
    </dialog>`}function nn(t,e,i,s,n,r,o,a,l){const d=t.kind==="node",u=t.kind==="http",p=t.accepted_statuses.map(h=>h.start===h.end?h.start:`${h.start}-${h.end}`).join(","),y=t.history.slice(0,30).reverse(),$=Math.max(1,...y.map(h=>h.latency_ms)),w=e?.items??[],S=w.reduce((h,A)=>h+A.samples,0),k=w.reduce((h,A)=>h+A.successes,0),B=w.reduce((h,A)=>h+A.latency_total_ms,0),C=S?`${(k/S*100).toFixed(2)}%`:"—",T=new Map(r.map(h=>[h.id,h.name])),_=h=>new Date(h).toLocaleString(void 0,{month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}),D=h=>h>=1e3?`${(h/1e3).toFixed(h>=1e4?0:1)} s`:`${Math.round(h)} ms`,x=S?D(B/S):"—";return c`
    <dialog id="detail-dialog" aria-labelledby="target-detail-title" @click=${l.backdrop}>
      ...
      <form @submit=${l.update} @input=${l.changed}>
        ...
        ${d?c`<label>RPC URL<input .value=${t.url} disabled /></label>`:c`
              ...
              ${u?c`
                    ...
                    ${Xs(a,t.tls_ca_secret_id,t.tls_client_certificate_secret_id,t.tls_client_private_key_secret_id)}
                  `:m}
        ...
        <div class="dialog-actions">
          ${d?m:c`<div class="danger-actions">
            <button class="button danger icon-button" type="button" aria-label="Move Target to Trash" title="Move to Trash" @click=${l.delete}><iconify-icon .icon=${he} aria-hidden="true"></iconify-icon></button>
    ...
    </dialog>`}var an=Object.getOwnPropertyDescriptor,rn=(t,e,i,s)=>{for(var n=s>1?void 0:s?an(e,i):e,r=t.length-1,o;r>=0;r--)(o=t[r])&&(n=o(n)||n);return n};let Le=class extends Us{render(){const t=this.targets.filter(a=>a.availability==="up").length,e=this.targets.filter(a=>a.availability==="down").length,i=this.alerts.filter(a=>a.delivery==="pending").length,s=Ms(this.targets,this.live),n=["overview","alerts","cluster","trash"],r=this.targets.filter(a=>`${a.name} ${a.url}`.toLowerCase().includes(this.search.toLowerCase())).filter(a=>this.statusFilter==="all"?!0:this.statusFilter==="paused"?a.paused:a.availability===this.statusFilter).sort((a,l)=>this.sort==="status"&&a.availability.localeCompare(l.availability)||a.name.localeCompare(l.name)),o={login:a=>{this.login(a)},logout:()=>{this.logout()},createIdentity:a=>{this.createIdentity(a)},openAddUser:()=>this.showDialog("add-user-dialog"),closeAddUser:()=>this.closeDialog("add-user-dialog"),openEditUser:a=>{this.editingIdentity=a,this.updateComplete.then(()=>this.showDialog("edit-user-dialog"))},closeEditUser:()=>{this.closeDialog("edit-user-dialog"),this.editingIdentity=void 0},openApiToken:()=>this.showDialog("api-token-dialog"),closeApiToken:()=>this.closeDialog("api-token-dialog"),dismissDialog:a=>this.dismissOnBackdrop(a),updateIdentity:(a,l)=>{this.updateIdentity(a,l)},deleteIdentity:a=>{this.deleteIdentity(a)},createApiToken:a=>{this.createApiToken(a)},revokeApiToken:a=>{this.revokeApiToken(a)},dismissToken:()=>this.newApiToken=""};return this.authReady&&!this.setupMode&&!this.session?c`${Js(this.saving,this.error,o)}${Ee()}`:this.setupMode&&this.setup?c`
        <main class="shell setup-shell">
          <header>
            <div class="brand">
      ...
      <main class="shell">
        ...
        ${this.activeSection==="overview"?this.renderOverview(r,t,e,i):this.activeSection==="alerts"?Hs(this.alerts,this.transitions,this.channels,{search:this.alertSearch,delivery:this.alertDeliveryFilter,kind:this.alertKindFilter,acknowledged:this.alertAcknowledgedFilter},this.saving,{create:()=>this.openChannelDialog(),edit:a=>this.openChannelDialog(a),remove:a=>{this.deleteResource("channels",a.id,a.name)},setDefault:(a,l)=>{this.setChannelDefault(a,l)},acknowledge:a=>{this.acknowledgeAlert(a)},retry:a=>{this.retryAlert(a)},setSearch:a=>this.alertSearch=a,setDelivery:a=>this.alertDeliveryFilter=a,setKind:a=>this.alertKindFilter=a,setAcknowledged:a=>this.alertAcknowledgedFilter=a}):this.activeSection==="cluster"?this.renderClusterPage():this.activeSection==="trash"?this.renderTrashPage():this.activeSection==="changePassword"?Bs(this.identities.find(a=>a.id===this.session?.identity_id),this.saving,o):this.activeSection==="users"?Ks(this.identities,this.session?.identity_id,this.editingIdentity,this.saving,o):Vs(this.apiTokens,this.newApiToken,this.saving,o)}
      </main>${Ee()}
      ${sn(this.channels,this.saving,{backdrop:a=>this.dismissOnBackdrop(a),close:()=>this.closeTargetDialog(),create:a=>{this.createTarget(a)}})}
      ...
      <dialog id="token-config-dialog" aria-labelledby="token-config-title" @click=${this.dismissOnBackdrop}>
        ...
        <form @submit=${this.createJoinToken}>
          ...
          <label class="switch"><span>Unlimited uses</span><input class="switch-control" type="checkbox" role="switch" .checked=${this.unlimitedUses} @change=${a=>this.unlimitedUses=a.target.checked} /></label>
    ...
    `}renderOverview(t,e,i,s){const n=this.targets.filter(l=>this.selectedIds.has(l.id)),r=n.some(l=>!l.paused),o=n.some(l=>l.paused),a=this.secrets.filter(l=>!l.referenced);return c`
      ...
      <section class="overview-top">
        ...
        <section class="panel" aria-label="Secrets">
          ...
          ${this.secrets.length?this.secrets.map(l=>c`<div class="resource"><div><strong>${l.name}</strong><code>${l.id} · ${l.referenced?"In use":"Unused"}</code></div><button class="button danger icon-button" aria-label=${`Delete secret ${l.name}`} title=${`Delete ${l.name}`} @click=${()=>this.deleteResource("secrets",l.id,l.name)}><iconify-icon .icon=${he} aria-hidden="true"></iconify-icon></button></div>`):c`<div class="empty">No reusable Secrets.</div>`}
        </section>
      </section>
